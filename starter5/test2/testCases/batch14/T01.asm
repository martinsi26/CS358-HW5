...
# ****** class C1 ****** # ClassDecl at 22.7
  .byte 0 # ClassDecl at 22.7
  .byte 0 # ClassDecl at 22.7
  .byte 195 # 'C' with high bit set # ClassDecl at 22.7
  .byte 49 # '1' # ClassDecl at 22.7
CLASS_C1: # ClassDecl at 22.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
# ****** class C2 ****** # ClassDecl at 19.7
  .byte 0 # ClassDecl at 19.7
  .byte 0 # ClassDecl at 19.7
  .byte 195 # 'C' with high bit set # ClassDecl at 19.7
  .byte 50 # '2' # ClassDecl at 19.7
CLASS_C2: # ClassDecl at 19.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
END_CLASS_C2: # ClassDecl at 19.7
END_CLASS_C1: # ClassDecl at 22.7
...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 74 # StringLiteral at 15.16
  .byte 117 # StringLiteral at 15.16
  .byte 109 # StringLiteral at 15.16
  .byte 98 # StringLiteral at 15.16
  .byte 108 # StringLiteral at 15.16
  .byte 101 # StringLiteral at 15.16
  .byte 115 # StringLiteral at 15.16
  .byte 32 # StringLiteral at 15.16
  .byte 111 # StringLiteral at 15.16
  .byte 102 # StringLiteral at 15.16
  .byte 32 # StringLiteral at 15.16
  .byte 67 # StringLiteral at 15.16
  .byte 114 # StringLiteral at 15.16
  .byte 117 # StringLiteral at 15.16
  .byte 109 # StringLiteral at 15.16
  .byte 98 # StringLiteral at 15.16
  .byte 108 # StringLiteral at 15.16
  .byte 101 # StringLiteral at 15.16
  .byte 115 # StringLiteral at 15.16
  .byte 33 # StringLiteral at 15.16
  .byte 10 # StringLiteral at 15.16
  .byte 0 # StringLiteral at 15.16
  .byte 0 # StringLiteral at 15.16
  .byte 0 # StringLiteral at 15.16
  .word CLASS_String # StringLiteral at 15.16
  .word 7 # StringLiteral at 15.16
  .word -21 # StringLiteral at 15.16
strLit_48: # StringLiteral at 15.16
.text
.globl main
main:
    jal vm_init
...
# begin: NewObject at 8.18; stackHeight = 12
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_C2
    sw $t0, -12($s7)
# end: NewObject at 8.18; stackHeight = 16
    lw $zero, ($sp) #**"abc22"
# end: LocalVarDecl at 8.10; stackHeight = 16
# begin: Assign at 9.12; stackHeight = 16
# begin: Cast at 9.14; stackHeight = 16
# begin: IdentifierExp at 9.18; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 9.18; stackHeight = 20
    # skipping cast check
# end: Cast at 9.14; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 12($sp)
# end: Assign at 9.12; stackHeight = 16
# begin: Assign at 10.12; stackHeight = 16
# begin: Cast at 10.14; stackHeight = 16
# begin: IdentifierExp at 10.18; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.18; stackHeight = 20
    la $t0, CLASS_C2
    la $t1, END_CLASS_C2
    jal checkCast
# end: Cast at 10.14; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 12($sp)
# end: Assign at 10.12; stackHeight = 16
# begin: Assign at 11.12; stackHeight = 16
# begin: Cast at 11.14; stackHeight = 16
# begin: IdentifierExp at 11.18; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 11.18; stackHeight = 20
    la $t0, CLASS_C2
    la $t1, END_CLASS_C2
    jal checkCast
# end: Cast at 11.14; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 8($sp)
# end: Assign at 11.12; stackHeight = 16
# begin: Assign at 12.12; stackHeight = 16
# begin: Cast at 12.14; stackHeight = 16
# begin: IdentifierExp at 12.18; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.18; stackHeight = 20
    # skipping cast check
# end: Cast at 12.14; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 12($sp)
# end: Assign at 12.12; stackHeight = 16
# begin: Assign at 13.12; stackHeight = 16
# begin: Cast at 13.14; stackHeight = 16
...
# end: IdentifierExp at 13.18; stackHeight = 20
    # skipping cast check
# end: Cast at 13.14; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 12($sp)
# end: Assign at 13.12; stackHeight = 16
# begin: Assign at 14.12; stackHeight = 16
# begin: Cast at 14.14; stackHeight = 16
# begin: IdentifierExp at 14.18; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.18; stackHeight = 20
    # skipping cast check
# end: Cast at 14.14; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 8($sp)
# end: Assign at 14.12; stackHeight = 16
# begin: CallStatement at 15.7; stackHeight = 16
# begin: Call at 15.7; stackHeight = 16
# begin: This at 15.7; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 15.7; stackHeight = 20
# begin: StringLiteral at 15.16; stackHeight = 20
    la $t0, strLit_48
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 15.16; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 15.7; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 15.7; stackHeight = 16
    addu $sp, $sp, 16
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
