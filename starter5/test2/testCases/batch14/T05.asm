...
# ****** class C1 ****** # ClassDecl at 14.7
  .byte 0 # ClassDecl at 14.7
  .byte 0 # ClassDecl at 14.7
  .byte 195 # 'C' with high bit set # ClassDecl at 14.7
  .byte 49 # '1' # ClassDecl at 14.7
CLASS_C1: # ClassDecl at 14.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
# ****** class C2 ****** # ClassDecl at 11.7
  .byte 0 # ClassDecl at 11.7
  .byte 0 # ClassDecl at 11.7
  .byte 195 # 'C' with high bit set # ClassDecl at 11.7
  .byte 50 # '2' # ClassDecl at 11.7
CLASS_C2: # ClassDecl at 11.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
END_CLASS_C2: # ClassDecl at 11.7
END_CLASS_C1: # ClassDecl at 14.7
...
# begin: Cast at 6.17; stackHeight = 4
# begin: IdentifierExp at 6.21; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 6.21; stackHeight = 8
    la $t0, CLASS_C2
    la $t1, END_CLASS_C2
    jal checkCast
# end: Cast at 6.17; stackHeight = 8
    lw $zero, ($sp) #**"abc2"
