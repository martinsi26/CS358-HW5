...
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 5.19
  .byte 0 # ArrayType at 5.19
  .byte 219 # '[' with high bit set # ArrayType at 5.19
  .byte 73 # 'I' # ArrayType at 5.19
CLASS_ARRAY_INT: # ArrayType at 5.19
  .word mth_Object_hashCode # ArrayType at 5.19
  .word mth_Object_equals # ArrayType at 5.19
  .word mth_Object_toString # ArrayType at 5.19
END_CLASS_ARRAY_INT: # ArrayType at 5.19
...
strLit_8: # StringLiteral at 6.18
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 5.9; stackHeight = 0
# begin: Call at 5.9; stackHeight = 0
# begin: Super at 5.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 5.9; stackHeight = 4
# begin: ArrayLookup at 5.30; stackHeight = 4
# begin: IntegerLiteral at 5.31; stackHeight = 4
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.31; stackHeight = 12
# begin: NewArray at 5.19; stackHeight = 12
# begin: IntegerLiteral at 5.27; stackHeight = 12
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.27; stackHeight = 20
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 5.19; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 5.30; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 5.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 5.9; stackHeight = 0
# begin: CallStatement at 6.9; stackHeight = 0
# begin: Call at 6.9; stackHeight = 0
# begin: Super at 6.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 6.9; stackHeight = 4
# begin: StringLiteral at 6.18; stackHeight = 4
    la $t0, strLit_8
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.18; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 6.9; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
