...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Main_main # MethodDeclVoid at 5.17
  .word mth_Main_init # MethodDeclNonVoid at 9.17
...
# field Main.q offset = -16: InstVarDecl at 4.9
# init parameter k offset = 4: MethodDeclNonVoid at 9.17
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 6.8; stackHeight = 0
# begin: Call at 6.8; stackHeight = 0
# begin: Super at 6.8; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 6.8; stackHeight = 4
# begin: InstVarAccess at 6.37; stackHeight = 4
# begin: Call at 6.28; stackHeight = 4
# begin: NewObject at 6.17; stackHeight = 4
    li $s6, 2
    li $s7, 0
    jal newObject
    la $t0, CLASS_Main
    sw $t0, -12($s7)
# end: NewObject at 6.17; stackHeight = 8
# begin: IntegerLiteral at 6.33; stackHeight = 8
    li $t0, 124
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.33; stackHeight = 16
    lw $zero, ($sp) #**"k"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.28; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 6.37; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.8; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 6.8; stackHeight = 0
# begin: CallStatement at 7.8; stackHeight = 0
# begin: Call at 7.8; stackHeight = 0
# begin: Super at 7.8; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 7.8; stackHeight = 4
# begin: StringLiteral at 7.17; stackHeight = 4
    la $t0, strLit_10
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 7.17; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.8; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.8; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Main_init:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:init"
# begin: Assign at 10.4; stackHeight = 0
# begin: IdentifierExp at 10.6; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.6; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 10.4; stackHeight = 0
# begin: This at 11.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
