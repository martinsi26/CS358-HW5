...
# ****** class IntList01 ****** # ClassDecl at 26.7
  ...
  .byte 76 # 'L' # ClassDecl at 26.7
  .byte 105 # 'i' # ClassDecl at 26.7
  .byte 115 # 's' # ClassDecl at 26.7
  .byte 116 # 't' # ClassDecl at 26.7
  .byte 48 # '0' # ClassDecl at 26.7
  .byte 49 # '1' # ClassDecl at 26.7
CLASS_IntList01: # ClassDecl at 26.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_IntList01_init # MethodDeclNonVoid at 29.19
END_CLASS_IntList01: # ClassDecl at 26.7
...
# field IntList01.val offset = -16: InstVarDecl at 27.6
# field IntList01.next offset = 0: InstVarDecl at 28.12
# init parameter v offset = 8: MethodDeclNonVoid at 29.19
# init parameter nxt offset = 4: MethodDeclNonVoid at 29.19
  .byte 32 # StringLiteral at 12.17
  .byte 0 # StringLiteral at 12.17
  .byte 0 # StringLiteral at 12.17
  .byte 0 # StringLiteral at 12.17
  .word CLASS_String # StringLiteral at 12.17
  .word 2 # StringLiteral at 12.17
  .word -1 # StringLiteral at 12.17
strLit_54: # StringLiteral at 12.17
  .byte 10 # StringLiteral at 14.16
  .byte 0 # StringLiteral at 14.16
  .byte 0 # StringLiteral at 14.16
  .byte 0 # StringLiteral at 14.16
  .word CLASS_String # StringLiteral at 14.16
  .word 2 # StringLiteral at 14.16
  .word -1 # StringLiteral at 14.16
strLit_62: # StringLiteral at 14.16
.text
.globl main
main:
    jal vm_init
...
# begin: Null at 6.22; stackHeight = 4
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 6.22; stackHeight = 8
    lw $zero, ($sp) #**"myList"
# end: LocalVarDecl at 6.13; stackHeight = 8
# begin: Block at 7.3; stackHeight = 8
# begin: LocalVarDecl at 7.12; stackHeight = 8
...
# end: IntegerLiteral at 7.16; stackHeight = 16
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 7.12; stackHeight = 16
# begin: BreakTarget at 7.3; stackHeight = 16
    j while_cond_34
  while_top_34:
# begin: Block at 7.3; stackHeight = 16
# begin: Block at 7.45; stackHeight = 16
# begin: Assign at 8.11; stackHeight = 16
# begin: Call at 8.29; stackHeight = 16
# begin: NewObject at 8.13; stackHeight = 16
    li $s6, 2
    li $s7, 1
    jal newObject
    la $t0, CLASS_IntList01
    sw $t0, -12($s7)
# end: NewObject at 8.13; stackHeight = 20
# begin: IdentifierExp at 8.34; stackHeight = 20
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.34; stackHeight = 28
    lw $zero, ($sp) #**"v"
# begin: IdentifierExp at 8.37; stackHeight = 28
    lw $t0, 20($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.37; stackHeight = 32
    lw $zero, ($sp) #**"nxt"
    lw $t0, 12($sp)
    sw $s2, 12($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.29; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 8($sp)
# end: Assign at 8.11; stackHeight = 16
# end: Block at 7.45; stackHeight = 16
# begin: Assign at 7.30; stackHeight = 16
# begin: Divide at 7.40; stackHeight = 16
# begin: Plus at 7.37; stackHeight = 16
# begin: Times at 7.34; stackHeight = 16
# begin: IdentifierExp at 7.33; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.33; stackHeight = 24
# begin: IntegerLiteral at 7.35; stackHeight = 24
    li $t0, 20
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.35; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 7.34; stackHeight = 24
# begin: IntegerLiteral at 7.38; stackHeight = 24
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.38; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 7.37; stackHeight = 24
# begin: IntegerLiteral at 7.41; stackHeight = 24
    li $t0, 11
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.41; stackHeight = 32
    jal divide
# end: Divide at 7.40; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 7.30; stackHeight = 16
# end: Block at 7.3; stackHeight = 16
  while_cond_34:
# begin: LessThan at 7.21; stackHeight = 16
# begin: IdentifierExp at 7.19; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.19; stackHeight = 24
# begin: IntegerLiteral at 7.23; stackHeight = 24
    li $t0, 100
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.23; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 7.21; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_34
  break_target_34:
# end: BreakTarget at 7.3; stackHeight = 16
    addu $sp, $sp, 8
# end: Block at 7.3; stackHeight = 8
# begin: Block at 10.3; stackHeight = 8
# begin: LocalVarDecl at 10.18; stackHeight = 8
# begin: IdentifierExp at 10.22; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.22; stackHeight = 12
    lw $zero, ($sp) #**"p"
# end: LocalVarDecl at 10.18; stackHeight = 12
# begin: BreakTarget at 10.3; stackHeight = 12
    j while_cond_59
  while_top_59:
# begin: Block at 10.3; stackHeight = 12
# begin: Block at 10.53; stackHeight = 12
# begin: CallStatement at 11.8; stackHeight = 12
# begin: Call at 11.8; stackHeight = 12
# begin: IdentifierExp at 11.4; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 11.4; stackHeight = 16
# begin: InstVarAccess at 11.18; stackHeight = 16
# begin: IdentifierExp at 11.17; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 11.17; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 11.18; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.8; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.8; stackHeight = 12
# begin: CallStatement at 12.8; stackHeight = 12
# begin: Call at 12.8; stackHeight = 12
# begin: IdentifierExp at 12.4; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.4; stackHeight = 16
# begin: StringLiteral at 12.17; stackHeight = 16
    la $t0, strLit_54
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.17; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: Block at 10.53; stackHeight = 12
# begin: Assign at 10.43; stackHeight = 12
# begin: InstVarAccess at 10.46; stackHeight = 12
# begin: IdentifierExp at 10.45; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.45; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, 0($t0)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 10.46; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 10.43; stackHeight = 12
# end: Block at 10.3; stackHeight = 12
  while_cond_59:
# begin: Not at 10.32; stackHeight = 12
# begin: Equals at 10.32; stackHeight = 12
# begin: IdentifierExp at 10.30; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.30; stackHeight = 16
# begin: Null at 10.35; stackHeight = 16
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 10.35; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 10.32; stackHeight = 16
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 10.32; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_59
  break_target_59:
# end: BreakTarget at 10.3; stackHeight = 12
    addu $sp, $sp, 4
# end: Block at 10.3; stackHeight = 8
# begin: CallStatement at 14.7; stackHeight = 8
# begin: Call at 14.7; stackHeight = 8
# begin: IdentifierExp at 14.3; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.3; stackHeight = 12
# begin: StringLiteral at 14.16; stackHeight = 12
    la $t0, strLit_62
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 14.16; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.7; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.7; stackHeight = 8
# begin: Block at 15.3; stackHeight = 8
# begin: LocalVarDecl at 15.18; stackHeight = 8
# begin: IdentifierExp at 15.22; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.22; stackHeight = 12
    lw $zero, ($sp) #**"p"
# end: LocalVarDecl at 15.18; stackHeight = 12
# begin: BreakTarget at 15.3; stackHeight = 12
    j while_cond_91
  while_top_91:
# begin: Block at 15.3; stackHeight = 12
# begin: Block at 15.71; stackHeight = 12
# begin: Assign at 16.11; stackHeight = 12
# begin: InstVarAccess at 16.19; stackHeight = 12
# begin: InstVarAccess at 16.14; stackHeight = 12
# begin: IdentifierExp at 16.13; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 16.13; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, 0($t0)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 16.14; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, 0($t0)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 16.19; stackHeight = 16
# begin: IdentifierExp at 16.4; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 16.4; stackHeight = 20
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    addu $sp, $sp, 4
    sw $t0, 0($t1)
# end: Assign at 16.11; stackHeight = 12
# end: Block at 15.71; stackHeight = 12
# begin: Assign at 15.61; stackHeight = 12
# begin: InstVarAccess at 15.64; stackHeight = 12
# begin: IdentifierExp at 15.63; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.63; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, 0($t0)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 15.64; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 15.61; stackHeight = 12
# end: Block at 15.3; stackHeight = 12
  while_cond_91:
# begin: And at 15.40; stackHeight = 12
# begin: Not at 15.32; stackHeight = 12
# begin: Equals at 15.32; stackHeight = 12
# begin: IdentifierExp at 15.30; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.30; stackHeight = 16
# begin: Null at 15.35; stackHeight = 16
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 15.35; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 15.32; stackHeight = 16
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 15.32; stackHeight = 16
    lw $t0, ($sp)
    beq $t0, $zero, skip_78
    addu $sp, $sp, 4
# begin: Not at 15.50; stackHeight = 12
# begin: Equals at 15.50; stackHeight = 12
# begin: InstVarAccess at 15.44; stackHeight = 12
# begin: IdentifierExp at 15.43; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.43; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, 0($t0)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 15.44; stackHeight = 16
# begin: Null at 15.53; stackHeight = 16
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 15.53; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 15.50; stackHeight = 16
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 15.50; stackHeight = 16
  skip_78:
# end: And at 15.40; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_91
  break_target_91:
# end: BreakTarget at 15.3; stackHeight = 12
    addu $sp, $sp, 4
# end: Block at 15.3; stackHeight = 8
# begin: Block at 18.3; stackHeight = 8
# begin: LocalVarDecl at 18.18; stackHeight = 8
# begin: IdentifierExp at 18.22; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 18.22; stackHeight = 12
    lw $zero, ($sp) #**"p"
# end: LocalVarDecl at 18.18; stackHeight = 12
# begin: BreakTarget at 18.3; stackHeight = 12
    j while_cond_116
  while_top_116:
# begin: Block at 18.3; stackHeight = 12
# begin: Block at 18.53; stackHeight = 12
# begin: CallStatement at 19.8; stackHeight = 12
# begin: Call at 19.8; stackHeight = 12
# begin: IdentifierExp at 19.4; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 19.4; stackHeight = 16
# begin: InstVarAccess at 19.18; stackHeight = 16
# begin: IdentifierExp at 19.17; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 19.17; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -16($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 19.18; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 20.8; stackHeight = 12
# begin: Call at 20.8; stackHeight = 12
# begin: IdentifierExp at 20.4; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 20.4; stackHeight = 16
# begin: StringLiteral at 20.17; stackHeight = 16
    la $t0, strLit_54
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 20.17; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.8; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.8; stackHeight = 12
# end: Block at 18.53; stackHeight = 12
# begin: Assign at 18.43; stackHeight = 12
# begin: InstVarAccess at 18.46; stackHeight = 12
# begin: IdentifierExp at 18.45; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 18.45; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, 0($t0)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 18.46; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 18.43; stackHeight = 12
# end: Block at 18.3; stackHeight = 12
  while_cond_116:
# begin: Not at 18.32; stackHeight = 12
# begin: Equals at 18.32; stackHeight = 12
# begin: IdentifierExp at 18.30; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 18.30; stackHeight = 16
# begin: Null at 18.35; stackHeight = 16
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 18.35; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 18.32; stackHeight = 16
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 18.32; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_116
  break_target_116:
# end: BreakTarget at 18.3; stackHeight = 12
    addu $sp, $sp, 4
# end: Block at 18.3; stackHeight = 8
...
# begin: StringLiteral at 22.16; stackHeight = 12
    la $t0, strLit_62
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 22.16; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: CallStatement at 22.7; stackHeight = 8
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_IntList01_init
mth_IntList01_init:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:init"
# begin: Assign at 30.7; stackHeight = 0
# begin: IdentifierExp at 30.9; stackHeight = 0
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 30.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 30.7; stackHeight = 0
# begin: Assign at 31.8; stackHeight = 0
# begin: IdentifierExp at 31.10; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 31.10; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($s2)
# end: Assign at 31.8; stackHeight = 0
# begin: This at 32.10; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 32.10; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
