...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Main_main # MethodDeclVoid at 10.14
  .word mth_Main_f1 # MethodDeclVoid at 15.14
  .word mth_Main_f2 # MethodDeclNonVoid at 25.13
  .word mth_Main_f3 # MethodDeclNonVoid at 31.13
  .word mth_Main_f4 # MethodDeclNonVoid at 40.13
...
# field Main.z offset = -16: InstVarDecl at 6.6
# field Main.a offset = -20: InstVarDecl at 7.6
# field Main.nn offset = -24: InstVarDecl at 8.6
# f1 parameter i offset = 4: MethodDeclVoid at 15.14
# f2 parameter i offset = 12: MethodDeclNonVoid at 25.13
# f2 parameter q offset = 4: MethodDeclNonVoid at 25.13
# f3 parameter i offset = 12: MethodDeclNonVoid at 31.13
# f3 parameter q offset = 4: MethodDeclNonVoid at 31.13
# f4 parameter i offset = 12: MethodDeclNonVoid at 40.13
# f4 parameter q offset = 4: MethodDeclNonVoid at 40.13
  .byte 10 # StringLiteral at 20.33
  .byte 0 # StringLiteral at 20.33
  .byte 0 # StringLiteral at 20.33
  .byte 0 # StringLiteral at 20.33
  .word CLASS_String # StringLiteral at 20.33
  .word 2 # StringLiteral at 20.33
  .word -1 # StringLiteral at 20.33
strLit_42: # StringLiteral at 20.33
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: Assign at 11.7; stackHeight = 0
# begin: NewObject at 11.9; stackHeight = 0
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Lib
    sw $t0, -12($s7)
# end: NewObject at 11.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($s2)
# end: Assign at 11.7; stackHeight = 0
# begin: CallStatement at 12.3; stackHeight = 0
# begin: Call at 12.3; stackHeight = 0
# begin: This at 12.3; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 12.3; stackHeight = 4
# begin: IntegerLiteral at 12.6; stackHeight = 4
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.6; stackHeight = 12
    lw $zero, ($sp) #**"i"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.3; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.3; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Main_f1:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:f1"
# begin: Assign at 16.5; stackHeight = 0
# begin: IntegerLiteral at 16.7; stackHeight = 0
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.7; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 16.5; stackHeight = 0
# begin: LocalVarDecl at 17.7; stackHeight = 0
# begin: IntegerLiteral at 17.11; stackHeight = 0
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.11; stackHeight = 8
    lw $zero, ($sp) #**"q"
# end: LocalVarDecl at 17.7; stackHeight = 8
# begin: Assign at 18.5; stackHeight = 8
# begin: IntegerLiteral at 18.7; stackHeight = 8
    li $t0, 36
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 18.7; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($s2)
# end: Assign at 18.5; stackHeight = 8
# begin: Assign at 19.5; stackHeight = 8
# begin: Call at 19.7; stackHeight = 8
# begin: This at 19.7; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 19.7; stackHeight = 12
# begin: Plus at 19.11; stackHeight = 12
# begin: IdentifierExp at 19.10; stackHeight = 12
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.10; stackHeight = 20
# begin: IntegerLiteral at 19.12; stackHeight = 20
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 19.12; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 19.11; stackHeight = 20
    lw $zero, ($sp) #**"i"
# begin: IdentifierExp at 19.15; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.15; stackHeight = 28
    lw $zero, ($sp) #**"q"
    lw $t0, 16($sp)
    sw $s2, 16($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 19.7; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 19.5; stackHeight = 8
# begin: CallStatement at 20.7; stackHeight = 8
# begin: Call at 20.7; stackHeight = 8
# begin: IdentifierExp at 20.3; stackHeight = 8
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 20.3; stackHeight = 12
# begin: IdentifierExp at 20.16; stackHeight = 12
    lw $t0, -20($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 20.16; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.7; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.7; stackHeight = 8
# begin: CallStatement at 20.24; stackHeight = 8
# begin: Call at 20.24; stackHeight = 8
# begin: IdentifierExp at 20.20; stackHeight = 8
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 20.20; stackHeight = 12
# begin: StringLiteral at 20.33; stackHeight = 12
    la $t0, strLit_42
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 20.33; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.24; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.24; stackHeight = 8
# begin: CallStatement at 21.7; stackHeight = 8
# begin: Call at 21.7; stackHeight = 8
# begin: IdentifierExp at 21.3; stackHeight = 8
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 21.3; stackHeight = 12
# begin: IdentifierExp at 21.16; stackHeight = 12
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.16; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 21.7; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 21.7; stackHeight = 8
# begin: CallStatement at 21.24; stackHeight = 8
# begin: Call at 21.24; stackHeight = 8
# begin: IdentifierExp at 21.20; stackHeight = 8
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 21.20; stackHeight = 12
# begin: StringLiteral at 21.33; stackHeight = 12
    la $t0, strLit_42
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 21.33; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 21.24; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 21.24; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Main_f2:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:f2"
# begin: Assign at 26.5; stackHeight = 0
# begin: Call at 26.7; stackHeight = 0
# begin: This at 26.7; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 26.7; stackHeight = 4
# begin: Plus at 26.11; stackHeight = 4
# begin: IdentifierExp at 26.10; stackHeight = 4
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 26.10; stackHeight = 12
# begin: IntegerLiteral at 26.12; stackHeight = 12
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 26.12; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 26.11; stackHeight = 12
    lw $zero, ($sp) #**"i"
...
# end: Call at 26.7; stackHeight = 8
    ...
    addu $sp, $sp, 8
    sw $t0, 4($sp)
# end: Assign at 26.5; stackHeight = 0
# begin: CallStatement at 27.7; stackHeight = 0
# begin: Call at 27.7; stackHeight = 0
# begin: IdentifierExp at 27.3; stackHeight = 0
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 27.3; stackHeight = 4
# begin: IdentifierExp at 27.16; stackHeight = 4
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 27.16; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 27.7; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 27.7; stackHeight = 0
# begin: CallStatement at 27.24; stackHeight = 0
# begin: Call at 27.24; stackHeight = 0
# begin: IdentifierExp at 27.20; stackHeight = 0
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 27.20; stackHeight = 4
# begin: StringLiteral at 27.33; stackHeight = 4
    la $t0, strLit_42
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 27.33; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 27.24; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 27.24; stackHeight = 0
# begin: Plus at 28.12; stackHeight = 0
# begin: IdentifierExp at 28.10; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 28.10; stackHeight = 8
# begin: IdentifierExp at 28.14; stackHeight = 8
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 28.14; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 28.12; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
...
mth_Main_f3:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:f3"
# begin: Assign at 32.6; stackHeight = 0
# begin: IntegerLiteral at 32.8; stackHeight = 0
    li $t0, 55
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 32.8; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -24($s2)
# end: Assign at 32.6; stackHeight = 0
# begin: Assign at 33.5; stackHeight = 0
# begin: Call at 33.7; stackHeight = 0
# begin: This at 33.7; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 33.7; stackHeight = 4
# begin: Plus at 33.11; stackHeight = 4
# begin: IdentifierExp at 33.10; stackHeight = 4
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 33.10; stackHeight = 12
# begin: IntegerLiteral at 33.12; stackHeight = 12
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 33.12; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 33.11; stackHeight = 12
    lw $zero, ($sp) #**"i"
# begin: IdentifierExp at 33.15; stackHeight = 12
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 33.15; stackHeight = 20
    lw $zero, ($sp) #**"q"
    lw $t0, 16($sp)
    sw $s2, 16($sp)
    move $s2, $t0
...
# end: Call at 33.7; stackHeight = 8
    ...
    addu $sp, $sp, 8
    sw $t0, 4($sp)
# end: Assign at 33.5; stackHeight = 0
# begin: CallStatement at 34.7; stackHeight = 0
# begin: Call at 34.7; stackHeight = 0
# begin: IdentifierExp at 34.3; stackHeight = 0
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 34.3; stackHeight = 4
# begin: IdentifierExp at 34.16; stackHeight = 4
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 34.16; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 34.24; stackHeight = 0
# begin: Call at 34.24; stackHeight = 0
# begin: IdentifierExp at 34.20; stackHeight = 0
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 34.20; stackHeight = 4
# begin: StringLiteral at 34.33; stackHeight = 4
    la $t0, strLit_42
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 34.33; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 34.24; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 34.24; stackHeight = 0
# begin: Assign at 35.5; stackHeight = 0
# begin: Plus at 35.9; stackHeight = 0
# begin: IdentifierExp at 35.7; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 35.7; stackHeight = 8
# begin: IdentifierExp at 35.11; stackHeight = 8
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 35.11; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 35.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 35.5; stackHeight = 0
# begin: CallStatement at 36.7; stackHeight = 0
# begin: Call at 36.7; stackHeight = 0
# begin: IdentifierExp at 36.3; stackHeight = 0
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 36.3; stackHeight = 4
# begin: IdentifierExp at 36.16; stackHeight = 4
    lw $t0, -24($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 36.16; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 36.7; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 36.7; stackHeight = 0
# begin: CallStatement at 36.25; stackHeight = 0
# begin: Call at 36.25; stackHeight = 0
# begin: IdentifierExp at 36.21; stackHeight = 0
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 36.21; stackHeight = 4
# begin: StringLiteral at 36.34; stackHeight = 4
    la $t0, strLit_42
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 36.34; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 36.25; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 36.25; stackHeight = 0
# begin: IdentifierExp at 37.10; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 37.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
...
# begin: IdentifierExp at 41.3; stackHeight = 0
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 41.3; stackHeight = 4
# begin: IdentifierExp at 41.16; stackHeight = 4
    lw $t0, -20($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 41.16; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 41.24; stackHeight = 0
# begin: Call at 41.24; stackHeight = 0
# begin: IdentifierExp at 41.20; stackHeight = 0
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 41.20; stackHeight = 4
# begin: StringLiteral at 41.33; stackHeight = 4
    la $t0, strLit_42
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 41.33; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 41.24; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 41.24; stackHeight = 0
# begin: Assign at 42.5; stackHeight = 0
# begin: Plus at 42.9; stackHeight = 0
# begin: IdentifierExp at 42.7; stackHeight = 0
    lw $t0, -20($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 42.7; stackHeight = 8
# begin: IdentifierExp at 42.11; stackHeight = 8
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 42.11; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 42.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($s2)
# end: Assign at 42.5; stackHeight = 0
# begin: Assign at 43.6; stackHeight = 0
# begin: Plus at 43.11; stackHeight = 0
# begin: IdentifierExp at 43.8; stackHeight = 0
    lw $t0, -24($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 43.8; stackHeight = 8
# begin: IntegerLiteral at 43.13; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 43.13; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 43.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -24($s2)
# end: Assign at 43.6; stackHeight = 0
# begin: If at 44.3; stackHeight = 0
# begin: Equals at 44.9; stackHeight = 0
# begin: IdentifierExp at 44.7; stackHeight = 0
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 44.7; stackHeight = 8
# begin: IntegerLiteral at 44.12; stackHeight = 8
    li $t0, 7
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 44.12; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 44.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_151
# begin: Assign at 44.17; stackHeight = 0
# begin: Call at 44.19; stackHeight = 0
# begin: This at 44.19; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 44.19; stackHeight = 4
# begin: IntegerLiteral at 44.22; stackHeight = 4
    li $t0, 105
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 44.22; stackHeight = 12
    lw $zero, ($sp) #**"i"
# begin: IdentifierExp at 44.27; stackHeight = 12
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 44.27; stackHeight = 20
    lw $zero, ($sp) #**"q"
    lw $t0, 16($sp)
    sw $s2, 16($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 44.19; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 4($sp)
# end: Assign at 44.17; stackHeight = 0
    j if_done_151
  if_else_151:
# begin: Block at 45.3; stackHeight = 0
# end: Block at 45.3; stackHeight = 0
  if_done_151:
# end: If at 44.3; stackHeight = 0
# begin: IdentifierExp at 45.10; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 45.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
