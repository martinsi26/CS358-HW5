...
# ****** class Classz2 ****** # ClassDecl at 3.7
  .byte 0 # ClassDecl at 3.7
  .byte 195 # 'C' with high bit set # ClassDecl at 3.7
  .byte 108 # 'l' # ClassDecl at 3.7
  .byte 97 # 'a' # ClassDecl at 3.7
  .byte 115 # 's' # ClassDecl at 3.7
  .byte 115 # 's' # ClassDecl at 3.7
  .byte 122 # 'z' # ClassDecl at 3.7
  .byte 50 # '2' # ClassDecl at 3.7
CLASS_Classz2: # ClassDecl at 3.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Classz2_myMethod # MethodDeclNonVoid at 6.16
# ****** class Main ****** # ClassDecl at 16.7
  .byte 205 # 'M' with high bit set # ClassDecl at 16.7
  .byte 97 # 'a' # ClassDecl at 16.7
  .byte 105 # 'i' # ClassDecl at 16.7
  .byte 110 # 'n' # ClassDecl at 16.7
CLASS_Main: # ClassDecl at 16.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Classz2_myMethod # MethodDeclNonVoid at 6.16
  .word mth_Main_main # MethodDeclVoid at 17.14
END_CLASS_Main: # ClassDecl at 16.7
# ****** class Classz3 ****** # ClassDecl at 22.7
  .byte 0 # ClassDecl at 22.7
  .byte 195 # 'C' with high bit set # ClassDecl at 22.7
  .byte 108 # 'l' # ClassDecl at 22.7
  .byte 97 # 'a' # ClassDecl at 22.7
  .byte 115 # 's' # ClassDecl at 22.7
  .byte 115 # 's' # ClassDecl at 22.7
  .byte 122 # 'z' # ClassDecl at 22.7
  .byte 51 # '3' # ClassDecl at 22.7
CLASS_Classz3: # ClassDecl at 22.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Classz2_myMethod # MethodDeclNonVoid at 6.16
END_CLASS_Classz3: # ClassDecl at 22.7
END_CLASS_Classz2: # ClassDecl at 3.7
...
# field Classz2.a offset = -16: InstVarDecl at 4.6
# field Classz2.c offset = -20: InstVarDecl at 5.6
# myMethod parameter b offset = 4: MethodDeclNonVoid at 6.16
  .byte 74 # StringLiteral at 13.10
  .byte 101 # StringLiteral at 13.10
  .byte 108 # StringLiteral at 13.10
  .byte 108 # StringLiteral at 13.10
  .byte 121 # StringLiteral at 13.10
  .byte 0 # StringLiteral at 13.10
  .byte 0 # StringLiteral at 13.10
  .byte 0 # StringLiteral at 13.10
  .word CLASS_String # StringLiteral at 13.10
  .word 3 # StringLiteral at 13.10
  .word -5 # StringLiteral at 13.10
strLit_27: # StringLiteral at 13.10
...
strLit_36: # StringLiteral at 19.18
.text
.globl main
main:
    jal vm_init
...
# end: CallStatement at 0.0; stackHeight = 0
    li $v0, 10
    syscall
.globl mth_Classz2_myMethod
mth_Classz2_myMethod:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:myMethod"
# begin: BreakTarget at 7.3; stackHeight = 0
    j while_cond_22
  while_top_22:
# begin: Block at 7.18; stackHeight = 0
# begin: Assign at 8.6; stackHeight = 0
# begin: Plus at 8.10; stackHeight = 0
# begin: IdentifierExp at 8.8; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.8; stackHeight = 8
# begin: IdentifierExp at 8.12; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.12; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 8.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 8.6; stackHeight = 0
# begin: Assign at 9.6; stackHeight = 0
# begin: Plus at 9.10; stackHeight = 0
# begin: IdentifierExp at 9.8; stackHeight = 0
    lw $t0, -20($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.8; stackHeight = 8
# begin: IdentifierExp at 9.12; stackHeight = 8
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.12; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 9.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($s2)
# end: Assign at 9.6; stackHeight = 0
# begin: Break at 10.4; stackHeight = 0
    j break_target_22
# end: Break at 10.4; stackHeight = 0
# end: Block at 7.18; stackHeight = 0
  while_cond_22:
# begin: LessThan at 7.12; stackHeight = 0
# begin: IdentifierExp at 7.10; stackHeight = 0
    lw $t0, -20($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.10; stackHeight = 8
# begin: IntegerLiteral at 7.14; stackHeight = 8
    li $t0, 10
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.14; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 7.12; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_22
  break_target_22:
# end: BreakTarget at 7.3; stackHeight = 0
# begin: CallStatement at 12.9; stackHeight = 0
# begin: Call at 12.9; stackHeight = 0
# begin: Super at 12.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.9; stackHeight = 4
# begin: IdentifierExp at 12.18; stackHeight = 4
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.18; stackHeight = 12
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.9; stackHeight = 0
# begin: StringLiteral at 13.10; stackHeight = 0
    la $t0, strLit_27
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 13.10; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 18.9; stackHeight = 0
# begin: Call at 18.9; stackHeight = 0
# begin: Super at 18.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 18.9; stackHeight = 4
# begin: Call at 18.18; stackHeight = 4
# begin: This at 18.18; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 18.18; stackHeight = 8
# begin: IdentifierExp at 18.27; stackHeight = 8
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 18.27; stackHeight = 16
    lw $zero, ($sp) #**"b"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 18.18; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 18.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 18.9; stackHeight = 0
# begin: CallStatement at 19.9; stackHeight = 0
# begin: Call at 19.9; stackHeight = 0
# begin: Super at 19.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 19.9; stackHeight = 4
# begin: StringLiteral at 19.18; stackHeight = 4
    la $t0, strLit_36
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 19.18; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 19.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 19.9; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
