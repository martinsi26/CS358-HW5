...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Main_numSum # MethodDeclNonVoid at 4.13
  .word mth_Main_readArray # MethodDeclVoid at 10.14
  .word mth_Main_main # MethodDeclVoid at 14.14
...
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 4.20
  .byte 0 # ArrayType at 4.20
  .byte 219 # '[' with high bit set # ArrayType at 4.20
  .byte 73 # 'I' # ArrayType at 4.20
CLASS_ARRAY_INT: # ArrayType at 4.20
  .word mth_Object_hashCode # ArrayType at 4.20
  .word mth_Object_equals # ArrayType at 4.20
  .word mth_Object_toString # ArrayType at 4.20
END_CLASS_ARRAY_INT: # ArrayType at 4.20
...
# numSum parameter anArray offset = 4: MethodDeclNonVoid at 4.13
# readArray parameter anArray offset = 4: MethodDeclVoid at 10.14
.text
.globl main
main:
    jal vm_init
...
# end: IntegerLiteral at 5.13; stackHeight = 8
    lw $zero, ($sp) #**"sum"
# end: LocalVarDecl at 5.7; stackHeight = 8
# begin: Block at 6.3; stackHeight = 8
# begin: LocalVarDecl at 6.12; stackHeight = 8
# begin: IntegerLiteral at 6.16; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.16; stackHeight = 16
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 6.12; stackHeight = 16
# begin: BreakTarget at 6.3; stackHeight = 16
    j while_cond_29
  while_top_29:
# begin: Block at 6.3; stackHeight = 16
# begin: Assign at 7.8; stackHeight = 16
# begin: Plus at 7.14; stackHeight = 16
# begin: IdentifierExp at 7.10; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.10; stackHeight = 24
# begin: ArrayLookup at 7.23; stackHeight = 24
# begin: IdentifierExp at 7.24; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.24; stackHeight = 32
# begin: IdentifierExp at 7.16; stackHeight = 32
    lw $t0, 36($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.16; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 7.23; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 7.14; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 7.8; stackHeight = 16
# begin: Assign at 6.39; stackHeight = 16
# begin: Plus at 6.40; stackHeight = 16
# begin: IdentifierExp at 6.39; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.39; stackHeight = 24
# begin: IntegerLiteral at 6.40; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.40; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 6.40; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 6.39; stackHeight = 16
# end: Block at 6.3; stackHeight = 16
  while_cond_29:
# begin: LessThan at 6.21; stackHeight = 16
...
# begin: ArrayLength at 6.30; stackHeight = 24
# begin: IdentifierExp at 6.23; stackHeight = 24
    lw $t0, 28($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 6.23; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 6.30; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 6.21; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_29
  break_target_29:
# end: BreakTarget at 6.3; stackHeight = 16
    addu $sp, $sp, 8
# end: Block at 6.3; stackHeight = 8
# begin: IdentifierExp at 8.10; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.10; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_readArray
mth_Main_readArray:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:readArray"
# begin: Block at 11.3; stackHeight = 0
# begin: LocalVarDecl at 11.12; stackHeight = 0
# begin: IntegerLiteral at 11.16; stackHeight = 0
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.16; stackHeight = 8
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 11.12; stackHeight = 8
# begin: BreakTarget at 11.3; stackHeight = 8
    j while_cond_56
  while_top_56:
# begin: Block at 11.3; stackHeight = 8
# begin: Assign at 12.15; stackHeight = 8
# begin: IdentifierExp at 12.4; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.4; stackHeight = 12
# begin: IdentifierExp at 12.12; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.12; stackHeight = 20
# begin: Call at 12.23; stackHeight = 20
# begin: Super at 12.23; stackHeight = 20
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.23; stackHeight = 24
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    jal mth_Lib_readInt
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 12.23; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 12.15; stackHeight = 8
# begin: Assign at 11.39; stackHeight = 8
# begin: Plus at 11.40; stackHeight = 8
# begin: IdentifierExp at 11.39; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.39; stackHeight = 16
# begin: IntegerLiteral at 11.40; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.40; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 11.40; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 11.39; stackHeight = 8
# end: Block at 11.3; stackHeight = 8
  while_cond_56:
# begin: LessThan at 11.21; stackHeight = 8
# begin: IdentifierExp at 11.19; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.19; stackHeight = 16
# begin: ArrayLength at 11.30; stackHeight = 16
# begin: IdentifierExp at 11.23; stackHeight = 16
    lw $t0, 20($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 11.23; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 11.30; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 11.21; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_56
  break_target_56:
# end: BreakTarget at 11.3; stackHeight = 8
    addu $sp, $sp, 8
# end: Block at 11.3; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
# begin: NewArray at 15.19; stackHeight = 0
# begin: IntegerLiteral at 15.27; stackHeight = 0
    li $t0, 100
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.27; stackHeight = 8
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 15.19; stackHeight = 4
    lw $zero, ($sp) #**"myArray"
...
# begin: Call at 17.12; stackHeight = 8
# begin: This at 17.12; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 17.12; stackHeight = 12
# begin: IdentifierExp at 17.19; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.19; stackHeight = 16
    lw $zero, ($sp) #**"anArray"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 17.12; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
