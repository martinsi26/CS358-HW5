...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_printboard # MethodDeclVoid at 22.14
  .word mth_Main_tryIt # MethodDeclVoid at 34.14
END_CLASS_Main: # ClassDecl at 3.7
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 7.2
  .byte 0 # ArrayType at 7.2
  .byte 219 # '[' with high bit set # ArrayType at 7.2
  .byte 73 # 'I' # ArrayType at 7.2
CLASS_ARRAY_INT: # ArrayType at 7.2
  .word mth_Object_hashCode # ArrayType at 7.2
  .word mth_Object_equals # ArrayType at 7.2
  .word mth_Object_toString # ArrayType at 7.2
END_CLASS_ARRAY_INT: # ArrayType at 7.2
...
# field Main.N offset = -16: InstVarDecl at 6.6
# field Main.row offset = 4: InstVarDecl at 7.8
# field Main.col offset = 8: InstVarDecl at 8.8
# field Main.diag1 offset = 12: InstVarDecl at 9.8
# field Main.diag2 offset = 16: InstVarDecl at 10.8
# tryIt parameter c offset = 4: MethodDeclVoid at 34.14
  .byte 32 # StringLiteral at 26.29
  .byte 81 # StringLiteral at 26.29
  .byte 0 # StringLiteral at 26.29
  .byte 0 # StringLiteral at 26.29
  .word CLASS_String # StringLiteral at 26.29
  .word 2 # StringLiteral at 26.29
  .word -2 # StringLiteral at 26.29
strLit_90: # StringLiteral at 26.29
  .byte 32 # StringLiteral at 26.47
  .byte 46 # StringLiteral at 26.47
  .byte 0 # StringLiteral at 26.47
  .byte 0 # StringLiteral at 26.47
  .word CLASS_String # StringLiteral at 26.47
  .word 2 # StringLiteral at 26.47
  .word -2 # StringLiteral at 26.47
strLit_93: # StringLiteral at 26.47
  .byte 10 # StringLiteral at 29.17
  .byte 0 # StringLiteral at 29.17
  .byte 0 # StringLiteral at 29.17
  .byte 0 # StringLiteral at 29.17
  .word CLASS_String # StringLiteral at 29.17
  .word 2 # StringLiteral at 29.17
  .word -1 # StringLiteral at 29.17
strLit_105: # StringLiteral at 29.17
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: Assign at 13.7; stackHeight = 0
# begin: NewObject at 13.9; stackHeight = 0
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Lib
    sw $t0, -12($s7)
# end: NewObject at 13.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($s2)
# end: Assign at 13.7; stackHeight = 0
# begin: Assign at 14.5; stackHeight = 0
# begin: IntegerLiteral at 14.7; stackHeight = 0
    li $t0, 8
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 14.7; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 14.5; stackHeight = 0
# begin: Assign at 15.7; stackHeight = 0
# begin: NewArray at 15.9; stackHeight = 0
# begin: IdentifierExp at 15.18; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 15.18; stackHeight = 8
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 15.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 4($s2)
# end: Assign at 15.7; stackHeight = 0
# begin: Assign at 16.7; stackHeight = 0
# begin: NewArray at 16.9; stackHeight = 0
# begin: IdentifierExp at 16.19; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.19; stackHeight = 8
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    la $t0, CLASS_ARRAY_INT
    sw $t0, -12($s7)
# end: NewArray at 16.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 8($s2)
# end: Assign at 16.7; stackHeight = 0
# begin: Assign at 17.9; stackHeight = 0
# begin: NewArray at 17.11; stackHeight = 0
# begin: Minus at 17.23; stackHeight = 0
# begin: Plus at 17.21; stackHeight = 0
# begin: IdentifierExp at 17.20; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.20; stackHeight = 8
# begin: IdentifierExp at 17.22; stackHeight = 8
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.22; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 17.21; stackHeight = 8
# begin: IntegerLiteral at 17.24; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.24; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 17.23; stackHeight = 8
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    la $t0, CLASS_ARRAY_INT
    sw $t0, -12($s7)
# end: NewArray at 17.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 12($s2)
# end: Assign at 17.9; stackHeight = 0
# begin: Assign at 18.9; stackHeight = 0
# begin: NewArray at 18.11; stackHeight = 0
# begin: Minus at 18.23; stackHeight = 0
# begin: Plus at 18.21; stackHeight = 0
# begin: IdentifierExp at 18.20; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 18.20; stackHeight = 8
# begin: IdentifierExp at 18.22; stackHeight = 8
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 18.22; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 18.21; stackHeight = 8
# begin: IntegerLiteral at 18.24; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 18.24; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 18.23; stackHeight = 8
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    la $t0, CLASS_ARRAY_INT
    sw $t0, -12($s7)
# end: NewArray at 18.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 16($s2)
# end: Assign at 18.9; stackHeight = 0
# begin: CallStatement at 19.3; stackHeight = 0
# begin: Call at 19.3; stackHeight = 0
# begin: This at 19.3; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 19.3; stackHeight = 4
# begin: IntegerLiteral at 19.9; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 19.9; stackHeight = 12
    lw $zero, ($sp) #**"c"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 19.3; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 19.3; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_printboard
mth_Main_printboard:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:printboard"
# begin: Block at 23.3; stackHeight = 0
# begin: LocalVarDecl at 23.12; stackHeight = 0
# begin: IntegerLiteral at 23.16; stackHeight = 0
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 23.16; stackHeight = 8
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 23.12; stackHeight = 8
# begin: BreakTarget at 23.3; stackHeight = 8
    j while_cond_110
  while_top_110:
# begin: Block at 23.3; stackHeight = 8
# begin: Block at 23.31; stackHeight = 8
# begin: Block at 24.4; stackHeight = 8
# begin: LocalVarDecl at 24.13; stackHeight = 8
# begin: IntegerLiteral at 24.17; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 24.17; stackHeight = 16
    lw $zero, ($sp) #**"j"
# end: LocalVarDecl at 24.13; stackHeight = 16
# begin: BreakTarget at 24.4; stackHeight = 16
    j while_cond_102
  while_top_102:
# begin: Block at 24.4; stackHeight = 16
# begin: Block at 24.32; stackHeight = 16
# begin: LocalVarDecl at 25.12; stackHeight = 16
# begin: Null at 25.19; stackHeight = 16
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 25.19; stackHeight = 20
    lw $zero, ($sp) #**"pVal"
# end: LocalVarDecl at 25.12; stackHeight = 20
# begin: If at 26.5; stackHeight = 20
# begin: Equals at 26.16; stackHeight = 20
# begin: ArrayLookup at 26.12; stackHeight = 20
# begin: IdentifierExp at 26.13; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 26.13; stackHeight = 28
# begin: IdentifierExp at 26.9; stackHeight = 28
    lw $t0, 8($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 26.9; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 26.12; stackHeight = 28
# begin: IdentifierExp at 26.19; stackHeight = 28
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 26.19; stackHeight = 36
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 26.16; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_95
# begin: Assign at 26.27; stackHeight = 20
# begin: StringLiteral at 26.29; stackHeight = 20
    la $t0, strLit_90
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 26.29; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 26.27; stackHeight = 20
    j if_done_95
  if_else_95:
# begin: Assign at 26.45; stackHeight = 20
# begin: StringLiteral at 26.47; stackHeight = 20
    la $t0, strLit_93
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 26.47; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 26.45; stackHeight = 20
  if_done_95:
# end: If at 26.5; stackHeight = 20
# begin: CallStatement at 27.9; stackHeight = 20
# begin: Call at 27.9; stackHeight = 20
# begin: IdentifierExp at 27.5; stackHeight = 20
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 27.5; stackHeight = 24
# begin: IdentifierExp at 27.18; stackHeight = 24
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 27.18; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 27.9; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 27.9; stackHeight = 20
    addu $sp, $sp, 4
# end: Block at 24.32; stackHeight = 16
# begin: Assign at 24.27; stackHeight = 16
# begin: Plus at 24.28; stackHeight = 16
# begin: IdentifierExp at 24.27; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 24.27; stackHeight = 24
# begin: IntegerLiteral at 24.28; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 24.28; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 24.28; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 24.27; stackHeight = 16
# end: Block at 24.4; stackHeight = 16
  while_cond_102:
# begin: LessThan at 24.22; stackHeight = 16
# begin: IdentifierExp at 24.20; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 24.20; stackHeight = 24
# begin: IdentifierExp at 24.24; stackHeight = 24
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 24.24; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 24.22; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_102
  break_target_102:
# end: BreakTarget at 24.4; stackHeight = 16
    addu $sp, $sp, 8
# end: Block at 24.4; stackHeight = 8
# begin: CallStatement at 29.8; stackHeight = 8
# begin: Call at 29.8; stackHeight = 8
# begin: IdentifierExp at 29.4; stackHeight = 8
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 29.4; stackHeight = 12
# begin: StringLiteral at 29.17; stackHeight = 12
    la $t0, strLit_105
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 29.17; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 29.8; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 29.8; stackHeight = 8
# end: Block at 23.31; stackHeight = 8
# begin: Assign at 23.26; stackHeight = 8
# begin: Plus at 23.27; stackHeight = 8
# begin: IdentifierExp at 23.26; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 23.26; stackHeight = 16
# begin: IntegerLiteral at 23.27; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 23.27; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 23.27; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 23.26; stackHeight = 8
# end: Block at 23.3; stackHeight = 8
  while_cond_110:
# begin: LessThan at 23.21; stackHeight = 8
# begin: IdentifierExp at 23.19; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 23.19; stackHeight = 16
# begin: IdentifierExp at 23.23; stackHeight = 16
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 23.23; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 23.21; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_110
  break_target_110:
# end: BreakTarget at 23.3; stackHeight = 8
    addu $sp, $sp, 8
# end: Block at 23.3; stackHeight = 0
# begin: CallStatement at 31.7; stackHeight = 0
# begin: Call at 31.7; stackHeight = 0
# begin: IdentifierExp at 31.3; stackHeight = 0
    lw $t0, 0($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 31.3; stackHeight = 4
# begin: StringLiteral at 31.16; stackHeight = 4
    la $t0, strLit_105
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 31.16; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 31.7; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 31.7; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_tryIt
mth_Main_tryIt:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:tryIt"
# begin: If at 37.3; stackHeight = 0
# begin: Equals at 37.8; stackHeight = 0
# begin: IdentifierExp at 37.7; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 37.7; stackHeight = 8
# begin: IdentifierExp at 37.10; stackHeight = 8
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 37.10; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 37.8; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_222
# begin: Block at 37.13; stackHeight = 0
# begin: CallStatement at 38.4; stackHeight = 0
# begin: Call at 38.4; stackHeight = 0
# begin: This at 38.4; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 38.4; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 38.4; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 38.4; stackHeight = 0
# end: Block at 37.13; stackHeight = 0
    j if_done_222
  if_else_222:
# begin: Block at 40.8; stackHeight = 0
# begin: Block at 41.4; stackHeight = 0
# begin: LocalVarDecl at 41.13; stackHeight = 0
# begin: IntegerLiteral at 41.17; stackHeight = 0
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 41.17; stackHeight = 8
    lw $zero, ($sp) #**"r"
# end: LocalVarDecl at 41.13; stackHeight = 8
# begin: BreakTarget at 41.4; stackHeight = 8
    j while_cond_219
  while_top_219:
# begin: Block at 41.4; stackHeight = 8
# begin: Block at 41.32; stackHeight = 8
# begin: If at 42.5; stackHeight = 8
# begin: And at 42.36; stackHeight = 8
# begin: And at 42.19; stackHeight = 8
# begin: Equals at 42.15; stackHeight = 8
# begin: ArrayLookup at 42.12; stackHeight = 8
# begin: IdentifierExp at 42.13; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 42.13; stackHeight = 16
# begin: IdentifierExp at 42.9; stackHeight = 16
    lw $t0, 4($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 42.9; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 42.12; stackHeight = 16
# begin: IntegerLiteral at 42.17; stackHeight = 16
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 42.17; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 42.15; stackHeight = 12
    lw $t0, ($sp)
    beq $t0, $zero, skip_150
    addu $sp, $sp, 4
# begin: Equals at 42.32; stackHeight = 8
# begin: ArrayLookup at 42.27; stackHeight = 8
# begin: Plus at 42.29; stackHeight = 8
# begin: IdentifierExp at 42.28; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 42.28; stackHeight = 16
# begin: IdentifierExp at 42.30; stackHeight = 16
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 42.30; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 42.29; stackHeight = 16
# begin: IdentifierExp at 42.22; stackHeight = 16
    lw $t0, 12($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 42.22; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 42.27; stackHeight = 16
# begin: IntegerLiteral at 42.34; stackHeight = 16
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 42.34; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 42.32; stackHeight = 12
  skip_150:
# end: And at 42.19; stackHeight = 12
    lw $t0, ($sp)
    beq $t0, $zero, skip_160
    addu $sp, $sp, 4
# begin: Equals at 42.51; stackHeight = 8
# begin: ArrayLookup at 42.44; stackHeight = 8
# begin: Minus at 42.48; stackHeight = 8
# begin: Plus at 42.46; stackHeight = 8
# begin: IdentifierExp at 42.45; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 42.45; stackHeight = 16
# begin: IntegerLiteral at 42.47; stackHeight = 16
    li $t0, 7
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 42.47; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 42.46; stackHeight = 16
# begin: IdentifierExp at 42.49; stackHeight = 16
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 42.49; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 42.48; stackHeight = 16
# begin: IdentifierExp at 42.39; stackHeight = 16
    lw $t0, 16($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 42.39; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 42.44; stackHeight = 16
# begin: IntegerLiteral at 42.53; stackHeight = 16
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 42.53; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 42.51; stackHeight = 12
  skip_160:
# end: And at 42.36; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_216
# begin: Block at 42.56; stackHeight = 8
# begin: Assign at 43.12; stackHeight = 8
# begin: IdentifierExp at 43.6; stackHeight = 8
    lw $t0, 4($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 43.6; stackHeight = 12
# begin: IdentifierExp at 43.10; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 43.10; stackHeight = 20
# begin: IntegerLiteral at 43.13; stackHeight = 20
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 43.13; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 43.12; stackHeight = 8
# begin: Assign at 44.16; stackHeight = 8
# begin: IdentifierExp at 44.6; stackHeight = 8
    lw $t0, 12($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 44.6; stackHeight = 12
# begin: Plus at 44.13; stackHeight = 12
# begin: IdentifierExp at 44.12; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 44.12; stackHeight = 20
# begin: IdentifierExp at 44.14; stackHeight = 20
    lw $t0, 24($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 44.14; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 44.13; stackHeight = 20
# begin: IntegerLiteral at 44.17; stackHeight = 20
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 44.17; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 44.16; stackHeight = 8
# begin: Assign at 45.18; stackHeight = 8
# begin: IdentifierExp at 45.6; stackHeight = 8
    lw $t0, 16($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 45.6; stackHeight = 12
# begin: Minus at 45.15; stackHeight = 12
# begin: Plus at 45.13; stackHeight = 12
# begin: IdentifierExp at 45.12; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 45.12; stackHeight = 20
# begin: IntegerLiteral at 45.14; stackHeight = 20
    li $t0, 7
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 45.14; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 45.13; stackHeight = 20
# begin: IdentifierExp at 45.16; stackHeight = 20
    lw $t0, 24($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 45.16; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 45.15; stackHeight = 20
...
# end: IntegerLiteral at 45.19; stackHeight = 28
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 45.18; stackHeight = 8
# begin: Assign at 46.12; stackHeight = 8
# begin: IdentifierExp at 46.6; stackHeight = 8
    lw $t0, 8($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 46.6; stackHeight = 12
# begin: IdentifierExp at 46.10; stackHeight = 12
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 46.10; stackHeight = 20
# begin: IdentifierExp at 46.13; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 46.13; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 46.12; stackHeight = 8
# begin: CallStatement at 47.6; stackHeight = 8
# begin: Call at 47.6; stackHeight = 8
# begin: This at 47.6; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 47.6; stackHeight = 12
# begin: Plus at 47.13; stackHeight = 12
# begin: IdentifierExp at 47.12; stackHeight = 12
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 47.12; stackHeight = 20
# begin: IntegerLiteral at 47.14; stackHeight = 20
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 47.14; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 47.13; stackHeight = 20
    lw $zero, ($sp) #**"c"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 47.6; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 47.6; stackHeight = 8
# begin: Assign at 48.12; stackHeight = 8
# begin: IdentifierExp at 48.6; stackHeight = 8
    lw $t0, 4($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 48.6; stackHeight = 12
# begin: IdentifierExp at 48.10; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 48.10; stackHeight = 20
# begin: IntegerLiteral at 48.13; stackHeight = 20
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 48.13; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 48.12; stackHeight = 8
# begin: Assign at 49.16; stackHeight = 8
# begin: IdentifierExp at 49.6; stackHeight = 8
    lw $t0, 12($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 49.6; stackHeight = 12
# begin: Plus at 49.13; stackHeight = 12
# begin: IdentifierExp at 49.12; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 49.12; stackHeight = 20
# begin: IdentifierExp at 49.14; stackHeight = 20
    lw $t0, 24($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 49.14; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 49.13; stackHeight = 20
# begin: IntegerLiteral at 49.17; stackHeight = 20
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 49.17; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 49.16; stackHeight = 8
# begin: Assign at 50.18; stackHeight = 8
# begin: IdentifierExp at 50.6; stackHeight = 8
    lw $t0, 16($s2)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 50.6; stackHeight = 12
# begin: Minus at 50.15; stackHeight = 12
# begin: Plus at 50.13; stackHeight = 12
# begin: IdentifierExp at 50.12; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 50.12; stackHeight = 20
# begin: IntegerLiteral at 50.14; stackHeight = 20
    li $t0, 7
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 50.14; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 50.13; stackHeight = 20
# begin: IdentifierExp at 50.16; stackHeight = 20
    lw $t0, 24($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 50.16; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 50.15; stackHeight = 20
# begin: IntegerLiteral at 50.19; stackHeight = 20
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 50.19; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 50.18; stackHeight = 8
# end: Block at 42.56; stackHeight = 8
    j if_done_216
  if_else_216:
# begin: Block at 52.4; stackHeight = 8
# end: Block at 52.4; stackHeight = 8
  if_done_216:
# end: If at 42.5; stackHeight = 8
# end: Block at 41.32; stackHeight = 8
# begin: Assign at 41.27; stackHeight = 8
# begin: Plus at 41.28; stackHeight = 8
# begin: IdentifierExp at 41.27; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 41.27; stackHeight = 16
# begin: IntegerLiteral at 41.28; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 41.28; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 41.28; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 41.27; stackHeight = 8
# end: Block at 41.4; stackHeight = 8
  while_cond_219:
# begin: LessThan at 41.22; stackHeight = 8
# begin: IdentifierExp at 41.20; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 41.20; stackHeight = 16
# begin: IdentifierExp at 41.24; stackHeight = 16
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 41.24; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 41.22; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_219
  break_target_219:
# end: BreakTarget at 41.4; stackHeight = 8
    addu $sp, $sp, 8
# end: Block at 41.4; stackHeight = 0
# end: Block at 40.8; stackHeight = 0
  if_done_222:
# end: If at 37.3; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
