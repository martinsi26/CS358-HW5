...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_setI # MethodDeclNonVoid at 14.14
  .word mth_Main_sum # MethodDeclNonVoid at 19.14
...
# setI parameter val offset = 4: MethodDeclNonVoid at 14.14
# sum parameter a offset = 12: MethodDeclNonVoid at 19.14
# sum parameter b offset = 4: MethodDeclNonVoid at 19.14
  .byte 32 # StringLiteral at 10.63
  .byte 0 # StringLiteral at 10.63
  .byte 0 # StringLiteral at 10.63
  .byte 0 # StringLiteral at 10.63
  .word CLASS_String # StringLiteral at 10.63
  .word 2 # StringLiteral at 10.63
  .word -1 # StringLiteral at 10.63
strLit_20: # StringLiteral at 10.63
...
strLit_28: # StringLiteral at 11.39
.text
.globl main
main:
    jal vm_init
...
# begin: This at 10.24; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 10.24; stackHeight = 12
# begin: Plus at 10.30; stackHeight = 12
# begin: IdentifierExp at 10.29; stackHeight = 12
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.29; stackHeight = 20
...
# end: IntegerLiteral at 10.31; stackHeight = 28
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 10.30; stackHeight = 20
    lw $zero, ($sp) #**"val"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 10.24; stackHeight = 16
    lw $zero, ($sp) #**"a"
# begin: Call at 10.35; stackHeight = 16
# begin: This at 10.35; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 10.35; stackHeight = 20
# begin: Times at 10.41; stackHeight = 20
# begin: IdentifierExp at 10.40; stackHeight = 20
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.40; stackHeight = 28
# begin: IntegerLiteral at 10.42; stackHeight = 28
    li $t0, 7
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.42; stackHeight = 36
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 10.41; stackHeight = 28
    lw $zero, ($sp) #**"val"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 10.35; stackHeight = 24
    lw $zero, ($sp) #**"b"
    lw $t0, 16($sp)
    sw $s2, 16($sp)
    move $s2, $t0
...
# begin: CallStatement at 10.54; stackHeight = 0
# begin: Call at 10.54; stackHeight = 0
# begin: Super at 10.54; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.54; stackHeight = 4
# begin: StringLiteral at 10.63; stackHeight = 4
    la $t0, strLit_20
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.63; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.54; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.54; stackHeight = 0
...
# begin: IdentifierExp at 16.12; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.12; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
...
mth_Main_sum:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:sum"
# begin: Plus at 19.42; stackHeight = 0
# begin: IdentifierExp at 19.41; stackHeight = 0
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.41; stackHeight = 8
# begin: IdentifierExp at 19.43; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.43; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 19.42; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
