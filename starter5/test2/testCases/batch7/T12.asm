...
# ****** class T12Helper ****** # ClassDecl at 17.7
  .byte 0 # ClassDecl at 17.7
  .byte 0 # ClassDecl at 17.7
  .byte 0 # ClassDecl at 17.7
  .byte 212 # 'T' with high bit set # ClassDecl at 17.7
  .byte 49 # '1' # ClassDecl at 17.7
  .byte 50 # '2' # ClassDecl at 17.7
  .byte 72 # 'H' # ClassDecl at 17.7
  .byte 101 # 'e' # ClassDecl at 17.7
  .byte 108 # 'l' # ClassDecl at 17.7
  .byte 112 # 'p' # ClassDecl at 17.7
  .byte 101 # 'e' # ClassDecl at 17.7
  .byte 114 # 'r' # ClassDecl at 17.7
CLASS_T12Helper: # ClassDecl at 17.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_T12Helper_getBool # MethodDeclNonVoid at 18.20
  .word mth_T12Helper_getInt # MethodDeclNonVoid at 21.16
END_CLASS_T12Helper: # ClassDecl at 17.7
...
# getBool parameter b offset = 12: MethodDeclNonVoid at 18.20
# getBool parameter n offset = 4: MethodDeclNonVoid at 18.20
# getInt parameter b offset = 12: MethodDeclNonVoid at 21.16
# getInt parameter n offset = 4: MethodDeclNonVoid at 21.16
  .byte 47 # StringLiteral at 7.17
...
strLit_12: # StringLiteral at 7.17
  .byte 10 # StringLiteral at 13.17
  .byte 0 # StringLiteral at 13.17
  .byte 0 # StringLiteral at 13.17
  .byte 0 # StringLiteral at 13.17
  .word CLASS_String # StringLiteral at 13.17
  .word 2 # StringLiteral at 13.17
  .word -1 # StringLiteral at 13.17
strLit_45: # StringLiteral at 13.17
.text
.globl main
main:
    jal vm_init
...
# begin: NewObject at 5.16; stackHeight = 0
    ...
    li $s7, 0
    jal newObject
    la $t0, CLASS_T12Helper
    sw $t0, -12($s7)
# end: NewObject at 5.16; stackHeight = 4
    lw $zero, ($sp) #**"h"
# end: LocalVarDecl at 5.12; stackHeight = 4
# begin: CallStatement at 6.8; stackHeight = 4
# begin: Call at 6.8; stackHeight = 4
# begin: Super at 6.8; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 6.8; stackHeight = 8
# begin: Call at 6.20; stackHeight = 8
# begin: IdentifierExp at 6.18; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 6.18; stackHeight = 12
# begin: True at 6.28; stackHeight = 12
    li $t0, 1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: True at 6.28; stackHeight = 16
    lw $zero, ($sp) #**"b"
# begin: IntegerLiteral at 6.34; stackHeight = 16
    li $t0, 8
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.34; stackHeight = 24
    lw $zero, ($sp) #**"n"
    lw $t0, 12($sp)
    sw $s2, 12($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.8; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 6.8; stackHeight = 4
...
# begin: CallStatement at 8.8; stackHeight = 4
# begin: Call at 8.8; stackHeight = 4
# begin: Super at 8.8; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.8; stackHeight = 8
# begin: Call at 8.20; stackHeight = 8
# begin: IdentifierExp at 8.18; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.18; stackHeight = 12
# begin: False at 8.28; stackHeight = 12
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: False at 8.28; stackHeight = 16
    lw $zero, ($sp) #**"b"
# begin: IntegerLiteral at 8.35; stackHeight = 16
    li $t0, 2373
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.35; stackHeight = 24
    lw $zero, ($sp) #**"n"
    lw $t0, 12($sp)
    sw $s2, 12($sp)
    move $s2, $t0
...
# end: Call at 8.20; stackHeight = 12
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.8; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.8; stackHeight = 4
# begin: CallStatement at 9.8; stackHeight = 4
# begin: Call at 9.8; stackHeight = 4
# begin: Super at 9.8; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.8; stackHeight = 8
# begin: StringLiteral at 9.17; stackHeight = 8
    la $t0, strLit_12
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.17; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.8; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.8; stackHeight = 4
# begin: CallStatement at 10.8; stackHeight = 4
# begin: Call at 10.8; stackHeight = 4
# begin: Super at 10.8; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.8; stackHeight = 8
# begin: Call at 10.19; stackHeight = 8
# begin: IdentifierExp at 10.17; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.17; stackHeight = 12
# begin: False at 10.26; stackHeight = 12
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: False at 10.26; stackHeight = 16
    lw $zero, ($sp) #**"b"
...
# end: IntegerLiteral at 10.33; stackHeight = 24
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 10.19; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.8; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.8; stackHeight = 4
# begin: CallStatement at 11.8; stackHeight = 4
# begin: Call at 11.8; stackHeight = 4
# begin: Super at 11.8; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.8; stackHeight = 8
# begin: StringLiteral at 11.17; stackHeight = 8
    la $t0, strLit_12
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 11.17; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.8; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.8; stackHeight = 4
# begin: CallStatement at 12.8; stackHeight = 4
# begin: Call at 12.8; stackHeight = 4
# begin: Super at 12.8; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.8; stackHeight = 8
# begin: Call at 12.19; stackHeight = 8
# begin: IdentifierExp at 12.17; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.17; stackHeight = 12
# begin: True at 12.26; stackHeight = 12
    li $t0, 1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: True at 12.26; stackHeight = 16
    lw $zero, ($sp) #**"b"
# begin: IntegerLiteral at 12.32; stackHeight = 16
    li $t0, 26
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.32; stackHeight = 24
    lw $zero, ($sp) #**"n"
    lw $t0, 12($sp)
    sw $s2, 12($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 12.19; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.8; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.8; stackHeight = 4
# begin: CallStatement at 13.8; stackHeight = 4
# begin: Call at 13.8; stackHeight = 4
# begin: Super at 13.8; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 13.8; stackHeight = 8
# begin: StringLiteral at 13.17; stackHeight = 8
    la $t0, strLit_45
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 13.17; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.8; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 13.8; stackHeight = 4
    addu $sp, $sp, 4
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_T12Helper_getBool
mth_T12Helper_getBool:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:getBool"
# begin: Not at 19.17; stackHeight = 0
# begin: Equals at 19.17; stackHeight = 0
# begin: LessThan at 19.12; stackHeight = 0
# begin: IdentifierExp at 19.10; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.10; stackHeight = 8
...
# end: IntegerLiteral at 19.14; stackHeight = 16
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 19.12; stackHeight = 4
# begin: IdentifierExp at 19.20; stackHeight = 4
    lw $t0, 16($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 19.20; stackHeight = 8
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 19.17; stackHeight = 4
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 19.17; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_T12Helper_getInt
mth_T12Helper_getInt:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:getInt"
# begin: If at 22.2; stackHeight = 0
# begin: IdentifierExp at 22.6; stackHeight = 0
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 22.6; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_75
# begin: Assign at 22.9; stackHeight = 0
# begin: Plus at 22.10; stackHeight = 0
...
# begin: IntegerLiteral at 22.10; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 22.10; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 22.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 4($sp)
# end: Assign at 22.9; stackHeight = 0
    j if_done_75
  if_else_75:
# begin: Block at 23.2; stackHeight = 0
# end: Block at 23.2; stackHeight = 0
  if_done_75:
# end: If at 22.2; stackHeight = 0
