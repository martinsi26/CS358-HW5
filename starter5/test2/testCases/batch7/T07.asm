...
# ****** class T07Helper ****** # ClassDecl at 10.7
  .byte 0 # ClassDecl at 10.7
  .byte 0 # ClassDecl at 10.7
  .byte 0 # ClassDecl at 10.7
  .byte 212 # 'T' with high bit set # ClassDecl at 10.7
  .byte 48 # '0' # ClassDecl at 10.7
  .byte 55 # '7' # ClassDecl at 10.7
  .byte 72 # 'H' # ClassDecl at 10.7
  .byte 101 # 'e' # ClassDecl at 10.7
  .byte 108 # 'l' # ClassDecl at 10.7
  .byte 112 # 'p' # ClassDecl at 10.7
  .byte 101 # 'e' # ClassDecl at 10.7
  .byte 114 # 'r' # ClassDecl at 10.7
CLASS_T07Helper: # ClassDecl at 10.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_T07Helper_call # MethodDeclVoid at 11.17
END_CLASS_T07Helper: # ClassDecl at 10.7
...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 84 # StringLiteral at 12.17
  .byte 104 # StringLiteral at 12.17
  .byte 105 # StringLiteral at 12.17
  ...
  .byte 32 # StringLiteral at 12.17
  .byte 109 # StringLiteral at 12.17
  .byte 101 # StringLiteral at 12.17
  .byte 115 # StringLiteral at 12.17
  .byte 115 # StringLiteral at 12.17
  .byte 97 # StringLiteral at 12.17
  .byte 103 # StringLiteral at 12.17
  .byte 101 # StringLiteral at 12.17
  .byte 10 # StringLiteral at 12.17
  .byte 0 # StringLiteral at 12.17
  .byte 0 # StringLiteral at 12.17
  .word CLASS_String # StringLiteral at 12.17
  .word 6 # StringLiteral at 12.17
  .word -18 # StringLiteral at 12.17
strLit_10: # StringLiteral at 12.17
.text
.globl main
main:
    jal vm_init
...
# end: CallStatement at 6.4; stackHeight = 4
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_T07Helper_call
mth_T07Helper_call:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:call"
# begin: CallStatement at 12.8; stackHeight = 0
# begin: Call at 12.8; stackHeight = 0
# begin: Super at 12.8; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.8; stackHeight = 4
# begin: StringLiteral at 12.17; stackHeight = 4
    la $t0, strLit_10
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.17; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.8; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.8; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
