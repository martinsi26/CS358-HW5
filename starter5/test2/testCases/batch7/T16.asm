...
# ****** class T16Helper ****** # ClassDecl at 13.7
  .byte 0 # ClassDecl at 13.7
  .byte 0 # ClassDecl at 13.7
  .byte 0 # ClassDecl at 13.7
  .byte 212 # 'T' with high bit set # ClassDecl at 13.7
  .byte 49 # '1' # ClassDecl at 13.7
  .byte 54 # '6' # ClassDecl at 13.7
  .byte 72 # 'H' # ClassDecl at 13.7
  .byte 101 # 'e' # ClassDecl at 13.7
  .byte 108 # 'l' # ClassDecl at 13.7
  .byte 112 # 'p' # ClassDecl at 13.7
  .byte 101 # 'e' # ClassDecl at 13.7
  .byte 114 # 'r' # ClassDecl at 13.7
CLASS_T16Helper: # ClassDecl at 13.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_T16Helper_getStr1 # MethodDeclNonVoid at 14.19
  .word mth_T16Helper_getStr2 # MethodDeclNonVoid at 19.19
END_CLASS_T16Helper: # ClassDecl at 13.7
...
# getStr1 parameter n offset = 4: MethodDeclNonVoid at 14.19
# getStr2 parameter b offset = 4: MethodDeclNonVoid at 19.19
...
strLit_11: # StringLiteral at 7.17
  .byte 80 # StringLiteral at 15.18
  .byte 117 # StringLiteral at 15.18
  .byte 114 # StringLiteral at 15.18
  .byte 112 # StringLiteral at 15.18
  .byte 108 # StringLiteral at 15.18
  .byte 101 # StringLiteral at 15.18
  .byte 0 # StringLiteral at 15.18
  .byte 0 # StringLiteral at 15.18
  .word CLASS_String # StringLiteral at 15.18
  .word 3 # StringLiteral at 15.18
  .word -6 # StringLiteral at 15.18
strLit_31: # StringLiteral at 15.18
  .byte 71 # StringLiteral at 16.23
  .byte 114 # StringLiteral at 16.23
  .byte 101 # StringLiteral at 16.23
  .byte 101 # StringLiteral at 16.23
  .byte 110 # StringLiteral at 16.23
  .byte 0 # StringLiteral at 16.23
  .byte 0 # StringLiteral at 16.23
  .byte 0 # StringLiteral at 16.23
  .word CLASS_String # StringLiteral at 16.23
  .word 3 # StringLiteral at 16.23
  .word -5 # StringLiteral at 16.23
strLit_38: # StringLiteral at 16.23
  .byte 66 # StringLiteral at 20.18
  .byte 108 # StringLiteral at 20.18
  .byte 97 # StringLiteral at 20.18
  .byte 99 # StringLiteral at 20.18
  .byte 107 # StringLiteral at 20.18
...
strLit_48: # StringLiteral at 20.18
  .byte 82 # StringLiteral at 21.18
  .byte 101 # StringLiteral at 21.18
...
strLit_53: # StringLiteral at 21.18
.text
.globl main
main:
    jal vm_init
...
# begin: Call at 6.19; stackHeight = 8
# begin: IdentifierExp at 6.17; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 6.17; stackHeight = 12
# begin: IntegerLiteral at 6.27; stackHeight = 12
    li $t0, 27
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.27; stackHeight = 20
    lw $zero, ($sp) #**"n"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.19; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: Call at 8.19; stackHeight = 8
# begin: IdentifierExp at 8.17; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.17; stackHeight = 12
# begin: False at 8.27; stackHeight = 12
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: False at 8.27; stackHeight = 16
    lw $zero, ($sp) #**"b"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.19; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: CallStatement at 9.8; stackHeight = 4
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_T16Helper_getStr1
mth_T16Helper_getStr1:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:getStr1"
# begin: LocalVarDecl at 15.9; stackHeight = 0
# begin: StringLiteral at 15.18; stackHeight = 0
    la $t0, strLit_31
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 15.18; stackHeight = 4
    lw $zero, ($sp) #**"rtnVal"
# end: LocalVarDecl at 15.9; stackHeight = 4
# begin: If at 16.2; stackHeight = 4
# begin: LessThan at 16.8; stackHeight = 4
# begin: IdentifierExp at 16.6; stackHeight = 4
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.6; stackHeight = 12
# begin: IntegerLiteral at 16.10; stackHeight = 12
    li $t0, 20
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.10; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 16.8; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_41
# begin: Assign at 16.21; stackHeight = 4
# begin: StringLiteral at 16.23; stackHeight = 4
    la $t0, strLit_38
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 16.23; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 16.21; stackHeight = 4
    j if_done_41
  if_else_41:
# begin: Block at 17.2; stackHeight = 4
# end: Block at 17.2; stackHeight = 4
  if_done_41:
# end: If at 16.2; stackHeight = 4
# begin: IdentifierExp at 17.9; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 4
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_T16Helper_getStr2
mth_T16Helper_getStr2:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:getStr2"
# begin: LocalVarDecl at 20.9; stackHeight = 0
# begin: StringLiteral at 20.18; stackHeight = 0
    la $t0, strLit_48
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 20.18; stackHeight = 4
    lw $zero, ($sp) #**"rtnVal"
# end: LocalVarDecl at 20.9; stackHeight = 4
# begin: If at 21.2; stackHeight = 4
# begin: IdentifierExp at 21.6; stackHeight = 4
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 21.6; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_56
# begin: Assign at 21.16; stackHeight = 4
# begin: StringLiteral at 21.18; stackHeight = 4
    la $t0, strLit_53
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 21.18; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 21.16; stackHeight = 4
    j if_done_56
  if_else_56:
# begin: Block at 22.2; stackHeight = 4
# end: Block at 22.2; stackHeight = 4
  if_done_56:
# end: If at 21.2; stackHeight = 4
# begin: IdentifierExp at 22.9; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
