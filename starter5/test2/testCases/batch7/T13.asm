...
# ****** class T13Helper ****** # ClassDecl at 15.7
  .byte 0 # ClassDecl at 15.7
  .byte 0 # ClassDecl at 15.7
  .byte 0 # ClassDecl at 15.7
  .byte 212 # 'T' with high bit set # ClassDecl at 15.7
  .byte 49 # '1' # ClassDecl at 15.7
  .byte 51 # '3' # ClassDecl at 15.7
  .byte 72 # 'H' # ClassDecl at 15.7
  .byte 101 # 'e' # ClassDecl at 15.7
  .byte 108 # 'l' # ClassDecl at 15.7
  .byte 112 # 'p' # ClassDecl at 15.7
  .byte 101 # 'e' # ClassDecl at 15.7
  .byte 114 # 'r' # ClassDecl at 15.7
CLASS_T13Helper: # ClassDecl at 15.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_T13Helper_getBool # MethodDeclNonVoid at 16.20
  .word mth_T13Helper_getInt # MethodDeclNonVoid at 19.16
END_CLASS_T13Helper: # ClassDecl at 15.7
...
# getBool parameter z offset = 4: MethodDeclNonVoid at 16.20
# getInt parameter s offset = 4: MethodDeclNonVoid at 19.16
  .byte 70 # StringLiteral at 6.28
  .byte 117 # StringLiteral at 6.28
  .byte 110 # StringLiteral at 6.28
  .byte 110 # StringLiteral at 6.28
  .byte 121 # StringLiteral at 6.28
  .byte 0 # StringLiteral at 6.28
  .byte 0 # StringLiteral at 6.28
  .byte 0 # StringLiteral at 6.28
  .word CLASS_String # StringLiteral at 6.28
  .word 3 # StringLiteral at 6.28
  .word -5 # StringLiteral at 6.28
strLit_6: # StringLiteral at 6.28
...
strLit_11: # StringLiteral at 7.17
  .byte 87 # StringLiteral at 10.26
  .byte 104 # StringLiteral at 10.26
  .byte 121 # StringLiteral at 10.26
  .byte 0 # StringLiteral at 10.26
  .word CLASS_String # StringLiteral at 10.26
  .word 2 # StringLiteral at 10.26
  .word -3 # StringLiteral at 10.26
strLit_26: # StringLiteral at 10.26
...
strLit_31: # StringLiteral at 11.17
.text
.globl main
main:
    jal vm_init
...
# begin: Null at 8.28; stackHeight = 12
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 8.28; stackHeight = 16
    lw $zero, ($sp) #**"z"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: StringLiteral at 10.26; stackHeight = 12
    la $t0, strLit_26
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.26; stackHeight = 16
    lw $zero, ($sp) #**"s"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: CallStatement at 11.8; stackHeight = 4
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_T13Helper_getBool
mth_T13Helper_getBool:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:getBool"
# begin: Not at 17.11; stackHeight = 0
# begin: Equals at 17.11; stackHeight = 0
# begin: IdentifierExp at 17.9; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.9; stackHeight = 4
# begin: Null at 17.14; stackHeight = 4
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 17.14; stackHeight = 8
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 17.11; stackHeight = 4
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 17.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_T13Helper_getInt
mth_T13Helper_getInt:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:getInt"
# begin: Minus at 20.9; stackHeight = 0
# begin: IntegerLiteral at 20.9; stackHeight = 0
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 20.9; stackHeight = 8
# begin: Call at 20.12; stackHeight = 8
# begin: IdentifierExp at 20.10; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 20.10; stackHeight = 12
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 20.12; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 20.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
