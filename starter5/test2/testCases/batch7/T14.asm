...
CLASS_T14Helper: # ClassDecl at 11.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_T14Helper_getStr # MethodDeclNonVoid at 12.19
END_CLASS_T14Helper: # ClassDecl at 11.7
...
# getStr parameter s offset = 12: MethodDeclNonVoid at 12.19
# getStr parameter n offset = 4: MethodDeclNonVoid at 12.19
  .byte 70 # StringLiteral at 6.26
  .byte 117 # StringLiteral at 6.26
  .byte 110 # StringLiteral at 6.26
  .byte 110 # StringLiteral at 6.26
  .byte 121 # StringLiteral at 6.26
  .byte 0 # StringLiteral at 6.26
  .byte 0 # StringLiteral at 6.26
  .byte 0 # StringLiteral at 6.26
  .word CLASS_String # StringLiteral at 6.26
  .word 3 # StringLiteral at 6.26
  .word -5 # StringLiteral at 6.26
...
strLit_12: # StringLiteral at 7.17
  .byte 98 # StringLiteral at 13.18
  .byte 105 # StringLiteral at 13.18
  .byte 103 # StringLiteral at 13.18
  .byte 103 # StringLiteral at 13.18
  .byte 103 # StringLiteral at 13.18
  .byte 103 # StringLiteral at 13.18
  .byte 103 # StringLiteral at 13.18
  ...
  .word 3 # StringLiteral at 13.18
  .word -7 # StringLiteral at 13.18
strLit_24: # StringLiteral at 13.18
.text
.globl main
main:
    jal vm_init
...
# end: StringLiteral at 6.26; stackHeight = 16
    lw $zero, ($sp) #**"s"
# begin: IntegerLiteral at 6.35; stackHeight = 16
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.35; stackHeight = 24
    lw $zero, ($sp) #**"n"
    lw $t0, 12($sp)
    sw $s2, 12($sp)
    move $s2, $t0
...
# end: CallStatement at 7.8; stackHeight = 4
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_T14Helper_getStr
mth_T14Helper_getStr:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:getStr"
# begin: LocalVarDecl at 13.9; stackHeight = 0
# begin: StringLiteral at 13.18; stackHeight = 0
    la $t0, strLit_24
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 13.18; stackHeight = 4
    lw $zero, ($sp) #**"rtnVal"
# end: LocalVarDecl at 13.9; stackHeight = 4
# begin: If at 14.2; stackHeight = 4
# begin: LessThan at 14.8; stackHeight = 4
# begin: IdentifierExp at 14.6; stackHeight = 4
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.6; stackHeight = 12
# begin: IntegerLiteral at 14.10; stackHeight = 12
    li $t0, 14
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 14.10; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 14.8; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_34
# begin: Assign at 14.21; stackHeight = 4
# begin: IdentifierExp at 14.23; stackHeight = 4
    lw $t0, 16($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.23; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 14.21; stackHeight = 4
    j if_done_34
  if_else_34:
# begin: Block at 15.2; stackHeight = 4
# end: Block at 15.2; stackHeight = 4
  if_done_34:
# end: If at 14.2; stackHeight = 4
# begin: IdentifierExp at 15.9; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
