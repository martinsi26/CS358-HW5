...
CLASS_T17Helper: # ClassDecl at 13.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_T17Helper_getStr # MethodDeclNonVoid at 14.19
END_CLASS_T17Helper: # ClassDecl at 13.7
...
# getStr parameter xyz offset = 4: MethodDeclNonVoid at 14.19
  .byte 72 # StringLiteral at 6.26
  .byte 111 # StringLiteral at 6.26
  .byte 108 # StringLiteral at 6.26
  .byte 100 # StringLiteral at 6.26
  .byte 32 # StringLiteral at 6.26
  .byte 105 # StringLiteral at 6.26
  .byte 116 # StringLiteral at 6.26
  .byte 33 # StringLiteral at 6.26
  .word CLASS_String # StringLiteral at 6.26
  .word 3 # StringLiteral at 6.26
  .word -8 # StringLiteral at 6.26
strLit_6: # StringLiteral at 6.26
...
# begin: StringLiteral at 6.26; stackHeight = 12
    la $t0, strLit_6
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.26; stackHeight = 16
    lw $zero, ($sp) #**"xyz"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: Null at 8.26; stackHeight = 12
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 8.26; stackHeight = 16
    lw $zero, ($sp) #**"xyz"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: CallStatement at 9.8; stackHeight = 4
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_T17Helper_getStr
mth_T17Helper_getStr:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:getStr"
...
# begin: Not at 16.10; stackHeight = 4
# begin: Equals at 16.10; stackHeight = 4
# begin: IdentifierExp at 16.6; stackHeight = 4
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 16.6; stackHeight = 8
# begin: Null at 16.13; stackHeight = 8
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 16.13; stackHeight = 12
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 16.10; stackHeight = 8
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 16.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_42
# begin: Assign at 16.26; stackHeight = 4
# begin: IdentifierExp at 16.28; stackHeight = 4
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 16.28; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 16.26; stackHeight = 4
    j if_done_42
  if_else_42:
