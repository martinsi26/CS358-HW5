...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_setI # MethodDeclNonVoid at 15.14
...
# ****** class Rec04 ****** # ClassDecl at 22.7
  .byte 0 # ClassDecl at 22.7
  .byte 0 # ClassDecl at 22.7
  .byte 0 # ClassDecl at 22.7
  .byte 210 # 'R' with high bit set # ClassDecl at 22.7
  .byte 101 # 'e' # ClassDecl at 22.7
  .byte 99 # 'c' # ClassDecl at 22.7
  .byte 48 # '0' # ClassDecl at 22.7
  .byte 52 # '4' # ClassDecl at 22.7
CLASS_Rec04: # ClassDecl at 22.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Rec04_init # MethodDeclNonVoid at 27.16
END_CLASS_Rec04: # ClassDecl at 22.7
...
# setI parameter val offset = 4: MethodDeclNonVoid at 15.14
# field Rec04.a offset = -16: InstVarDecl at 24.7
# field Rec04.b offset = -20: InstVarDecl at 25.7
# init parameter a offset = 12: MethodDeclNonVoid at 27.16
# init parameter b offset = 4: MethodDeclNonVoid at 27.16
  .byte 32 # StringLiteral at 10.39
...
strLit_26: # StringLiteral at 10.39
  .byte 10 # StringLiteral at 12.41
  .byte 0 # StringLiteral at 12.41
  .byte 0 # StringLiteral at 12.41
  .byte 0 # StringLiteral at 12.41
  .word CLASS_String # StringLiteral at 12.41
  .word 2 # StringLiteral at 12.41
  .word -1 # StringLiteral at 12.41
strLit_44: # StringLiteral at 12.41
.text
.globl main
main:
    jal vm_init
...
# begin: Call at 9.27; stackHeight = 8
# begin: NewObject at 9.15; stackHeight = 8
    li $s6, 3
    li $s7, 0
    jal newObject
    la $t0, CLASS_Rec04
    sw $t0, -12($s7)
# end: NewObject at 9.15; stackHeight = 12
# begin: Call at 9.32; stackHeight = 12
# begin: This at 9.32; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 9.32; stackHeight = 16
# begin: Times at 9.38; stackHeight = 16
# begin: IdentifierExp at 9.37; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.37; stackHeight = 24
# begin: IntegerLiteral at 9.39; stackHeight = 24
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.39; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 9.38; stackHeight = 24
    lw $zero, ($sp) #**"val"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 9.32; stackHeight = 20
    lw $zero, ($sp) #**"a"
# begin: Call at 9.43; stackHeight = 20
# begin: This at 9.43; stackHeight = 20
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 9.43; stackHeight = 24
# begin: Times at 9.49; stackHeight = 24
# begin: IdentifierExp at 9.48; stackHeight = 24
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.48; stackHeight = 32
# begin: IntegerLiteral at 9.50; stackHeight = 32
    li $t0, 7
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.50; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 9.49; stackHeight = 32
    lw $zero, ($sp) #**"val"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 9.43; stackHeight = 28
    lw $zero, ($sp) #**"b"
    lw $t0, 16($sp)
    sw $s2, 16($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.27; stackHeight = 12
    lw $zero, ($sp) #**"r"
# end: LocalVarDecl at 9.11; stackHeight = 12
# begin: CallStatement at 10.11; stackHeight = 12
# begin: Call at 10.11; stackHeight = 12
# begin: Super at 10.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.11; stackHeight = 16
# begin: IdentifierExp at 10.20; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.20; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# end: Call at 10.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.11; stackHeight = 12
# begin: CallStatement at 10.30; stackHeight = 12
# begin: Call at 10.30; stackHeight = 12
# begin: Super at 10.30; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.30; stackHeight = 16
# begin: StringLiteral at 10.39; stackHeight = 16
    la $t0, strLit_26
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.39; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.30; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.30; stackHeight = 12
# begin: CallStatement at 11.11; stackHeight = 12
# begin: Call at 11.11; stackHeight = 12
# begin: Super at 11.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.11; stackHeight = 16
# begin: InstVarAccess at 11.21; stackHeight = 16
# begin: IdentifierExp at 11.20; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 11.20; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 11.21; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.11; stackHeight = 12
# begin: CallStatement at 11.32; stackHeight = 12
# begin: Call at 11.32; stackHeight = 12
# begin: Super at 11.32; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.32; stackHeight = 16
# begin: StringLiteral at 11.41; stackHeight = 16
    la $t0, strLit_26
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 11.41; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.32; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.32; stackHeight = 12
...
# begin: InstVarAccess at 12.21; stackHeight = 16
...
# end: IdentifierExp at 12.20; stackHeight = 20
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 12.21; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 12.32; stackHeight = 12
# begin: Call at 12.32; stackHeight = 12
# begin: Super at 12.32; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.32; stackHeight = 16
# begin: StringLiteral at 12.41; stackHeight = 16
    la $t0, strLit_44
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.41; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.32; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.32; stackHeight = 12
    addu $sp, $sp, 12
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
# begin: IdentifierExp at 16.9; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 16.7; stackHeight = 0
# begin: IdentifierExp at 17.12; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.12; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Rec04_init
mth_Rec04_init:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:init"
# begin: Assign at 28.12; stackHeight = 0
# begin: IdentifierExp at 28.14; stackHeight = 0
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 28.14; stackHeight = 8
# begin: This at 28.5; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 28.5; stackHeight = 12
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 28.12; stackHeight = 0
# begin: Assign at 29.12; stackHeight = 0
# begin: IdentifierExp at 29.14; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 29.14; stackHeight = 8
# begin: This at 29.5; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 29.5; stackHeight = 12
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($t1)
# end: Assign at 29.12; stackHeight = 0
# begin: This at 30.12; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 30.12; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
