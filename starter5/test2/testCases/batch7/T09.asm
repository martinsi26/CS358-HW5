...
CLASS_T09Helper: # ClassDecl at 11.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_T09Helper_call # MethodDeclVoid at 12.17
END_CLASS_T09Helper: # ClassDecl at 11.7
...
# call parameter s offset = 4: MethodDeclVoid at 12.17
  .byte 87 # StringLiteral at 6.9
  .byte 105 # StringLiteral at 6.9
  .byte 108 # StringLiteral at 6.9
  .byte 108 # StringLiteral at 6.9
  .byte 121 # StringLiteral at 6.9
  .byte 0 # StringLiteral at 6.9
  .byte 0 # StringLiteral at 6.9
  .byte 0 # StringLiteral at 6.9
  .word CLASS_String # StringLiteral at 6.9
  .word 3 # StringLiteral at 6.9
  .word -5 # StringLiteral at 6.9
strLit_6: # StringLiteral at 6.9
  .byte 87 # StringLiteral at 7.9
  .byte 111 # StringLiteral at 7.9
  .byte 110 # StringLiteral at 7.9
  .byte 107 # StringLiteral at 7.9
  .byte 97 # StringLiteral at 7.9
  .byte 0 # StringLiteral at 7.9
  .byte 0 # StringLiteral at 7.9
  .byte 0 # StringLiteral at 7.9
  .word CLASS_String # StringLiteral at 7.9
  .word 3 # StringLiteral at 7.9
  .word -5 # StringLiteral at 7.9
strLit_10: # StringLiteral at 7.9
  .byte 60 # StringLiteral at 13.17
  .byte 60 # StringLiteral at 13.17
  ...
  .word -2 # StringLiteral at 13.17
strLit_17: # StringLiteral at 13.17
  .byte 60 # StringLiteral at 15.17
  .byte 60 # StringLiteral at 15.17
  .byte 10 # StringLiteral at 15.17
  .byte 0 # StringLiteral at 15.17
  .word CLASS_String # StringLiteral at 15.17
  .word 2 # StringLiteral at 15.17
  .word -3 # StringLiteral at 15.17
strLit_25: # StringLiteral at 15.17
.text
.globl main
main:
    jal vm_init
...
# end: CallStatement at 7.4; stackHeight = 4
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_T09Helper_call
mth_T09Helper_call:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:call"
# begin: CallStatement at 13.8; stackHeight = 0
# begin: Call at 13.8; stackHeight = 0
# begin: Super at 13.8; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 13.8; stackHeight = 4
# begin: StringLiteral at 13.17; stackHeight = 4
    la $t0, strLit_17
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 13.17; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.8; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 13.8; stackHeight = 0
...
# begin: IdentifierExp at 14.17; stackHeight = 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.17; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
