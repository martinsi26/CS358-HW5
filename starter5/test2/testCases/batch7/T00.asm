...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_incrI # MethodDeclNonVoid at 21.14
...
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 8.15
  .byte 0 # ArrayType at 8.15
  .byte 219 # '[' with high bit set # ArrayType at 8.15
  .byte 73 # 'I' # ArrayType at 8.15
CLASS_ARRAY_INT: # ArrayType at 8.15
  .word mth_Object_hashCode # ArrayType at 8.15
  .word mth_Object_equals # ArrayType at 8.15
  .word mth_Object_toString # ArrayType at 8.15
END_CLASS_ARRAY_INT: # ArrayType at 8.15
...
# field Main.i offset = -16: InstVarDecl at 5.7
  ...
  .word 2 # StringLiteral at 16.22
  .word -1 # StringLiteral at 16.22
strLit_66: # StringLiteral at 16.22
  .byte 10 # StringLiteral at 18.19
  .byte 0 # StringLiteral at 18.19
  .byte 0 # StringLiteral at 18.19
  .byte 0 # StringLiteral at 18.19
  .word CLASS_String # StringLiteral at 18.19
  .word 2 # StringLiteral at 18.19
  .word -1 # StringLiteral at 18.19
strLit_74: # StringLiteral at 18.19
.text
.globl main
main:
    jal vm_init
...
# begin: NewArray at 8.15; stackHeight = 0
# begin: IntegerLiteral at 8.23; stackHeight = 0
    li $t0, 10
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.23; stackHeight = 8
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 8.15; stackHeight = 4
    lw $zero, ($sp) #**"a"
# end: LocalVarDecl at 8.11; stackHeight = 4
# begin: Assign at 9.7; stackHeight = 4
# begin: IntegerLiteral at 9.9; stackHeight = 4
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.9; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 9.7; stackHeight = 4
# begin: Block at 10.5; stackHeight = 4
# begin: LocalVarDecl at 10.14; stackHeight = 4
# begin: IntegerLiteral at 10.18; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.18; stackHeight = 12
    lw $zero, ($sp) #**"j"
# end: LocalVarDecl at 10.14; stackHeight = 12
# begin: BreakTarget at 10.5; stackHeight = 12
    j while_cond_34
  while_top_34:
# begin: Block at 10.5; stackHeight = 12
# begin: Block at 10.40; stackHeight = 12
# begin: Assign at 11.12; stackHeight = 12
# begin: IdentifierExp at 11.7; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 11.7; stackHeight = 16
...
# begin: Times at 11.15; stackHeight = 24
# begin: IdentifierExp at 11.14; stackHeight = 24
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.14; stackHeight = 32
# begin: IdentifierExp at 11.16; stackHeight = 32
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.16; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 11.15; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 11.12; stackHeight = 12
# end: Block at 10.40; stackHeight = 12
# begin: Assign at 10.35; stackHeight = 12
# begin: Plus at 10.36; stackHeight = 12
# begin: IdentifierExp at 10.35; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.35; stackHeight = 20
# begin: IntegerLiteral at 10.36; stackHeight = 20
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.36; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 10.36; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 10.35; stackHeight = 12
# end: Block at 10.5; stackHeight = 12
  while_cond_34:
# begin: LessThan at 10.23; stackHeight = 12
# begin: IdentifierExp at 10.21; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.21; stackHeight = 20
# begin: ArrayLength at 10.26; stackHeight = 20
# begin: IdentifierExp at 10.25; stackHeight = 20
    lw $t0, 16($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.25; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 10.26; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 10.23; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_34
  break_target_34:
# end: BreakTarget at 10.5; stackHeight = 12
    addu $sp, $sp, 8
# end: Block at 10.5; stackHeight = 4
...
# begin: Call at 13.7; stackHeight = 8
# begin: This at 13.7; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 13.7; stackHeight = 12
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 13.7; stackHeight = 16
# begin: Plus at 13.29; stackHeight = 16
# begin: ArrayLookup at 13.19; stackHeight = 16
# begin: Call at 13.20; stackHeight = 16
# begin: This at 13.20; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 13.20; stackHeight = 20
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 13.20; stackHeight = 24
...
# end: IdentifierExp at 13.18; stackHeight = 28
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 13.19; stackHeight = 24
# begin: IntegerLiteral at 13.31; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.31; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 13.29; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
...
# begin: Block at 14.5; stackHeight = 4
# begin: LocalVarDecl at 14.14; stackHeight = 4
# begin: IntegerLiteral at 14.18; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 14.18; stackHeight = 12
    lw $zero, ($sp) #**"j"
# end: LocalVarDecl at 14.14; stackHeight = 12
# begin: BreakTarget at 14.5; stackHeight = 12
    j while_cond_72
  while_top_72:
# begin: Block at 14.5; stackHeight = 12
# begin: Block at 14.40; stackHeight = 12
# begin: CallStatement at 15.13; stackHeight = 12
# begin: Call at 15.13; stackHeight = 12
# begin: Super at 15.13; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 15.13; stackHeight = 16
# begin: ArrayLookup at 15.23; stackHeight = 16
# begin: IdentifierExp at 15.24; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 15.24; stackHeight = 24
# begin: IdentifierExp at 15.22; stackHeight = 24
    lw $t0, 20($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.22; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 15.23; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 15.13; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 15.13; stackHeight = 12
# begin: CallStatement at 16.13; stackHeight = 12
# begin: Call at 16.13; stackHeight = 12
# begin: Super at 16.13; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 16.13; stackHeight = 16
# begin: StringLiteral at 16.22; stackHeight = 16
    la $t0, strLit_66
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 16.22; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 16.13; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 16.13; stackHeight = 12
# end: Block at 14.40; stackHeight = 12
# begin: Assign at 14.35; stackHeight = 12
# begin: Plus at 14.36; stackHeight = 12
# begin: IdentifierExp at 14.35; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.35; stackHeight = 20
# begin: IntegerLiteral at 14.36; stackHeight = 20
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 14.36; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 14.36; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 14.35; stackHeight = 12
# end: Block at 14.5; stackHeight = 12
  while_cond_72:
# begin: LessThan at 14.23; stackHeight = 12
# begin: IdentifierExp at 14.21; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.21; stackHeight = 20
# begin: ArrayLength at 14.26; stackHeight = 20
# begin: IdentifierExp at 14.25; stackHeight = 20
    lw $t0, 16($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.25; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 14.26; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 14.23; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_72
  break_target_72:
# end: BreakTarget at 14.5; stackHeight = 12
    addu $sp, $sp, 8
# end: Block at 14.5; stackHeight = 4
# begin: CallStatement at 18.10; stackHeight = 4
# begin: Call at 18.10; stackHeight = 4
# begin: Super at 18.10; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 18.10; stackHeight = 8
# begin: StringLiteral at 18.19; stackHeight = 8
    la $t0, strLit_74
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 18.19; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 18.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 18.10; stackHeight = 4
    addu $sp, $sp, 4
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Main_incrI:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:incrI"
# begin: Assign at 21.24; stackHeight = 0
# begin: Plus at 21.25; stackHeight = 0
# begin: IdentifierExp at 21.24; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.24; stackHeight = 8
...
# end: IntegerLiteral at 21.25; stackHeight = 16
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 21.25; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 21.24; stackHeight = 0
# begin: IdentifierExp at 21.36; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.36; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
