...
# ****** class T11Helper ****** # ClassDecl at 13.7
...
CLASS_T11Helper: # ClassDecl at 13.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_T11Helper_getBool # MethodDeclNonVoid at 14.20
  .word mth_T11Helper_getInt # MethodDeclNonVoid at 17.16
END_CLASS_T11Helper: # ClassDecl at 13.7
...
strLit_10: # StringLiteral at 7.17
  .byte 10 # StringLiteral at 9.17
  .byte 0 # StringLiteral at 9.17
  .byte 0 # StringLiteral at 9.17
  .byte 0 # StringLiteral at 9.17
  .word CLASS_String # StringLiteral at 9.17
  .word 2 # StringLiteral at 9.17
  .word -1 # StringLiteral at 9.17
strLit_19: # StringLiteral at 9.17
.text
.globl main
main:
    jal vm_init
...
# end: IdentifierExp at 8.17; stackHeight = 12
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 8.19; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# end: CallStatement at 9.8; stackHeight = 4
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_T11Helper_getBool
mth_T11Helper_getBool:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:getBool"
# begin: False at 15.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: False at 15.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_T11Helper_getInt
mth_T11Helper_getInt:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:getInt"
# begin: Minus at 18.9; stackHeight = 0
...
# begin: IntegerLiteral at 18.10; stackHeight = 8
    li $t0, 333
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 18.10; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 18.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
