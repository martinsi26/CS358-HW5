...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_setJ # MethodDeclNonVoid at 16.14
  .word mth_Main_sum # MethodDeclNonVoid at 21.14
...
# field Main.j offset = -16: InstVarDecl at 5.7
# setJ parameter val offset = 4: MethodDeclNonVoid at 16.14
# sum parameter a offset = 12: MethodDeclNonVoid at 21.14
# sum parameter b offset = 4: MethodDeclNonVoid at 21.14
  .byte 120 # StringLiteral at 10.22
  .byte 32 # StringLiteral at 10.22
  .byte 0 # StringLiteral at 10.22
  .byte 0 # StringLiteral at 10.22
  .word CLASS_String # StringLiteral at 10.22
  .word 2 # StringLiteral at 10.22
  .word -2 # StringLiteral at 10.22
strLit_23: # StringLiteral at 10.22
...
strLit_31: # StringLiteral at 12.22
.text
.globl main
main:
    jal vm_init
...
# begin: Block at 9.5; stackHeight = 0
# begin: LocalVarDecl at 9.14; stackHeight = 0
# begin: Minus at 9.19; stackHeight = 0
# begin: IdentifierExp at 9.18; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.18; stackHeight = 8
# begin: IntegerLiteral at 9.20; stackHeight = 8
    li $t0, 23
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.20; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 9.19; stackHeight = 8
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 9.14; stackHeight = 8
# begin: BreakTarget at 9.5; stackHeight = 8
    j while_cond_37
  while_top_37:
# begin: Block at 9.5; stackHeight = 8
# begin: Block at 9.50; stackHeight = 8
# begin: CallStatement at 10.13; stackHeight = 8
# begin: Call at 10.13; stackHeight = 8
# begin: Super at 10.13; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.13; stackHeight = 12
# begin: StringLiteral at 10.22; stackHeight = 12
    la $t0, strLit_23
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.22; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.13; stackHeight = 8
# begin: CallStatement at 11.13; stackHeight = 8
# begin: Call at 11.13; stackHeight = 8
# begin: Super at 11.13; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.13; stackHeight = 12
# begin: IdentifierExp at 11.22; stackHeight = 12
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.22; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.13; stackHeight = 8
...
# end: Block at 9.50; stackHeight = 8
# begin: Assign at 9.41; stackHeight = 8
# begin: Plus at 9.45; stackHeight = 8
# begin: IdentifierExp at 9.43; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.43; stackHeight = 16
# begin: IntegerLiteral at 9.47; stackHeight = 16
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.47; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 9.45; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 9.41; stackHeight = 8
# end: Block at 9.5; stackHeight = 8
  while_cond_37:
# begin: LessThan at 9.26; stackHeight = 8
# begin: IdentifierExp at 9.24; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.24; stackHeight = 16
# begin: Call at 9.28; stackHeight = 16
# begin: This at 9.28; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 9.28; stackHeight = 20
# begin: Plus at 9.34; stackHeight = 20
# begin: IdentifierExp at 9.33; stackHeight = 20
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.33; stackHeight = 28
# begin: IntegerLiteral at 9.35; stackHeight = 28
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.35; stackHeight = 36
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 9.34; stackHeight = 28
    lw $zero, ($sp) #**"val"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 9.28; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 9.26; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_37
  break_target_37:
# end: BreakTarget at 9.5; stackHeight = 8
    addu $sp, $sp, 8
# end: Block at 9.5; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
# begin: IdentifierExp at 18.12; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 18.12; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
...
mth_Main_sum:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:sum"
# begin: Plus at 21.42; stackHeight = 0
# begin: IdentifierExp at 21.41; stackHeight = 0
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.41; stackHeight = 8
# begin: IdentifierExp at 21.43; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.43; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 21.42; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
