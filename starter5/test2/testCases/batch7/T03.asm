...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_setI # MethodDeclNonVoid at 21.14
...
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 9.15
  .byte 0 # ArrayType at 9.15
  .byte 219 # '[' with high bit set # ArrayType at 9.15
  .byte 73 # 'I' # ArrayType at 9.15
CLASS_ARRAY_INT: # ArrayType at 9.15
  .word mth_Object_hashCode # ArrayType at 9.15
  .word mth_Object_equals # ArrayType at 9.15
  .word mth_Object_toString # ArrayType at 9.15
END_CLASS_ARRAY_INT: # ArrayType at 9.15
...
# setI parameter val offset = 4: MethodDeclNonVoid at 21.14
  .byte 32 # StringLiteral at 14.39
  .byte 0 # StringLiteral at 14.39
  .byte 0 # StringLiteral at 14.39
  .byte 0 # StringLiteral at 14.39
  .word CLASS_String # StringLiteral at 14.39
  .word 2 # StringLiteral at 14.39
  .word -1 # StringLiteral at 14.39
strLit_57: # StringLiteral at 14.39
  .byte 10 # StringLiteral at 16.42
  .byte 0 # StringLiteral at 16.42
  .byte 0 # StringLiteral at 16.42
  .byte 0 # StringLiteral at 16.42
  .word CLASS_String # StringLiteral at 16.42
  .word 2 # StringLiteral at 16.42
  .word -1 # StringLiteral at 16.42
strLit_76: # StringLiteral at 16.42
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: LocalVarDecl at 8.9; stackHeight = 0
# begin: IntegerLiteral at 8.13; stackHeight = 0
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.13; stackHeight = 8
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 8.9; stackHeight = 8
# begin: LocalVarDecl at 9.11; stackHeight = 8
# begin: NewArray at 9.15; stackHeight = 8
# begin: Call at 9.23; stackHeight = 8
# begin: This at 9.23; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 9.23; stackHeight = 12
# begin: Times at 9.30; stackHeight = 12
# begin: IdentifierExp at 9.28; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.28; stackHeight = 20
# begin: IntegerLiteral at 9.32; stackHeight = 20
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.32; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 9.30; stackHeight = 20
    lw $zero, ($sp) #**"val"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 9.23; stackHeight = 16
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 9.15; stackHeight = 12
    lw $zero, ($sp) #**"a"
# end: LocalVarDecl at 9.11; stackHeight = 12
# begin: Assign at 10.10; stackHeight = 12
# begin: IdentifierExp at 10.5; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.5; stackHeight = 16
# begin: IntegerLiteral at 10.7; stackHeight = 16
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.7; stackHeight = 24
# begin: Call at 10.12; stackHeight = 24
# begin: This at 10.12; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 10.12; stackHeight = 28
# begin: Plus at 10.19; stackHeight = 28
# begin: IdentifierExp at 10.17; stackHeight = 28
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.17; stackHeight = 36
# begin: IntegerLiteral at 10.21; stackHeight = 36
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.21; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 10.19; stackHeight = 36
    lw $zero, ($sp) #**"val"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 10.12; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 10.10; stackHeight = 12
# begin: Assign at 11.10; stackHeight = 12
# begin: IdentifierExp at 11.5; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 11.5; stackHeight = 16
# begin: IntegerLiteral at 11.7; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.7; stackHeight = 24
# begin: Call at 11.12; stackHeight = 24
# begin: This at 11.12; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.12; stackHeight = 28
# begin: Plus at 11.19; stackHeight = 28
# begin: IdentifierExp at 11.17; stackHeight = 28
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.17; stackHeight = 36
# begin: IntegerLiteral at 11.21; stackHeight = 36
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.21; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 11.19; stackHeight = 36
    lw $zero, ($sp) #**"val"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 11.12; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 11.10; stackHeight = 12
# begin: Assign at 12.10; stackHeight = 12
# begin: IdentifierExp at 12.5; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.5; stackHeight = 16
# begin: IntegerLiteral at 12.7; stackHeight = 16
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.7; stackHeight = 24
# begin: Call at 12.12; stackHeight = 24
# begin: This at 12.12; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 12.12; stackHeight = 28
# begin: Plus at 12.19; stackHeight = 28
# begin: IdentifierExp at 12.17; stackHeight = 28
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.17; stackHeight = 36
# begin: IntegerLiteral at 12.21; stackHeight = 36
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.21; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 12.19; stackHeight = 36
    lw $zero, ($sp) #**"val"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 12.12; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
...
# begin: Assign at 13.10; stackHeight = 12
# begin: IdentifierExp at 13.5; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.5; stackHeight = 16
# begin: IntegerLiteral at 13.7; stackHeight = 16
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.7; stackHeight = 24
# begin: Call at 13.12; stackHeight = 24
# begin: This at 13.12; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 13.12; stackHeight = 28
# begin: Plus at 13.19; stackHeight = 28
# begin: IdentifierExp at 13.17; stackHeight = 28
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.17; stackHeight = 36
# begin: IntegerLiteral at 13.21; stackHeight = 36
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.21; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 13.19; stackHeight = 36
    lw $zero, ($sp) #**"val"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 13.12; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 13.10; stackHeight = 12
...
# begin: IdentifierExp at 14.20; stackHeight = 16
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.20; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 14.30; stackHeight = 12
# begin: Call at 14.30; stackHeight = 12
# begin: Super at 14.30; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 14.30; stackHeight = 16
# begin: StringLiteral at 14.39; stackHeight = 16
    la $t0, strLit_57
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 14.39; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.30; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.30; stackHeight = 12
...
# begin: ArrayLength at 15.21; stackHeight = 16
...
# end: IdentifierExp at 15.20; stackHeight = 20
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 15.21; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 15.37; stackHeight = 12
# begin: Call at 15.37; stackHeight = 12
# begin: Super at 15.37; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 15.37; stackHeight = 16
# begin: StringLiteral at 15.46; stackHeight = 16
    la $t0, strLit_57
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 15.46; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 15.37; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 15.37; stackHeight = 12
# begin: CallStatement at 16.11; stackHeight = 12
# begin: Call at 16.11; stackHeight = 12
# begin: Super at 16.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 16.11; stackHeight = 16
# begin: ArrayLookup at 16.21; stackHeight = 16
# begin: IntegerLiteral at 16.22; stackHeight = 16
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.22; stackHeight = 24
# begin: IdentifierExp at 16.20; stackHeight = 24
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 16.20; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 16.21; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 16.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 16.11; stackHeight = 12
# begin: CallStatement at 16.33; stackHeight = 12
# begin: Call at 16.33; stackHeight = 12
# begin: Super at 16.33; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 16.33; stackHeight = 16
# begin: StringLiteral at 16.42; stackHeight = 16
    la $t0, strLit_76
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 16.42; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 16.33; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 16.33; stackHeight = 12
# begin: CallStatement at 17.11; stackHeight = 12
# begin: Call at 17.11; stackHeight = 12
# begin: Super at 17.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 17.11; stackHeight = 16
# begin: ArrayLookup at 17.21; stackHeight = 16
# begin: IntegerLiteral at 17.22; stackHeight = 16
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.22; stackHeight = 24
# begin: IdentifierExp at 17.20; stackHeight = 24
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.20; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 17.21; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 17.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 17.11; stackHeight = 12
# begin: CallStatement at 17.33; stackHeight = 12
# begin: Call at 17.33; stackHeight = 12
# begin: Super at 17.33; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 17.33; stackHeight = 16
# begin: StringLiteral at 17.42; stackHeight = 16
    la $t0, strLit_76
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 17.42; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 17.33; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 17.33; stackHeight = 12
# begin: CallStatement at 18.11; stackHeight = 12
# begin: Call at 18.11; stackHeight = 12
# begin: Super at 18.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 18.11; stackHeight = 16
# begin: ArrayLookup at 18.21; stackHeight = 16
# begin: Minus at 18.30; stackHeight = 16
# begin: ArrayLength at 18.23; stackHeight = 16
# begin: IdentifierExp at 18.22; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 18.22; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 18.23; stackHeight = 24
# begin: IntegerLiteral at 18.31; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 18.31; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 18.30; stackHeight = 24
# begin: IdentifierExp at 18.20; stackHeight = 24
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 18.20; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 18.21; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 18.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 18.11; stackHeight = 12
# begin: CallStatement at 18.42; stackHeight = 12
# begin: Call at 18.42; stackHeight = 12
# begin: Super at 18.42; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 18.42; stackHeight = 16
# begin: StringLiteral at 18.51; stackHeight = 16
    la $t0, strLit_76
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 18.51; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 18.42; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 18.42; stackHeight = 12
    addu $sp, $sp, 12
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
# begin: IdentifierExp at 22.9; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 22.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 22.7; stackHeight = 0
# begin: IdentifierExp at 23.12; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 23.12; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
