...
CLASS_Main: # ClassDecl at 2.7
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Main_main # MethodDeclVoid at 6.15
  .word mth_Main_incrI # MethodDeclNonVoid at 27.14
...
END_CLASS_RunMain: # ClassDecl at 0.0
  .byte 0 # ArrayType at 8.17
  .byte 219 # '[' with high bit set # ArrayType at 8.17
  .byte 91 # '[' # ArrayType at 8.17
  .byte 73 # 'I' # ArrayType at 8.17
CLASS_ARRAY_ARRAY_INT: # ArrayType at 8.17
  .word mth_Object_hashCode # ArrayType at 8.17
  .word mth_Object_equals # ArrayType at 8.17
  .word mth_Object_toString # ArrayType at 8.17
END_CLASS_ARRAY_ARRAY_INT: # ArrayType at 8.17
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 10.16
  .byte 0 # ArrayType at 10.16
  .byte 219 # '[' with high bit set # ArrayType at 10.16
  .byte 73 # 'I' # ArrayType at 10.16
CLASS_ARRAY_INT: # ArrayType at 10.16
  .word mth_Object_hashCode # ArrayType at 10.16
  .word mth_Object_equals # ArrayType at 10.16
  .word mth_Object_toString # ArrayType at 10.16
END_CLASS_ARRAY_INT: # ArrayType at 10.16
...
# field Main.i offset = -16: InstVarDecl at 4.7
  .byte 32 # StringLiteral at 19.29
  .byte 0 # StringLiteral at 19.29
  .byte 0 # StringLiteral at 19.29
  .byte 0 # StringLiteral at 19.29
  .word CLASS_String # StringLiteral at 19.29
  .word 2 # StringLiteral at 19.29
  .word -1 # StringLiteral at 19.29
strLit_109: # StringLiteral at 19.29
  .byte 10 # StringLiteral at 21.24
  .byte 0 # StringLiteral at 21.24
  .byte 0 # StringLiteral at 21.24
  .byte 0 # StringLiteral at 21.24
  .word CLASS_String # StringLiteral at 21.24
  .word 2 # StringLiteral at 21.24
  .word -1 # StringLiteral at 21.24
strLit_117: # StringLiteral at 21.24
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: LocalVarDecl at 7.9; stackHeight = 0
# begin: IntegerLiteral at 7.16; stackHeight = 0
    li $t0, 11
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.16; stackHeight = 8
    lw $zero, ($sp) #**"size"
# end: LocalVarDecl at 7.9; stackHeight = 8
# begin: LocalVarDecl at 8.13; stackHeight = 8
# begin: NewArray at 8.17; stackHeight = 8
# begin: IdentifierExp at 8.25; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.25; stackHeight = 16
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 8.17; stackHeight = 12
    lw $zero, ($sp) #**"a"
# end: LocalVarDecl at 8.13; stackHeight = 12
# begin: Block at 9.5; stackHeight = 12
# begin: LocalVarDecl at 9.14; stackHeight = 12
# begin: IntegerLiteral at 9.18; stackHeight = 12
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.18; stackHeight = 20
    lw $zero, ($sp) #**"j"
# end: LocalVarDecl at 9.14; stackHeight = 20
# begin: BreakTarget at 9.5; stackHeight = 20
    j while_cond_37
  while_top_37:
# begin: Block at 9.5; stackHeight = 20
# begin: Block at 9.40; stackHeight = 20
# begin: Assign at 10.14; stackHeight = 20
# begin: IdentifierExp at 10.9; stackHeight = 20
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.9; stackHeight = 24
# begin: IdentifierExp at 10.11; stackHeight = 24
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.11; stackHeight = 32
# begin: NewArray at 10.16; stackHeight = 32
# begin: IdentifierExp at 10.24; stackHeight = 32
    lw $t0, 24($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.24; stackHeight = 40
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 10.16; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 10.14; stackHeight = 20
# end: Block at 9.40; stackHeight = 20
# begin: Assign at 9.35; stackHeight = 20
# begin: Plus at 9.36; stackHeight = 20
# begin: IdentifierExp at 9.35; stackHeight = 20
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.35; stackHeight = 28
# begin: IntegerLiteral at 9.36; stackHeight = 28
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.36; stackHeight = 36
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 9.36; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 9.35; stackHeight = 20
# end: Block at 9.5; stackHeight = 20
  while_cond_37:
# begin: LessThan at 9.23; stackHeight = 20
# begin: IdentifierExp at 9.21; stackHeight = 20
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.21; stackHeight = 28
# begin: ArrayLength at 9.26; stackHeight = 28
# begin: IdentifierExp at 9.25; stackHeight = 28
    lw $t0, 16($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 9.25; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 9.26; stackHeight = 36
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 9.23; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_37
  break_target_37:
# end: BreakTarget at 9.5; stackHeight = 20
    addu $sp, $sp, 8
# end: Block at 9.5; stackHeight = 12
# begin: LocalVarDecl at 12.9; stackHeight = 12
# begin: IntegerLiteral at 12.13; stackHeight = 12
    li $t0, 24
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.13; stackHeight = 20
    lw $zero, ($sp) #**"k"
# end: LocalVarDecl at 12.9; stackHeight = 20
# begin: Assign at 13.7; stackHeight = 20
# begin: IntegerLiteral at 13.9; stackHeight = 20
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.9; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 13.7; stackHeight = 20
# begin: Block at 14.5; stackHeight = 20
# begin: LocalVarDecl at 14.14; stackHeight = 20
# begin: IntegerLiteral at 14.18; stackHeight = 20
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 14.18; stackHeight = 28
    lw $zero, ($sp) #**"j"
# end: LocalVarDecl at 14.14; stackHeight = 28
# begin: BreakTarget at 14.5; stackHeight = 28
    j while_cond_131
  while_top_131:
# begin: Block at 14.5; stackHeight = 28
# begin: Block at 14.40; stackHeight = 28
# begin: Assign at 15.45; stackHeight = 28
# begin: ArrayLookup at 15.8; stackHeight = 28
# begin: Remainder at 15.16; stackHeight = 28
# begin: Call at 15.9; stackHeight = 28
# begin: This at 15.9; stackHeight = 28
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 15.9; stackHeight = 32
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 15.9; stackHeight = 36
# begin: ArrayLength at 15.18; stackHeight = 36
# begin: IdentifierExp at 15.17; stackHeight = 36
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.17; stackHeight = 40
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 15.18; stackHeight = 44
    jal remainder
# end: Remainder at 15.16; stackHeight = 36
# begin: IdentifierExp at 15.7; stackHeight = 36
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.7; stackHeight = 40
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: ArrayLookup at 15.8; stackHeight = 32
# begin: Remainder at 15.34; stackHeight = 32
# begin: Call at 15.27; stackHeight = 32
# begin: This at 15.27; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 15.27; stackHeight = 36
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 15.27; stackHeight = 40
# begin: ArrayLength at 15.36; stackHeight = 40
# begin: IdentifierExp at 15.35; stackHeight = 40
    lw $t0, 28($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.35; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 15.36; stackHeight = 48
    jal remainder
# end: Remainder at 15.34; stackHeight = 40
# begin: IntegerLiteral at 15.47; stackHeight = 40
    li $t0, 28
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.47; stackHeight = 48
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 15.45; stackHeight = 28
# begin: Block at 16.7; stackHeight = 28
# begin: LocalVarDecl at 16.16; stackHeight = 28
# begin: IntegerLiteral at 16.21; stackHeight = 28
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.21; stackHeight = 36
    lw $zero, ($sp) #**"jj"
# end: LocalVarDecl at 16.16; stackHeight = 36
# begin: BreakTarget at 16.7; stackHeight = 36
    j while_cond_123
  while_top_123:
# begin: Block at 16.7; stackHeight = 36
# begin: Block at 16.45; stackHeight = 36
# begin: Block at 17.9; stackHeight = 36
# begin: Assign at 17.16; stackHeight = 36
# begin: IntegerLiteral at 17.18; stackHeight = 36
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.18; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 16($sp)
# end: Assign at 17.16; stackHeight = 36
# begin: BreakTarget at 17.9; stackHeight = 36
    j while_cond_115
  while_top_115:
# begin: Block at 17.9; stackHeight = 36
# begin: Block at 17.43; stackHeight = 36
# begin: CallStatement at 18.17; stackHeight = 36
# begin: Call at 18.17; stackHeight = 36
# begin: Super at 18.17; stackHeight = 36
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 18.17; stackHeight = 40
# begin: ArrayLookup at 18.31; stackHeight = 40
# begin: IdentifierExp at 18.32; stackHeight = 40
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 18.32; stackHeight = 48
# begin: ArrayLookup at 18.27; stackHeight = 48
# begin: IdentifierExp at 18.28; stackHeight = 48
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 18.28; stackHeight = 56
# begin: IdentifierExp at 18.26; stackHeight = 56
    lw $t0, 44($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 18.26; stackHeight = 60
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: ArrayLookup at 18.27; stackHeight = 52
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 18.31; stackHeight = 48
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 18.17; stackHeight = 40
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 18.17; stackHeight = 36
# begin: CallStatement at 19.17; stackHeight = 36
# begin: Call at 19.17; stackHeight = 36
# begin: Super at 19.17; stackHeight = 36
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 19.17; stackHeight = 40
# begin: StringLiteral at 19.29; stackHeight = 40
    la $t0, strLit_109
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 19.29; stackHeight = 44
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 19.17; stackHeight = 40
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 19.17; stackHeight = 36
# end: Block at 17.43; stackHeight = 36
# begin: Assign at 17.38; stackHeight = 36
# begin: Plus at 17.39; stackHeight = 36
# begin: IdentifierExp at 17.38; stackHeight = 36
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.38; stackHeight = 44
# begin: IntegerLiteral at 17.39; stackHeight = 44
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.39; stackHeight = 52
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 17.39; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 16($sp)
# end: Assign at 17.38; stackHeight = 36
# end: Block at 17.9; stackHeight = 36
  while_cond_115:
# begin: LessThan at 17.23; stackHeight = 36
# begin: IdentifierExp at 17.21; stackHeight = 36
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.21; stackHeight = 44
# begin: ArrayLength at 17.29; stackHeight = 44
# begin: ArrayLookup at 17.26; stackHeight = 44
# begin: IdentifierExp at 17.27; stackHeight = 44
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.27; stackHeight = 52
# begin: IdentifierExp at 17.25; stackHeight = 52
    lw $t0, 40($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.25; stackHeight = 56
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: ArrayLookup at 17.26; stackHeight = 48
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 17.29; stackHeight = 52
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 17.23; stackHeight = 40
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_115
  break_target_115:
# end: BreakTarget at 17.9; stackHeight = 36
# end: Block at 17.9; stackHeight = 36
# begin: CallStatement at 21.15; stackHeight = 36
# begin: Call at 21.15; stackHeight = 36
# begin: Super at 21.15; stackHeight = 36
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 21.15; stackHeight = 40
# begin: StringLiteral at 21.24; stackHeight = 40
    la $t0, strLit_117
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 21.24; stackHeight = 44
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 21.15; stackHeight = 40
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 21.15; stackHeight = 36
# end: Block at 16.45; stackHeight = 36
# begin: Assign at 16.39; stackHeight = 36
# begin: Plus at 16.41; stackHeight = 36
# begin: IdentifierExp at 16.39; stackHeight = 36
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.39; stackHeight = 44
# begin: IntegerLiteral at 16.41; stackHeight = 44
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.41; stackHeight = 52
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 16.41; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 16.39; stackHeight = 36
# end: Block at 16.7; stackHeight = 36
  while_cond_123:
# begin: LessThan at 16.27; stackHeight = 36
# begin: IdentifierExp at 16.24; stackHeight = 36
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.24; stackHeight = 44
# begin: ArrayLength at 16.30; stackHeight = 44
# begin: IdentifierExp at 16.29; stackHeight = 44
    lw $t0, 32($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 16.29; stackHeight = 48
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 16.30; stackHeight = 52
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 16.27; stackHeight = 40
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_123
  break_target_123:
# end: BreakTarget at 16.7; stackHeight = 36
    addu $sp, $sp, 8
# end: Block at 16.7; stackHeight = 28
# begin: CallStatement at 23.13; stackHeight = 28
# begin: Call at 23.13; stackHeight = 28
# begin: Super at 23.13; stackHeight = 28
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 23.13; stackHeight = 32
# begin: StringLiteral at 23.22; stackHeight = 32
    la $t0, strLit_117
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 23.22; stackHeight = 36
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: Call at 23.13; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 23.13; stackHeight = 28
# end: Block at 14.40; stackHeight = 28
# begin: Assign at 14.35; stackHeight = 28
# begin: Plus at 14.36; stackHeight = 28
# begin: IdentifierExp at 14.35; stackHeight = 28
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.35; stackHeight = 36
# begin: IntegerLiteral at 14.36; stackHeight = 36
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 14.36; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 14.36; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 14.35; stackHeight = 28
# end: Block at 14.5; stackHeight = 28
  while_cond_131:
# begin: LessThan at 14.23; stackHeight = 28
# begin: IdentifierExp at 14.21; stackHeight = 28
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.21; stackHeight = 36
# begin: ArrayLength at 14.26; stackHeight = 36
# begin: IdentifierExp at 14.25; stackHeight = 36
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.25; stackHeight = 40
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 14.26; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 14.23; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_131
  break_target_131:
# end: BreakTarget at 14.5; stackHeight = 28
    addu $sp, $sp, 8
# end: Block at 14.5; stackHeight = 20
    addu $sp, $sp, 20
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_incrI
mth_Main_incrI:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:incrI"
# begin: Assign at 28.6; stackHeight = 0
# begin: Plus at 28.10; stackHeight = 0
# begin: IdentifierExp at 28.8; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 28.8; stackHeight = 8
# begin: IntegerLiteral at 28.12; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 28.12; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 28.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 28.6; stackHeight = 0
# begin: IdentifierExp at 29.11; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 29.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
