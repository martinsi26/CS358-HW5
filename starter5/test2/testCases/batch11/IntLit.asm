...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 10 # StringLiteral at 6.33
  .byte 0 # StringLiteral at 6.33
  .byte 0 # StringLiteral at 6.33
  .byte 0 # StringLiteral at 6.33
  .word CLASS_String # StringLiteral at 6.33
  .word 2 # StringLiteral at 6.33
  .word -1 # StringLiteral at 6.33
strLit_10: # StringLiteral at 6.33
.text
.globl main
main:
    jal vm_init
...
# begin: CallStatement at 6.24; stackHeight = 4
# begin: Call at 6.24; stackHeight = 4
# begin: IdentifierExp at 6.20; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 6.20; stackHeight = 8
# begin: StringLiteral at 6.33; stackHeight = 8
    la $t0, strLit_10
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.33; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.24; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 6.24; stackHeight = 4
...
# begin: CallStatement at 7.25; stackHeight = 4
# begin: Call at 7.25; stackHeight = 4
# begin: IdentifierExp at 7.21; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.21; stackHeight = 8
# begin: StringLiteral at 7.34; stackHeight = 8
    la $t0, strLit_10
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 7.34; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.25; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.25; stackHeight = 4
...
# begin: CallStatement at 8.33; stackHeight = 4
# begin: Call at 8.33; stackHeight = 4
# begin: IdentifierExp at 8.29; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.29; stackHeight = 8
# begin: StringLiteral at 8.42; stackHeight = 8
    la $t0, strLit_10
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.42; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.33; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.33; stackHeight = 4
...
# begin: IntegerLiteral at 9.16; stackHeight = 8
    li $t0, 3262923
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.16; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 9.30; stackHeight = 4
# begin: Call at 9.30; stackHeight = 4
# begin: IdentifierExp at 9.26; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 9.26; stackHeight = 8
# begin: StringLiteral at 9.39; stackHeight = 8
    la $t0, strLit_10
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.39; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.30; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.30; stackHeight = 4
    addu $sp, $sp, 4
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
