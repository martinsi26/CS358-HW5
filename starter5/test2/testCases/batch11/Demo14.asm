...
CLASS_Main: # ClassDecl at 2.7
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Main_main # MethodDeclVoid at 3.14
  .word mth_Main_name # MethodDeclNonVoid at 9.16
# ****** class YourClass ****** # ClassDecl at 14.7
  .byte 0 # ClassDecl at 14.7
  .byte 0 # ClassDecl at 14.7
  .byte 0 # ClassDecl at 14.7
  .byte 217 # 'Y' with high bit set # ClassDecl at 14.7
  .byte 111 # 'o' # ClassDecl at 14.7
  .byte 117 # 'u' # ClassDecl at 14.7
  .byte 114 # 'r' # ClassDecl at 14.7
  .byte 67 # 'C' # ClassDecl at 14.7
  .byte 108 # 'l' # ClassDecl at 14.7
  .byte 97 # 'a' # ClassDecl at 14.7
  .byte 115 # 's' # ClassDecl at 14.7
  .byte 115 # 's' # ClassDecl at 14.7
CLASS_YourClass: # ClassDecl at 14.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Main_main # MethodDeclVoid at 3.14
  .word mth_YourClass_name # MethodDeclNonVoid at 15.16
END_CLASS_YourClass: # ClassDecl at 14.7
...
# name parameter x offset = 4: MethodDeclNonVoid at 9.16
# name parameter x offset = 4: MethodDeclNonVoid at 15.16
  .byte 66 # StringLiteral at 10.19
  .byte 117 # StringLiteral at 10.19
  .byte 100 # StringLiteral at 10.19
  .byte 100 # StringLiteral at 10.19
  .byte 121 # StringLiteral at 10.19
  .byte 0 # StringLiteral at 10.19
  .byte 0 # StringLiteral at 10.19
  .byte 0 # StringLiteral at 10.19
  .word CLASS_String # StringLiteral at 10.19
  .word 3 # StringLiteral at 10.19
  .word -5 # StringLiteral at 10.19
strLit_23: # StringLiteral at 10.19
  .byte 77 # StringLiteral at 11.23
  .byte 117 # StringLiteral at 11.23
  .byte 100 # StringLiteral at 11.23
  .byte 100 # StringLiteral at 11.23
  .byte 121 # StringLiteral at 11.23
  .byte 0 # StringLiteral at 11.23
  .byte 0 # StringLiteral at 11.23
  .byte 0 # StringLiteral at 11.23
  .word CLASS_String # StringLiteral at 11.23
  .word 3 # StringLiteral at 11.23
  .word -5 # StringLiteral at 11.23
strLit_30: # StringLiteral at 11.23
  .byte 65 # StringLiteral at 16.10
  .byte 0 # StringLiteral at 16.10
  .byte 0 # StringLiteral at 16.10
  .byte 0 # StringLiteral at 16.10
  .word CLASS_String # StringLiteral at 16.10
  .word 2 # StringLiteral at 16.10
  .word -1 # StringLiteral at 16.10
strLit_40: # StringLiteral at 16.10
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: LocalVarDecl at 4.8; stackHeight = 0
# begin: Null at 4.15; stackHeight = 0
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 4.15; stackHeight = 4
    lw $zero, ($sp) #**"var1"
# end: LocalVarDecl at 4.8; stackHeight = 4
# begin: Assign at 5.8; stackHeight = 4
# begin: NewObject at 5.10; stackHeight = 4
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_YourClass
    sw $t0, -12($s7)
# end: NewObject at 5.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 5.8; stackHeight = 4
# begin: LocalVarDecl at 6.10; stackHeight = 4
# begin: Call at 6.19; stackHeight = 4
# begin: IdentifierExp at 6.14; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 6.14; stackHeight = 8
# begin: IntegerLiteral at 6.24; stackHeight = 8
    li $t0, 44
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.24; stackHeight = 16
    lw $zero, ($sp) #**"x"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.19; stackHeight = 8
    lw $zero, ($sp) #**"s"
# end: LocalVarDecl at 6.10; stackHeight = 8
# begin: CallStatement at 7.3; stackHeight = 8
# begin: Call at 7.3; stackHeight = 8
# begin: This at 7.3; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 7.3; stackHeight = 12
# begin: IdentifierExp at 7.12; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.12; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.3; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.3; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
# begin: StringLiteral at 10.19; stackHeight = 0
    la $t0, strLit_23
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.19; stackHeight = 4
    lw $zero, ($sp) #**"rtnVal"
# end: LocalVarDecl at 10.10; stackHeight = 4
# begin: If at 11.3; stackHeight = 4
# begin: GreaterThan at 11.9; stackHeight = 4
# begin: IdentifierExp at 11.7; stackHeight = 4
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.7; stackHeight = 12
...
# end: IntegerLiteral at 11.11; stackHeight = 20
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 11.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_33
# begin: Assign at 11.21; stackHeight = 4
# begin: StringLiteral at 11.23; stackHeight = 4
    la $t0, strLit_30
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 11.23; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 11.21; stackHeight = 4
    j if_done_33
  if_else_33:
# begin: Block at 12.3; stackHeight = 4
# end: Block at 12.3; stackHeight = 4
  if_done_33:
# end: If at 11.3; stackHeight = 4
# begin: IdentifierExp at 12.10; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 4
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_YourClass_name
mth_YourClass_name:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:name"
# begin: Call at 16.14; stackHeight = 0
# begin: StringLiteral at 16.10; stackHeight = 0
    la $t0, strLit_40
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 16.10; stackHeight = 4
# begin: Call at 16.27; stackHeight = 4
# begin: Super at 16.27; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 16.27; stackHeight = 8
# begin: Minus at 16.33; stackHeight = 8
# begin: IdentifierExp at 16.32; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.32; stackHeight = 16
# begin: IntegerLiteral at 16.34; stackHeight = 16
    li $t0, 20
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.34; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 16.33; stackHeight = 16
    lw $zero, ($sp) #**"x"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 16.27; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 16.14; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
