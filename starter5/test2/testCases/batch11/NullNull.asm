...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 72 # StringLiteral at 6.19
  .byte 101 # StringLiteral at 6.19
  .byte 108 # StringLiteral at 6.19
  .byte 108 # StringLiteral at 6.19
  ...
  .word 3 # StringLiteral at 6.19
  .word -5 # StringLiteral at 6.19
strLit_3: # StringLiteral at 6.19
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: If at 5.3; stackHeight = 0
# begin: Equals at 5.12; stackHeight = 0
# begin: Null at 5.7; stackHeight = 0
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 5.7; stackHeight = 4
# begin: Null at 5.15; stackHeight = 4
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 5.15; stackHeight = 8
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 5.12; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_9
# begin: Block at 5.21; stackHeight = 0
...
# end: Block at 5.21; stackHeight = 0
    j if_done_9
  if_else_9:
# begin: Block at 8.2; stackHeight = 0
# end: Block at 8.2; stackHeight = 0
  if_done_9:
# end: If at 5.3; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
