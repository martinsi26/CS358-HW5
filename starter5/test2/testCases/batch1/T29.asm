...
# begin: Remainder at 5.22; stackHeight = 4
# begin: IntegerLiteral at 5.20; stackHeight = 4
    li $t0, 52
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.20; stackHeight = 12
...
# end: IntegerLiteral at 5.23; stackHeight = 20
    jal remainder
# end: Remainder at 5.22; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
