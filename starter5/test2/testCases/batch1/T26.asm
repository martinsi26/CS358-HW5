...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 97 # StringLiteral at 5.21
  .byte 98 # StringLiteral at 5.21
  .byte 99 # StringLiteral at 5.21
  .byte 0 # StringLiteral at 5.21
  .word CLASS_String # StringLiteral at 5.21
  .word 2 # StringLiteral at 5.21
  .word -3 # StringLiteral at 5.21
strLit_0: # StringLiteral at 5.21
  .byte 100 # StringLiteral at 5.30
  .byte 101 # StringLiteral at 5.30
  .byte 102 # StringLiteral at 5.30
  .byte 0 # StringLiteral at 5.30
  .word CLASS_String # StringLiteral at 5.30
  .word 2 # StringLiteral at 5.30
  .word -3 # StringLiteral at 5.30
strLit_1: # StringLiteral at 5.30
.text
.globl main
main:
    jal vm_init
...
# begin: Not at 5.27; stackHeight = 4
# begin: Equals at 5.27; stackHeight = 4
# begin: StringLiteral at 5.21; stackHeight = 4
    la $t0, strLit_0
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 5.21; stackHeight = 8
# begin: StringLiteral at 5.30; stackHeight = 8
    la $t0, strLit_1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 5.30; stackHeight = 12
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 5.27; stackHeight = 8
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 5.27; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
