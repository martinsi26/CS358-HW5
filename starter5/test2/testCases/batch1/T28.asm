...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 97 # StringLiteral at 5.25
  .byte 98 # StringLiteral at 5.25
  .byte 99 # StringLiteral at 5.25
  .byte 0 # StringLiteral at 5.25
  .word CLASS_String # StringLiteral at 5.25
  .word 2 # StringLiteral at 5.25
  .word -3 # StringLiteral at 5.25
strLit_2: # StringLiteral at 5.25
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 5.15; stackHeight = 0
# begin: Call at 5.15; stackHeight = 0
# begin: NewObject at 5.5; stackHeight = 0
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Lib
    sw $t0, -12($s7)
# end: NewObject at 5.5; stackHeight = 4
# begin: Not at 5.31; stackHeight = 4
# begin: Equals at 5.31; stackHeight = 4
# begin: StringLiteral at 5.25; stackHeight = 4
    la $t0, strLit_2
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 5.25; stackHeight = 8
# begin: StringLiteral at 5.34; stackHeight = 8
    la $t0, strLit_2
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 5.34; stackHeight = 12
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 5.31; stackHeight = 8
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 5.31; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 5.15; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 5.15; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
