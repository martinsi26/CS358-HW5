...
strLit_0: # StringLiteral at 5.21
  .byte 100 # StringLiteral at 5.28
  .byte 101 # StringLiteral at 5.28
  .byte 102 # StringLiteral at 5.28
  .byte 0 # StringLiteral at 5.28
  .word CLASS_String # StringLiteral at 5.28
  .word 2 # StringLiteral at 5.28
  .word -3 # StringLiteral at 5.28
strLit_1: # StringLiteral at 5.28
.text
.globl main
main:
    jal vm_init
...
# begin: Equals at 5.26; stackHeight = 4
# begin: StringLiteral at 5.21; stackHeight = 4
    la $t0, strLit_0
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 5.21; stackHeight = 8
# begin: StringLiteral at 5.28; stackHeight = 8
    la $t0, strLit_1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 5.28; stackHeight = 12
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 5.26; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
