...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_inner # MethodDeclVoid at 9.15
  .word mth_Main_abc # MethodDeclVoid at 13.15
...
# ****** class IntHolder3 ****** # ClassDecl at 26.7
  ...
  .byte 72 # 'H' # ClassDecl at 26.7
  .byte 111 # 'o' # ClassDecl at 26.7
  .byte 108 # 'l' # ClassDecl at 26.7
  .byte 100 # 'd' # ClassDecl at 26.7
  .byte 101 # 'e' # ClassDecl at 26.7
  .byte 114 # 'r' # ClassDecl at 26.7
  .byte 51 # '3' # ClassDecl at 26.7
CLASS_IntHolder3: # ClassDecl at 26.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
END_CLASS_IntHolder3: # ClassDecl at 26.7
...
# inner parameter h offset = 4: MethodDeclVoid at 9.15
# field IntHolder3.val offset = -16: InstVarDecl at 27.7
  .byte 32 # StringLiteral at 17.43
  .byte 0 # StringLiteral at 17.43
  .byte 0 # StringLiteral at 17.43
  .byte 0 # StringLiteral at 17.43
  .word CLASS_String # StringLiteral at 17.43
  .word 2 # StringLiteral at 17.43
  .word -1 # StringLiteral at 17.43
strLit_32: # StringLiteral at 17.43
  .byte 10 # StringLiteral at 22.43
  .byte 0 # StringLiteral at 22.43
  .byte 0 # StringLiteral at 22.43
  .byte 0 # StringLiteral at 22.43
  .word CLASS_String # StringLiteral at 22.43
  .word 2 # StringLiteral at 22.43
  .word -1 # StringLiteral at 22.43
strLit_78: # StringLiteral at 22.43
.text
.globl main
main:
    jal vm_init
...
# end: CallStatement at 6.5; stackHeight = 0
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_inner
mth_Main_inner:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:inner"
# begin: Assign at 10.11; stackHeight = 0
# begin: Plus at 10.19; stackHeight = 0
# begin: InstVarAccess at 10.14; stackHeight = 0
# begin: IdentifierExp at 10.13; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.13; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 10.14; stackHeight = 8
...
# end: IntegerLiteral at 10.21; stackHeight = 16
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 10.19; stackHeight = 8
...
# end: IdentifierExp at 10.5; stackHeight = 12
    ...
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 10.11; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Main_abc:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:abc"
# begin: LocalVarDecl at 14.16; stackHeight = 0
# begin: NewObject at 14.20; stackHeight = 0
    li $s6, 2
    li $s7, 0
    jal newObject
    la $t0, CLASS_IntHolder3
    sw $t0, -12($s7)
# end: NewObject at 14.20; stackHeight = 4
    lw $zero, ($sp) #**"z"
# end: LocalVarDecl at 14.16; stackHeight = 4
# begin: Assign at 15.11; stackHeight = 4
# begin: IntegerLiteral at 15.13; stackHeight = 4
    li $t0, 12
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.13; stackHeight = 12
# begin: IdentifierExp at 15.5; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
...
# begin: CallStatement at 16.5; stackHeight = 4
# begin: Call at 16.5; stackHeight = 4
# begin: This at 16.5; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 16.5; stackHeight = 8
# begin: IdentifierExp at 16.11; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 16.11; stackHeight = 12
    lw $zero, ($sp) #**"h"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 16.5; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 16.5; stackHeight = 4
# begin: CallStatement at 17.11; stackHeight = 4
# begin: Call at 17.11; stackHeight = 4
# begin: Super at 17.11; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 17.11; stackHeight = 8
# begin: InstVarAccess at 17.21; stackHeight = 8
# begin: IdentifierExp at 17.20; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.20; stackHeight = 12
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 17.21; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 17.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 17.11; stackHeight = 4
# begin: CallStatement at 17.34; stackHeight = 4
# begin: Call at 17.34; stackHeight = 4
# begin: Super at 17.34; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 17.34; stackHeight = 8
# begin: StringLiteral at 17.43; stackHeight = 8
    la $t0, strLit_32
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 17.43; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 17.34; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 17.34; stackHeight = 4
# begin: CallStatement at 18.5; stackHeight = 4
# begin: Call at 18.5; stackHeight = 4
# begin: This at 18.5; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 18.5; stackHeight = 8
# begin: IdentifierExp at 18.11; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 18.11; stackHeight = 12
    lw $zero, ($sp) #**"h"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 18.5; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 18.5; stackHeight = 4
# begin: CallStatement at 19.5; stackHeight = 4
# begin: Call at 19.5; stackHeight = 4
# begin: This at 19.5; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 19.5; stackHeight = 8
# begin: IdentifierExp at 19.11; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 19.11; stackHeight = 12
    lw $zero, ($sp) #**"h"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 19.5; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 19.5; stackHeight = 4
# begin: CallStatement at 20.11; stackHeight = 4
# begin: Call at 20.11; stackHeight = 4
# begin: Super at 20.11; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 20.11; stackHeight = 8
# begin: InstVarAccess at 20.21; stackHeight = 8
...
# end: IdentifierExp at 20.20; stackHeight = 12
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 20.21; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.11; stackHeight = 4
# begin: CallStatement at 20.34; stackHeight = 4
# begin: Call at 20.34; stackHeight = 4
# begin: Super at 20.34; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 20.34; stackHeight = 8
# begin: StringLiteral at 20.43; stackHeight = 8
    la $t0, strLit_32
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 20.43; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.34; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.34; stackHeight = 4
# begin: Block at 21.5; stackHeight = 4
# begin: LocalVarDecl at 21.14; stackHeight = 4
# begin: IntegerLiteral at 21.18; stackHeight = 4
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 21.18; stackHeight = 12
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 21.14; stackHeight = 12
# begin: BreakTarget at 21.5; stackHeight = 12
    j while_cond_71
  while_top_71:
# begin: Block at 21.5; stackHeight = 12
# begin: CallStatement at 21.34; stackHeight = 12
# begin: Call at 21.34; stackHeight = 12
# begin: This at 21.34; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 21.34; stackHeight = 16
# begin: IdentifierExp at 21.40; stackHeight = 16
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 21.40; stackHeight = 20
    lw $zero, ($sp) #**"h"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 21.34; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 21.34; stackHeight = 12
# begin: Assign at 21.29; stackHeight = 12
# begin: Plus at 21.30; stackHeight = 12
# begin: IdentifierExp at 21.29; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.29; stackHeight = 20
# begin: IntegerLiteral at 21.30; stackHeight = 20
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 21.30; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 21.30; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 21.29; stackHeight = 12
# end: Block at 21.5; stackHeight = 12
  while_cond_71:
# begin: Not at 21.23; stackHeight = 12
# begin: GreaterThan at 21.23; stackHeight = 12
# begin: IdentifierExp at 21.21; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.21; stackHeight = 20
# begin: IntegerLiteral at 21.26; stackHeight = 20
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 21.26; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 21.23; stackHeight = 16
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 21.23; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_71
  break_target_71:
# end: BreakTarget at 21.5; stackHeight = 12
    addu $sp, $sp, 8
# end: Block at 21.5; stackHeight = 4
# begin: CallStatement at 22.11; stackHeight = 4
# begin: Call at 22.11; stackHeight = 4
# begin: Super at 22.11; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.11; stackHeight = 8
# begin: InstVarAccess at 22.21; stackHeight = 8
# begin: IdentifierExp at 22.20; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 22.20; stackHeight = 12
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 22.21; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.11; stackHeight = 4
# begin: CallStatement at 22.34; stackHeight = 4
# begin: Call at 22.34; stackHeight = 4
# begin: Super at 22.34; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.34; stackHeight = 8
# begin: StringLiteral at 22.43; stackHeight = 8
    la $t0, strLit_78
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 22.43; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.34; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.34; stackHeight = 4
    addu $sp, $sp, 4
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
