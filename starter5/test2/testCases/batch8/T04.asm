...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_level1Fcn # MethodDeclVoid at 9.15
  .word mth_Main_level2Fcn # MethodDeclVoid at 18.15
  .word mth_Main_level3Fcn # MethodDeclVoid at 27.15
  .word mth_Main_level4Fcn # MethodDeclVoid at 31.15
...
# ****** class IntHolder4 ****** # ClassDecl at 37.7
  .byte 0 # ClassDecl at 37.7
  .byte 0 # ClassDecl at 37.7
  .byte 201 # 'I' with high bit set # ClassDecl at 37.7
  .byte 110 # 'n' # ClassDecl at 37.7
  .byte 116 # 't' # ClassDecl at 37.7
  .byte 72 # 'H' # ClassDecl at 37.7
  .byte 111 # 'o' # ClassDecl at 37.7
  .byte 108 # 'l' # ClassDecl at 37.7
  .byte 100 # 'd' # ClassDecl at 37.7
  .byte 101 # 'e' # ClassDecl at 37.7
  .byte 114 # 'r' # ClassDecl at 37.7
  .byte 52 # '4' # ClassDecl at 37.7
CLASS_IntHolder4: # ClassDecl at 37.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
END_CLASS_IntHolder4: # ClassDecl at 37.7
...
# level1Fcn parameter x offset = 4: MethodDeclVoid at 9.15
# level2Fcn parameter z offset = 8: MethodDeclVoid at 18.15
# level2Fcn parameter x offset = 4: MethodDeclVoid at 18.15
# level3Fcn parameter q offset = 8: MethodDeclVoid at 27.15
# level3Fcn parameter x offset = 4: MethodDeclVoid at 27.15
# level4Fcn parameter r offset = 8: MethodDeclVoid at 31.15
# level4Fcn parameter x offset = 4: MethodDeclVoid at 31.15
# field IntHolder4.val offset = -16: InstVarDecl at 38.7
  .byte 10 # StringLiteral at 12.44
  .byte 0 # StringLiteral at 12.44
  .byte 0 # StringLiteral at 12.44
  .byte 0 # StringLiteral at 12.44
  .word CLASS_String # StringLiteral at 12.44
  .word 2 # StringLiteral at 12.44
  .word -1 # StringLiteral at 12.44
strLit_21: # StringLiteral at 12.44
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 6.5; stackHeight = 0
# begin: Call at 6.5; stackHeight = 0
# begin: This at 6.5; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 6.5; stackHeight = 4
# begin: IntegerLiteral at 6.15; stackHeight = 4
    li $t0, 276
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.15; stackHeight = 12
    lw $zero, ($sp) #**"x"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.5; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 6.5; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_level1Fcn
mth_Main_level1Fcn:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:level1Fcn"
# begin: LocalVarDecl at 10.16; stackHeight = 0
# begin: NewObject at 10.21; stackHeight = 0
    li $s6, 2
    li $s7, 0
    jal newObject
    la $t0, CLASS_IntHolder4
    sw $t0, -12($s7)
# end: NewObject at 10.21; stackHeight = 4
    lw $zero, ($sp) #**"xx"
# end: LocalVarDecl at 10.16; stackHeight = 4
# begin: Assign at 11.12; stackHeight = 4
# begin: IdentifierExp at 11.14; stackHeight = 4
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.14; stackHeight = 12
...
# end: IdentifierExp at 11.5; stackHeight = 16
    ...
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 11.12; stackHeight = 4
# begin: CallStatement at 12.11; stackHeight = 4
# begin: Call at 12.11; stackHeight = 4
# begin: Super at 12.11; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.11; stackHeight = 8
# begin: InstVarAccess at 12.22; stackHeight = 8
# begin: IdentifierExp at 12.20; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.20; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 12.22; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.11; stackHeight = 4
# begin: CallStatement at 12.35; stackHeight = 4
# begin: Call at 12.35; stackHeight = 4
# begin: Super at 12.35; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.35; stackHeight = 8
# begin: StringLiteral at 12.44; stackHeight = 8
    la $t0, strLit_21
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.44; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: Call at 12.35; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.35; stackHeight = 4
# begin: CallStatement at 13.5; stackHeight = 4
# begin: Call at 13.5; stackHeight = 4
# begin: This at 13.5; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 13.5; stackHeight = 8
# begin: IntegerLiteral at 13.15; stackHeight = 8
    li $t0, 103
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.15; stackHeight = 16
    lw $zero, ($sp) #**"z"
...
# end: IdentifierExp at 13.20; stackHeight = 20
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.5; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 13.5; stackHeight = 4
# begin: CallStatement at 14.11; stackHeight = 4
# begin: Call at 14.11; stackHeight = 4
# begin: Super at 14.11; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 14.11; stackHeight = 8
# begin: InstVarAccess at 14.22; stackHeight = 8
# begin: IdentifierExp at 14.20; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.20; stackHeight = 12
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 14.22; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.11; stackHeight = 4
# begin: CallStatement at 14.35; stackHeight = 4
# begin: Call at 14.35; stackHeight = 4
# begin: Super at 14.35; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 14.35; stackHeight = 8
# begin: StringLiteral at 14.44; stackHeight = 8
    la $t0, strLit_21
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 14.44; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.35; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.35; stackHeight = 4
    addu $sp, $sp, 4
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_level2Fcn
mth_Main_level2Fcn:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:level2Fcn"
# begin: If at 19.5; stackHeight = 0
# begin: Not at 19.11; stackHeight = 0
# begin: LessThan at 19.11; stackHeight = 0
# begin: IdentifierExp at 19.9; stackHeight = 0
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.9; stackHeight = 8
# begin: IntegerLiteral at 19.14; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 19.14; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 19.11; stackHeight = 4
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 19.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_74
# begin: CallStatement at 20.7; stackHeight = 0
# begin: Call at 20.7; stackHeight = 0
# begin: This at 20.7; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 20.7; stackHeight = 4
# begin: Minus at 20.18; stackHeight = 4
# begin: IdentifierExp at 20.17; stackHeight = 4
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 20.17; stackHeight = 12
# begin: IntegerLiteral at 20.19; stackHeight = 12
    li $t0, 23
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 20.19; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 20.18; stackHeight = 12
    lw $zero, ($sp) #**"q"
...
# end: IdentifierExp at 20.23; stackHeight = 16
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.7; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.7; stackHeight = 0
    j if_done_74
  if_else_74:
# begin: Block at 21.10; stackHeight = 0
# begin: CallStatement at 22.13; stackHeight = 0
# begin: Call at 22.13; stackHeight = 0
# begin: Super at 22.13; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.13; stackHeight = 4
# begin: Plus at 22.27; stackHeight = 4
# begin: InstVarAccess at 22.23; stackHeight = 4
...
# end: IdentifierExp at 22.22; stackHeight = 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 22.23; stackHeight = 12
# begin: IdentifierExp at 22.28; stackHeight = 12
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 22.28; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 22.27; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.13; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.13; stackHeight = 0
# begin: CallStatement at 22.37; stackHeight = 0
# begin: Call at 22.37; stackHeight = 0
# begin: Super at 22.37; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.37; stackHeight = 4
# begin: StringLiteral at 22.46; stackHeight = 4
    la $t0, strLit_21
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 22.46; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.37; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.37; stackHeight = 0
# begin: Assign at 23.13; stackHeight = 0
# begin: Plus at 23.21; stackHeight = 0
# begin: InstVarAccess at 23.16; stackHeight = 0
# begin: IdentifierExp at 23.15; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 23.15; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -16($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 23.16; stackHeight = 8
# begin: IntegerLiteral at 23.23; stackHeight = 8
    li $t0, 63
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 23.23; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 23.21; stackHeight = 8
# begin: IdentifierExp at 23.7; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 23.7; stackHeight = 12
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 23.13; stackHeight = 0
# end: Block at 21.10; stackHeight = 0
  if_done_74:
# end: If at 19.5; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_level3Fcn
mth_Main_level3Fcn:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:level3Fcn"
# begin: CallStatement at 28.5; stackHeight = 0
# begin: Call at 28.5; stackHeight = 0
# begin: This at 28.5; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 28.5; stackHeight = 4
# begin: Plus at 28.16; stackHeight = 4
# begin: IdentifierExp at 28.15; stackHeight = 4
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 28.15; stackHeight = 12
# begin: IntegerLiteral at 28.17; stackHeight = 12
    li $t0, 6
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 28.17; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 28.16; stackHeight = 12
    lw $zero, ($sp) #**"r"
# begin: IdentifierExp at 28.20; stackHeight = 12
    lw $t0, 16($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 28.20; stackHeight = 16
    lw $zero, ($sp) #**"x"
    lw $t0, 12($sp)
    sw $s2, 12($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 28.5; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 28.5; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_level4Fcn
mth_Main_level4Fcn:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:level4Fcn"
# begin: CallStatement at 32.5; stackHeight = 0
# begin: Call at 32.5; stackHeight = 0
# begin: This at 32.5; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 32.5; stackHeight = 4
# begin: Minus at 32.15; stackHeight = 4
# begin: IntegerLiteral at 32.15; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 32.15; stackHeight = 12
# begin: IntegerLiteral at 32.16; stackHeight = 12
    li $t0, 44
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 32.16; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 32.15; stackHeight = 12
    lw $zero, ($sp) #**"z"
# begin: IdentifierExp at 32.20; stackHeight = 12
    lw $t0, 16($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 32.20; stackHeight = 16
    lw $zero, ($sp) #**"x"
    lw $t0, 12($sp)
    sw $s2, 12($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 32.5; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 32.5; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
