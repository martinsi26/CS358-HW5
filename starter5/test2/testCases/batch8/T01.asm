...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_bot # MethodDeclVoid at 16.15
  .word mth_Main_mid # MethodDeclVoid at 20.15
  .word mth_Main_top # MethodDeclNonVoid at 25.14
...
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 16.26
  .byte 0 # ArrayType at 16.26
  .byte 219 # '[' with high bit set # ArrayType at 16.26
  .byte 73 # 'I' # ArrayType at 16.26
CLASS_ARRAY_INT: # ArrayType at 16.26
  .word mth_Object_hashCode # ArrayType at 16.26
  .word mth_Object_equals # ArrayType at 16.26
  .word mth_Object_toString # ArrayType at 16.26
END_CLASS_ARRAY_INT: # ArrayType at 16.26
...
# field Main.x offset = -16: InstVarDecl at 5.7
# bot parameter k offset = 8: MethodDeclVoid at 16.15
# bot parameter x offset = 4: MethodDeclVoid at 16.15
# mid parameter n offset = 8: MethodDeclVoid at 20.15
# mid parameter x offset = 4: MethodDeclVoid at 20.15
# top parameter x offset = 4: MethodDeclNonVoid at 25.14
  .byte 32 # StringLiteral at 8.45
  .byte 0 # StringLiteral at 8.45
  .byte 0 # StringLiteral at 8.45
  .byte 0 # StringLiteral at 8.45
  .word CLASS_String # StringLiteral at 8.45
  .word 2 # StringLiteral at 8.45
  .word -1 # StringLiteral at 8.45
strLit_8: # StringLiteral at 8.45
.text
.globl main
main:
    jal vm_init
...
# begin: IntegerLiteral at 8.24; stackHeight = 8
    li $t0, 100
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.24; stackHeight = 16
    lw $zero, ($sp) #**"x"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 8.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 8.36; stackHeight = 0
# begin: Call at 8.36; stackHeight = 0
# begin: Super at 8.36; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.36; stackHeight = 4
# begin: StringLiteral at 8.45; stackHeight = 4
    la $t0, strLit_8
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.45; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.36; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.36; stackHeight = 0
...
# begin: Call at 9.20; stackHeight = 4
# begin: This at 9.20; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 9.20; stackHeight = 8
# begin: IntegerLiteral at 9.24; stackHeight = 8
    li $t0, 24
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.24; stackHeight = 16
    lw $zero, ($sp) #**"x"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 9.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 9.35; stackHeight = 0
# begin: Call at 9.35; stackHeight = 0
# begin: Super at 9.35; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.35; stackHeight = 4
# begin: StringLiteral at 9.44; stackHeight = 4
    la $t0, strLit_8
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.44; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.35; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.35; stackHeight = 0
...
# begin: IntegerLiteral at 10.24; stackHeight = 8
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.24; stackHeight = 16
    lw $zero, ($sp) #**"x"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: Super at 10.34; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.34; stackHeight = 4
...
# begin: Call at 11.20; stackHeight = 4
# begin: This at 11.20; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.20; stackHeight = 8
# begin: Minus at 11.24; stackHeight = 8
# begin: IntegerLiteral at 11.24; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.24; stackHeight = 16
# begin: IntegerLiteral at 11.25; stackHeight = 16
    li $t0, 9
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.25; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 11.24; stackHeight = 16
    lw $zero, ($sp) #**"x"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 11.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 11.35; stackHeight = 0
# begin: Call at 11.35; stackHeight = 0
# begin: Super at 11.35; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.35; stackHeight = 4
# begin: StringLiteral at 11.44; stackHeight = 4
    la $t0, strLit_8
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 11.44; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.35; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.35; stackHeight = 0
...
# begin: Minus at 12.24; stackHeight = 8
# begin: IntegerLiteral at 12.24; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.24; stackHeight = 16
# begin: IntegerLiteral at 12.25; stackHeight = 16
    li $t0, 9
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.25; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 12.24; stackHeight = 16
    lw $zero, ($sp) #**"x"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 12.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 12.35; stackHeight = 0
# begin: Call at 12.35; stackHeight = 0
# begin: Super at 12.35; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.35; stackHeight = 4
# begin: StringLiteral at 12.44; stackHeight = 4
    la $t0, strLit_8
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.44; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.35; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.35; stackHeight = 0
...
# begin: Minus at 13.24; stackHeight = 8
# begin: IntegerLiteral at 13.24; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.24; stackHeight = 16
# begin: IntegerLiteral at 13.25; stackHeight = 16
    li $t0, 994
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.25; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 13.24; stackHeight = 16
    lw $zero, ($sp) #**"x"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 13.37; stackHeight = 0
# begin: Call at 13.37; stackHeight = 0
# begin: Super at 13.37; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 13.37; stackHeight = 4
# begin: StringLiteral at 13.46; stackHeight = 4
    la $t0, strLit_8
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 13.46; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.37; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 13.37; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Main_bot:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:bot"
# begin: Assign at 17.10; stackHeight = 0
# begin: IdentifierExp at 17.5; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.5; stackHeight = 4
# begin: IntegerLiteral at 17.7; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.7; stackHeight = 12
# begin: Plus at 17.17; stackHeight = 12
# begin: ArrayLookup at 17.13; stackHeight = 12
# begin: IntegerLiteral at 17.14; stackHeight = 12
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.14; stackHeight = 20
# begin: IdentifierExp at 17.12; stackHeight = 20
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.12; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 17.13; stackHeight = 20
# begin: IdentifierExp at 17.19; stackHeight = 20
    lw $t0, 28($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.19; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 17.17; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 17.10; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Main_mid:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:mid"
# begin: If at 21.5; stackHeight = 0
# begin: GreaterThan at 21.11; stackHeight = 0
# begin: IdentifierExp at 21.9; stackHeight = 0
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.9; stackHeight = 8
# begin: IntegerLiteral at 21.13; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 21.13; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 21.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_108
# begin: CallStatement at 21.16; stackHeight = 0
# begin: Call at 21.16; stackHeight = 0
# begin: This at 21.16; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 21.16; stackHeight = 4
# begin: Times at 21.21; stackHeight = 4
# begin: IntegerLiteral at 21.20; stackHeight = 4
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 21.20; stackHeight = 12
# begin: IdentifierExp at 21.22; stackHeight = 12
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.22; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 21.21; stackHeight = 12
    lw $zero, ($sp) #**"k"
...
# end: IdentifierExp at 21.25; stackHeight = 16
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 21.16; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 21.16; stackHeight = 0
    j if_done_108
  if_else_108:
# begin: Assign at 22.15; stackHeight = 0
# begin: IdentifierExp at 22.10; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 22.10; stackHeight = 4
# begin: IntegerLiteral at 22.12; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 22.12; stackHeight = 12
# begin: Plus at 22.22; stackHeight = 12
# begin: ArrayLookup at 22.18; stackHeight = 12
# begin: IntegerLiteral at 22.19; stackHeight = 12
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 22.19; stackHeight = 20
# begin: IdentifierExp at 22.17; stackHeight = 20
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 22.17; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 22.18; stackHeight = 20
# begin: IdentifierExp at 22.24; stackHeight = 20
    lw $t0, 28($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 22.24; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 22.22; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 22.15; stackHeight = 0
  if_done_108:
# end: If at 21.5; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Main_top:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:top"
# begin: LocalVarDecl at 26.11; stackHeight = 0
# begin: NewArray at 26.18; stackHeight = 0
# begin: IntegerLiteral at 26.26; stackHeight = 0
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 26.26; stackHeight = 8
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 26.18; stackHeight = 4
    lw $zero, ($sp) #**"spot"
# end: LocalVarDecl at 26.11; stackHeight = 4
# begin: CallStatement at 27.5; stackHeight = 4
# begin: Call at 27.5; stackHeight = 4
# begin: This at 27.5; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 27.5; stackHeight = 8
# begin: Plus at 27.10; stackHeight = 8
# begin: IdentifierExp at 27.9; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 27.9; stackHeight = 16
# begin: IntegerLiteral at 27.11; stackHeight = 16
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 27.11; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 27.10; stackHeight = 16
    lw $zero, ($sp) #**"n"
# begin: IdentifierExp at 27.14; stackHeight = 16
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 27.14; stackHeight = 20
    lw $zero, ($sp) #**"x"
    lw $t0, 12($sp)
    sw $s2, 12($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 27.5; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 27.5; stackHeight = 4
# begin: ArrayLookup at 28.16; stackHeight = 4
# begin: IntegerLiteral at 28.17; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 28.17; stackHeight = 12
# begin: IdentifierExp at 28.12; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 28.12; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 28.16; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 4
    lw $ra, ($sp)
