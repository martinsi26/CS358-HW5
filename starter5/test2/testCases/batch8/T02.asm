...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_printIntArray # MethodDeclVoid at 12.15
  .word mth_Main_intervalArray # MethodDeclNonVoid at 20.16
  .word mth_Main_setRtnVal # MethodDeclVoid at 30.15
  .word mth_Main_helpSetRtnVal # MethodDeclVoid at 34.15
...
# printIntArray parameter arr offset = 4: MethodDeclVoid at 12.15
# intervalArray parameter start offset = 20: MethodDeclNonVoid at 20.16
# intervalArray parameter count offset = 12: MethodDeclNonVoid at 20.16
# intervalArray parameter delta offset = 4: MethodDeclNonVoid at 20.16
# setRtnVal parameter idx offset = 16: MethodDeclVoid at 30.15
# setRtnVal parameter val offset = 8: MethodDeclVoid at 30.15
# setRtnVal parameter rtnVal offset = 4: MethodDeclVoid at 30.15
# helpSetRtnVal parameter j offset = 16: MethodDeclVoid at 34.15
# helpSetRtnVal parameter v offset = 8: MethodDeclVoid at 34.15
# helpSetRtnVal parameter rtnVal offset = 4: MethodDeclVoid at 34.15
  .byte 32 # StringLiteral at 15.22
  .byte 0 # StringLiteral at 15.22
  .byte 0 # StringLiteral at 15.22
  .byte 0 # StringLiteral at 15.22
  .word CLASS_String # StringLiteral at 15.22
  .word 2 # StringLiteral at 15.22
  .word -1 # StringLiteral at 15.22
strLit_51: # StringLiteral at 15.22
  ...
  .word -1 # StringLiteral at 17.20
strLit_59: # StringLiteral at 17.20
.text
.globl main
main:
    jal vm_init
...
# begin: Call at 6.18; stackHeight = 0
# begin: This at 6.18; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 6.18; stackHeight = 4
# begin: IntegerLiteral at 6.32; stackHeight = 4
    li $t0, 23
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.32; stackHeight = 12
    lw $zero, ($sp) #**"start"
# begin: IntegerLiteral at 6.35; stackHeight = 12
    li $t0, 8
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.35; stackHeight = 20
    lw $zero, ($sp) #**"count"
# begin: IntegerLiteral at 6.37; stackHeight = 20
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.37; stackHeight = 28
    lw $zero, ($sp) #**"delta"
    lw $t0, 24($sp)
    sw $s2, 24($sp)
    move $s2, $t0
    ...
    lw $t0, -12($s2)
    lw $t0, 52($t0)
    jalr $t0 # intervalArray
    addu $sp, $sp, 24
    lw $s2, ($sp)
    addu $sp, $sp, 4
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.18; stackHeight = 4
    lw $zero, ($sp) #**"arr1"
# end: LocalVarDecl at 6.11; stackHeight = 4
# begin: LocalVarDecl at 7.11; stackHeight = 4
# begin: Call at 7.18; stackHeight = 4
# begin: This at 7.18; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 7.18; stackHeight = 8
# begin: IntegerLiteral at 7.32; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.32; stackHeight = 16
    lw $zero, ($sp) #**"start"
# begin: IntegerLiteral at 7.34; stackHeight = 16
    li $t0, 20
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.34; stackHeight = 24
    lw $zero, ($sp) #**"count"
# begin: Minus at 7.37; stackHeight = 24
# begin: IntegerLiteral at 7.37; stackHeight = 24
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.37; stackHeight = 32
# begin: IntegerLiteral at 7.38; stackHeight = 32
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.38; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 7.37; stackHeight = 32
    lw $zero, ($sp) #**"delta"
    lw $t0, 24($sp)
    sw $s2, 24($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.18; stackHeight = 8
    lw $zero, ($sp) #**"arr2"
# end: LocalVarDecl at 7.11; stackHeight = 8
# begin: CallStatement at 8.5; stackHeight = 8
# begin: Call at 8.5; stackHeight = 8
# begin: This at 8.5; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 8.5; stackHeight = 12
# begin: IdentifierExp at 8.19; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.19; stackHeight = 16
    lw $zero, ($sp) #**"arr"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    lw $t0, -12($s2)
    lw $t0, 48($t0)
    jalr $t0 # printIntArray
    addu $sp, $sp, 4
    lw $s2, ($sp)
    addu $sp, $sp, 4
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.5; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.5; stackHeight = 8
# begin: CallStatement at 9.5; stackHeight = 8
# begin: Call at 9.5; stackHeight = 8
# begin: This at 9.5; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 9.5; stackHeight = 12
# begin: IdentifierExp at 9.19; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 9.19; stackHeight = 16
    lw $zero, ($sp) #**"arr"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.5; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.5; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_printIntArray
mth_Main_printIntArray:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:printIntArray"
# begin: Block at 13.5; stackHeight = 0
# begin: LocalVarDecl at 13.14; stackHeight = 0
# begin: IntegerLiteral at 13.18; stackHeight = 0
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.18; stackHeight = 8
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 13.14; stackHeight = 8
# begin: BreakTarget at 13.5; stackHeight = 8
    j while_cond_57
  while_top_57:
# begin: Block at 13.5; stackHeight = 8
# begin: Block at 13.42; stackHeight = 8
# begin: CallStatement at 14.13; stackHeight = 8
# begin: Call at 14.13; stackHeight = 8
# begin: Super at 14.13; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 14.13; stackHeight = 12
# begin: ArrayLookup at 14.25; stackHeight = 12
# begin: IdentifierExp at 14.26; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.26; stackHeight = 20
# begin: IdentifierExp at 14.22; stackHeight = 20
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.22; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLookup at 14.25; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.13; stackHeight = 8
# begin: CallStatement at 15.13; stackHeight = 8
# begin: Call at 15.13; stackHeight = 8
# begin: Super at 15.13; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 15.13; stackHeight = 12
# begin: StringLiteral at 15.22; stackHeight = 12
    la $t0, strLit_51
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 15.22; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 15.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 15.13; stackHeight = 8
# end: Block at 13.42; stackHeight = 8
# begin: Assign at 13.37; stackHeight = 8
# begin: Plus at 13.38; stackHeight = 8
# begin: IdentifierExp at 13.37; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.37; stackHeight = 16
# begin: IntegerLiteral at 13.38; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.38; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 13.38; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 13.37; stackHeight = 8
# end: Block at 13.5; stackHeight = 8
  while_cond_57:
# begin: LessThan at 13.23; stackHeight = 8
# begin: IdentifierExp at 13.21; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.21; stackHeight = 16
# begin: ArrayLength at 13.28; stackHeight = 16
# begin: IdentifierExp at 13.25; stackHeight = 16
    lw $t0, 20($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.25; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 13.28; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 13.23; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_57
  break_target_57:
# end: BreakTarget at 13.5; stackHeight = 8
    addu $sp, $sp, 8
# end: Block at 13.5; stackHeight = 0
...
# end: CallStatement at 17.11; stackHeight = 0
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_intervalArray
mth_Main_intervalArray:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:intervalArray"
# begin: LocalVarDecl at 21.11; stackHeight = 0
# begin: NewArray at 21.20; stackHeight = 0
# begin: IdentifierExp at 21.28; stackHeight = 0
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.28; stackHeight = 8
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 21.20; stackHeight = 4
    lw $zero, ($sp) #**"rtnVal"
# end: LocalVarDecl at 21.11; stackHeight = 4
# begin: Block at 22.5; stackHeight = 4
# begin: LocalVarDecl at 22.14; stackHeight = 4
# begin: IntegerLiteral at 22.18; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 22.18; stackHeight = 12
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 22.14; stackHeight = 12
# begin: BreakTarget at 22.5; stackHeight = 12
    j while_cond_104
  while_top_104:
# begin: Block at 22.5; stackHeight = 12
# begin: Block at 22.37; stackHeight = 12
# begin: CallStatement at 23.7; stackHeight = 12
# begin: Call at 23.7; stackHeight = 12
# begin: This at 23.7; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 23.7; stackHeight = 16
# begin: IdentifierExp at 23.17; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 23.17; stackHeight = 24
    lw $zero, ($sp) #**"idx"
# begin: IdentifierExp at 23.20; stackHeight = 24
    lw $t0, 44($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 23.20; stackHeight = 32
    lw $zero, ($sp) #**"val"
# begin: IdentifierExp at 23.27; stackHeight = 32
    lw $t0, 28($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 23.27; stackHeight = 36
    lw $zero, ($sp) #**"rtnVal"
    lw $t0, 20($sp)
    sw $s2, 20($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 23.7; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 23.7; stackHeight = 12
# begin: Assign at 24.13; stackHeight = 12
# begin: Plus at 24.21; stackHeight = 12
# begin: IdentifierExp at 24.15; stackHeight = 12
    lw $t0, 32($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 24.15; stackHeight = 20
# begin: IdentifierExp at 24.23; stackHeight = 20
    lw $t0, 24($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 24.23; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 24.21; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 32($sp)
# end: Assign at 24.13; stackHeight = 12
# end: Block at 22.37; stackHeight = 12
# begin: Assign at 22.32; stackHeight = 12
# begin: Plus at 22.33; stackHeight = 12
# begin: IdentifierExp at 22.32; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 22.32; stackHeight = 20
# begin: IntegerLiteral at 22.33; stackHeight = 20
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 22.33; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 22.33; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 22.32; stackHeight = 12
# end: Block at 22.5; stackHeight = 12
  while_cond_104:
# begin: LessThan at 22.23; stackHeight = 12
# begin: IdentifierExp at 22.21; stackHeight = 12
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
...
# begin: IdentifierExp at 22.25; stackHeight = 20
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 22.25; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 22.23; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_104
  break_target_104:
# end: BreakTarget at 22.5; stackHeight = 12
    addu $sp, $sp, 8
# end: Block at 22.5; stackHeight = 4
# begin: IdentifierExp at 26.12; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 26.12; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 4
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_setRtnVal
mth_Main_setRtnVal:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:setRtnVal"
# begin: CallStatement at 31.5; stackHeight = 0
# begin: Call at 31.5; stackHeight = 0
# begin: This at 31.5; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 31.5; stackHeight = 4
# begin: IdentifierExp at 31.19; stackHeight = 4
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 31.19; stackHeight = 12
    lw $zero, ($sp) #**"j"
# begin: IdentifierExp at 31.24; stackHeight = 12
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 31.24; stackHeight = 20
    lw $zero, ($sp) #**"v"
# begin: IdentifierExp at 31.29; stackHeight = 20
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 31.29; stackHeight = 24
    lw $zero, ($sp) #**"rtnVal"
    lw $t0, 20($sp)
    sw $s2, 20($sp)
    move $s2, $t0
    ...
    lw $t0, -12($s2)
    lw $t0, 60($t0)
    jalr $t0 # helpSetRtnVal
    addu $sp, $sp, 20
    lw $s2, ($sp)
    addu $sp, $sp, 4
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 31.5; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 31.5; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_helpSetRtnVal
mth_Main_helpSetRtnVal:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:helpSetRtnVal"
# begin: Assign at 35.15; stackHeight = 0
# begin: IdentifierExp at 35.5; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 35.5; stackHeight = 4
# begin: IdentifierExp at 35.12; stackHeight = 4
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 35.12; stackHeight = 12
# begin: IdentifierExp at 35.17; stackHeight = 12
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 35.17; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 35.15; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
