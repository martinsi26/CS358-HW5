...
# fib parameter n offset = 4: MethodDeclNonVoid at 29.16
...
strLit_16: # StringLiteral at 20.15
...
strLit_24: # StringLiteral at 22.15
  ...
  .word -2 # StringLiteral at 24.15
strLit_32: # StringLiteral at 24.15
.text
.globl main
main:
    jal vm_init
...
# begin: This at 17.15; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 17.15; stackHeight = 16
...
# begin: This at 34.15; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 34.15; stackHeight = 12
...
# begin: This at 34.26; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 34.26; stackHeight = 20
