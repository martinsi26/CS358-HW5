...
CLASS_Vehicle: # ClassDecl at 14.7
  ...
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Vehicle_price # MethodDeclNonVoid at 15.13
...
CLASS_Car: # ClassDecl at 20.7
  ...
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Car_price # MethodDeclNonVoid at 21.13
...
strLit_15: # StringLiteral at 8.18
...
strLit_24: # StringLiteral at 10.18
.text
.globl main
main:
    jal vm_init
...
# begin: NewObject at 6.16; stackHeight = 4
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Vehicle
    sw $t0, -12($s7)
# end: NewObject at 6.16; stackHeight = 8
    lw $zero, ($sp) #**"v2"
# end: LocalVarDecl at 6.11; stackHeight = 8
# begin: CallStatement at 7.9; stackHeight = 8
# begin: Call at 7.9; stackHeight = 8
# begin: Super at 7.9; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 7.9; stackHeight = 12
# begin: Call at 7.21; stackHeight = 12
# begin: IdentifierExp at 7.18; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.18; stackHeight = 16
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 7.21; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# end: Call at 7.9; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.9; stackHeight = 8
# begin: CallStatement at 8.9; stackHeight = 8
# begin: Call at 8.9; stackHeight = 8
# begin: Super at 8.9; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.9; stackHeight = 12
# begin: StringLiteral at 8.18; stackHeight = 12
    la $t0, strLit_15
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.18; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.9; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.9; stackHeight = 8
# begin: CallStatement at 9.9; stackHeight = 8
# begin: Call at 9.9; stackHeight = 8
# begin: Super at 9.9; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.9; stackHeight = 12
# begin: Call at 9.21; stackHeight = 12
# begin: IdentifierExp at 9.18; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 9.18; stackHeight = 16
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 9.21; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.9; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.9; stackHeight = 8
# begin: CallStatement at 10.9; stackHeight = 8
# begin: Call at 10.9; stackHeight = 8
# begin: Super at 10.9; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.9; stackHeight = 12
# begin: StringLiteral at 10.18; stackHeight = 12
    la $t0, strLit_24
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.18; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
mth_Vehicle_price:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:price"
# begin: IntegerLiteral at 16.10; stackHeight = 0
    li $t0, 100
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
...
mth_Car_price:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:price"
# begin: IntegerLiteral at 22.10; stackHeight = 0
    li $t0, 200
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 22.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
