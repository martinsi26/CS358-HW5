...
# begin: CallStatement at 7.11; stackHeight = 28
...
# begin: IntegerLiteral at 7.20; stackHeight = 32
    li $t0, 29
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.20; stackHeight = 40
# begin: IdentifierExp at 7.23; stackHeight = 40
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.23; stackHeight = 48
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
...
# end: Plus at 7.22; stackHeight = 40
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.11; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.11; stackHeight = 28
# begin: CallStatement at 8.11; stackHeight = 28
# begin: Call at 8.11; stackHeight = 28
# begin: This at 8.11; stackHeight = 28
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 8.11; stackHeight = 32
# begin: IdentifierExp at 8.20; stackHeight = 32
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.20; stackHeight = 36
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.11; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.11; stackHeight = 28
    addu $sp, $sp, 28
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
