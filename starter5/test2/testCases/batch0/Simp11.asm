...
# begin: CallStatement at 4.7; stackHeight = 8
# begin: Call at 4.7; stackHeight = 8
# begin: This at 4.7; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 4.7; stackHeight = 12
# begin: Minus at 4.19; stackHeight = 12
# begin: IdentifierExp at 4.16; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 4.16; stackHeight = 20
# begin: IntegerLiteral at 4.20; stackHeight = 20
    li $t0, 263
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 4.20; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 4.19; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# end: Call at 4.7; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 4.7; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
