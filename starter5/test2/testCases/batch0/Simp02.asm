...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 3.11; stackHeight = 0
# begin: Call at 3.11; stackHeight = 0
# begin: Super at 3.11; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 3.11; stackHeight = 4
# begin: IntegerLiteral at 3.20; stackHeight = 4
    li $t0, 345
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 3.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 3.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 3.11; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
