...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 72 # StringLiteral at 3.22
  .byte 101 # StringLiteral at 3.22
  .byte 108 # StringLiteral at 3.22
  .byte 108 # StringLiteral at 3.22
  .byte 111 # StringLiteral at 3.22
  .byte 46 # StringLiteral at 3.22
  .byte 10 # StringLiteral at 3.22
  .byte 0 # StringLiteral at 3.22
  .word CLASS_String # StringLiteral at 3.22
  .word 3 # StringLiteral at 3.22
  .word -7 # StringLiteral at 3.22
strLit_0: # StringLiteral at 3.22
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 3.13; stackHeight = 0
# begin: Call at 3.13; stackHeight = 0
# begin: Super at 3.13; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 3.13; stackHeight = 4
# begin: StringLiteral at 3.22; stackHeight = 4
    la $t0, strLit_0
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 3.22; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 3.13; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 3.13; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
