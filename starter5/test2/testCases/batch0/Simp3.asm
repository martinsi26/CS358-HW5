...
CLASS_Main: # ClassDecl at 2.7
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Main_main # MethodDeclVoid at 3.15
...
# ****** class mainn ****** # ClassDecl at 7.7
  .byte 0 # ClassDecl at 7.7
  .byte 0 # ClassDecl at 7.7
  .byte 0 # ClassDecl at 7.7
  .byte 237 # 'm' with high bit set # ClassDecl at 7.7
  .byte 97 # 'a' # ClassDecl at 7.7
  .byte 105 # 'i' # ClassDecl at 7.7
  .byte 110 # 'n' # ClassDecl at 7.7
  .byte 110 # 'n' # ClassDecl at 7.7
CLASS_mainn: # ClassDecl at 7.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
END_CLASS_mainn: # ClassDecl at 7.7
...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 67 # StringLiteral at 4.20
  .byte 111 # StringLiteral at 4.20
  .byte 109 # StringLiteral at 4.20
  .byte 112 # StringLiteral at 4.20
  .byte 108 # StringLiteral at 4.20
  .byte 101 # StringLiteral at 4.20
  .byte 116 # StringLiteral at 4.20
  .byte 101 # StringLiteral at 4.20
  .byte 33 # StringLiteral at 4.20
  .byte 10 # StringLiteral at 4.20
  .byte 0 # StringLiteral at 4.20
  .byte 0 # StringLiteral at 4.20
  .word CLASS_String # StringLiteral at 4.20
  .word 4 # StringLiteral at 4.20
  .word -10 # StringLiteral at 4.20
strLit_0: # StringLiteral at 4.20
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 4.11; stackHeight = 0
# begin: Call at 4.11; stackHeight = 0
# begin: Super at 4.11; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 4.11; stackHeight = 4
# begin: StringLiteral at 4.20; stackHeight = 4
    la $t0, strLit_0
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 4.20; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 4.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 4.11; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
