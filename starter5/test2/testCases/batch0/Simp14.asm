...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  ...
  .byte 46 # StringLiteral at 6.15
  .byte 46 # StringLiteral at 6.15
  .byte 46 # StringLiteral at 6.15
  .byte 32 # StringLiteral at 6.15
  .byte 10 # StringLiteral at 6.15
  .byte 0 # StringLiteral at 6.15
  .byte 0 # StringLiteral at 6.15
  .word CLASS_String # StringLiteral at 6.15
  .word 3 # StringLiteral at 6.15
  .word -6 # StringLiteral at 6.15
strLit_17: # StringLiteral at 6.15
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: LocalVarDecl at 3.15; stackHeight = 0
# begin: IntegerLiteral at 3.21; stackHeight = 0
    li $t0, 321
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 3.21; stackHeight = 8
    lw $zero, ($sp) #**"xyz"
# end: LocalVarDecl at 3.15; stackHeight = 8
# begin: LocalVarDecl at 4.15; stackHeight = 8
# begin: Plus at 4.24; stackHeight = 8
# begin: IdentifierExp at 4.21; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 4.21; stackHeight = 16
# begin: IntegerLiteral at 4.25; stackHeight = 16
    li $t0, 18
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 4.25; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
...
# end: Plus at 4.24; stackHeight = 16
    lw $zero, ($sp) #**"abc"
# end: LocalVarDecl at 4.15; stackHeight = 16
# begin: LocalVarDecl at 5.8; stackHeight = 16
# begin: Minus at 5.16; stackHeight = 16
# begin: IntegerLiteral at 5.14; stackHeight = 16
    li $t0, 23
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.14; stackHeight = 24
# begin: IdentifierExp at 5.17; stackHeight = 24
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 5.17; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
...
# end: Minus at 5.16; stackHeight = 24
    lw $zero, ($sp) #**"val"
# end: LocalVarDecl at 5.8; stackHeight = 24
# begin: LocalVarDecl at 6.11; stackHeight = 24
# begin: StringLiteral at 6.15; stackHeight = 24
    la $t0, strLit_17
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.15; stackHeight = 28
    lw $zero, ($sp) #**"s"
# end: LocalVarDecl at 6.11; stackHeight = 28
# begin: CallStatement at 7.17; stackHeight = 28
# begin: Call at 7.17; stackHeight = 28
# begin: Super at 7.17; stackHeight = 28
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 7.17; stackHeight = 32
# begin: Plus at 7.28; stackHeight = 32
# begin: IntegerLiteral at 7.26; stackHeight = 32
    li $t0, 29
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.26; stackHeight = 40
# begin: IdentifierExp at 7.29; stackHeight = 40
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.29; stackHeight = 48
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 7.28; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.17; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.17; stackHeight = 28
# begin: CallStatement at 8.17; stackHeight = 28
# begin: Call at 8.17; stackHeight = 28
# begin: Super at 8.17; stackHeight = 28
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.17; stackHeight = 32
# begin: IdentifierExp at 8.26; stackHeight = 32
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.26; stackHeight = 36
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.17; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.17; stackHeight = 28
    addu $sp, $sp, 28
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
