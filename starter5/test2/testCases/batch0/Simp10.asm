...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: LocalVarDecl at 3.11; stackHeight = 0
# begin: IntegerLiteral at 3.17; stackHeight = 0
    li $t0, 27
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 3.17; stackHeight = 8
    lw $zero, ($sp) #**"val"
# end: LocalVarDecl at 3.11; stackHeight = 8
# begin: CallStatement at 4.13; stackHeight = 8
# begin: Call at 4.13; stackHeight = 8
# begin: Super at 4.13; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 4.13; stackHeight = 12
# begin: Minus at 4.25; stackHeight = 12
# begin: IdentifierExp at 4.22; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 4.22; stackHeight = 20
# begin: IntegerLiteral at 4.26; stackHeight = 20
    li $t0, 263
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 4.26; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 4.25; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 4.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 4.13; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
