...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 10 # StringLiteral at 6.26
  .byte 0 # StringLiteral at 6.26
  .byte 0 # StringLiteral at 6.26
  .byte 0 # StringLiteral at 6.26
  .word CLASS_String # StringLiteral at 6.26
  .word 2 # StringLiteral at 6.26
  .word -1 # StringLiteral at 6.26
strLit_16: # StringLiteral at 6.26
.text
.globl main
main:
    jal vm_init
...
# begin: CallStatement at 5.17; stackHeight = 16
...
# begin: IdentifierExp at 5.26; stackHeight = 20
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 5.26; stackHeight = 28
# begin: IntegerLiteral at 5.30; stackHeight = 28
    li $t0, 17
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.30; stackHeight = 36
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
...
# end: Call at 5.17; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 5.17; stackHeight = 16
# begin: CallStatement at 6.17; stackHeight = 16
# begin: Call at 6.17; stackHeight = 16
# begin: Super at 6.17; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 6.17; stackHeight = 20
# begin: StringLiteral at 6.26; stackHeight = 20
    la $t0, strLit_16
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.26; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.17; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 6.17; stackHeight = 16
    addu $sp, $sp, 16
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
