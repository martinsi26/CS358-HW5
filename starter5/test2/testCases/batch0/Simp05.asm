...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 3.7; stackHeight = 0
# begin: Call at 3.7; stackHeight = 0
# begin: This at 3.7; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 3.7; stackHeight = 4
# begin: StringLiteral at 3.16; stackHeight = 4
    la $t0, strLit_0
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 3.16; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: Call at 3.7; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 3.7; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
