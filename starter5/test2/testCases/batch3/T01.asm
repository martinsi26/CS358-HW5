...
# ****** class IntPair01 ****** # ClassDecl at 26.7
  .byte 0 # ClassDecl at 26.7
  .byte 0 # ClassDecl at 26.7
  .byte 0 # ClassDecl at 26.7
  .byte 201 # 'I' with high bit set # ClassDecl at 26.7
  .byte 110 # 'n' # ClassDecl at 26.7
  .byte 116 # 't' # ClassDecl at 26.7
  .byte 80 # 'P' # ClassDecl at 26.7
  .byte 97 # 'a' # ClassDecl at 26.7
  .byte 105 # 'i' # ClassDecl at 26.7
  .byte 114 # 'r' # ClassDecl at 26.7
  .byte 48 # '0' # ClassDecl at 26.7
  .byte 49 # '1' # ClassDecl at 26.7
CLASS_IntPair01: # ClassDecl at 26.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
END_CLASS_IntPair01: # ClassDecl at 26.7
...
# field IntPair01.first offset = -16: InstVarDecl at 27.7
# field IntPair01.second offset = -20: InstVarDecl at 28.7
  .byte 10 # StringLiteral at 12.46
  .byte 0 # StringLiteral at 12.46
  .byte 0 # StringLiteral at 12.46
  .byte 0 # StringLiteral at 12.46
  .word CLASS_String # StringLiteral at 12.46
  .word 2 # StringLiteral at 12.46
  .word -1 # StringLiteral at 12.46
strLit_38: # StringLiteral at 12.46
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: LocalVarDecl at 5.15; stackHeight = 0
# begin: Null at 5.20; stackHeight = 0
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 5.20; stackHeight = 4
    lw $zero, ($sp) #**"p1"
# end: LocalVarDecl at 5.15; stackHeight = 4
# begin: LocalVarDecl at 6.15; stackHeight = 4
# begin: NewObject at 6.20; stackHeight = 4
    li $s6, 3
    li $s7, 0
    jal newObject
    la $t0, CLASS_IntPair01
    sw $t0, -12($s7)
# end: NewObject at 6.20; stackHeight = 8
    lw $zero, ($sp) #**"p2"
# end: LocalVarDecl at 6.15; stackHeight = 8
# begin: Assign at 7.14; stackHeight = 8
# begin: IntegerLiteral at 7.16; stackHeight = 8
    li $t0, 34
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.16; stackHeight = 16
# begin: IdentifierExp at 7.5; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.5; stackHeight = 20
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 7.14; stackHeight = 8
# begin: Assign at 8.15; stackHeight = 8
...
# begin: IdentifierExp at 8.5; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.5; stackHeight = 20
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($t1)
# end: Assign at 8.15; stackHeight = 8
# begin: LocalVarDecl at 9.15; stackHeight = 8
# begin: NewObject at 9.20; stackHeight = 8
    li $s6, 3
    li $s7, 0
    jal newObject
    la $t0, CLASS_IntPair01
    sw $t0, -12($s7)
# end: NewObject at 9.20; stackHeight = 12
    lw $zero, ($sp) #**"p3"
# end: LocalVarDecl at 9.15; stackHeight = 12
# begin: Assign at 10.14; stackHeight = 12
# begin: Minus at 10.16; stackHeight = 12
# begin: IntegerLiteral at 10.16; stackHeight = 12
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.16; stackHeight = 20
# begin: IntegerLiteral at 10.17; stackHeight = 20
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.17; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 10.16; stackHeight = 20
# begin: IdentifierExp at 10.5; stackHeight = 20
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.5; stackHeight = 24
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 10.14; stackHeight = 12
# begin: Assign at 11.15; stackHeight = 12
# begin: IntegerLiteral at 11.17; stackHeight = 12
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.17; stackHeight = 20
# begin: IdentifierExp at 11.5; stackHeight = 20
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 11.5; stackHeight = 24
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($t1)
# end: Assign at 11.15; stackHeight = 12
# begin: Block at 11.19; stackHeight = 12
# end: Block at 11.19; stackHeight = 12
# begin: CallStatement at 12.11; stackHeight = 12
# begin: Call at 12.11; stackHeight = 12
# begin: Super at 12.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.11; stackHeight = 16
# begin: InstVarAccess at 12.22; stackHeight = 16
# begin: IdentifierExp at 12.20; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.20; stackHeight = 20
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 12.22; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.11; stackHeight = 12
# begin: CallStatement at 12.37; stackHeight = 12
# begin: Call at 12.37; stackHeight = 12
# begin: Super at 12.37; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.37; stackHeight = 16
# begin: StringLiteral at 12.46; stackHeight = 16
    la $t0, strLit_38
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.46; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.37; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.37; stackHeight = 12
# begin: CallStatement at 13.11; stackHeight = 12
# begin: Call at 13.11; stackHeight = 12
# begin: Super at 13.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 13.11; stackHeight = 16
# begin: InstVarAccess at 13.22; stackHeight = 16
# begin: IdentifierExp at 13.20; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.20; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -20($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 13.22; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 13.11; stackHeight = 12
# begin: CallStatement at 13.38; stackHeight = 12
# begin: Call at 13.38; stackHeight = 12
# begin: Super at 13.38; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 13.38; stackHeight = 16
# begin: StringLiteral at 13.47; stackHeight = 16
    la $t0, strLit_38
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 13.47; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.38; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 13.38; stackHeight = 12
# begin: CallStatement at 14.11; stackHeight = 12
# begin: Call at 14.11; stackHeight = 12
# begin: Super at 14.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 14.11; stackHeight = 16
# begin: InstVarAccess at 14.22; stackHeight = 16
# begin: IdentifierExp at 14.20; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.20; stackHeight = 20
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 14.22; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.11; stackHeight = 12
# begin: CallStatement at 14.37; stackHeight = 12
# begin: Call at 14.37; stackHeight = 12
# begin: Super at 14.37; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 14.37; stackHeight = 16
# begin: StringLiteral at 14.46; stackHeight = 16
    la $t0, strLit_38
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 14.46; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.37; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.37; stackHeight = 12
# begin: CallStatement at 15.11; stackHeight = 12
# begin: Call at 15.11; stackHeight = 12
# begin: Super at 15.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 15.11; stackHeight = 16
# begin: InstVarAccess at 15.22; stackHeight = 16
# begin: IdentifierExp at 15.20; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.20; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -20($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 15.22; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 15.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 15.11; stackHeight = 12
# begin: CallStatement at 15.38; stackHeight = 12
# begin: Call at 15.38; stackHeight = 12
# begin: Super at 15.38; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 15.38; stackHeight = 16
# begin: StringLiteral at 15.47; stackHeight = 16
    la $t0, strLit_38
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 15.47; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 15.38; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 15.38; stackHeight = 12
# begin: Assign at 16.8; stackHeight = 12
# begin: IdentifierExp at 16.10; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 16.10; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 8($sp)
# end: Assign at 16.8; stackHeight = 12
# begin: Assign at 17.14; stackHeight = 12
# begin: IntegerLiteral at 17.16; stackHeight = 12
    li $t0, 99
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.16; stackHeight = 20
# begin: IdentifierExp at 17.5; stackHeight = 20
    lw $t0, 16($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.5; stackHeight = 24
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 17.14; stackHeight = 12
# begin: Assign at 18.15; stackHeight = 12
# begin: Minus at 18.17; stackHeight = 12
# begin: IntegerLiteral at 18.17; stackHeight = 12
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 18.17; stackHeight = 20
# begin: IntegerLiteral at 18.18; stackHeight = 20
    li $t0, 223
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 18.18; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 18.17; stackHeight = 20
# begin: IdentifierExp at 18.5; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 18.5; stackHeight = 24
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($t1)
# end: Assign at 18.15; stackHeight = 12
# begin: CallStatement at 19.11; stackHeight = 12
# begin: Call at 19.11; stackHeight = 12
# begin: Super at 19.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 19.11; stackHeight = 16
# begin: InstVarAccess at 19.22; stackHeight = 16
# begin: IdentifierExp at 19.20; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 19.20; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -16($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 19.22; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 19.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 19.11; stackHeight = 12
# begin: CallStatement at 19.37; stackHeight = 12
# begin: Call at 19.37; stackHeight = 12
# begin: Super at 19.37; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 19.37; stackHeight = 16
# begin: StringLiteral at 19.46; stackHeight = 16
    la $t0, strLit_38
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 19.46; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 19.37; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 19.37; stackHeight = 12
# begin: CallStatement at 20.11; stackHeight = 12
# begin: Call at 20.11; stackHeight = 12
# begin: Super at 20.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 20.11; stackHeight = 16
# begin: InstVarAccess at 20.22; stackHeight = 16
# begin: IdentifierExp at 20.20; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 20.20; stackHeight = 20
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 20.22; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.11; stackHeight = 12
# begin: CallStatement at 20.38; stackHeight = 12
# begin: Call at 20.38; stackHeight = 12
# begin: Super at 20.38; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 20.38; stackHeight = 16
# begin: StringLiteral at 20.47; stackHeight = 16
    la $t0, strLit_38
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 20.47; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.38; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.38; stackHeight = 12
# begin: CallStatement at 21.11; stackHeight = 12
# begin: Call at 21.11; stackHeight = 12
# begin: Super at 21.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 21.11; stackHeight = 16
# begin: Equals at 21.23; stackHeight = 16
# begin: IdentifierExp at 21.21; stackHeight = 16
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 21.21; stackHeight = 20
# begin: IdentifierExp at 21.25; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 21.25; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 21.23; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 21.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 21.11; stackHeight = 12
# begin: CallStatement at 21.35; stackHeight = 12
# begin: Call at 21.35; stackHeight = 12
# begin: Super at 21.35; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 21.35; stackHeight = 16
# begin: Not at 21.47; stackHeight = 16
# begin: Equals at 21.47; stackHeight = 16
# begin: IdentifierExp at 21.45; stackHeight = 16
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 21.45; stackHeight = 20
# begin: IdentifierExp at 21.49; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 21.49; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 21.47; stackHeight = 20
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 21.47; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 21.35; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 21.35; stackHeight = 12
# begin: CallStatement at 22.11; stackHeight = 12
# begin: Call at 22.11; stackHeight = 12
# begin: Super at 22.11; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.11; stackHeight = 16
# begin: Equals at 22.23; stackHeight = 16
# begin: IdentifierExp at 22.21; stackHeight = 16
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 22.21; stackHeight = 20
# begin: IdentifierExp at 22.25; stackHeight = 20
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 22.25; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 22.23; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.11; stackHeight = 12
# begin: CallStatement at 22.35; stackHeight = 12
# begin: Call at 22.35; stackHeight = 12
# begin: Super at 22.35; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.35; stackHeight = 16
# begin: Not at 22.47; stackHeight = 16
# begin: Equals at 22.47; stackHeight = 16
# begin: IdentifierExp at 22.45; stackHeight = 16
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 22.45; stackHeight = 20
# begin: IdentifierExp at 22.49; stackHeight = 20
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 22.49; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 22.47; stackHeight = 20
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 22.47; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.35; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.35; stackHeight = 12
# begin: CallStatement at 22.59; stackHeight = 12
# begin: Call at 22.59; stackHeight = 12
# begin: Super at 22.59; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.59; stackHeight = 16
# begin: StringLiteral at 22.68; stackHeight = 16
    la $t0, strLit_38
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 22.68; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.59; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.59; stackHeight = 12
    addu $sp, $sp, 12
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
