...
# begin: Not at 6.14; stackHeight = 4
# begin: IdentifierExp at 6.15; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 6.15; stackHeight = 8
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 6.14; stackHeight = 8
    lw $zero, ($sp) #**"y"
# end: LocalVarDecl at 6.10; stackHeight = 8
# begin: LocalVarDecl at 7.10; stackHeight = 8
# begin: Not at 7.14; stackHeight = 8
# begin: Not at 7.15; stackHeight = 8
# begin: Not at 7.16; stackHeight = 8
# begin: Not at 7.17; stackHeight = 8
# begin: Not at 7.18; stackHeight = 8
# begin: IdentifierExp at 7.19; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.19; stackHeight = 12
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 7.18; stackHeight = 12
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 7.17; stackHeight = 12
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 7.16; stackHeight = 12
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 7.15; stackHeight = 12
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 7.14; stackHeight = 12
    lw $zero, ($sp) #**"x"
...
# begin: IdentifierExp at 8.18; stackHeight = 16
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.18; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: CallStatement at 9.8; stackHeight = 12
# begin: Call at 9.8; stackHeight = 12
# begin: Super at 9.8; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.8; stackHeight = 16
...
# end: IdentifierExp at 9.18; stackHeight = 20
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.8; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.8; stackHeight = 12
# begin: CallStatement at 10.8; stackHeight = 12
# begin: Call at 10.8; stackHeight = 12
# begin: Super at 10.8; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.8; stackHeight = 16
...
# end: IdentifierExp at 10.18; stackHeight = 20
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.8; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.8; stackHeight = 12
    addu $sp, $sp, 12
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
