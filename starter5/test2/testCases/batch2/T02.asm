...
strLit_1: # StringLiteral at 5.16
  ...
  .word 5 # StringLiteral at 6.16
  .word -16 # StringLiteral at 6.16
strLit_5: # StringLiteral at 6.16
  .byte 10 # StringLiteral at 8.20
  .byte 0 # StringLiteral at 8.20
  .byte 0 # StringLiteral at 8.20
  .byte 0 # StringLiteral at 8.20
  .word CLASS_String # StringLiteral at 8.20
  .word 2 # StringLiteral at 8.20
  .word -1 # StringLiteral at 8.20
strLit_12: # StringLiteral at 8.20
  .byte 33 # StringLiteral at 11.16
  .byte 33 # StringLiteral at 11.16
  .byte 33 # StringLiteral at 11.16
  .byte 0 # StringLiteral at 11.16
  .word CLASS_String # StringLiteral at 11.16
  .word 2 # StringLiteral at 11.16
  .word -3 # StringLiteral at 11.16
strLit_25: # StringLiteral at 11.16
  .byte 111 # StringLiteral at 12.16
  .byte 114 # StringLiteral at 12.16
  .byte 97 # StringLiteral at 12.16
  .byte 110 # StringLiteral at 12.16
  .byte 103 # StringLiteral at 12.16
  .byte 101 # StringLiteral at 12.16
  .byte 0 # StringLiteral at 12.16
  .byte 0 # StringLiteral at 12.16
  .word CLASS_String # StringLiteral at 12.16
  .word 3 # StringLiteral at 12.16
  .word -6 # StringLiteral at 12.16
strLit_29: # StringLiteral at 12.16
.text
.globl main
main:
    jal vm_init
...
# begin: StringLiteral at 6.16; stackHeight = 4
    la $t0, strLit_5
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.16; stackHeight = 8
    lw $zero, ($sp) #**"a"
# end: LocalVarDecl at 6.12; stackHeight = 8
# begin: CallStatement at 7.11; stackHeight = 8
# begin: Call at 7.11; stackHeight = 8
# begin: Super at 7.11; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 7.11; stackHeight = 12
# begin: IdentifierExp at 7.20; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.20; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.11; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.11; stackHeight = 8
...
# begin: StringLiteral at 8.20; stackHeight = 12
    la $t0, strLit_12
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.20; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: CallStatement at 9.11; stackHeight = 8
# begin: Call at 9.11; stackHeight = 8
# begin: Super at 9.11; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.11; stackHeight = 12
# begin: IdentifierExp at 9.20; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 9.20; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.11; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.11; stackHeight = 8
...
# begin: StringLiteral at 10.20; stackHeight = 12
    la $t0, strLit_12
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.20; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: LocalVarDecl at 11.12; stackHeight = 8
# begin: StringLiteral at 11.16; stackHeight = 8
    la $t0, strLit_25
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 11.16; stackHeight = 12
    lw $zero, ($sp) #**"b"
# end: LocalVarDecl at 11.12; stackHeight = 12
# begin: LocalVarDecl at 12.12; stackHeight = 12
# begin: StringLiteral at 12.16; stackHeight = 12
    la $t0, strLit_29
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.16; stackHeight = 16
    lw $zero, ($sp) #**"c"
...
# begin: IdentifierExp at 13.9; stackHeight = 16
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.9; stackHeight = 20
# begin: IdentifierExp at 13.18; stackHeight = 20
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.18; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: CallStatement at 14.11; stackHeight = 16
# begin: Call at 14.11; stackHeight = 16
# begin: Super at 14.11; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 14.11; stackHeight = 20
# begin: IdentifierExp at 14.20; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.20; stackHeight = 24
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.11; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.11; stackHeight = 16
    addu $sp, $sp, 16
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
