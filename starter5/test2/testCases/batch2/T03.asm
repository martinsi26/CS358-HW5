...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_trueMethod # MethodDeclNonVoid at 19.20
  .word mth_Main_falseMethod # MethodDeclNonVoid at 24.20
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: If at 5.7; stackHeight = 0
# begin: And at 5.49; stackHeight = 0
# begin: And at 5.32; stackHeight = 0
# begin: And at 5.16; stackHeight = 0
# begin: True at 5.11; stackHeight = 0
    li $t0, 1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: True at 5.11; stackHeight = 4
    lw $t0, ($sp)
    beq $t0, $zero, skip_3
    addu $sp, $sp, 4
# begin: Call at 5.19; stackHeight = 0
# begin: This at 5.19; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 5.19; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
...
# end: Call at 5.19; stackHeight = 4
  skip_3:
# end: And at 5.16; stackHeight = 4
    lw $t0, ($sp)
    beq $t0, $zero, skip_6
    addu $sp, $sp, 4
# begin: Call at 5.35; stackHeight = 0
# begin: This at 5.35; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 5.35; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 5.35; stackHeight = 4
  skip_6:
# end: And at 5.32; stackHeight = 4
    lw $t0, ($sp)
    beq $t0, $zero, skip_9
    addu $sp, $sp, 4
# begin: Call at 5.52; stackHeight = 0
# begin: This at 5.52; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 5.52; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 5.52; stackHeight = 4
  skip_9:
# end: And at 5.49; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_20
# begin: Block at 5.66; stackHeight = 0
# begin: CallStatement at 6.10; stackHeight = 0
# begin: Call at 6.10; stackHeight = 0
# begin: Super at 6.10; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 6.10; stackHeight = 4
# begin: IntegerLiteral at 6.19; stackHeight = 4
    li $t0, 8722
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.19; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.10; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 6.10; stackHeight = 0
# end: Block at 5.66; stackHeight = 0
    j if_done_20
  if_else_20:
# begin: Block at 8.12; stackHeight = 0
# begin: CallStatement at 9.10; stackHeight = 0
# begin: Call at 9.10; stackHeight = 0
# begin: Super at 9.10; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.10; stackHeight = 4
...
# end: IntegerLiteral at 9.19; stackHeight = 12
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.10; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.10; stackHeight = 0
# end: Block at 8.12; stackHeight = 0
  if_done_20:
# end: If at 5.7; stackHeight = 0
# begin: If at 11.7; stackHeight = 0
# begin: Or at 11.58; stackHeight = 0
# begin: Or at 11.41; stackHeight = 0
# begin: And at 11.25; stackHeight = 0
# begin: Call at 11.11; stackHeight = 0
# begin: This at 11.11; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.11; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
...
# end: Call at 11.11; stackHeight = 4
    ...
    beq $t0, $zero, skip_25
    addu $sp, $sp, 4
# begin: Call at 11.28; stackHeight = 0
# begin: This at 11.28; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.28; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.28; stackHeight = 4
  skip_25:
# end: And at 11.25; stackHeight = 4
    lw $t0, ($sp)
    bne $t0, $zero, skip_28
    addu $sp, $sp, 4
# begin: Call at 11.44; stackHeight = 0
# begin: This at 11.44; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.44; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.44; stackHeight = 4
  skip_28:
# end: Or at 11.41; stackHeight = 4
    lw $t0, ($sp)
    bne $t0, $zero, skip_31
    addu $sp, $sp, 4
# begin: Call at 11.61; stackHeight = 0
# begin: This at 11.61; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.61; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.61; stackHeight = 4
  skip_31:
# end: Or at 11.58; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_42
# begin: Block at 11.75; stackHeight = 0
# begin: CallStatement at 12.10; stackHeight = 0
# begin: Call at 12.10; stackHeight = 0
# begin: Super at 12.10; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.10; stackHeight = 4
# begin: IntegerLiteral at 12.19; stackHeight = 4
    li $t0, 764
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.19; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.10; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.10; stackHeight = 0
# end: Block at 11.75; stackHeight = 0
    j if_done_42
  if_else_42:
# begin: Block at 14.12; stackHeight = 0
# begin: CallStatement at 15.10; stackHeight = 0
# begin: Call at 15.10; stackHeight = 0
# begin: Super at 15.10; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 15.10; stackHeight = 4
# begin: IntegerLiteral at 15.19; stackHeight = 4
    li $t0, 4761
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.19; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 15.10; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 15.10; stackHeight = 0
# end: Block at 14.12; stackHeight = 0
  if_done_42:
# end: If at 11.7; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_trueMethod
mth_Main_trueMethod:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:trueMethod"
# begin: CallStatement at 20.8; stackHeight = 0
# begin: Call at 20.8; stackHeight = 0
# begin: Super at 20.8; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 20.8; stackHeight = 4
# begin: IntegerLiteral at 20.17; stackHeight = 4
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 20.17; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.8; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.8; stackHeight = 0
# begin: True at 21.9; stackHeight = 0
    li $t0, 1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: True at 21.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_falseMethod
mth_Main_falseMethod:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:falseMethod"
# begin: CallStatement at 25.8; stackHeight = 0
# begin: Call at 25.8; stackHeight = 0
# begin: Super at 25.8; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 25.8; stackHeight = 4
# begin: IntegerLiteral at 25.17; stackHeight = 4
    li $t0, 9
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 25.17; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 25.8; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 25.8; stackHeight = 0
# begin: False at 26.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: False at 26.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
