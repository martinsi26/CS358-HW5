...
strLit_22: # StringLiteral at 9.17
.text
.globl main
main:
    jal vm_init
...
# begin: NewObject at 5.11; stackHeight = 0
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Main
    sw $t0, -12($s7)
# end: NewObject at 5.11; stackHeight = 4
    lw $zero, ($sp) #**"z"
# end: LocalVarDecl at 5.7; stackHeight = 4
# begin: LocalVarDecl at 6.7; stackHeight = 4
# begin: NewObject at 6.12; stackHeight = 4
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Main
    sw $t0, -12($s7)
# end: NewObject at 6.12; stackHeight = 8
    lw $zero, ($sp) #**"zz"
# end: LocalVarDecl at 6.7; stackHeight = 8
...
# begin: Equals at 7.20; stackHeight = 12
# begin: IdentifierExp at 7.18; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.18; stackHeight = 16
# begin: Null at 7.23; stackHeight = 16
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 7.23; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 7.20; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: Equals at 8.21; stackHeight = 12
# begin: IdentifierExp at 8.18; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.18; stackHeight = 16
# begin: Null at 8.24; stackHeight = 16
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 8.24; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 8.21; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: CallStatement at 9.8; stackHeight = 8
# begin: Call at 9.8; stackHeight = 8
# begin: Super at 9.8; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.8; stackHeight = 12
# begin: StringLiteral at 9.17; stackHeight = 12
    la $t0, strLit_22
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.17; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.8; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.8; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
