...
END_CLASS_RunMain: # ClassDecl at 0.0
  .byte 0 # ArrayType at 6.15
  .byte 219 # '[' with high bit set # ArrayType at 6.15
  .byte 79 # 'O' # ArrayType at 6.15
  .byte 98 # 'b' # ArrayType at 6.15
  .byte 106 # 'j' # ArrayType at 6.15
  .byte 101 # 'e' # ArrayType at 6.15
  .byte 99 # 'c' # ArrayType at 6.15
  .byte 116 # 't' # ArrayType at 6.15
CLASS_ARRAY_Object: # ArrayType at 6.15
  .word mth_Object_hashCode # ArrayType at 6.15
  .word mth_Object_equals # ArrayType at 6.15
  .word mth_Object_toString # ArrayType at 6.15
END_CLASS_ARRAY_Object: # ArrayType at 6.15
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 5.12
  .byte 0 # ArrayType at 5.12
  .byte 219 # '[' with high bit set # ArrayType at 5.12
  .byte 73 # 'I' # ArrayType at 5.12
CLASS_ARRAY_INT: # ArrayType at 5.12
  .word mth_Object_hashCode # ArrayType at 5.12
  .word mth_Object_equals # ArrayType at 5.12
  .word mth_Object_toString # ArrayType at 5.12
END_CLASS_ARRAY_INT: # ArrayType at 5.12
...
# begin: NewArray at 5.12; stackHeight = 0
...
# end: IntegerLiteral at 6.26; stackHeight = 12
    ...
    sw $t0, -12($s7)
# end: NewArray at 6.15; stackHeight = 8
    lw $zero, ($sp) #**"y"
# end: LocalVarDecl at 6.11; stackHeight = 8
# begin: CallStatement at 7.8; stackHeight = 8
# begin: Call at 7.8; stackHeight = 8
# begin: Super at 7.8; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 7.8; stackHeight = 12
# begin: ArrayLength at 7.18; stackHeight = 12
# begin: IdentifierExp at 7.17; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.17; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 7.18; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.8; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.8; stackHeight = 8
...
# begin: ArrayLength at 8.18; stackHeight = 12
# begin: IdentifierExp at 8.17; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.17; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, -4($t0)
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 8.18; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
