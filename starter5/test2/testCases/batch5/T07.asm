...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 67 # StringLiteral at 6.49
  .byte 117 # StringLiteral at 6.49
  .byte 114 # StringLiteral at 6.49
  .byte 108 # StringLiteral at 6.49
  .byte 121 # StringLiteral at 6.49
  .byte 0 # StringLiteral at 6.49
  .byte 0 # StringLiteral at 6.49
  .byte 0 # StringLiteral at 6.49
  .word CLASS_String # StringLiteral at 6.49
  .word 3 # StringLiteral at 6.49
  .word -5 # StringLiteral at 6.49
strLit_4: # StringLiteral at 6.49
  .byte 65 # StringLiteral at 6.36
  .byte 110 # StringLiteral at 6.36
  .byte 100 # StringLiteral at 6.36
  .byte 0 # StringLiteral at 6.36
  .word CLASS_String # StringLiteral at 6.36
  .word 2 # StringLiteral at 6.36
  .word -3 # StringLiteral at 6.36
strLit_3: # StringLiteral at 6.36
  .byte 76 # StringLiteral at 6.20
  .byte 97 # StringLiteral at 6.20
  .byte 114 # StringLiteral at 6.20
  .byte 114 # StringLiteral at 6.20
  .byte 121 # StringLiteral at 6.20
...
strLit_1: # StringLiteral at 6.20
  .byte 77 # StringLiteral at 6.7
  .byte 111 # StringLiteral at 6.7
  .byte 101 # StringLiteral at 6.7
  .byte 0 # StringLiteral at 6.7
  .word CLASS_String # StringLiteral at 6.7
  .word 2 # StringLiteral at 6.7
  .word -3 # StringLiteral at 6.7
strLit_0: # StringLiteral at 6.7
  .byte 10 # StringLiteral at 7.20
  .byte 0 # StringLiteral at 7.20
  .byte 0 # StringLiteral at 7.20
  .byte 0 # StringLiteral at 7.20
  .word CLASS_String # StringLiteral at 7.20
  .word 2 # StringLiteral at 7.20
  .word -1 # StringLiteral at 7.20
strLit_10: # StringLiteral at 7.20
.text
.globl main
main:
    jal vm_init
...
# begin: Call at 6.29; stackHeight = 4
# begin: Call at 6.13; stackHeight = 4
# begin: StringLiteral at 6.7; stackHeight = 4
    la $t0, strLit_0
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.7; stackHeight = 8
# begin: StringLiteral at 6.20; stackHeight = 8
    la $t0, strLit_1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: Call at 6.42; stackHeight = 8
# begin: StringLiteral at 6.36; stackHeight = 8
    la $t0, strLit_3
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.36; stackHeight = 12
# begin: StringLiteral at 6.49; stackHeight = 12
    la $t0, strLit_4
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.49; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.42; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.29; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
