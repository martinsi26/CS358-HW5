...
# begin: Call at 5.26; stackHeight = 4
# begin: Super at 5.26; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 5.26; stackHeight = 8
# begin: IntegerLiteral at 5.36; stackHeight = 8
    li $t0, 67
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.36; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    jal mth_Lib_intToChar
    addu $sp, $sp, 8
    lw $s2, ($sp)
    addu $sp, $sp, 4
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 5.26; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
