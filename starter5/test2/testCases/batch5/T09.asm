...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 106 # StringLiteral at 5.20
  .byte 101 # StringLiteral at 5.20
  .byte 108 # StringLiteral at 5.20
  .byte 108 # StringLiteral at 5.20
  .byte 111 # StringLiteral at 5.20
  .byte 10 # StringLiteral at 5.20
  .byte 0 # StringLiteral at 5.20
  .byte 0 # StringLiteral at 5.20
  .word CLASS_String # StringLiteral at 5.20
  .word 3 # StringLiteral at 5.20
  .word -6 # StringLiteral at 5.20
strLit_0: # StringLiteral at 5.20
  .byte 32 # StringLiteral at 6.20
  .byte 97 # StringLiteral at 6.20
  .byte 110 # StringLiteral at 6.20
  .byte 100 # StringLiteral at 6.20
  .byte 10 # StringLiteral at 6.20
  .byte 0 # StringLiteral at 6.20
  .byte 0 # StringLiteral at 6.20
  .byte 0 # StringLiteral at 6.20
  .word CLASS_String # StringLiteral at 6.20
  .word 3 # StringLiteral at 6.20
  .word -5 # StringLiteral at 6.20
strLit_4: # StringLiteral at 6.20
  .byte 32 # StringLiteral at 7.20
  .byte 32 # StringLiteral at 7.20
  .byte 109 # StringLiteral at 7.20
  .byte 117 # StringLiteral at 7.20
  .byte 115 # StringLiteral at 7.20
  .byte 116 # StringLiteral at 7.20
  .byte 97 # StringLiteral at 7.20
  .byte 114 # StringLiteral at 7.20
  .byte 100 # StringLiteral at 7.20
  .byte 10 # StringLiteral at 7.20
  .byte 0 # StringLiteral at 7.20
  .byte 0 # StringLiteral at 7.20
  .word CLASS_String # StringLiteral at 7.20
  .word 4 # StringLiteral at 7.20
  .word -10 # StringLiteral at 7.20
strLit_8: # StringLiteral at 7.20
  .byte 58 # StringLiteral at 11.20
...
strLit_26: # StringLiteral at 11.20
...
strLit_34: # StringLiteral at 13.20
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 5.11; stackHeight = 0
# begin: Call at 5.11; stackHeight = 0
# begin: Super at 5.11; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 5.11; stackHeight = 4
# begin: StringLiteral at 5.20; stackHeight = 4
    la $t0, strLit_0
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 5.20; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 5.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 5.11; stackHeight = 0
# begin: CallStatement at 6.11; stackHeight = 0
# begin: Call at 6.11; stackHeight = 0
# begin: Super at 6.11; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 6.11; stackHeight = 4
...
# end: StringLiteral at 6.20; stackHeight = 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 6.11; stackHeight = 0
# begin: CallStatement at 7.11; stackHeight = 0
# begin: Call at 7.11; stackHeight = 0
# begin: Super at 7.11; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 7.11; stackHeight = 4
# begin: StringLiteral at 7.20; stackHeight = 4
    la $t0, strLit_8
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 7.20; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.11; stackHeight = 0
# begin: LocalVarDecl at 8.9; stackHeight = 0
# begin: Call at 8.19; stackHeight = 0
# begin: Super at 8.19; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.19; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    jal mth_Lib_readInt
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 8.19; stackHeight = 8
    lw $zero, ($sp) #**"n"
# end: LocalVarDecl at 8.9; stackHeight = 8
# begin: LocalVarDecl at 9.9; stackHeight = 8
# begin: Call at 9.19; stackHeight = 8
# begin: Super at 9.19; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.19; stackHeight = 12
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    jal mth_Lib_readInt
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 9.19; stackHeight = 16
    lw $zero, ($sp) #**"k"
# end: LocalVarDecl at 9.9; stackHeight = 16
# begin: CallStatement at 10.11; stackHeight = 16
# begin: Call at 10.11; stackHeight = 16
# begin: Super at 10.11; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.11; stackHeight = 20
# begin: IdentifierExp at 10.20; stackHeight = 20
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.20; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.11; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.11; stackHeight = 16
# begin: CallStatement at 11.11; stackHeight = 16
# begin: Call at 11.11; stackHeight = 16
# begin: Super at 11.11; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.11; stackHeight = 20
# begin: StringLiteral at 11.20; stackHeight = 20
    la $t0, strLit_26
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 11.20; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.11; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.11; stackHeight = 16
# begin: CallStatement at 12.11; stackHeight = 16
# begin: Call at 12.11; stackHeight = 16
# begin: Super at 12.11; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.11; stackHeight = 20
# begin: IdentifierExp at 12.20; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.20; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.11; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.11; stackHeight = 16
# begin: CallStatement at 13.11; stackHeight = 16
# begin: Call at 13.11; stackHeight = 16
# begin: Super at 13.11; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 13.11; stackHeight = 20
# begin: StringLiteral at 13.20; stackHeight = 20
    la $t0, strLit_34
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 13.20; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.11; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 13.11; stackHeight = 16
    addu $sp, $sp, 16
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
