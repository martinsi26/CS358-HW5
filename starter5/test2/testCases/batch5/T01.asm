...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 107 # StringLiteral at 5.20
  .byte 0 # StringLiteral at 5.20
  .byte 0 # StringLiteral at 5.20
  .byte 0 # StringLiteral at 5.20
  .word CLASS_String # StringLiteral at 5.20
  .word 2 # StringLiteral at 5.20
  .word -1 # StringLiteral at 5.20
...
# begin: Call at 5.24; stackHeight = 4
# begin: StringLiteral at 5.20; stackHeight = 4
    la $t0, strLit_0
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 5.20; stackHeight = 8
# begin: IntegerLiteral at 5.31; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.31; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 5.24; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
