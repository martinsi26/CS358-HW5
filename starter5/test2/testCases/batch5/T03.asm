...
strLit_58: # StringLiteral at 14.20
.text
.globl main
main:
    jal vm_init
...
# begin: Minus at 5.13; stackHeight = 0
...
# begin: IntegerLiteral at 5.14; stackHeight = 8
    li $t0, 137
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.14; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
...
# begin: IdentifierExp at 6.18; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.18; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 6.17; stackHeight = 16
    lw $zero, ($sp) #**"b"
# end: LocalVarDecl at 6.9; stackHeight = 16
# begin: LocalVarDecl at 7.9; stackHeight = 16
# begin: Times at 7.17; stackHeight = 16
# begin: Minus at 7.13; stackHeight = 16
...
# begin: IntegerLiteral at 7.14; stackHeight = 24
    li $t0, 141
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.14; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 7.13; stackHeight = 24
# begin: IdentifierExp at 7.18; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.18; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 7.17; stackHeight = 24
    lw $zero, ($sp) #**"c"
# end: LocalVarDecl at 7.9; stackHeight = 24
# begin: LocalVarDecl at 8.9; stackHeight = 24
# begin: Times at 8.17; stackHeight = 24
# begin: Minus at 8.13; stackHeight = 24
# begin: IntegerLiteral at 8.13; stackHeight = 24
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.13; stackHeight = 32
# begin: IntegerLiteral at 8.14; stackHeight = 32
    li $t0, 141
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.14; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 8.13; stackHeight = 32
# begin: IdentifierExp at 8.18; stackHeight = 32
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.18; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 8.17; stackHeight = 32
    lw $zero, ($sp) #**"d"
# end: LocalVarDecl at 8.9; stackHeight = 32
# begin: LocalVarDecl at 9.12; stackHeight = 32
# begin: Call at 9.23; stackHeight = 32
# begin: Super at 9.23; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.23; stackHeight = 36
# begin: IdentifierExp at 9.35; stackHeight = 36
    lw $t0, 28($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.35; stackHeight = 44
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.23; stackHeight = 36
    lw $zero, ($sp) #**"aa"
# end: LocalVarDecl at 9.12; stackHeight = 36
# begin: LocalVarDecl at 10.12; stackHeight = 36
# begin: Call at 10.23; stackHeight = 36
# begin: Super at 10.23; stackHeight = 36
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.23; stackHeight = 40
# begin: IdentifierExp at 10.35; stackHeight = 40
    lw $t0, 24($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.35; stackHeight = 48
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.23; stackHeight = 40
    lw $zero, ($sp) #**"bb"
# end: LocalVarDecl at 10.12; stackHeight = 40
# begin: LocalVarDecl at 11.12; stackHeight = 40
# begin: Call at 11.23; stackHeight = 40
# begin: Super at 11.23; stackHeight = 40
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.23; stackHeight = 44
# begin: IdentifierExp at 11.35; stackHeight = 44
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.35; stackHeight = 52
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.23; stackHeight = 44
    lw $zero, ($sp) #**"cc"
# end: LocalVarDecl at 11.12; stackHeight = 44
# begin: LocalVarDecl at 12.12; stackHeight = 44
# begin: Call at 12.23; stackHeight = 44
# begin: Super at 12.23; stackHeight = 44
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.23; stackHeight = 48
# begin: IdentifierExp at 12.35; stackHeight = 48
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.35; stackHeight = 56
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.23; stackHeight = 48
    lw $zero, ($sp) #**"dd"
# end: LocalVarDecl at 12.12; stackHeight = 48
...
# begin: IdentifierExp at 13.20; stackHeight = 52
    lw $t0, 16($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.20; stackHeight = 56
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: StringLiteral at 14.20; stackHeight = 52
    la $t0, strLit_58
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 14.20; stackHeight = 56
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: IdentifierExp at 15.20; stackHeight = 52
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.20; stackHeight = 56
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: StringLiteral at 16.20; stackHeight = 52
    la $t0, strLit_58
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 16.20; stackHeight = 56
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: IdentifierExp at 17.20; stackHeight = 52
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.20; stackHeight = 56
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: StringLiteral at 18.20; stackHeight = 52
    la $t0, strLit_58
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 18.20; stackHeight = 56
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: IdentifierExp at 19.20; stackHeight = 52
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 19.20; stackHeight = 56
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: StringLiteral at 20.20; stackHeight = 52
    la $t0, strLit_58
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 20.20; stackHeight = 56
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
