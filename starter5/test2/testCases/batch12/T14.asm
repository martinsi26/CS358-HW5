...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 87 # StringLiteral at 6.17
  .byte 101 # StringLiteral at 6.17
  .byte 32 # StringLiteral at 6.17
  .byte 103 # StringLiteral at 6.17
  .byte 111 # StringLiteral at 6.17
  .byte 116 # StringLiteral at 6.17
  .byte 32 # StringLiteral at 6.17
  .byte 104 # StringLiteral at 6.17
  .byte 101 # StringLiteral at 6.17
  .byte 114 # StringLiteral at 6.17
  .byte 101 # StringLiteral at 6.17
  .byte 10 # StringLiteral at 6.17
  .word CLASS_String # StringLiteral at 6.17
  .word 4 # StringLiteral at 6.17
  .word -12 # StringLiteral at 6.17
strLit_7: # StringLiteral at 6.17
  .byte 83 # StringLiteral at 8.17
  .byte 104 # StringLiteral at 8.17
  .byte 111 # StringLiteral at 8.17
  .byte 117 # StringLiteral at 8.17
  .byte 108 # StringLiteral at 8.17
  .byte 100 # StringLiteral at 8.17
  .byte 32 # StringLiteral at 8.17
  .byte 110 # StringLiteral at 8.17
  .byte 111 # StringLiteral at 8.17
  .byte 116 # StringLiteral at 8.17
  .byte 32 # StringLiteral at 8.17
  .byte 103 # StringLiteral at 8.17
  .byte 101 # StringLiteral at 8.17
  .byte 116 # StringLiteral at 8.17
  .byte 32 # StringLiteral at 8.17
  .byte 104 # StringLiteral at 8.17
  .byte 101 # StringLiteral at 8.17
  .byte 114 # StringLiteral at 8.17
  .byte 101 # StringLiteral at 8.17
  .byte 46 # StringLiteral at 8.17
  .byte 10 # StringLiteral at 8.17
  .byte 0 # StringLiteral at 8.17
  .byte 0 # StringLiteral at 8.17
  .byte 0 # StringLiteral at 8.17
  .word CLASS_String # StringLiteral at 8.17
  .word 7 # StringLiteral at 8.17
  .word -21 # StringLiteral at 8.17
strLit_20: # StringLiteral at 8.17
.text
.globl main
main:
    jal vm_init
...
# begin: NewArray at 7.14; stackHeight = 4
# begin: Minus at 7.22; stackHeight = 4
# begin: IntegerLiteral at 7.22; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.22; stackHeight = 12
# begin: IntegerLiteral at 7.23; stackHeight = 12
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.23; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 7.22; stackHeight = 12
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    la $t0, CLASS_ARRAY_INT
    sw $t0, -12($s7)
# end: NewArray at 7.14; stackHeight = 8
    lw $zero, ($sp) #**"def"
# end: LocalVarDecl at 7.8; stackHeight = 8
# begin: CallStatement at 8.8; stackHeight = 8
# begin: Call at 8.8; stackHeight = 8
# begin: Super at 8.8; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.8; stackHeight = 12
# begin: StringLiteral at 8.17; stackHeight = 12
    la $t0, strLit_20
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.17; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.8; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.8; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
