...
# ****** class C1 ****** # ClassDecl at 15.7
  .byte 0 # ClassDecl at 15.7
  .byte 0 # ClassDecl at 15.7
  .byte 195 # 'C' with high bit set # ClassDecl at 15.7
  .byte 49 # '1' # ClassDecl at 15.7
CLASS_C1: # ClassDecl at 15.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
# ****** class C2 ****** # ClassDecl at 12.7
  .byte 0 # ClassDecl at 12.7
  .byte 0 # ClassDecl at 12.7
  .byte 195 # 'C' with high bit set # ClassDecl at 12.7
  .byte 50 # '2' # ClassDecl at 12.7
CLASS_C2: # ClassDecl at 12.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
# ****** class C3 ****** # ClassDecl at 18.7
  .byte 0 # ClassDecl at 18.7
  .byte 0 # ClassDecl at 18.7
  .byte 195 # 'C' with high bit set # ClassDecl at 18.7
  .byte 51 # '3' # ClassDecl at 18.7
CLASS_C3: # ClassDecl at 18.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
END_CLASS_C3: # ClassDecl at 18.7
END_CLASS_C2: # ClassDecl at 12.7
END_CLASS_C1: # ClassDecl at 15.7
...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 83 # StringLiteral at 8.16
  .byte 104 # StringLiteral at 8.16
  .byte 111 # StringLiteral at 8.16
  .byte 117 # StringLiteral at 8.16
  .byte 108 # StringLiteral at 8.16
  .byte 100 # StringLiteral at 8.16
  .byte 32 # StringLiteral at 8.16
  .byte 110 # StringLiteral at 8.16
  .byte 111 # StringLiteral at 8.16
  .byte 116 # StringLiteral at 8.16
  .byte 32 # StringLiteral at 8.16
  .byte 103 # StringLiteral at 8.16
  .byte 101 # StringLiteral at 8.16
  .byte 116 # StringLiteral at 8.16
  .byte 32 # StringLiteral at 8.16
  .byte 104 # StringLiteral at 8.16
  .byte 101 # StringLiteral at 8.16
  .byte 114 # StringLiteral at 8.16
  .byte 101 # StringLiteral at 8.16
  .byte 10 # StringLiteral at 8.16
  .word CLASS_String # StringLiteral at 8.16
  .word 6 # StringLiteral at 8.16
  .word -20 # StringLiteral at 8.16
...
# begin: Assign at 7.12; stackHeight = 8
# begin: Cast at 7.14; stackHeight = 8
# begin: IdentifierExp at 7.18; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.18; stackHeight = 12
    la $t0, CLASS_C3
    la $t1, END_CLASS_C3
    jal checkCast
# end: Cast at 7.14; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 4($sp)
# end: Assign at 7.12; stackHeight = 8
# begin: CallStatement at 8.7; stackHeight = 8
# begin: Call at 8.7; stackHeight = 8
# begin: This at 8.7; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 8.7; stackHeight = 12
# begin: StringLiteral at 8.16; stackHeight = 12
    la $t0, strLit_14
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.16; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: Call at 8.7; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.7; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
