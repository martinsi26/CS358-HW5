...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  ...
  .byte 101 # StringLiteral at 7.17
  .byte 46 # StringLiteral at 7.17
  .byte 10 # StringLiteral at 7.17
  .byte 0 # StringLiteral at 7.17
  .byte 0 # StringLiteral at 7.17
  .byte 0 # StringLiteral at 7.17
  .word CLASS_String # StringLiteral at 7.17
  .word 7 # StringLiteral at 7.17
  .word -21 # StringLiteral at 7.17
strLit_15: # StringLiteral at 7.17
.text
.globl main
main:
    jal vm_init
...
# begin: Minus at 6.14; stackHeight = 4
...
# begin: IntegerLiteral at 6.15; stackHeight = 12
    li $t0, 23
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.15; stackHeight = 20
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 6.14; stackHeight = 12
...
# begin: StringLiteral at 7.17; stackHeight = 16
    la $t0, strLit_15
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 7.17; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
