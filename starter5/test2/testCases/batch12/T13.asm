...
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 5.14
  .byte 0 # ArrayType at 5.14
  .byte 219 # '[' with high bit set # ArrayType at 5.14
  .byte 73 # 'I' # ArrayType at 5.14
CLASS_ARRAY_INT: # ArrayType at 5.14
  .word mth_Object_hashCode # ArrayType at 5.14
  .word mth_Object_equals # ArrayType at 5.14
  .word mth_Object_toString # ArrayType at 5.14
END_CLASS_ARRAY_INT: # ArrayType at 5.14
...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 87 # StringLiteral at 7.17
  .byte 101 # StringLiteral at 7.17
  .byte 32 # StringLiteral at 7.17
  .byte 103 # StringLiteral at 7.17
  .byte 111 # StringLiteral at 7.17
  .byte 116 # StringLiteral at 7.17
  .byte 32 # StringLiteral at 7.17
  .byte 104 # StringLiteral at 7.17
  .byte 101 # StringLiteral at 7.17
  .byte 114 # StringLiteral at 7.17
  .byte 101 # StringLiteral at 7.17
  .byte 10 # StringLiteral at 7.17
  .word CLASS_String # StringLiteral at 7.17
  .word 4 # StringLiteral at 7.17
  .word -12 # StringLiteral at 7.17
strLit_12: # StringLiteral at 7.17
  .byte 83 # StringLiteral at 9.17
  .byte 104 # StringLiteral at 9.17
  .byte 111 # StringLiteral at 9.17
  .byte 117 # StringLiteral at 9.17
  .byte 108 # StringLiteral at 9.17
  .byte 100 # StringLiteral at 9.17
  .byte 32 # StringLiteral at 9.17
  .byte 110 # StringLiteral at 9.17
  .byte 111 # StringLiteral at 9.17
  .byte 116 # StringLiteral at 9.17
  .byte 32 # StringLiteral at 9.17
  .byte 103 # StringLiteral at 9.17
  .byte 101 # StringLiteral at 9.17
  .byte 116 # StringLiteral at 9.17
  .byte 32 # StringLiteral at 9.17
  .byte 104 # StringLiteral at 9.17
  .byte 101 # StringLiteral at 9.17
  .byte 114 # StringLiteral at 9.17
  .byte 101 # StringLiteral at 9.17
  .byte 46 # StringLiteral at 9.17
  .byte 10 # StringLiteral at 9.17
  .byte 0 # StringLiteral at 9.17
  .byte 0 # StringLiteral at 9.17
  .byte 0 # StringLiteral at 9.17
  .word CLASS_String # StringLiteral at 9.17
  .word 7 # StringLiteral at 9.17
  .word -21 # StringLiteral at 9.17
strLit_23: # StringLiteral at 9.17
.text
.globl main
main:
    jal vm_init
...
# begin: NewArray at 5.14; stackHeight = 0
# begin: IntegerLiteral at 5.22; stackHeight = 0
    li $t0, 9
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.22; stackHeight = 8
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 5.14; stackHeight = 4
    lw $zero, ($sp) #**"abc"
...
# begin: IntegerLiteral at 6.6; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.6; stackHeight = 16
...
# begin: Assign at 8.10; stackHeight = 4
# begin: IdentifierExp at 8.2; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.2; stackHeight = 8
# begin: Minus at 8.6; stackHeight = 8
# begin: IntegerLiteral at 8.6; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.6; stackHeight = 16
# begin: IntegerLiteral at 8.7; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.7; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 8.6; stackHeight = 16
# begin: IntegerLiteral at 8.12; stackHeight = 16
    li $t0, 22
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.12; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 8.10; stackHeight = 4
