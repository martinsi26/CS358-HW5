...
strLit_8: # StringLiteral at 7.17
  .byte 32 # StringLiteral at 10.17
  .byte 46 # StringLiteral at 10.17
  .byte 46 # StringLiteral at 10.17
  .byte 46 # StringLiteral at 10.17
  .byte 32 # StringLiteral at 10.17
  .byte 115 # StringLiteral at 10.17
  ...
  .word 8 # StringLiteral at 10.17
  .word -26 # StringLiteral at 10.17
strLit_22: # StringLiteral at 10.17
.text
.globl main
main:
    jal vm_init
...
# begin: LocalVarDecl at 6.6; stackHeight = 8
# begin: IntegerLiteral at 6.10; stackHeight = 8
    li $t0, 24
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.10; stackHeight = 16
    lw $zero, ($sp) #**"b"
# end: LocalVarDecl at 6.6; stackHeight = 16
# begin: CallStatement at 7.8; stackHeight = 16
# begin: Call at 7.8; stackHeight = 16
# begin: Super at 7.8; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 7.8; stackHeight = 20
# begin: StringLiteral at 7.17; stackHeight = 20
    la $t0, strLit_8
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 7.17; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.8; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.8; stackHeight = 16
# begin: LocalVarDecl at 8.6; stackHeight = 16
# begin: Divide at 8.11; stackHeight = 16
# begin: IdentifierExp at 8.10; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.10; stackHeight = 24
# begin: IdentifierExp at 8.12; stackHeight = 24
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.12; stackHeight = 32
    jal divide
# end: Divide at 8.11; stackHeight = 24
    lw $zero, ($sp) #**"c"
# end: LocalVarDecl at 8.6; stackHeight = 24
# begin: CallStatement at 9.8; stackHeight = 24
# begin: Call at 9.8; stackHeight = 24
# begin: Super at 9.8; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.8; stackHeight = 28
# begin: IdentifierExp at 9.17; stackHeight = 28
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.17; stackHeight = 36
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.8; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.8; stackHeight = 24
# begin: CallStatement at 10.8; stackHeight = 24
# begin: Call at 10.8; stackHeight = 24
# begin: Super at 10.8; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.8; stackHeight = 28
# begin: StringLiteral at 10.17; stackHeight = 28
    la $t0, strLit_22
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.17; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.8; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.8; stackHeight = 24
    addu $sp, $sp, 24
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
