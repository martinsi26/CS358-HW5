...
strLit_14: # StringLiteral at 7.17
.text
.globl main
main:
    jal vm_init
...
# begin: IntegerLiteral at 6.7; stackHeight = 16
    li $t0, 12
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.7; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 6.6; stackHeight = 16
...
# end: IntegerLiteral at 6.13; stackHeight = 24
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 6.11; stackHeight = 4
