...
strLit_21: # StringLiteral at 9.17
.text
.globl main
main:
    jal vm_init
...
# begin: Assign at 8.9; stackHeight = 4
...
# begin: IntegerLiteral at 8.11; stackHeight = 16
    li $t0, 22
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.11; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    addu $t1, $t1, $t2
    sw $t0, ($t1)
# end: Assign at 8.9; stackHeight = 4
