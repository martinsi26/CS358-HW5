...
strLit_11: # StringLiteral at 8.17
.text
.globl main
main:
    jal vm_init
...
# begin: LocalVarDecl at 7.6; stackHeight = 4
# begin: InstVarAccess at 7.11; stackHeight = 4
# begin: IdentifierExp at 7.10; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.10; stackHeight = 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 7.11; stackHeight = 12
    lw $zero, ($sp) #**"z"
# end: LocalVarDecl at 7.6; stackHeight = 12
