...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 115 # StringLiteral at 8.11
  .byte 104 # StringLiteral at 8.11
  .byte 111 # StringLiteral at 8.11
  .byte 117 # StringLiteral at 8.11
  .byte 108 # StringLiteral at 8.11
  .byte 100 # StringLiteral at 8.11
  .byte 32 # StringLiteral at 8.11
  .byte 110 # StringLiteral at 8.11
  .byte 111 # StringLiteral at 8.11
  .byte 116 # StringLiteral at 8.11
  .byte 32 # StringLiteral at 8.11
  .byte 103 # StringLiteral at 8.11
  .byte 101 # StringLiteral at 8.11
  .byte 116 # StringLiteral at 8.11
  .byte 32 # StringLiteral at 8.11
  .byte 104 # StringLiteral at 8.11
  .byte 101 # StringLiteral at 8.11
  .byte 114 # StringLiteral at 8.11
  .byte 101 # StringLiteral at 8.11
  .byte 10 # StringLiteral at 8.11
  .word CLASS_String # StringLiteral at 8.11
  .word 6 # StringLiteral at 8.11
  .word -20 # StringLiteral at 8.11
strLit_14: # StringLiteral at 8.11
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: LocalVarDecl at 5.5; stackHeight = 0
# begin: Null at 5.12; stackHeight = 0
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 5.12; stackHeight = 4
    lw $zero, ($sp) #**"var1"
# end: LocalVarDecl at 5.5; stackHeight = 4
# begin: LocalVarDecl at 6.5; stackHeight = 4
# begin: NewObject at 6.13; stackHeight = 4
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_C1
    sw $t0, -12($s7)
# end: NewObject at 6.13; stackHeight = 8
    lw $zero, ($sp) #**"abc11"
# end: LocalVarDecl at 6.5; stackHeight = 8
# begin: Assign at 7.7; stackHeight = 8
# begin: Cast at 7.9; stackHeight = 8
...
# end: IdentifierExp at 7.13; stackHeight = 12
    ...
    la $t1, END_CLASS_C2
    jal checkCast
# end: Cast at 7.9; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 4($sp)
# end: Assign at 7.7; stackHeight = 8
# begin: CallStatement at 8.2; stackHeight = 8
# begin: Call at 8.2; stackHeight = 8
# begin: This at 8.2; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 8.2; stackHeight = 12
# begin: StringLiteral at 8.11; stackHeight = 12
    la $t0, strLit_14
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.11; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.2; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.2; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
