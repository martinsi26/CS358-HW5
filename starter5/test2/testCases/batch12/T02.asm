...
# field Main.a offset = -16: InstVarDecl at 4.9
...
strLit_10: # StringLiteral at 8.17
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: LocalVarDecl at 6.7; stackHeight = 0
# begin: Null at 6.11; stackHeight = 0
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 6.11; stackHeight = 4
    lw $zero, ($sp) #**"t"
# end: LocalVarDecl at 6.7; stackHeight = 4
# begin: Assign at 7.6; stackHeight = 4
# begin: IntegerLiteral at 7.8; stackHeight = 4
    li $t0, 24
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.8; stackHeight = 12
# begin: IdentifierExp at 7.2; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.2; stackHeight = 16
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 7.6; stackHeight = 4
...
# begin: StringLiteral at 8.17; stackHeight = 8
    la $t0, strLit_10
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.17; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
