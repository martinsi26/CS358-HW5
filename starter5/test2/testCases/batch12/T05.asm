...
# begin: ArrayLength at 6.13; stackHeight = 4
# begin: IdentifierExp at 6.10; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 6.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: ArrayLength at 6.13; stackHeight = 12
    lw $zero, ($sp) #**"x"
