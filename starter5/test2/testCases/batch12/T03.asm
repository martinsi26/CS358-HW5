...
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 5.2
  .byte 0 # ArrayType at 5.2
  .byte 219 # '[' with high bit set # ArrayType at 5.2
  .byte 73 # 'I' # ArrayType at 5.2
CLASS_ARRAY_INT: # ArrayType at 5.2
  .word mth_Object_hashCode # ArrayType at 5.2
  .word mth_Object_equals # ArrayType at 5.2
  .word mth_Object_toString # ArrayType at 5.2
END_CLASS_ARRAY_INT: # ArrayType at 5.2
...
# begin: Null at 5.14; stackHeight = 0
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 5.14; stackHeight = 4
    lw $zero, ($sp) #**"abc"
