...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 32 # StringLiteral at 10.41
  .byte 0 # StringLiteral at 10.41
  .byte 0 # StringLiteral at 10.41
  .byte 0 # StringLiteral at 10.41
  .word CLASS_String # StringLiteral at 10.41
  .word 2 # StringLiteral at 10.41
  .word -1 # StringLiteral at 10.41
strLit_26: # StringLiteral at 10.41
  .byte 10 # StringLiteral at 12.20
  .byte 0 # StringLiteral at 12.20
  .byte 0 # StringLiteral at 12.20
  .byte 0 # StringLiteral at 12.20
  .word CLASS_String # StringLiteral at 12.20
  .word 2 # StringLiteral at 12.20
  .word -1 # StringLiteral at 12.20
strLit_32: # StringLiteral at 12.20
.text
.globl main
main:
    jal vm_init
...
# begin: BreakTarget at 7.5; stackHeight = 16
    j while_cond_31
  while_top_31:
# begin: Block at 7.20; stackHeight = 16
# begin: Assign at 8.9; stackHeight = 16
# begin: Minus at 8.13; stackHeight = 16
# begin: IdentifierExp at 8.11; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.11; stackHeight = 24
# begin: IdentifierExp at 8.15; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.15; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 8.13; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 8.9; stackHeight = 16
# begin: Assign at 9.9; stackHeight = 16
# begin: Plus at 9.13; stackHeight = 16
...
# begin: IntegerLiteral at 9.15; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.15; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 9.13; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 9.9; stackHeight = 16
...
# begin: CallStatement at 10.32; stackHeight = 16
# begin: Call at 10.32; stackHeight = 16
# begin: Super at 10.32; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.32; stackHeight = 20
# begin: StringLiteral at 10.41; stackHeight = 20
    la $t0, strLit_26
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.41; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.32; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.32; stackHeight = 16
# end: Block at 7.20; stackHeight = 16
  while_cond_31:
# begin: Not at 7.14; stackHeight = 16
# begin: LessThan at 7.14; stackHeight = 16
...
# begin: IntegerLiteral at 7.17; stackHeight = 24
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.17; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 7.14; stackHeight = 20
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 7.14; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
...
# begin: StringLiteral at 12.20; stackHeight = 20
    la $t0, strLit_32
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.20; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
