...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 32 # StringLiteral at 7.40
  .byte 0 # StringLiteral at 7.40
  .byte 0 # StringLiteral at 7.40
  .byte 0 # StringLiteral at 7.40
  .word CLASS_String # StringLiteral at 7.40
  .word 2 # StringLiteral at 7.40
  .word -1 # StringLiteral at 7.40
strLit_23: # StringLiteral at 7.40
  .byte 10 # StringLiteral at 10.42
  .byte 0 # StringLiteral at 10.42
  .byte 0 # StringLiteral at 10.42
  .byte 0 # StringLiteral at 10.42
  .word CLASS_String # StringLiteral at 10.42
  .word 2 # StringLiteral at 10.42
  .word -1 # StringLiteral at 10.42
strLit_51: # StringLiteral at 10.42
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: Block at 5.5; stackHeight = 0
# begin: LocalVarDecl at 5.14; stackHeight = 0
# begin: IntegerLiteral at 5.18; stackHeight = 0
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.18; stackHeight = 8
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 5.14; stackHeight = 8
# begin: BreakTarget at 5.5; stackHeight = 8
    j while_cond_57
  while_top_57:
# begin: Block at 5.5; stackHeight = 8
# begin: Block at 5.35; stackHeight = 8
# begin: LocalVarDecl at 6.11; stackHeight = 8
# begin: Times at 6.17; stackHeight = 8
# begin: IdentifierExp at 6.15; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.15; stackHeight = 16
# begin: IdentifierExp at 6.19; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.19; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
...
# end: Times at 6.17; stackHeight = 16
    lw $zero, ($sp) #**"j"
# end: LocalVarDecl at 6.11; stackHeight = 16
# begin: CallStatement at 7.13; stackHeight = 16
# begin: Call at 7.13; stackHeight = 16
# begin: Super at 7.13; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 7.13; stackHeight = 20
# begin: IdentifierExp at 7.22; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.22; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.13; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.13; stackHeight = 16
# begin: CallStatement at 7.31; stackHeight = 16
# begin: Call at 7.31; stackHeight = 16
# begin: Super at 7.31; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 7.31; stackHeight = 20
# begin: StringLiteral at 7.40; stackHeight = 20
    la $t0, strLit_23
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 7.40; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.31; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.31; stackHeight = 16
# begin: CallStatement at 8.13; stackHeight = 16
# begin: Call at 8.13; stackHeight = 16
# begin: Super at 8.13; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.13; stackHeight = 20
# begin: IdentifierExp at 8.22; stackHeight = 20
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.22; stackHeight = 28
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.13; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.13; stackHeight = 16
# begin: CallStatement at 8.31; stackHeight = 16
# begin: Call at 8.31; stackHeight = 16
# begin: Super at 8.31; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.31; stackHeight = 20
# begin: StringLiteral at 8.40; stackHeight = 20
    la $t0, strLit_23
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.40; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.31; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.31; stackHeight = 16
# begin: CallStatement at 9.13; stackHeight = 16
# begin: Call at 9.13; stackHeight = 16
# begin: Super at 9.13; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.13; stackHeight = 20
# begin: Plus at 9.23; stackHeight = 20
# begin: IdentifierExp at 9.22; stackHeight = 20
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.22; stackHeight = 28
# begin: IntegerLiteral at 9.24; stackHeight = 28
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.24; stackHeight = 36
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 9.23; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.13; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.13; stackHeight = 16
# begin: CallStatement at 9.33; stackHeight = 16
# begin: Call at 9.33; stackHeight = 16
# begin: Super at 9.33; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.33; stackHeight = 20
# begin: StringLiteral at 9.42; stackHeight = 20
    la $t0, strLit_23
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.42; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.33; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.33; stackHeight = 16
# begin: CallStatement at 10.13; stackHeight = 16
# begin: Call at 10.13; stackHeight = 16
# begin: Super at 10.13; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.13; stackHeight = 20
# begin: Minus at 10.23; stackHeight = 20
# begin: IdentifierExp at 10.22; stackHeight = 20
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.22; stackHeight = 28
# begin: IntegerLiteral at 10.24; stackHeight = 28
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.24; stackHeight = 36
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 10.23; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.13; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.13; stackHeight = 16
# begin: CallStatement at 10.33; stackHeight = 16
# begin: Call at 10.33; stackHeight = 16
# begin: Super at 10.33; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.33; stackHeight = 20
# begin: StringLiteral at 10.42; stackHeight = 20
    la $t0, strLit_51
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.42; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.33; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.33; stackHeight = 16
    addu $sp, $sp, 8
# end: Block at 5.35; stackHeight = 8
# begin: Assign at 5.30; stackHeight = 8
# begin: Plus at 5.31; stackHeight = 8
# begin: IdentifierExp at 5.30; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 5.30; stackHeight = 16
# begin: IntegerLiteral at 5.31; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.31; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 5.31; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 5.30; stackHeight = 8
# end: Block at 5.5; stackHeight = 8
  while_cond_57:
# begin: Not at 5.23; stackHeight = 8
# begin: GreaterThan at 5.23; stackHeight = 8
# begin: IdentifierExp at 5.21; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 5.21; stackHeight = 16
# begin: IntegerLiteral at 5.26; stackHeight = 16
    li $t0, 20
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.26; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 5.23; stackHeight = 12
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 5.23; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_57
  break_target_57:
# end: BreakTarget at 5.5; stackHeight = 8
    addu $sp, $sp, 8
# end: Block at 5.5; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
