...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  ...
  .byte 115 # StringLiteral at 7.19
  .byte 111 # StringLiteral at 7.19
  .byte 32 # StringLiteral at 7.19
  .byte 116 # StringLiteral at 7.19
  .byte 114 # StringLiteral at 7.19
  .byte 117 # StringLiteral at 7.19
  .byte 101 # StringLiteral at 7.19
  .byte 33 # StringLiteral at 7.19
  .byte 10 # StringLiteral at 7.19
  .byte 0 # StringLiteral at 7.19
  .byte 0 # StringLiteral at 7.19
  .word CLASS_String # StringLiteral at 7.19
  .word 5 # StringLiteral at 7.19
  .word -14 # StringLiteral at 7.19
strLit_7: # StringLiteral at 7.19
  ...
  .byte 115 # StringLiteral at 10.19
  .byte 111 # StringLiteral at 10.19
  .byte 32 # StringLiteral at 10.19
  .byte 102 # StringLiteral at 10.19
  .byte 97 # StringLiteral at 10.19
  .byte 108 # StringLiteral at 10.19
  .byte 115 # StringLiteral at 10.19
  .byte 101 # StringLiteral at 10.19
  .byte 33 # StringLiteral at 10.19
  .byte 10 # StringLiteral at 10.19
  .byte 0 # StringLiteral at 10.19
  .word CLASS_String # StringLiteral at 10.19
  .word 5 # StringLiteral at 10.19
  .word -15 # StringLiteral at 10.19
strLit_12: # StringLiteral at 10.19
  .byte 84 # StringLiteral at 13.19
  .byte 114 # StringLiteral at 13.19
  .byte 117 # StringLiteral at 13.19
  .byte 101 # StringLiteral at 13.19
  .byte 44 # StringLiteral at 13.19
  ...
  .byte 121 # StringLiteral at 13.19
  .byte 33 # StringLiteral at 13.19
  .byte 10 # StringLiteral at 13.19
  .byte 0 # StringLiteral at 13.19
  .byte 0 # StringLiteral at 13.19
  .byte 0 # StringLiteral at 13.19
  .word CLASS_String # StringLiteral at 13.19
  .word 5 # StringLiteral at 13.19
  .word -13 # StringLiteral at 13.19
strLit_21: # StringLiteral at 13.19
  .byte 70 # StringLiteral at 16.19
  .byte 97 # StringLiteral at 16.19
  .byte 108 # StringLiteral at 16.19
  .byte 115 # StringLiteral at 16.19
  .byte 101 # StringLiteral at 16.19
  .byte 44 # StringLiteral at 16.19
  .byte 32 # StringLiteral at 16.19
  .byte 73 # StringLiteral at 16.19
  .byte 32 # StringLiteral at 16.19
  .byte 115 # StringLiteral at 16.19
  .byte 97 # StringLiteral at 16.19
  .byte 121 # StringLiteral at 16.19
  .byte 33 # StringLiteral at 16.19
  .byte 10 # StringLiteral at 16.19
  .byte 0 # StringLiteral at 16.19
  .byte 0 # StringLiteral at 16.19
  .word CLASS_String # StringLiteral at 16.19
  .word 5 # StringLiteral at 16.19
  .word -14 # StringLiteral at 16.19
strLit_26: # StringLiteral at 16.19
.text
.globl main
main:
    jal vm_init
...
# begin: GreaterThan at 6.13; stackHeight = 8
...
# begin: IntegerLiteral at 6.15; stackHeight = 16
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.15; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 6.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_17
# begin: Block at 6.18; stackHeight = 8
...
# end: Block at 6.18; stackHeight = 8
    j if_done_17
  if_else_17:
# begin: Block at 9.12; stackHeight = 8
...
# end: Block at 9.12; stackHeight = 8
  if_done_17:
# end: If at 6.7; stackHeight = 8
# begin: If at 12.7; stackHeight = 8
# begin: GreaterThan at 12.13; stackHeight = 8
# begin: IntegerLiteral at 12.11; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.11; stackHeight = 16
# begin: IdentifierExp at 12.15; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.15; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 12.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_31
# begin: Block at 12.18; stackHeight = 8
...
# end: Block at 12.18; stackHeight = 8
    j if_done_31
  if_else_31:
# begin: Block at 15.12; stackHeight = 8
...
# end: Block at 15.12; stackHeight = 8
  if_done_31:
# end: If at 12.7; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
