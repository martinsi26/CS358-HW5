...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 32 # StringLiteral at 8.41
  .byte 0 # StringLiteral at 8.41
  .byte 0 # StringLiteral at 8.41
  .byte 0 # StringLiteral at 8.41
  .word CLASS_String # StringLiteral at 8.41
  .word 2 # StringLiteral at 8.41
  .word -1 # StringLiteral at 8.41
strLit_27: # StringLiteral at 8.41
  .byte 10 # StringLiteral at 10.20
  .byte 0 # StringLiteral at 10.20
  .byte 0 # StringLiteral at 10.20
  .byte 0 # StringLiteral at 10.20
  .word CLASS_String # StringLiteral at 10.20
  .word 2 # StringLiteral at 10.20
  .word -1 # StringLiteral at 10.20
strLit_35: # StringLiteral at 10.20
.text
.globl main
main:
    jal vm_init
...
# begin: Block at 6.5; stackHeight = 8
# begin: LocalVarDecl at 6.14; stackHeight = 8
# begin: IntegerLiteral at 6.18; stackHeight = 8
    li $t0, 50
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.18; stackHeight = 16
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 6.14; stackHeight = 16
# begin: BreakTarget at 6.5; stackHeight = 16
    j while_cond_33
  while_top_33:
# begin: Block at 6.5; stackHeight = 16
# begin: Block at 6.37; stackHeight = 16
# begin: If at 7.7; stackHeight = 16
# begin: GreaterThan at 7.13; stackHeight = 16
# begin: IdentifierExp at 7.11; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.11; stackHeight = 24
# begin: IntegerLiteral at 7.15; stackHeight = 24
    li $t0, 25
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.15; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 7.13; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_22
# begin: Break at 7.19; stackHeight = 16
    j break_target_33
# end: Break at 7.19; stackHeight = 16
    j if_done_22
  if_else_22:
# begin: Block at 8.7; stackHeight = 16
# end: Block at 8.7; stackHeight = 16
  if_done_22:
# end: If at 7.7; stackHeight = 16
...
# begin: CallStatement at 8.32; stackHeight = 16
# begin: Call at 8.32; stackHeight = 16
# begin: Super at 8.32; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.32; stackHeight = 20
# begin: StringLiteral at 8.41; stackHeight = 20
    la $t0, strLit_27
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.41; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.32; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.32; stackHeight = 16
# end: Block at 6.37; stackHeight = 16
# begin: Assign at 6.32; stackHeight = 16
# begin: Plus at 6.33; stackHeight = 16
# begin: IdentifierExp at 6.32; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.32; stackHeight = 24
# begin: IntegerLiteral at 6.33; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.33; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 6.33; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 6.32; stackHeight = 16
# end: Block at 6.5; stackHeight = 16
  while_cond_33:
# begin: Not at 6.24; stackHeight = 16
# begin: GreaterThan at 6.24; stackHeight = 16
# begin: IdentifierExp at 6.22; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.22; stackHeight = 24
# begin: IntegerLiteral at 6.27; stackHeight = 24
    li $t0, 100
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.27; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 6.24; stackHeight = 20
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 6.24; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_33
  break_target_33:
# end: BreakTarget at 6.5; stackHeight = 16
    addu $sp, $sp, 8
# end: Block at 6.5; stackHeight = 8
