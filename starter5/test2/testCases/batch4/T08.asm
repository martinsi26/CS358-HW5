...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  ...
  .word 2 # StringLiteral at 8.22
  .word -1 # StringLiteral at 8.22
strLit_8: # StringLiteral at 8.22
...
strLit_31: # StringLiteral at 12.20
.text
.globl main
main:
    jal vm_init
...
# begin: Block at 6.10; stackHeight = 8
# end: Block at 6.10; stackHeight = 8
# begin: BreakTarget at 6.5; stackHeight = 8
    j while_cond_29
  while_top_29:
# begin: Block at 6.5; stackHeight = 8
# begin: Block at 6.14; stackHeight = 8
# begin: CallStatement at 7.13; stackHeight = 8
# begin: Call at 7.13; stackHeight = 8
# begin: Super at 7.13; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 7.13; stackHeight = 12
# begin: IdentifierExp at 7.22; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.22; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 7.13; stackHeight = 8
# begin: CallStatement at 8.13; stackHeight = 8
# begin: Call at 8.13; stackHeight = 8
# begin: Super at 8.13; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.13; stackHeight = 12
# begin: StringLiteral at 8.22; stackHeight = 12
    la $t0, strLit_8
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.22; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.13; stackHeight = 8
# begin: Assign at 9.9; stackHeight = 8
# begin: Minus at 9.13; stackHeight = 8
# begin: IdentifierExp at 9.11; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.11; stackHeight = 16
# begin: IntegerLiteral at 9.15; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.15; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 9.13; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 9.9; stackHeight = 8
# begin: If at 10.7; stackHeight = 8
# begin: Not at 10.13; stackHeight = 8
# begin: GreaterThan at 10.13; stackHeight = 8
# begin: IdentifierExp at 10.11; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.11; stackHeight = 16
# begin: IntegerLiteral at 10.16; stackHeight = 16
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.16; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 10.13; stackHeight = 12
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 10.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_23
# begin: Break at 10.19; stackHeight = 8
    j break_target_29
# end: Break at 10.19; stackHeight = 8
    j if_done_23
  if_else_23:
# begin: Block at 11.5; stackHeight = 8
# end: Block at 11.5; stackHeight = 8
  if_done_23:
# end: If at 10.7; stackHeight = 8
# end: Block at 6.14; stackHeight = 8
# begin: Block at 6.12; stackHeight = 8
# end: Block at 6.12; stackHeight = 8
# end: Block at 6.5; stackHeight = 8
  while_cond_29:
# begin: True at 6.11; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: True at 6.11; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_29
  break_target_29:
# end: BreakTarget at 6.5; stackHeight = 8
# end: Block at 6.5; stackHeight = 8
...
# begin: StringLiteral at 12.20; stackHeight = 12
    la $t0, strLit_31
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.20; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
