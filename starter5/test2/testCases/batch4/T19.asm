...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 32 # StringLiteral at 9.37
  .byte 0 # StringLiteral at 9.37
  .byte 0 # StringLiteral at 9.37
  .byte 0 # StringLiteral at 9.37
  .word CLASS_String # StringLiteral at 9.37
  .word 2 # StringLiteral at 9.37
  .word -1 # StringLiteral at 9.37
strLit_52: # StringLiteral at 9.37
  .byte 10 # StringLiteral at 12.37
  .byte 0 # StringLiteral at 12.37
  .byte 0 # StringLiteral at 12.37
  .byte 0 # StringLiteral at 12.37
  .word CLASS_String # StringLiteral at 12.37
  .word 2 # StringLiteral at 12.37
  .word -1 # StringLiteral at 12.37
strLit_76: # StringLiteral at 12.37
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: Block at 5.2; stackHeight = 0
...
# begin: BreakTarget at 5.2; stackHeight = 8
    j while_cond_94
  while_top_94:
# begin: Block at 5.2; stackHeight = 8
# begin: Block at 5.34; stackHeight = 8
# begin: Block at 6.6; stackHeight = 8
# begin: LocalVarDecl at 6.15; stackHeight = 8
# begin: IntegerLiteral at 6.19; stackHeight = 8
    li $t0, 97
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.19; stackHeight = 16
    lw $zero, ($sp) #**"j"
# end: LocalVarDecl at 6.15; stackHeight = 16
# begin: BreakTarget at 6.6; stackHeight = 16
    j while_cond_90
  while_top_90:
# begin: Block at 6.6; stackHeight = 16
# begin: Block at 6.38; stackHeight = 16
# begin: Block at 7.3; stackHeight = 16
# begin: LocalVarDecl at 7.12; stackHeight = 16
# begin: IntegerLiteral at 7.16; stackHeight = 16
    li $t0, 97
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.16; stackHeight = 24
    lw $zero, ($sp) #**"k"
# end: LocalVarDecl at 7.12; stackHeight = 24
# begin: BreakTarget at 7.3; stackHeight = 24
    j while_cond_86
  while_top_86:
# begin: Block at 7.3; stackHeight = 24
# begin: Block at 7.35; stackHeight = 24
# begin: Block at 8.7; stackHeight = 24
# begin: LocalVarDecl at 8.16; stackHeight = 24
# begin: IntegerLiteral at 8.20; stackHeight = 24
    li $t0, 97
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.20; stackHeight = 32
    lw $zero, ($sp) #**"n"
# end: LocalVarDecl at 8.16; stackHeight = 32
# begin: BreakTarget at 8.7; stackHeight = 32
    j while_cond_82
  while_top_82:
# begin: Block at 8.7; stackHeight = 32
# begin: Block at 8.39; stackHeight = 32
# begin: CallStatement at 9.10; stackHeight = 32
# begin: Call at 9.10; stackHeight = 32
# begin: Super at 9.10; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.10; stackHeight = 36
# begin: IdentifierExp at 9.19; stackHeight = 36
    lw $t0, 28($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.19; stackHeight = 44
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.10; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.10; stackHeight = 32
# begin: CallStatement at 9.28; stackHeight = 32
# begin: Call at 9.28; stackHeight = 32
# begin: Super at 9.28; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.28; stackHeight = 36
# begin: StringLiteral at 9.37; stackHeight = 36
    la $t0, strLit_52
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.37; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.28; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.28; stackHeight = 32
# begin: CallStatement at 10.10; stackHeight = 32
# begin: Call at 10.10; stackHeight = 32
# begin: Super at 10.10; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.10; stackHeight = 36
# begin: IdentifierExp at 10.19; stackHeight = 36
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.19; stackHeight = 44
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.10; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.10; stackHeight = 32
# begin: CallStatement at 10.28; stackHeight = 32
# begin: Call at 10.28; stackHeight = 32
# begin: Super at 10.28; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.28; stackHeight = 36
# begin: StringLiteral at 10.37; stackHeight = 36
    la $t0, strLit_52
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 10.37; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.28; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.28; stackHeight = 32
# begin: CallStatement at 11.10; stackHeight = 32
# begin: Call at 11.10; stackHeight = 32
# begin: Super at 11.10; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.10; stackHeight = 36
# begin: IdentifierExp at 11.19; stackHeight = 36
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.19; stackHeight = 44
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.10; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.10; stackHeight = 32
# begin: CallStatement at 11.28; stackHeight = 32
# begin: Call at 11.28; stackHeight = 32
# begin: Super at 11.28; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.28; stackHeight = 36
# begin: StringLiteral at 11.37; stackHeight = 36
    la $t0, strLit_52
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 11.37; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.28; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.28; stackHeight = 32
# begin: CallStatement at 12.10; stackHeight = 32
# begin: Call at 12.10; stackHeight = 32
# begin: Super at 12.10; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.10; stackHeight = 36
# begin: IdentifierExp at 12.19; stackHeight = 36
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.19; stackHeight = 44
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.10; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.10; stackHeight = 32
# begin: CallStatement at 12.28; stackHeight = 32
# begin: Call at 12.28; stackHeight = 32
# begin: Super at 12.28; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.28; stackHeight = 36
# begin: StringLiteral at 12.37; stackHeight = 36
    la $t0, strLit_76
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.37; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.28; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.28; stackHeight = 32
# end: Block at 8.39; stackHeight = 32
# begin: Assign at 8.34; stackHeight = 32
# begin: Plus at 8.35; stackHeight = 32
# begin: IdentifierExp at 8.34; stackHeight = 32
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.34; stackHeight = 40
# begin: IntegerLiteral at 8.35; stackHeight = 40
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.35; stackHeight = 48
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 8.35; stackHeight = 40
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 8.34; stackHeight = 32
# end: Block at 8.7; stackHeight = 32
  while_cond_82:
# begin: LessThan at 8.27; stackHeight = 32
# begin: IdentifierExp at 8.25; stackHeight = 32
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.25; stackHeight = 40
# begin: IntegerLiteral at 8.29; stackHeight = 40
    li $t0, 100
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.29; stackHeight = 48
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 8.27; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_82
  break_target_82:
# end: BreakTarget at 8.7; stackHeight = 32
    addu $sp, $sp, 8
# end: Block at 8.7; stackHeight = 24
# end: Block at 7.35; stackHeight = 24
# begin: Assign at 7.30; stackHeight = 24
# begin: Plus at 7.31; stackHeight = 24
# begin: IdentifierExp at 7.30; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.30; stackHeight = 32
# begin: IntegerLiteral at 7.31; stackHeight = 32
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.31; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 7.31; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 7.30; stackHeight = 24
# end: Block at 7.3; stackHeight = 24
  while_cond_86:
# begin: LessThan at 7.23; stackHeight = 24
# begin: IdentifierExp at 7.21; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.21; stackHeight = 32
# begin: IntegerLiteral at 7.25; stackHeight = 32
    li $t0, 100
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.25; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 7.23; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_86
  break_target_86:
# end: BreakTarget at 7.3; stackHeight = 24
    addu $sp, $sp, 8
# end: Block at 7.3; stackHeight = 16
# end: Block at 6.38; stackHeight = 16
# begin: Assign at 6.33; stackHeight = 16
# begin: Plus at 6.34; stackHeight = 16
# begin: IdentifierExp at 6.33; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.33; stackHeight = 24
# begin: IntegerLiteral at 6.34; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.34; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 6.34; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 6.33; stackHeight = 16
# end: Block at 6.6; stackHeight = 16
  while_cond_90:
# begin: LessThan at 6.26; stackHeight = 16
# begin: IdentifierExp at 6.24; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.24; stackHeight = 24
# begin: IntegerLiteral at 6.28; stackHeight = 24
    li $t0, 100
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.28; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 6.26; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_90
  break_target_90:
# end: BreakTarget at 6.6; stackHeight = 16
    addu $sp, $sp, 8
# end: Block at 6.6; stackHeight = 8
# end: Block at 5.34; stackHeight = 8
# begin: Assign at 5.29; stackHeight = 8
# begin: Plus at 5.30; stackHeight = 8
# begin: IdentifierExp at 5.29; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 5.29; stackHeight = 16
# begin: IntegerLiteral at 5.30; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.30; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 5.30; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 5.29; stackHeight = 8
# end: Block at 5.2; stackHeight = 8
  while_cond_94:
# begin: LessThan at 5.22; stackHeight = 8
# begin: IdentifierExp at 5.20; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 5.20; stackHeight = 16
# begin: IntegerLiteral at 5.24; stackHeight = 16
    li $t0, 100
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.24; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 5.22; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_94
  break_target_94:
# end: BreakTarget at 5.2; stackHeight = 8
    addu $sp, $sp, 8
# end: Block at 5.2; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
