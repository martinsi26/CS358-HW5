...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 10 # StringLiteral at 7.22
  .byte 0 # StringLiteral at 7.22
  .byte 0 # StringLiteral at 7.22
  .byte 0 # StringLiteral at 7.22
  .word CLASS_String # StringLiteral at 7.22
  .word 2 # StringLiteral at 7.22
  .word -1 # StringLiteral at 7.22
strLit_17: # StringLiteral at 7.22
.text
.globl main
main:
    jal vm_init
...
# begin: CallStatement at 6.13; stackHeight = 8
# begin: Call at 6.13; stackHeight = 8
# begin: Super at 6.13; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 6.13; stackHeight = 12
# begin: IdentifierExp at 6.22; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.22; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.13; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 6.13; stackHeight = 8
...
# begin: StringLiteral at 7.22; stackHeight = 12
    la $t0, strLit_17
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 7.22; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: Block at 5.5; stackHeight = 8
  while_cond_23:
# begin: Not at 5.24; stackHeight = 8
# begin: GreaterThan at 5.24; stackHeight = 8
# begin: IdentifierExp at 5.22; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 5.22; stackHeight = 16
...
# end: IntegerLiteral at 5.27; stackHeight = 24
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 5.24; stackHeight = 12
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 5.24; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_23
  break_target_23:
