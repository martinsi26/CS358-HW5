...
# ****** class Rec03 ****** # ClassDecl at 24.7
  .byte 0 # ClassDecl at 24.7
  .byte 0 # ClassDecl at 24.7
  .byte 0 # ClassDecl at 24.7
  .byte 210 # 'R' with high bit set # ClassDecl at 24.7
  .byte 101 # 'e' # ClassDecl at 24.7
  .byte 99 # 'c' # ClassDecl at 24.7
  .byte 48 # '0' # ClassDecl at 24.7
  .byte 51 # '3' # ClassDecl at 24.7
CLASS_Rec03: # ClassDecl at 24.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
END_CLASS_Rec03: # ClassDecl at 24.7
...
# field Rec03.s offset = 0: InstVarDecl at 25.10
# field Rec03.next offset = 4: InstVarDecl at 26.9
  .byte 97 # StringLiteral at 6.10
  .byte 98 # StringLiteral at 6.10
  .byte 108 # StringLiteral at 6.10
  .byte 101 # StringLiteral at 6.10
  .word CLASS_String # StringLiteral at 6.10
  .word 2 # StringLiteral at 6.10
  .word -4 # StringLiteral at 6.10
strLit_7: # StringLiteral at 6.10
  .byte 98 # StringLiteral at 9.10
  .byte 97 # StringLiteral at 9.10
  .byte 107 # StringLiteral at 9.10
  .byte 101 # StringLiteral at 9.10
  .byte 114 # StringLiteral at 9.10
  .byte 0 # StringLiteral at 9.10
  .byte 0 # StringLiteral at 9.10
  .byte 0 # StringLiteral at 9.10
  .word CLASS_String # StringLiteral at 9.10
  .word 3 # StringLiteral at 9.10
  .word -5 # StringLiteral at 9.10
strLit_20: # StringLiteral at 9.10
  .byte 99 # StringLiteral at 12.10
  .byte 111 # StringLiteral at 12.10
  .byte 114 # StringLiteral at 12.10
  .byte 110 # StringLiteral at 12.10
  .byte 101 # StringLiteral at 12.10
  .byte 114 # StringLiteral at 12.10
  .byte 0 # StringLiteral at 12.10
  .byte 0 # StringLiteral at 12.10
  .word CLASS_String # StringLiteral at 12.10
  .word 3 # StringLiteral at 12.10
  .word -6 # StringLiteral at 12.10
strLit_33: # StringLiteral at 12.10
  .byte 32 # StringLiteral at 17.42
  .byte 0 # StringLiteral at 17.42
  .byte 0 # StringLiteral at 17.42
  .byte 0 # StringLiteral at 17.42
  .word CLASS_String # StringLiteral at 17.42
  .word 2 # StringLiteral at 17.42
  .word -1 # StringLiteral at 17.42
strLit_55: # StringLiteral at 17.42
...
strLit_65: # StringLiteral at 20.18
.text
.globl main
main:
    jal vm_init
...
# begin: NewObject at 5.14; stackHeight = 0
    li $s6, 1
    li $s7, 2
    jal newObject
    la $t0, CLASS_Rec03
    sw $t0, -12($s7)
# end: NewObject at 5.14; stackHeight = 4
    lw $zero, ($sp) #**"r1"
# end: LocalVarDecl at 5.9; stackHeight = 4
# begin: Assign at 6.8; stackHeight = 4
# begin: StringLiteral at 6.10; stackHeight = 4
    la $t0, strLit_7
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.10; stackHeight = 8
# begin: IdentifierExp at 6.3; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 6.3; stackHeight = 12
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    addu $sp, $sp, 4
    sw $t0, 0($t1)
# end: Assign at 6.8; stackHeight = 4
# begin: Assign at 7.11; stackHeight = 4
# begin: Null at 7.13; stackHeight = 4
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 7.13; stackHeight = 8
# begin: IdentifierExp at 7.3; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.3; stackHeight = 12
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 4($t1)
# end: Assign at 7.11; stackHeight = 4
# begin: LocalVarDecl at 8.9; stackHeight = 4
# begin: NewObject at 8.14; stackHeight = 4
    li $s6, 1
    li $s7, 2
    jal newObject
    la $t0, CLASS_Rec03
    sw $t0, -12($s7)
# end: NewObject at 8.14; stackHeight = 8
    lw $zero, ($sp) #**"r2"
# end: LocalVarDecl at 8.9; stackHeight = 8
# begin: Assign at 9.8; stackHeight = 8
# begin: StringLiteral at 9.10; stackHeight = 8
    la $t0, strLit_20
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.10; stackHeight = 12
# begin: IdentifierExp at 9.3; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 9.3; stackHeight = 16
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($t1)
# end: Assign at 9.8; stackHeight = 8
# begin: Assign at 10.11; stackHeight = 8
# begin: IdentifierExp at 10.13; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.13; stackHeight = 12
# begin: IdentifierExp at 10.3; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.3; stackHeight = 16
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
...
# begin: LocalVarDecl at 11.9; stackHeight = 8
# begin: NewObject at 11.14; stackHeight = 8
    li $s6, 1
    li $s7, 2
    jal newObject
    la $t0, CLASS_Rec03
    sw $t0, -12($s7)
# end: NewObject at 11.14; stackHeight = 12
    lw $zero, ($sp) #**"r3"
# end: LocalVarDecl at 11.9; stackHeight = 12
# begin: Assign at 12.8; stackHeight = 12
# begin: StringLiteral at 12.10; stackHeight = 12
    la $t0, strLit_33
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.10; stackHeight = 16
# begin: IdentifierExp at 12.3; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.3; stackHeight = 20
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($t1)
# end: Assign at 12.8; stackHeight = 12
# begin: Assign at 13.11; stackHeight = 12
# begin: IdentifierExp at 13.13; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.13; stackHeight = 16
# begin: IdentifierExp at 13.3; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.3; stackHeight = 20
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 4($t1)
# end: Assign at 13.11; stackHeight = 12
# begin: LocalVarDecl at 14.9; stackHeight = 12
# begin: Null at 14.14; stackHeight = 12
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 14.14; stackHeight = 16
    lw $zero, ($sp) #**"r4"
# end: LocalVarDecl at 14.9; stackHeight = 16
# begin: Assign at 15.6; stackHeight = 16
# begin: IdentifierExp at 15.8; stackHeight = 16
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 15.8; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 15.6; stackHeight = 16
# begin: BreakTarget at 16.3; stackHeight = 16
    j while_cond_64
  while_top_64:
# begin: Block at 16.22; stackHeight = 16
...
# begin: InstVarAccess at 17.22; stackHeight = 20
...
# end: IdentifierExp at 17.20; stackHeight = 24
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 17.22; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: CallStatement at 17.33; stackHeight = 16
# begin: Call at 17.33; stackHeight = 16
# begin: Super at 17.33; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 17.33; stackHeight = 20
# begin: StringLiteral at 17.42; stackHeight = 20
    la $t0, strLit_55
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 17.42; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 17.33; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 17.33; stackHeight = 16
# begin: Assign at 18.8; stackHeight = 16
# begin: InstVarAccess at 18.12; stackHeight = 16
# begin: IdentifierExp at 18.10; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 18.10; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, 4($t0)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 18.12; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($sp)
# end: Assign at 18.8; stackHeight = 16
# end: Block at 16.22; stackHeight = 16
  while_cond_64:
# begin: Not at 16.13; stackHeight = 16
# begin: Equals at 16.13; stackHeight = 16
# begin: IdentifierExp at 16.10; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 16.10; stackHeight = 20
# begin: Null at 16.16; stackHeight = 20
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 16.16; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 16.13; stackHeight = 20
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 16.13; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_64
  break_target_64:
# end: BreakTarget at 16.3; stackHeight = 16
# begin: CallStatement at 20.9; stackHeight = 16
# begin: Call at 20.9; stackHeight = 16
# begin: Super at 20.9; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 20.9; stackHeight = 20
...
# end: StringLiteral at 20.18; stackHeight = 24
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.9; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.9; stackHeight = 16
    addu $sp, $sp, 16
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
