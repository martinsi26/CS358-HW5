...
# ****** class Rec04 ****** # ClassDecl at 40.7
  .byte 0 # ClassDecl at 40.7
  .byte 0 # ClassDecl at 40.7
  .byte 0 # ClassDecl at 40.7
  .byte 210 # 'R' with high bit set # ClassDecl at 40.7
  .byte 101 # 'e' # ClassDecl at 40.7
  .byte 99 # 'c' # ClassDecl at 40.7
  .byte 48 # '0' # ClassDecl at 40.7
  .byte 52 # '4' # ClassDecl at 40.7
CLASS_Rec04: # ClassDecl at 40.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
END_CLASS_Rec04: # ClassDecl at 40.7
...
# field Rec04.s offset = 0: InstVarDecl at 41.10
# field Rec04.next offset = 4: InstVarDecl at 42.9
  .byte 97 # StringLiteral at 6.12
  .byte 98 # StringLiteral at 6.12
  .byte 108 # StringLiteral at 6.12
  .byte 101 # StringLiteral at 6.12
  .word CLASS_String # StringLiteral at 6.12
  .word 2 # StringLiteral at 6.12
  .word -4 # StringLiteral at 6.12
strLit_7: # StringLiteral at 6.12
  .byte 98 # StringLiteral at 9.12
  .byte 97 # StringLiteral at 9.12
  .byte 107 # StringLiteral at 9.12
  .byte 101 # StringLiteral at 9.12
  .byte 114 # StringLiteral at 9.12
  .byte 0 # StringLiteral at 9.12
  .byte 0 # StringLiteral at 9.12
  .byte 0 # StringLiteral at 9.12
  .word CLASS_String # StringLiteral at 9.12
  .word 3 # StringLiteral at 9.12
  .word -5 # StringLiteral at 9.12
strLit_20: # StringLiteral at 9.12
  .byte 99 # StringLiteral at 12.12
  .byte 111 # StringLiteral at 12.12
  .byte 114 # StringLiteral at 12.12
  .byte 110 # StringLiteral at 12.12
  .byte 101 # StringLiteral at 12.12
  .byte 114 # StringLiteral at 12.12
  .byte 0 # StringLiteral at 12.12
  .byte 0 # StringLiteral at 12.12
  .word CLASS_String # StringLiteral at 12.12
  .word 3 # StringLiteral at 12.12
  .word -6 # StringLiteral at 12.12
strLit_33: # StringLiteral at 12.12
  .byte 32 # StringLiteral at 20.44
  .byte 0 # StringLiteral at 20.44
  .byte 0 # StringLiteral at 20.44
  .byte 0 # StringLiteral at 20.44
  .word CLASS_String # StringLiteral at 20.44
  .word 2 # StringLiteral at 20.44
  .word -1 # StringLiteral at 20.44
strLit_62: # StringLiteral at 20.44
  .byte 10 # StringLiteral at 25.20
  .byte 0 # StringLiteral at 25.20
  .byte 0 # StringLiteral at 25.20
  .byte 0 # StringLiteral at 25.20
  .word CLASS_String # StringLiteral at 25.20
  .word 2 # StringLiteral at 25.20
  .word -1 # StringLiteral at 25.20
strLit_84: # StringLiteral at 25.20
.text
.globl main
main:
    jal vm_init
...
# begin: NewObject at 5.16; stackHeight = 0
    li $s6, 1
    li $s7, 2
    jal newObject
    la $t0, CLASS_Rec04
    sw $t0, -12($s7)
# end: NewObject at 5.16; stackHeight = 4
    lw $zero, ($sp) #**"r1"
# end: LocalVarDecl at 5.11; stackHeight = 4
# begin: Assign at 6.10; stackHeight = 4
# begin: StringLiteral at 6.12; stackHeight = 4
    la $t0, strLit_7
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.12; stackHeight = 8
# begin: IdentifierExp at 6.5; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 6.5; stackHeight = 12
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    addu $sp, $sp, 4
    sw $t0, 0($t1)
# end: Assign at 6.10; stackHeight = 4
# begin: Assign at 7.13; stackHeight = 4
# begin: Null at 7.15; stackHeight = 4
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 7.15; stackHeight = 8
...
# end: IdentifierExp at 7.5; stackHeight = 12
    ...
    addu $sp, $sp, 4
    sw $t0, 4($t1)
# end: Assign at 7.13; stackHeight = 4
# begin: LocalVarDecl at 8.11; stackHeight = 4
# begin: NewObject at 8.16; stackHeight = 4
    li $s6, 1
    li $s7, 2
    jal newObject
    la $t0, CLASS_Rec04
    sw $t0, -12($s7)
# end: NewObject at 8.16; stackHeight = 8
    lw $zero, ($sp) #**"r2"
# end: LocalVarDecl at 8.11; stackHeight = 8
# begin: Assign at 9.10; stackHeight = 8
# begin: StringLiteral at 9.12; stackHeight = 8
    la $t0, strLit_20
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.12; stackHeight = 12
# begin: IdentifierExp at 9.5; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 9.5; stackHeight = 16
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 0($t1)
# end: Assign at 9.10; stackHeight = 8
# begin: Assign at 10.13; stackHeight = 8
# begin: IdentifierExp at 10.15; stackHeight = 8
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.15; stackHeight = 12
# begin: IdentifierExp at 10.5; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.5; stackHeight = 16
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 4($t1)
# end: Assign at 10.13; stackHeight = 8
# begin: LocalVarDecl at 11.11; stackHeight = 8
# begin: NewObject at 11.16; stackHeight = 8
    li $s6, 1
    li $s7, 2
    jal newObject
    la $t0, CLASS_Rec04
    sw $t0, -12($s7)
# end: NewObject at 11.16; stackHeight = 12
    lw $zero, ($sp) #**"r3"
# end: LocalVarDecl at 11.11; stackHeight = 12
# begin: Assign at 12.10; stackHeight = 12
# begin: StringLiteral at 12.12; stackHeight = 12
    la $t0, strLit_33
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.12; stackHeight = 16
...
# end: IdentifierExp at 12.5; stackHeight = 20
    ...
    addu $sp, $sp, 4
    sw $t0, 0($t1)
# end: Assign at 12.10; stackHeight = 12
# begin: Assign at 13.13; stackHeight = 12
# begin: IdentifierExp at 13.15; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.15; stackHeight = 16
...
# end: IdentifierExp at 13.5; stackHeight = 20
    ...
    addu $sp, $sp, 4
    sw $t0, 4($t1)
# end: Assign at 13.13; stackHeight = 12
# begin: LocalVarDecl at 15.11; stackHeight = 12
# begin: Null at 15.16; stackHeight = 12
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 15.16; stackHeight = 16
    lw $zero, ($sp) #**"r4"
# end: LocalVarDecl at 15.11; stackHeight = 16
# begin: LocalVarDecl at 16.9; stackHeight = 16
# begin: IntegerLiteral at 16.17; stackHeight = 16
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.17; stackHeight = 24
    lw $zero, ($sp) #**"count"
# end: LocalVarDecl at 16.9; stackHeight = 24
# begin: Assign at 17.8; stackHeight = 24
# begin: IdentifierExp at 17.10; stackHeight = 24
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.10; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 8($sp)
# end: Assign at 17.8; stackHeight = 24
# begin: Assign at 18.11; stackHeight = 24
# begin: IntegerLiteral at 18.13; stackHeight = 24
    li $t0, 15
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 18.13; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 18.11; stackHeight = 24
# begin: BreakTarget at 19.5; stackHeight = 24
    j while_cond_83
  while_top_83:
# begin: Block at 19.24; stackHeight = 24
# begin: CallStatement at 20.13; stackHeight = 24
# begin: Call at 20.13; stackHeight = 24
# begin: Super at 20.13; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 20.13; stackHeight = 28
# begin: InstVarAccess at 20.24; stackHeight = 28
# begin: IdentifierExp at 20.22; stackHeight = 28
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 20.22; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 20.24; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.13; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.13; stackHeight = 24
# begin: CallStatement at 20.35; stackHeight = 24
# begin: Call at 20.35; stackHeight = 24
# begin: Super at 20.35; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 20.35; stackHeight = 28
# begin: StringLiteral at 20.44; stackHeight = 28
    la $t0, strLit_62
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 20.44; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.35; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.35; stackHeight = 24
# begin: Assign at 21.13; stackHeight = 24
# begin: Minus at 21.21; stackHeight = 24
...
# begin: IntegerLiteral at 21.23; stackHeight = 32
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 21.23; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 21.21; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 21.13; stackHeight = 24
# begin: If at 22.7; stackHeight = 24
# begin: Not at 22.17; stackHeight = 24
# begin: GreaterThan at 22.17; stackHeight = 24
# begin: IdentifierExp at 22.11; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 22.11; stackHeight = 32
# begin: IntegerLiteral at 22.20; stackHeight = 32
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 22.20; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 22.17; stackHeight = 28
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 22.17; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_77
# begin: Break at 22.23; stackHeight = 24
    j break_target_83
# end: Break at 22.23; stackHeight = 24
    j if_done_77
  if_else_77:
...
# begin: Assign at 23.10; stackHeight = 24
# begin: InstVarAccess at 23.14; stackHeight = 24
# begin: IdentifierExp at 23.12; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 23.12; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, 4($t0)
...
# end: InstVarAccess at 23.14; stackHeight = 28
    ...
    addu $sp, $sp, 4
    sw $t0, 8($sp)
# end: Assign at 23.10; stackHeight = 24
# end: Block at 19.24; stackHeight = 24
  while_cond_83:
# begin: Not at 19.15; stackHeight = 24
# begin: Equals at 19.15; stackHeight = 24
# begin: IdentifierExp at 19.12; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 19.12; stackHeight = 28
# begin: Null at 19.18; stackHeight = 28
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 19.18; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 19.15; stackHeight = 28
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 19.15; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_83
  break_target_83:
# end: BreakTarget at 19.5; stackHeight = 24
# begin: CallStatement at 25.11; stackHeight = 24
# begin: Call at 25.11; stackHeight = 24
# begin: Super at 25.11; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 25.11; stackHeight = 28
# begin: StringLiteral at 25.20; stackHeight = 28
    la $t0, strLit_84
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 25.20; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 25.11; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 25.11; stackHeight = 24
# begin: Assign at 27.13; stackHeight = 24
# begin: IdentifierExp at 27.15; stackHeight = 24
    lw $t0, 16($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 27.15; stackHeight = 28
# begin: IdentifierExp at 27.5; stackHeight = 28
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 27.5; stackHeight = 32
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 4($t1)
# end: Assign at 27.13; stackHeight = 24
# begin: Assign at 28.8; stackHeight = 24
# begin: IdentifierExp at 28.10; stackHeight = 24
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 28.10; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 8($sp)
# end: Assign at 28.8; stackHeight = 24
# begin: Assign at 29.11; stackHeight = 24
# begin: IntegerLiteral at 29.13; stackHeight = 24
    li $t0, 15
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 29.13; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 29.11; stackHeight = 24
# begin: BreakTarget at 30.5; stackHeight = 24
    j while_cond_128
  while_top_128:
# begin: Block at 30.24; stackHeight = 24
# begin: CallStatement at 31.13; stackHeight = 24
# begin: Call at 31.13; stackHeight = 24
# begin: Super at 31.13; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 31.13; stackHeight = 28
# begin: InstVarAccess at 31.24; stackHeight = 28
# begin: IdentifierExp at 31.22; stackHeight = 28
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 31.22; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, 0($t0)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 31.24; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 31.13; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 31.13; stackHeight = 24
# begin: CallStatement at 31.35; stackHeight = 24
# begin: Call at 31.35; stackHeight = 24
# begin: Super at 31.35; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 31.35; stackHeight = 28
# begin: StringLiteral at 31.44; stackHeight = 28
    la $t0, strLit_62
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 31.44; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 31.35; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 31.35; stackHeight = 24
# begin: Assign at 32.13; stackHeight = 24
# begin: Minus at 32.21; stackHeight = 24
# begin: IdentifierExp at 32.15; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 32.15; stackHeight = 32
# begin: IntegerLiteral at 32.23; stackHeight = 32
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 32.23; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 32.21; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 32.13; stackHeight = 24
# begin: If at 33.7; stackHeight = 24
# begin: Not at 33.17; stackHeight = 24
# begin: GreaterThan at 33.17; stackHeight = 24
# begin: IdentifierExp at 33.11; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 33.11; stackHeight = 32
# begin: IntegerLiteral at 33.20; stackHeight = 32
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 33.20; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 33.17; stackHeight = 28
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 33.17; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_122
# begin: Break at 33.23; stackHeight = 24
    j break_target_128
# end: Break at 33.23; stackHeight = 24
    j if_done_122
  if_else_122:
# begin: Block at 34.7; stackHeight = 24
# end: Block at 34.7; stackHeight = 24
  if_done_122:
# end: If at 33.7; stackHeight = 24
# begin: Assign at 34.10; stackHeight = 24
# begin: InstVarAccess at 34.14; stackHeight = 24
# begin: IdentifierExp at 34.12; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 34.12; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, nullPtrException
    lw $t0, 4($t0)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: InstVarAccess at 34.14; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 8($sp)
# end: Assign at 34.10; stackHeight = 24
# end: Block at 30.24; stackHeight = 24
  while_cond_128:
# begin: Not at 30.15; stackHeight = 24
# begin: Equals at 30.15; stackHeight = 24
# begin: IdentifierExp at 30.12; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 30.12; stackHeight = 28
# begin: Null at 30.18; stackHeight = 28
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 30.18; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 4
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 30.15; stackHeight = 28
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 30.15; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_128
  break_target_128:
# end: BreakTarget at 30.5; stackHeight = 24
# begin: CallStatement at 36.11; stackHeight = 24
# begin: Call at 36.11; stackHeight = 24
# begin: Super at 36.11; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 36.11; stackHeight = 28
# begin: StringLiteral at 36.20; stackHeight = 28
    la $t0, strLit_84
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 36.20; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 36.11; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 36.11; stackHeight = 24
    addu $sp, $sp, 24
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
