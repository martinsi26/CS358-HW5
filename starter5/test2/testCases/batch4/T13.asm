...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 88 # StringLiteral at 5.16
  .byte 0 # StringLiteral at 5.16
  .byte 0 # StringLiteral at 5.16
  .byte 0 # StringLiteral at 5.16
  .word CLASS_String # StringLiteral at 5.16
  .word 2 # StringLiteral at 5.16
  .word -1 # StringLiteral at 5.16
strLit_1: # StringLiteral at 5.16
  .byte 32 # StringLiteral at 6.20
  .byte 0 # StringLiteral at 6.20
  .byte 0 # StringLiteral at 6.20
  .byte 0 # StringLiteral at 6.20
  .word CLASS_String # StringLiteral at 6.20
  .word 2 # StringLiteral at 6.20
  .word -1 # StringLiteral at 6.20
strLit_5: # StringLiteral at 6.20
.text
.globl main
main:
    jal vm_init
...
# begin: StringLiteral at 5.16; stackHeight = 0
    la $t0, strLit_1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 5.16; stackHeight = 4
    lw $zero, ($sp) #**"x"
# end: LocalVarDecl at 5.12; stackHeight = 4
# begin: LocalVarDecl at 6.12; stackHeight = 4
# begin: StringLiteral at 6.20; stackHeight = 4
    la $t0, strLit_5
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.20; stackHeight = 8
    lw $zero, ($sp) #**"blank"
# end: LocalVarDecl at 6.12; stackHeight = 8
# begin: Block at 7.5; stackHeight = 8
# begin: LocalVarDecl at 7.14; stackHeight = 8
# begin: IntegerLiteral at 7.18; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.18; stackHeight = 16
    lw $zero, ($sp) #**"v"
# end: LocalVarDecl at 7.14; stackHeight = 16
# begin: BreakTarget at 7.5; stackHeight = 16
    j while_cond_58
  while_top_58:
# begin: Block at 7.5; stackHeight = 16
# begin: Block at 8.7; stackHeight = 16
# begin: LocalVarDecl at 8.16; stackHeight = 16
# begin: IntegerLiteral at 8.20; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.20; stackHeight = 24
    lw $zero, ($sp) #**"h"
# end: LocalVarDecl at 8.16; stackHeight = 24
# begin: BreakTarget at 8.7; stackHeight = 24
    j while_cond_55
  while_top_55:
# begin: Block at 8.7; stackHeight = 24
# begin: If at 9.9; stackHeight = 24
# begin: Equals at 9.23; stackHeight = 24
# begin: Times at 9.20; stackHeight = 24
# begin: Divide at 9.18; stackHeight = 24
# begin: Plus at 9.15; stackHeight = 24
# begin: IdentifierExp at 9.14; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.14; stackHeight = 32
# begin: IdentifierExp at 9.16; stackHeight = 32
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.16; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 9.15; stackHeight = 32
# begin: IntegerLiteral at 9.19; stackHeight = 32
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.19; stackHeight = 40
    jal divide
# end: Divide at 9.18; stackHeight = 32
# begin: IntegerLiteral at 9.21; stackHeight = 32
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.21; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 9.20; stackHeight = 32
# begin: Plus at 9.27; stackHeight = 32
# begin: IdentifierExp at 9.26; stackHeight = 32
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.26; stackHeight = 40
# begin: IdentifierExp at 9.28; stackHeight = 40
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.28; stackHeight = 48
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 9.27; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Equals at 9.23; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_53
# begin: CallStatement at 10.17; stackHeight = 24
# begin: Call at 10.17; stackHeight = 24
# begin: Super at 10.17; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 10.17; stackHeight = 28
# begin: IdentifierExp at 10.26; stackHeight = 28
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.26; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.17; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.17; stackHeight = 24
    j if_done_53
  if_else_53:
# begin: CallStatement at 12.17; stackHeight = 24
# begin: Call at 12.17; stackHeight = 24
# begin: Super at 12.17; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.17; stackHeight = 28
# begin: IdentifierExp at 12.26; stackHeight = 28
    lw $t0, 20($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.26; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.17; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.17; stackHeight = 24
  if_done_53:
# end: If at 9.9; stackHeight = 24
# begin: Assign at 8.32; stackHeight = 24
# begin: Plus at 8.33; stackHeight = 24
# begin: IdentifierExp at 8.32; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.32; stackHeight = 32
# begin: IntegerLiteral at 8.33; stackHeight = 32
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.33; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 8.33; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 8.32; stackHeight = 24
# end: Block at 8.7; stackHeight = 24
  while_cond_55:
# begin: Not at 8.25; stackHeight = 24
# begin: GreaterThan at 8.25; stackHeight = 24
# begin: IdentifierExp at 8.23; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.23; stackHeight = 32
# begin: IntegerLiteral at 8.28; stackHeight = 32
    li $t0, 20
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.28; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 8.25; stackHeight = 28
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 8.25; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_55
  break_target_55:
# end: BreakTarget at 8.7; stackHeight = 24
    addu $sp, $sp, 8
# end: Block at 8.7; stackHeight = 16
# begin: Assign at 7.30; stackHeight = 16
# begin: Plus at 7.31; stackHeight = 16
# begin: IdentifierExp at 7.30; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.30; stackHeight = 24
# begin: IntegerLiteral at 7.31; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.31; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 7.31; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 7.30; stackHeight = 16
# end: Block at 7.5; stackHeight = 16
  while_cond_58:
# begin: Not at 7.23; stackHeight = 16
# begin: GreaterThan at 7.23; stackHeight = 16
# begin: IdentifierExp at 7.21; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.21; stackHeight = 24
# begin: IntegerLiteral at 7.26; stackHeight = 24
    li $t0, 20
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.26; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 7.23; stackHeight = 20
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 7.23; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_58
  break_target_58:
# end: BreakTarget at 7.5; stackHeight = 16
    addu $sp, $sp, 8
# end: Block at 7.5; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
