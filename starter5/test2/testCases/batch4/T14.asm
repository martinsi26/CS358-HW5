...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 73 # StringLiteral at 6.19
  .byte 116 # StringLiteral at 6.19
  .byte 39 # StringLiteral at 6.19
  ...
  .byte 117 # StringLiteral at 6.19
  .byte 101 # StringLiteral at 6.19
  .byte 33 # StringLiteral at 6.19
  .byte 10 # StringLiteral at 6.19
  .byte 0 # StringLiteral at 6.19
  .byte 0 # StringLiteral at 6.19
  .word CLASS_String # StringLiteral at 6.19
  .word 5 # StringLiteral at 6.19
  .word -14 # StringLiteral at 6.19
strLit_1: # StringLiteral at 6.19
  .byte 73 # StringLiteral at 9.19
  .byte 116 # StringLiteral at 9.19
  .byte 39 # StringLiteral at 9.19
  .byte 115 # StringLiteral at 9.19
  .byte 32 # StringLiteral at 9.19
  .byte 115 # StringLiteral at 9.19
  .byte 111 # StringLiteral at 9.19
  .byte 32 # StringLiteral at 9.19
  .byte 102 # StringLiteral at 9.19
  .byte 97 # StringLiteral at 9.19
  .byte 108 # StringLiteral at 9.19
  .byte 115 # StringLiteral at 9.19
  .byte 101 # StringLiteral at 9.19
  .byte 33 # StringLiteral at 9.19
  .byte 10 # StringLiteral at 9.19
  .byte 0 # StringLiteral at 9.19
  .word CLASS_String # StringLiteral at 9.19
  .word 5 # StringLiteral at 9.19
  .word -15 # StringLiteral at 9.19
strLit_6: # StringLiteral at 9.19
  .byte 84 # StringLiteral at 12.19
  .byte 114 # StringLiteral at 12.19
  .byte 117 # StringLiteral at 12.19
  .byte 101 # StringLiteral at 12.19
  .byte 44 # StringLiteral at 12.19
  .byte 32 # StringLiteral at 12.19
  .byte 73 # StringLiteral at 12.19
  .byte 32 # StringLiteral at 12.19
  .byte 115 # StringLiteral at 12.19
  .byte 97 # StringLiteral at 12.19
  .byte 121 # StringLiteral at 12.19
  .byte 33 # StringLiteral at 12.19
  .byte 10 # StringLiteral at 12.19
  .byte 0 # StringLiteral at 12.19
  .byte 0 # StringLiteral at 12.19
  .byte 0 # StringLiteral at 12.19
  .word CLASS_String # StringLiteral at 12.19
  .word 5 # StringLiteral at 12.19
  .word -13 # StringLiteral at 12.19
strLit_13: # StringLiteral at 12.19
  .byte 70 # StringLiteral at 15.19
  .byte 97 # StringLiteral at 15.19
  .byte 108 # StringLiteral at 15.19
  .byte 115 # StringLiteral at 15.19
  .byte 101 # StringLiteral at 15.19
  .byte 44 # StringLiteral at 15.19
  .byte 32 # StringLiteral at 15.19
  .byte 73 # StringLiteral at 15.19
  .byte 32 # StringLiteral at 15.19
  .byte 115 # StringLiteral at 15.19
  .byte 97 # StringLiteral at 15.19
  .byte 121 # StringLiteral at 15.19
  .byte 33 # StringLiteral at 15.19
  .byte 10 # StringLiteral at 15.19
  .byte 0 # StringLiteral at 15.19
  .byte 0 # StringLiteral at 15.19
  .word CLASS_String # StringLiteral at 15.19
  .word 5 # StringLiteral at 15.19
  .word -14 # StringLiteral at 15.19
strLit_18: # StringLiteral at 15.19
.text
.globl main
main:
    jal vm_init
...
# end: True at 5.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_11
# begin: Block at 5.17; stackHeight = 0
...
# begin: StringLiteral at 6.19; stackHeight = 4
    la $t0, strLit_1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 6.19; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: Block at 5.17; stackHeight = 0
    j if_done_11
  if_else_11:
...
# begin: StringLiteral at 9.19; stackHeight = 4
    la $t0, strLit_6
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.19; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: False at 11.11; stackHeight = 0
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: False at 11.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_23
# begin: Block at 11.18; stackHeight = 0
...
# begin: StringLiteral at 12.19; stackHeight = 4
    la $t0, strLit_13
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.19; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# end: Block at 11.18; stackHeight = 0
    j if_done_23
  if_else_23:
...
# begin: StringLiteral at 15.19; stackHeight = 4
    la $t0, strLit_18
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 15.19; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
