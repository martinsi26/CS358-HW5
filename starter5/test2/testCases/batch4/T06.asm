...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 10 # StringLiteral at 11.41
  .byte 0 # StringLiteral at 11.41
  .byte 0 # StringLiteral at 11.41
  .byte 0 # StringLiteral at 11.41
  .word CLASS_String # StringLiteral at 11.41
  .word 2 # StringLiteral at 11.41
  .word -1 # StringLiteral at 11.41
strLit_31: # StringLiteral at 11.41
.text
.globl main
main:
    jal vm_init
...
# begin: BreakTarget at 7.5; stackHeight = 16
    j while_cond_48
  while_top_48:
# begin: Block at 7.18; stackHeight = 16
# begin: LocalVarDecl at 8.11; stackHeight = 16
# begin: Minus at 8.19; stackHeight = 16
...
# begin: IdentifierExp at 8.20; stackHeight = 24
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.20; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 8.19; stackHeight = 24
    lw $zero, ($sp) #**"diff"
# end: LocalVarDecl at 8.11; stackHeight = 24
# begin: LocalVarDecl at 9.11; stackHeight = 24
# begin: Divide at 9.26; stackHeight = 24
# begin: IdentifierExp at 9.22; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.22; stackHeight = 32
# begin: IntegerLiteral at 9.27; stackHeight = 32
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.27; stackHeight = 40
    jal divide
# end: Divide at 9.26; stackHeight = 32
    lw $zero, ($sp) #**"halfDiff"
# end: LocalVarDecl at 9.11; stackHeight = 32
# begin: LocalVarDecl at 10.11; stackHeight = 32
# begin: Plus at 10.27; stackHeight = 32
# begin: IdentifierExp at 10.19; stackHeight = 32
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.19; stackHeight = 40
# begin: IntegerLiteral at 10.28; stackHeight = 40
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.28; stackHeight = 48
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 10.27; stackHeight = 40
    lw $zero, ($sp) #**"delta"
# end: LocalVarDecl at 10.11; stackHeight = 40
# begin: CallStatement at 11.13; stackHeight = 40
# begin: Call at 11.13; stackHeight = 40
# begin: Super at 11.13; stackHeight = 40
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.13; stackHeight = 44
# begin: IdentifierExp at 11.22; stackHeight = 44
    lw $t0, 36($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.22; stackHeight = 52
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.13; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.13; stackHeight = 40
# begin: CallStatement at 11.32; stackHeight = 40
# begin: Call at 11.32; stackHeight = 40
# begin: Super at 11.32; stackHeight = 40
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.32; stackHeight = 44
# begin: StringLiteral at 11.41; stackHeight = 44
    la $t0, strLit_31
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 11.41; stackHeight = 48
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.32; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.32; stackHeight = 40
# begin: Assign at 12.9; stackHeight = 40
# begin: Minus at 12.13; stackHeight = 40
# begin: IdentifierExp at 12.11; stackHeight = 40
    lw $t0, 32($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.11; stackHeight = 48
# begin: IdentifierExp at 12.15; stackHeight = 48
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.15; stackHeight = 56
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 12.13; stackHeight = 48
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 32($sp)
# end: Assign at 12.9; stackHeight = 40
# begin: If at 13.7; stackHeight = 40
# begin: Not at 13.13; stackHeight = 40
# begin: LessThan at 13.13; stackHeight = 40
# begin: IdentifierExp at 13.11; stackHeight = 40
    lw $t0, 32($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.11; stackHeight = 48
# begin: IdentifierExp at 13.16; stackHeight = 48
    lw $t0, 32($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.16; stackHeight = 56
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 13.13; stackHeight = 44
    lw $t0, ($sp)
    xor $t0, $t0, 1
    sw $t0, ($sp)
# end: Not at 13.13; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_46
# begin: Break at 13.19; stackHeight = 40
    addu $sp, $sp, 24
    j break_target_48
# end: Break at 13.19; stackHeight = 40
    j if_done_46
  if_else_46:
# begin: Block at 14.5; stackHeight = 40
# end: Block at 14.5; stackHeight = 40
  if_done_46:
# end: If at 13.7; stackHeight = 40
    addu $sp, $sp, 24
# end: Block at 7.18; stackHeight = 16
  while_cond_48:
# begin: True at 7.12; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: True at 7.12; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_48
  break_target_48:
# end: BreakTarget at 7.5; stackHeight = 16
...
# begin: IdentifierExp at 15.20; stackHeight = 20
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 15.20; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 15.30; stackHeight = 16
# begin: Call at 15.30; stackHeight = 16
# begin: Super at 15.30; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 15.30; stackHeight = 20
# begin: StringLiteral at 15.39; stackHeight = 20
    la $t0, strLit_31
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 15.39; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 15.30; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 15.30; stackHeight = 16
...
# begin: CallStatement at 16.30; stackHeight = 16
# begin: Call at 16.30; stackHeight = 16
# begin: Super at 16.30; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 16.30; stackHeight = 20
# begin: StringLiteral at 16.39; stackHeight = 20
    la $t0, strLit_31
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 16.39; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 16.30; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 16.30; stackHeight = 16
    addu $sp, $sp, 16
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
