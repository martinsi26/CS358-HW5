...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 10 # StringLiteral at 12.22
  .byte 0 # StringLiteral at 12.22
  .byte 0 # StringLiteral at 12.22
  .byte 0 # StringLiteral at 12.22
  .word CLASS_String # StringLiteral at 12.22
  .word 2 # StringLiteral at 12.22
  .word -1 # StringLiteral at 12.22
strLit_29: # StringLiteral at 12.22
  .byte 42 # StringLiteral at 16.18
  ...
  .word -2 # StringLiteral at 16.18
strLit_44: # StringLiteral at 16.18
.text
.globl main
main:
    jal vm_init
...
# begin: BreakTarget at 6.2; stackHeight = 8
    j while_cond_69
  while_top_69:
# begin: Block at 6.19; stackHeight = 8
# begin: LocalVarDecl at 7.10; stackHeight = 8
# begin: IdentifierExp at 7.14; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
...
# begin: BreakTarget at 8.6; stackHeight = 16
    j while_cond_54
  while_top_54:
# begin: Block at 8.26; stackHeight = 16
# begin: LocalVarDecl at 9.7; stackHeight = 16
# begin: IdentifierExp at 9.11; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.11; stackHeight = 24
    lw $zero, ($sp) #**"z"
# end: LocalVarDecl at 9.7; stackHeight = 24
# begin: BreakTarget at 10.3; stackHeight = 24
    j while_cond_39
  while_top_39:
# begin: Block at 10.22; stackHeight = 24
# begin: CallStatement at 11.13; stackHeight = 24
# begin: Call at 11.13; stackHeight = 24
# begin: Super at 11.13; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.13; stackHeight = 28
# begin: IdentifierExp at 11.22; stackHeight = 28
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.22; stackHeight = 36
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.13; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.13; stackHeight = 24
# begin: CallStatement at 12.13; stackHeight = 24
# begin: Call at 12.13; stackHeight = 24
# begin: Super at 12.13; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.13; stackHeight = 28
# begin: StringLiteral at 12.22; stackHeight = 28
    la $t0, strLit_29
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.22; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.13; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.13; stackHeight = 24
# begin: Assign at 13.9; stackHeight = 24
# begin: Plus at 13.13; stackHeight = 24
# begin: IdentifierExp at 13.11; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.11; stackHeight = 32
# begin: IntegerLiteral at 13.15; stackHeight = 32
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.15; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 13.13; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 13.9; stackHeight = 24
# end: Block at 10.22; stackHeight = 24
  while_cond_39:
# begin: LessThan at 10.12; stackHeight = 24
# begin: IdentifierExp at 10.10; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.10; stackHeight = 32
# begin: Plus at 10.16; stackHeight = 32
# begin: IdentifierExp at 10.14; stackHeight = 32
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.14; stackHeight = 40
# begin: IntegerLiteral at 10.18; stackHeight = 40
    li $t0, 12
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.18; stackHeight = 48
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 10.16; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 10.12; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_39
  break_target_39:
# end: BreakTarget at 10.3; stackHeight = 24
# begin: CallStatement at 15.9; stackHeight = 24
# begin: Call at 15.9; stackHeight = 24
# begin: Super at 15.9; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 15.9; stackHeight = 28
# begin: IdentifierExp at 15.18; stackHeight = 28
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 15.18; stackHeight = 36
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 15.9; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 15.9; stackHeight = 24
# begin: CallStatement at 16.9; stackHeight = 24
# begin: Call at 16.9; stackHeight = 24
# begin: Super at 16.9; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 16.9; stackHeight = 28
# begin: StringLiteral at 16.18; stackHeight = 28
    la $t0, strLit_44
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 16.18; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 16.9; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 16.9; stackHeight = 24
# begin: Assign at 17.5; stackHeight = 24
# begin: Plus at 17.9; stackHeight = 24
# begin: IdentifierExp at 17.7; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.7; stackHeight = 32
# begin: IntegerLiteral at 17.11; stackHeight = 32
    li $t0, 17
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.11; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 17.9; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 17.5; stackHeight = 24
    addu $sp, $sp, 8
# end: Block at 8.26; stackHeight = 16
  while_cond_54:
# begin: LessThan at 8.15; stackHeight = 16
# begin: IdentifierExp at 8.13; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.13; stackHeight = 24
# begin: Plus at 8.19; stackHeight = 24
# begin: IdentifierExp at 8.17; stackHeight = 24
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.17; stackHeight = 32
# begin: IntegerLiteral at 8.21; stackHeight = 32
    li $t0, 126
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.21; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 8.19; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 8.15; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_54
  break_target_54:
# end: BreakTarget at 8.6; stackHeight = 16
# begin: CallStatement at 19.12; stackHeight = 16
# begin: Call at 19.12; stackHeight = 16
# begin: Super at 19.12; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 19.12; stackHeight = 20
# begin: IdentifierExp at 19.21; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.21; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 19.12; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 19.12; stackHeight = 16
# begin: CallStatement at 20.12; stackHeight = 16
# begin: Call at 20.12; stackHeight = 16
# begin: Super at 20.12; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 20.12; stackHeight = 20
# begin: StringLiteral at 20.21; stackHeight = 20
    la $t0, strLit_44
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 20.21; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.12; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.12; stackHeight = 16
# begin: Assign at 21.8; stackHeight = 16
# begin: Plus at 21.12; stackHeight = 16
# begin: IdentifierExp at 21.10; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.10; stackHeight = 24
# begin: IntegerLiteral at 21.14; stackHeight = 24
    li $t0, 84
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 21.14; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 21.12; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 21.8; stackHeight = 16
    addu $sp, $sp, 8
# end: Block at 6.19; stackHeight = 8
  while_cond_69:
# begin: LessThan at 6.11; stackHeight = 8
# begin: IdentifierExp at 6.9; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.9; stackHeight = 16
# begin: IntegerLiteral at 6.13; stackHeight = 16
    li $t0, 1000
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 6.13; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 6.11; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_69
  break_target_69:
# end: BreakTarget at 6.2; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
