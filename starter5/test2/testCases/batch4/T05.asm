...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 84 # StringLiteral at 8.22
  .byte 104 # StringLiteral at 8.22
  .byte 105 # StringLiteral at 8.22
  .byte 115 # StringLiteral at 8.22
  .byte 32 # StringLiteral at 8.22
  .byte 115 # StringLiteral at 8.22
  .byte 104 # StringLiteral at 8.22
  .byte 111 # StringLiteral at 8.22
  .byte 117 # StringLiteral at 8.22
  .byte 108 # StringLiteral at 8.22
  .byte 100 # StringLiteral at 8.22
  .byte 32 # StringLiteral at 8.22
  .byte 110 # StringLiteral at 8.22
  .byte 111 # StringLiteral at 8.22
  .byte 116 # StringLiteral at 8.22
  .byte 32 # StringLiteral at 8.22
  .byte 98 # StringLiteral at 8.22
  .byte 101 # StringLiteral at 8.22
  .byte 32 # StringLiteral at 8.22
  .byte 112 # StringLiteral at 8.22
  .byte 114 # StringLiteral at 8.22
  .byte 105 # StringLiteral at 8.22
  .byte 110 # StringLiteral at 8.22
  .byte 116 # StringLiteral at 8.22
  .byte 101 # StringLiteral at 8.22
  .byte 100 # StringLiteral at 8.22
  .byte 10 # StringLiteral at 8.22
  .byte 0 # StringLiteral at 8.22
  .word CLASS_String # StringLiteral at 8.22
  .word 8 # StringLiteral at 8.22
  .word -27 # StringLiteral at 8.22
strLit_11: # StringLiteral at 8.22
  .byte 84 # StringLiteral at 11.20
  .byte 104 # StringLiteral at 11.20
  .byte 105 # StringLiteral at 11.20
  .byte 115 # StringLiteral at 11.20
  .byte 32 # StringLiteral at 11.20
  .byte 115 # StringLiteral at 11.20
  .byte 104 # StringLiteral at 11.20
  .byte 111 # StringLiteral at 11.20
  .byte 117 # StringLiteral at 11.20
  .byte 108 # StringLiteral at 11.20
  .byte 100 # StringLiteral at 11.20
  .byte 32 # StringLiteral at 11.20
  .byte 98 # StringLiteral at 11.20
  .byte 101 # StringLiteral at 11.20
  .byte 32 # StringLiteral at 11.20
  .byte 112 # StringLiteral at 11.20
  .byte 114 # StringLiteral at 11.20
  .byte 105 # StringLiteral at 11.20
  .byte 110 # StringLiteral at 11.20
  .byte 116 # StringLiteral at 11.20
  .byte 101 # StringLiteral at 11.20
  .byte 100 # StringLiteral at 11.20
  .byte 10 # StringLiteral at 11.20
  .byte 0 # StringLiteral at 11.20
  .word CLASS_String # StringLiteral at 11.20
  .word 7 # StringLiteral at 11.20
  .word -23 # StringLiteral at 11.20
strLit_18: # StringLiteral at 11.20
.text
.globl main
main:
    jal vm_init
...
# begin: BreakTarget at 7.5; stackHeight = 16
    j while_cond_17
  while_top_17:
# begin: Block at 7.19; stackHeight = 16
...
# begin: StringLiteral at 8.22; stackHeight = 20
    la $t0, strLit_11
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 8.22; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
...
# begin: Break at 9.7; stackHeight = 16
    j break_target_17
# end: Break at 9.7; stackHeight = 16
# end: Block at 7.19; stackHeight = 16
  while_cond_17:
# begin: GreaterThan at 7.14; stackHeight = 16
# begin: IdentifierExp at 7.12; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.12; stackHeight = 24
# begin: IdentifierExp at 7.16; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.16; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 7.14; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_17
  break_target_17:
