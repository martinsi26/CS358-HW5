...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 72 # StringLiteral at 8.23
  .byte 105 # StringLiteral at 8.23
  .byte 116 # StringLiteral at 8.23
  .byte 32 # StringLiteral at 8.23
  .byte 100 # StringLiteral at 8.23
  .byte 101 # StringLiteral at 8.23
  .byte 102 # StringLiteral at 8.23
  .byte 97 # StringLiteral at 8.23
  .byte 117 # StringLiteral at 8.23
  .byte 108 # StringLiteral at 8.23
  .byte 116 # StringLiteral at 8.23
  .byte 32 # StringLiteral at 8.23
  .byte 99 # StringLiteral at 8.23
  .byte 97 # StringLiteral at 8.23
  ...
  .word 6 # StringLiteral at 8.23
  .word -17 # StringLiteral at 8.23
strLit_24: # StringLiteral at 8.23
  .byte 68 # StringLiteral at 12.22
  .byte 111 # StringLiteral at 12.22
  .byte 110 # StringLiteral at 12.22
  .byte 101 # StringLiteral at 12.22
  .byte 32 # StringLiteral at 12.22
  .byte 119 # StringLiteral at 12.22
  .byte 105 # StringLiteral at 12.22
  .byte 116 # StringLiteral at 12.22
  .byte 104 # StringLiteral at 12.22
  .byte 32 # StringLiteral at 12.22
  .byte 84 # StringLiteral at 12.22
  .byte 101 # StringLiteral at 12.22
  ...
  .word -17 # StringLiteral at 12.22
strLit_34: # StringLiteral at 12.22
.text
.globl main
main:
    jal vm_init
...
# begin: Times at 6.13; stackHeight = 8
...
# end: IntegerLiteral at 6.14; stackHeight = 24
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 6.13; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    li $t1, 15
...
# begin: Default at 7.13; stackHeight = 8
  case_label_17:
# end: Default at 7.13; stackHeight = 8
# begin: Case at 7.22; stackHeight = 8
  case_label_19:
# end: Case at 7.22; stackHeight = 8
# begin: Case at 7.31; stackHeight = 8
  case_label_21:
# end: Case at 7.31; stackHeight = 8
# begin: Case at 7.40; stackHeight = 8
  case_label_23:
# end: Case at 7.40; stackHeight = 8
...
# begin: CallStatement at 12.13; stackHeight = 0
# begin: Call at 12.13; stackHeight = 0
# begin: Super at 12.13; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.13; stackHeight = 4
# begin: StringLiteral at 12.22; stackHeight = 4
    la $t0, strLit_34
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.22; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.13; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.13; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
