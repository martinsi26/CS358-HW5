...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 68 # StringLiteral at 9.22
  .byte 111 # StringLiteral at 9.22
  .byte 110 # StringLiteral at 9.22
  .byte 101 # StringLiteral at 9.22
  .byte 32 # StringLiteral at 9.22
  .byte 119 # StringLiteral at 9.22
  .byte 105 # StringLiteral at 9.22
  .byte 116 # StringLiteral at 9.22
  .byte 104 # StringLiteral at 9.22
  .byte 32 # StringLiteral at 9.22
  .byte 84 # StringLiteral at 9.22
  .byte 101 # StringLiteral at 9.22
  .byte 115 # StringLiteral at 9.22
  .byte 116 # StringLiteral at 9.22
  .byte 32 # StringLiteral at 9.22
  .byte 48 # StringLiteral at 9.22
  ...
  .word -17 # StringLiteral at 9.22
strLit_20: # StringLiteral at 9.22
.text
.globl main
main:
    jal vm_init
...
# end: LessThan at 5.25; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_18
  break_target_18:
# end: BreakTarget at 5.7; stackHeight = 8
    addu $sp, $sp, 8
# end: Block at 5.7; stackHeight = 0
# begin: CallStatement at 9.13; stackHeight = 0
# begin: Call at 9.13; stackHeight = 0
# begin: Super at 9.13; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.13; stackHeight = 4
# begin: StringLiteral at 9.22; stackHeight = 4
    la $t0, strLit_20
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.22; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.13; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.13; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
