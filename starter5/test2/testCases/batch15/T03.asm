...
strLit_21: # StringLiteral at 8.23
  .byte 67 # StringLiteral at 11.23
  .byte 97 # StringLiteral at 11.23
  .byte 115 # StringLiteral at 11.23
  .byte 101 # StringLiteral at 11.23
  .byte 32 # StringLiteral at 11.23
  .byte 50 # StringLiteral at 11.23
  .byte 10 # StringLiteral at 11.23
  .byte 0 # StringLiteral at 11.23
  .word CLASS_String # StringLiteral at 11.23
  .word 3 # StringLiteral at 11.23
  .word -7 # StringLiteral at 11.23
strLit_32: # StringLiteral at 11.23
  .byte 68 # StringLiteral at 14.23
  .byte 101 # StringLiteral at 14.23
  .byte 102 # StringLiteral at 14.23
  .byte 97 # StringLiteral at 14.23
  .byte 117 # StringLiteral at 14.23
  .byte 108 # StringLiteral at 14.23
  .byte 116 # StringLiteral at 14.23
  .byte 32 # StringLiteral at 14.23
  .byte 99 # StringLiteral at 14.23
  .byte 97 # StringLiteral at 14.23
  .byte 115 # StringLiteral at 14.23
  .byte 101 # StringLiteral at 14.23
  .byte 10 # StringLiteral at 14.23
  .byte 0 # StringLiteral at 14.23
  .byte 0 # StringLiteral at 14.23
  .byte 0 # StringLiteral at 14.23
  .word CLASS_String # StringLiteral at 14.23
  .word 5 # StringLiteral at 14.23
  .word -13 # StringLiteral at 14.23
strLit_44: # StringLiteral at 14.23
  .byte 68 # StringLiteral at 18.22
  .byte 111 # StringLiteral at 18.22
  .byte 110 # StringLiteral at 18.22
  .byte 101 # StringLiteral at 18.22
  .byte 32 # StringLiteral at 18.22
  .byte 119 # StringLiteral at 18.22
  .byte 105 # StringLiteral at 18.22
  .byte 116 # StringLiteral at 18.22
  .byte 104 # StringLiteral at 18.22
  .byte 32 # StringLiteral at 18.22
  .byte 84 # StringLiteral at 18.22
  .byte 101 # StringLiteral at 18.22
  .byte 115 # StringLiteral at 18.22
  .byte 116 # StringLiteral at 18.22
  .byte 32 # StringLiteral at 18.22
  .byte 51 # StringLiteral at 18.22
  .byte 10 # StringLiteral at 18.22
  .byte 0 # StringLiteral at 18.22
  .byte 0 # StringLiteral at 18.22
  .byte 0 # StringLiteral at 18.22
  .word CLASS_String # StringLiteral at 18.22
  .word 6 # StringLiteral at 18.22
  .word -17 # StringLiteral at 18.22
strLit_54: # StringLiteral at 18.22
.text
.globl main
main:
    jal vm_init
...
# begin: Minus at 5.20; stackHeight = 0
...
# begin: IntegerLiteral at 5.21; stackHeight = 8
    li $t0, 20
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.21; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 5.20; stackHeight = 8
    lw $zero, ($sp) #**"i"
...
# begin: Block at 5.38; stackHeight = 8
...
# end: IdentifierExp at 6.12; stackHeight = 16
    ...
    li $t1, 17
    beq $t0, $t1, case_label_39
    li $t1, -2
    beq $t0, $t1, case_label_43
    j case_label_37
# begin: Case at 7.4; stackHeight = 8
  case_label_16:
# end: Case at 7.4; stackHeight = 8
# begin: Case at 7.13; stackHeight = 8
  case_label_20:
# end: Case at 7.13; stackHeight = 8
...
# begin: Case at 10.13; stackHeight = 8
  case_label_31:
# end: Case at 10.13; stackHeight = 8
# begin: CallStatement at 11.14; stackHeight = 8
# begin: Call at 11.14; stackHeight = 8
# begin: Super at 11.14; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 11.14; stackHeight = 12
# begin: StringLiteral at 11.23; stackHeight = 12
    la $t0, strLit_32
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 11.23; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.14; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 11.14; stackHeight = 8
# begin: Break at 12.8; stackHeight = 8
    j break_target_49
# end: Break at 12.8; stackHeight = 8
# begin: Default at 13.4; stackHeight = 8
  case_label_37:
# end: Default at 13.4; stackHeight = 8
# begin: Case at 13.13; stackHeight = 8
  case_label_39:
# end: Case at 13.13; stackHeight = 8
# begin: Case at 13.22; stackHeight = 8
  case_label_43:
# end: Case at 13.22; stackHeight = 8
# begin: CallStatement at 14.14; stackHeight = 8
# begin: Call at 14.14; stackHeight = 8
# begin: Super at 14.14; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 14.14; stackHeight = 12
# begin: StringLiteral at 14.23; stackHeight = 12
    la $t0, strLit_44
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 14.23; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.14; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.14; stackHeight = 8
# begin: Break at 15.8; stackHeight = 8
    j break_target_49
# end: Break at 15.8; stackHeight = 8
  break_target_49:
# end: Switch at 6.4; stackHeight = 8
# end: Block at 5.38; stackHeight = 8
# begin: Assign at 5.33; stackHeight = 8
# begin: Plus at 5.34; stackHeight = 8
# begin: IdentifierExp at 5.33; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 5.33; stackHeight = 16
# begin: IntegerLiteral at 5.34; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.34; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 5.34; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 5.33; stackHeight = 8
# end: Block at 5.7; stackHeight = 8
  while_cond_52:
# begin: LessThan at 5.27; stackHeight = 8
# begin: IdentifierExp at 5.25; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 5.25; stackHeight = 16
# begin: IntegerLiteral at 5.29; stackHeight = 16
    li $t0, 20
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.29; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 5.27; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_52
  break_target_52:
# end: BreakTarget at 5.7; stackHeight = 8
    addu $sp, $sp, 8
# end: Block at 5.7; stackHeight = 0
# begin: CallStatement at 18.13; stackHeight = 0
# begin: Call at 18.13; stackHeight = 0
# begin: Super at 18.13; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 18.13; stackHeight = 4
# begin: StringLiteral at 18.22; stackHeight = 4
    la $t0, strLit_54
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 18.22; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 18.13; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 18.13; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
