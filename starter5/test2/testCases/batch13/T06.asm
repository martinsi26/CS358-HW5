...
strLit_58: # StringLiteral at 23.17
.text
.globl main
main:
    jal vm_init
...
# begin: If at 9.6; stackHeight = 16
# begin: GreaterThan at 9.12; stackHeight = 16
# begin: IntegerLiteral at 9.10; stackHeight = 16
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.10; stackHeight = 24
# begin: IntegerLiteral at 9.14; stackHeight = 24
    li $t0, 10
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.14; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 9.12; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_31
# begin: Block at 9.18; stackHeight = 16
# begin: Assign at 10.7; stackHeight = 16
# begin: Plus at 10.13; stackHeight = 16
# begin: IdentifierExp at 10.9; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.9; stackHeight = 24
# begin: IntegerLiteral at 10.15; stackHeight = 24
    li $t0, 23
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.15; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 10.13; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 10.7; stackHeight = 16
# end: Block at 9.18; stackHeight = 16
    j if_done_31
  if_else_31:
# begin: Block at 12.11; stackHeight = 16
# begin: Assign at 13.7; stackHeight = 16
# begin: Minus at 13.13; stackHeight = 16
# begin: IdentifierExp at 13.9; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.9; stackHeight = 24
# begin: IntegerLiteral at 13.15; stackHeight = 24
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.15; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
...
# end: Minus at 13.13; stackHeight = 24
    ...
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 13.7; stackHeight = 16
# end: Block at 12.11; stackHeight = 16
  if_done_31:
# end: If at 9.6; stackHeight = 16
# begin: If at 15.6; stackHeight = 16
# begin: GreaterThan at 15.12; stackHeight = 16
# begin: IntegerLiteral at 15.10; stackHeight = 16
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.10; stackHeight = 24
# begin: Minus at 15.14; stackHeight = 24
# begin: IntegerLiteral at 15.14; stackHeight = 24
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.14; stackHeight = 32
...
# end: IntegerLiteral at 15.15; stackHeight = 40
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 15.14; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 15.12; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_49
# begin: Block at 15.18; stackHeight = 16
# begin: Assign at 16.7; stackHeight = 16
# begin: Plus at 16.13; stackHeight = 16
# begin: IdentifierExp at 16.9; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.9; stackHeight = 24
# begin: IntegerLiteral at 16.15; stackHeight = 24
    li $t0, 19
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.15; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 16.13; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 16.7; stackHeight = 16
# end: Block at 15.18; stackHeight = 16
    j if_done_49
  if_else_49:
# begin: Block at 18.11; stackHeight = 16
# begin: Assign at 19.7; stackHeight = 16
# begin: Minus at 19.13; stackHeight = 16
# begin: IdentifierExp at 19.9; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.9; stackHeight = 24
# begin: IntegerLiteral at 19.15; stackHeight = 24
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 19.15; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 19.13; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 19.7; stackHeight = 16
# end: Block at 18.11; stackHeight = 16
  if_done_49:
# end: If at 15.6; stackHeight = 16
...
# begin: IdentifierExp at 22.17; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 22.17; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 23.8; stackHeight = 8
# begin: Call at 23.8; stackHeight = 8
# begin: Super at 23.8; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 23.8; stackHeight = 12
# begin: StringLiteral at 23.17; stackHeight = 12
    la $t0, strLit_58
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 23.17; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 23.8; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 23.8; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
