...
# ****** class Vehicle ****** # ClassDecl at 21.7
  .byte 0 # ClassDecl at 21.7
  .byte 214 # 'V' with high bit set # ClassDecl at 21.7
  .byte 101 # 'e' # ClassDecl at 21.7
  .byte 104 # 'h' # ClassDecl at 21.7
  .byte 105 # 'i' # ClassDecl at 21.7
  .byte 99 # 'c' # ClassDecl at 21.7
  .byte 108 # 'l' # ClassDecl at 21.7
  .byte 101 # 'e' # ClassDecl at 21.7
CLASS_Vehicle: # ClassDecl at 21.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Vehicle_price # MethodDeclNonVoid at 22.16
# ****** class Car ****** # ClassDecl at 26.7
  .byte 0 # ClassDecl at 26.7
  .byte 195 # 'C' with high bit set # ClassDecl at 26.7
  .byte 97 # 'a' # ClassDecl at 26.7
  .byte 114 # 'r' # ClassDecl at 26.7
CLASS_Car: # ClassDecl at 26.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Car_price # MethodDeclNonVoid at 27.16
# ****** class Honda ****** # ClassDecl at 31.7
  .byte 0 # ClassDecl at 31.7
  .byte 0 # ClassDecl at 31.7
  .byte 0 # ClassDecl at 31.7
  .byte 200 # 'H' with high bit set # ClassDecl at 31.7
  .byte 111 # 'o' # ClassDecl at 31.7
  .byte 110 # 'n' # ClassDecl at 31.7
  .byte 100 # 'd' # ClassDecl at 31.7
  .byte 97 # 'a' # ClassDecl at 31.7
CLASS_Honda: # ClassDecl at 31.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Car_price # MethodDeclNonVoid at 27.16
END_CLASS_Honda: # ClassDecl at 31.7
END_CLASS_Car: # ClassDecl at 26.7
END_CLASS_Vehicle: # ClassDecl at 21.7
...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 10 # StringLiteral at 17.17
  .byte 0 # StringLiteral at 17.17
  .byte 0 # StringLiteral at 17.17
  .byte 0 # StringLiteral at 17.17
  .word CLASS_String # StringLiteral at 17.17
  .word 2 # StringLiteral at 17.17
  .word -1 # StringLiteral at 17.17
strLit_57: # StringLiteral at 17.17
.text
.globl main
main:
    jal vm_init
...
# begin: LocalVarDecl at 6.6; stackHeight = 4
# begin: NewObject at 6.10; stackHeight = 4
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Car
    sw $t0, -12($s7)
# end: NewObject at 6.10; stackHeight = 8
    lw $zero, ($sp) #**"c"
# end: LocalVarDecl at 6.6; stackHeight = 8
# begin: LocalVarDecl at 7.8; stackHeight = 8
# begin: NewObject at 7.12; stackHeight = 8
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Honda
    sw $t0, -12($s7)
# end: NewObject at 7.12; stackHeight = 12
    lw $zero, ($sp) #**"h"
# end: LocalVarDecl at 7.8; stackHeight = 12
# begin: LocalVarDecl at 8.6; stackHeight = 12
# begin: IntegerLiteral at 8.12; stackHeight = 12
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.12; stackHeight = 20
    lw $zero, ($sp) #**"sum"
# end: LocalVarDecl at 8.6; stackHeight = 20
# begin: Block at 11.2; stackHeight = 20
# begin: LocalVarDecl at 11.11; stackHeight = 20
# begin: IntegerLiteral at 11.15; stackHeight = 20
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.15; stackHeight = 28
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 11.11; stackHeight = 28
# begin: BreakTarget at 11.2; stackHeight = 28
    j while_cond_51
  while_top_51:
# begin: Block at 11.2; stackHeight = 28
# begin: Block at 11.33; stackHeight = 28
# begin: Assign at 12.10; stackHeight = 28
# begin: Plus at 12.16; stackHeight = 28
# begin: IdentifierExp at 12.12; stackHeight = 28
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.12; stackHeight = 36
# begin: Call at 12.20; stackHeight = 36
# begin: IdentifierExp at 12.18; stackHeight = 36
    lw $t0, 32($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.18; stackHeight = 40
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 12.20; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 12.16; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 12.10; stackHeight = 28
# begin: Assign at 13.10; stackHeight = 28
# begin: Plus at 13.16; stackHeight = 28
# begin: IdentifierExp at 13.12; stackHeight = 28
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.12; stackHeight = 36
# begin: Call at 13.20; stackHeight = 36
# begin: IdentifierExp at 13.18; stackHeight = 36
    lw $t0, 28($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.18; stackHeight = 40
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 13.20; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 13.16; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 13.10; stackHeight = 28
# begin: Assign at 14.10; stackHeight = 28
# begin: Plus at 14.16; stackHeight = 28
# begin: IdentifierExp at 14.12; stackHeight = 28
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.12; stackHeight = 36
# begin: Call at 14.20; stackHeight = 36
...
# end: IdentifierExp at 14.18; stackHeight = 40
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 14.20; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 14.16; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 14.10; stackHeight = 28
# end: Block at 11.33; stackHeight = 28
# begin: Assign at 11.28; stackHeight = 28
# begin: Plus at 11.29; stackHeight = 28
# begin: IdentifierExp at 11.28; stackHeight = 28
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.28; stackHeight = 36
# begin: IntegerLiteral at 11.29; stackHeight = 36
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.29; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 11.29; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 11.28; stackHeight = 28
# end: Block at 11.2; stackHeight = 28
  while_cond_51:
# begin: LessThan at 11.20; stackHeight = 28
# begin: IdentifierExp at 11.18; stackHeight = 28
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.18; stackHeight = 36
# begin: IntegerLiteral at 11.22; stackHeight = 36
    li $t0, 2000
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.22; stackHeight = 44
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 11.20; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_51
  break_target_51:
# end: BreakTarget at 11.2; stackHeight = 28
    addu $sp, $sp, 8
# end: Block at 11.2; stackHeight = 20
# begin: CallStatement at 16.8; stackHeight = 20
# begin: Call at 16.8; stackHeight = 20
# begin: Super at 16.8; stackHeight = 20
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 16.8; stackHeight = 24
# begin: IdentifierExp at 16.17; stackHeight = 24
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.17; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 16.8; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 16.8; stackHeight = 20
# begin: CallStatement at 17.8; stackHeight = 20
# begin: Call at 17.8; stackHeight = 20
# begin: Super at 17.8; stackHeight = 20
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 17.8; stackHeight = 24
# begin: StringLiteral at 17.17; stackHeight = 24
    la $t0, strLit_57
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 17.17; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 17.8; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 17.8; stackHeight = 20
    addu $sp, $sp, 20
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Vehicle_price:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:price"
# begin: IntegerLiteral at 23.9; stackHeight = 0
    li $t0, 1234
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 23.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
