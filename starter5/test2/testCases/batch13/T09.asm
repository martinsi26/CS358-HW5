...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 10 # StringLiteral at 47.17
  .byte 0 # StringLiteral at 47.17
  .byte 0 # StringLiteral at 47.17
  .byte 0 # StringLiteral at 47.17
  .word CLASS_String # StringLiteral at 47.17
  .word 2 # StringLiteral at 47.17
  .word -1 # StringLiteral at 47.17
strLit_209: # StringLiteral at 47.17
.text
.globl main
main:
    jal vm_init
...
# begin: IntegerLiteral at 5.12; stackHeight = 0
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.12; stackHeight = 8
    lw $zero, ($sp) #**"sum"
# end: LocalVarDecl at 5.6; stackHeight = 8
# begin: Block at 8.2; stackHeight = 8
# begin: LocalVarDecl at 8.11; stackHeight = 8
# begin: IntegerLiteral at 8.15; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.15; stackHeight = 16
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 8.11; stackHeight = 16
# begin: BreakTarget at 8.2; stackHeight = 16
    j while_cond_203
  while_top_203:
# begin: Block at 8.2; stackHeight = 16
# begin: Block at 8.33; stackHeight = 16
# begin: Switch at 9.6; stackHeight = 16
# begin: Times at 9.15; stackHeight = 16
# begin: IdentifierExp at 9.14; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.14; stackHeight = 24
# begin: IntegerLiteral at 9.16; stackHeight = 24
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.16; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 9.15; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    li $t1, 9
    beq $t0, $t1, case_label_22
    li $t1, 12
    beq $t0, $t1, case_label_32
    li $t1, 15
    beq $t0, $t1, case_label_42
    li $t1, 18
    beq $t0, $t1, case_label_46
    li $t1, 21
    beq $t0, $t1, case_label_50
    li $t1, 276
    beq $t0, $t1, case_label_54
    li $t1, 252
    beq $t0, $t1, case_label_58
    li $t1, 228
    beq $t0, $t1, case_label_62
    li $t1, 71
    beq $t0, $t1, case_label_64
    li $t1, 297
    beq $t0, $t1, case_label_68
    li $t1, 261
    beq $t0, $t1, case_label_72
    li $t1, 33
    beq $t0, $t1, case_label_84
    li $t1, 28
    beq $t0, $t1, case_label_86
    li $t1, 1
    beq $t0, $t1, case_label_88
    li $t1, 159
    beq $t0, $t1, case_label_92
    li $t1, 78
    beq $t0, $t1, case_label_102
    li $t1, 273
    beq $t0, $t1, case_label_106
    li $t1, 81
    beq $t0, $t1, case_label_116
    li $t1, 144
    beq $t0, $t1, case_label_120
    li $t1, 294
    beq $t0, $t1, case_label_124
    li $t1, 57
    beq $t0, $t1, case_label_135
    li $t1, 225
    beq $t0, $t1, case_label_139
    li $t1, 48
    beq $t0, $t1, case_label_143
    li $t1, 255
    beq $t0, $t1, case_label_153
    li $t1, 0
    beq $t0, $t1, case_label_157
    li $t1, 3
    beq $t0, $t1, case_label_161
    li $t1, 6
    beq $t0, $t1, case_label_165
    li $t1, 24
    beq $t0, $t1, case_label_169
    li $t1, 22
    beq $t0, $t1, case_label_177
    li $t1, 27
    beq $t0, $t1, case_label_181
    li $t1, 264
    beq $t0, $t1, case_label_185
    li $t1, 72
    beq $t0, $t1, case_label_189
    li $t1, 219
    beq $t0, $t1, case_label_193
    j case_label_125
# begin: Case at 10.6; stackHeight = 16
  case_label_22:
# end: Case at 10.6; stackHeight = 16
# begin: Assign at 10.20; stackHeight = 16
# begin: Minus at 10.26; stackHeight = 16
# begin: IdentifierExp at 10.22; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.22; stackHeight = 24
# begin: IntegerLiteral at 10.28; stackHeight = 24
    li $t0, 23
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.28; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 10.26; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 10.20; stackHeight = 16
# begin: Break at 10.32; stackHeight = 16
    j break_target_200
# end: Break at 10.32; stackHeight = 16
# begin: Case at 11.6; stackHeight = 16
  case_label_32:
# end: Case at 11.6; stackHeight = 16
# begin: Assign at 11.20; stackHeight = 16
# begin: Times at 11.26; stackHeight = 16
# begin: IdentifierExp at 11.22; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.22; stackHeight = 24
# begin: IntegerLiteral at 11.28; stackHeight = 24
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.28; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 11.26; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 11.20; stackHeight = 16
# begin: Break at 11.31; stackHeight = 16
    j break_target_200
# end: Break at 11.31; stackHeight = 16
# begin: Case at 12.6; stackHeight = 16
  case_label_42:
# end: Case at 12.6; stackHeight = 16
# begin: Case at 13.6; stackHeight = 16
  case_label_46:
# end: Case at 13.6; stackHeight = 16
# begin: Case at 14.6; stackHeight = 16
  case_label_50:
# end: Case at 14.6; stackHeight = 16
# begin: Case at 15.6; stackHeight = 16
  case_label_54:
# end: Case at 15.6; stackHeight = 16
# begin: Case at 16.6; stackHeight = 16
  case_label_58:
# end: Case at 16.6; stackHeight = 16
# begin: Case at 17.6; stackHeight = 16
  case_label_62:
# end: Case at 17.6; stackHeight = 16
# begin: Case at 18.6; stackHeight = 16
  case_label_64:
# end: Case at 18.6; stackHeight = 16
# begin: Case at 19.6; stackHeight = 16
  case_label_68:
# end: Case at 19.6; stackHeight = 16
# begin: Case at 20.6; stackHeight = 16
  case_label_72:
# end: Case at 20.6; stackHeight = 16
# begin: Assign at 20.21; stackHeight = 16
# begin: Plus at 20.27; stackHeight = 16
# begin: IdentifierExp at 20.23; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 20.23; stackHeight = 24
# begin: Remainder at 20.32; stackHeight = 24
# begin: IdentifierExp at 20.30; stackHeight = 24
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 20.30; stackHeight = 32
# begin: IntegerLiteral at 20.34; stackHeight = 32
    li $t0, 67
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 20.34; stackHeight = 40
    jal remainder
# end: Remainder at 20.32; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 20.27; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 20.21; stackHeight = 16
# begin: Break at 20.39; stackHeight = 16
    j break_target_200
# end: Break at 20.39; stackHeight = 16
# begin: Case at 21.6; stackHeight = 16
  case_label_84:
# end: Case at 21.6; stackHeight = 16
# begin: Case at 22.6; stackHeight = 16
  case_label_86:
# end: Case at 22.6; stackHeight = 16
# begin: Case at 23.6; stackHeight = 16
  case_label_88:
# end: Case at 23.6; stackHeight = 16
# begin: Case at 24.6; stackHeight = 16
  case_label_92:
# end: Case at 24.6; stackHeight = 16
# begin: Assign at 24.21; stackHeight = 16
# begin: Times at 24.27; stackHeight = 16
# begin: IdentifierExp at 24.23; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 24.23; stackHeight = 24
# begin: IntegerLiteral at 24.29; stackHeight = 24
    li $t0, 2
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 24.29; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 24.27; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 24.21; stackHeight = 16
# begin: Break at 24.32; stackHeight = 16
    j break_target_200
# end: Break at 24.32; stackHeight = 16
# begin: Case at 25.6; stackHeight = 16
  case_label_102:
# end: Case at 25.6; stackHeight = 16
# begin: Case at 26.6; stackHeight = 16
  case_label_106:
# end: Case at 26.6; stackHeight = 16
# begin: Assign at 26.21; stackHeight = 16
# begin: Divide at 26.27; stackHeight = 16
...
# begin: IntegerLiteral at 26.29; stackHeight = 24
    li $t0, 13
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 26.29; stackHeight = 32
    jal divide
# end: Divide at 26.27; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 26.21; stackHeight = 16
# begin: Break at 26.33; stackHeight = 16
    j break_target_200
# end: Break at 26.33; stackHeight = 16
# begin: Case at 27.6; stackHeight = 16
  case_label_116:
# end: Case at 27.6; stackHeight = 16
# begin: Case at 28.6; stackHeight = 16
  case_label_120:
# end: Case at 28.6; stackHeight = 16
# begin: Case at 29.6; stackHeight = 16
  case_label_124:
# end: Case at 29.6; stackHeight = 16
# begin: Default at 30.6; stackHeight = 16
  case_label_125:
# end: Default at 30.6; stackHeight = 16
# begin: Assign at 30.15; stackHeight = 16
# begin: Plus at 30.18; stackHeight = 16
# begin: IdentifierExp at 30.15; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 30.15; stackHeight = 24
# begin: IntegerLiteral at 30.18; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 30.18; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 30.18; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 30.15; stackHeight = 16
# begin: Break at 30.22; stackHeight = 16
    j break_target_200
# end: Break at 30.22; stackHeight = 16
# begin: Case at 31.6; stackHeight = 16
  case_label_135:
# end: Case at 31.6; stackHeight = 16
# begin: Case at 32.6; stackHeight = 16
  case_label_139:
# end: Case at 32.6; stackHeight = 16
# begin: Case at 33.6; stackHeight = 16
  case_label_143:
# end: Case at 33.6; stackHeight = 16
# begin: Assign at 33.21; stackHeight = 16
# begin: Times at 33.27; stackHeight = 16
# begin: IdentifierExp at 33.23; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 33.23; stackHeight = 24
# begin: IntegerLiteral at 33.29; stackHeight = 24
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 33.29; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 33.27; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 33.21; stackHeight = 16
# begin: Break at 33.32; stackHeight = 16
    j break_target_200
# end: Break at 33.32; stackHeight = 16
# begin: Case at 34.6; stackHeight = 16
  case_label_153:
# end: Case at 34.6; stackHeight = 16
# begin: Case at 35.6; stackHeight = 16
  case_label_157:
# end: Case at 35.6; stackHeight = 16
# begin: Case at 36.6; stackHeight = 16
  case_label_161:
# end: Case at 36.6; stackHeight = 16
# begin: Case at 37.6; stackHeight = 16
  case_label_165:
# end: Case at 37.6; stackHeight = 16
# begin: Case at 38.6; stackHeight = 16
  case_label_169:
# end: Case at 38.6; stackHeight = 16
# begin: Assign at 38.20; stackHeight = 16
# begin: Times at 38.26; stackHeight = 16
# begin: IdentifierExp at 38.22; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 38.22; stackHeight = 24
# begin: IntegerLiteral at 38.28; stackHeight = 24
    li $t0, 11
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 38.28; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 38.26; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 38.20; stackHeight = 16
# begin: Break at 38.32; stackHeight = 16
    j break_target_200
# end: Break at 38.32; stackHeight = 16
# begin: Case at 39.6; stackHeight = 16
  case_label_177:
# end: Case at 39.6; stackHeight = 16
# begin: Case at 40.6; stackHeight = 16
  case_label_181:
# end: Case at 40.6; stackHeight = 16
# begin: Case at 41.6; stackHeight = 16
  case_label_185:
# end: Case at 41.6; stackHeight = 16
# begin: Case at 42.6; stackHeight = 16
  case_label_189:
# end: Case at 42.6; stackHeight = 16
# begin: Case at 43.6; stackHeight = 16
  case_label_193:
# end: Case at 43.6; stackHeight = 16
# begin: Assign at 43.21; stackHeight = 16
# begin: Times at 43.27; stackHeight = 16
# begin: IdentifierExp at 43.23; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 43.23; stackHeight = 24
# begin: IntegerLiteral at 43.29; stackHeight = 24
    li $t0, 19
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 43.29; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 43.27; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 43.21; stackHeight = 16
# begin: Break at 43.33; stackHeight = 16
    j break_target_200
# end: Break at 43.33; stackHeight = 16
  break_target_200:
# end: Switch at 9.6; stackHeight = 16
# end: Block at 8.33; stackHeight = 16
# begin: Assign at 8.28; stackHeight = 16
# begin: Plus at 8.29; stackHeight = 16
# begin: IdentifierExp at 8.28; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.28; stackHeight = 24
# begin: IntegerLiteral at 8.29; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.29; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 8.29; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 8.28; stackHeight = 16
# end: Block at 8.2; stackHeight = 16
  while_cond_203:
# begin: LessThan at 8.20; stackHeight = 16
# begin: IdentifierExp at 8.18; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.18; stackHeight = 24
# begin: IntegerLiteral at 8.22; stackHeight = 24
    li $t0, 2000
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.22; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 8.20; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_203
  break_target_203:
# end: BreakTarget at 8.2; stackHeight = 16
    addu $sp, $sp, 8
# end: Block at 8.2; stackHeight = 8
# begin: CallStatement at 46.8; stackHeight = 8
# begin: Call at 46.8; stackHeight = 8
# begin: Super at 46.8; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 46.8; stackHeight = 12
# begin: IdentifierExp at 46.17; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 46.17; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 46.8; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 46.8; stackHeight = 8
# begin: CallStatement at 47.8; stackHeight = 8
# begin: Call at 47.8; stackHeight = 8
# begin: Super at 47.8; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 47.8; stackHeight = 12
# begin: StringLiteral at 47.17; stackHeight = 12
    la $t0, strLit_209
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 47.17; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 47.8; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 47.8; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
