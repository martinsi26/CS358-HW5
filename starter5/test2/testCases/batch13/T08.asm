...
strLit_49: # StringLiteral at 17.18
.text
.globl main
main:
    jal vm_init
...
# begin: Block at 8.3; stackHeight = 8
# begin: LocalVarDecl at 8.12; stackHeight = 8
# begin: IntegerLiteral at 8.16; stackHeight = 8
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.16; stackHeight = 16
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 8.12; stackHeight = 16
# begin: BreakTarget at 8.3; stackHeight = 16
    j while_cond_43
  while_top_43:
# begin: Block at 8.3; stackHeight = 16
# begin: Block at 8.34; stackHeight = 16
# begin: LocalVarDecl at 9.8; stackHeight = 16
# begin: IntegerLiteral at 9.12; stackHeight = 16
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.12; stackHeight = 24
    lw $zero, ($sp) #**"z"
# end: LocalVarDecl at 9.8; stackHeight = 24
# begin: BreakTarget at 10.4; stackHeight = 24
    j while_cond_40
  while_top_40:
# begin: Block at 10.18; stackHeight = 24
# begin: Assign at 11.5; stackHeight = 24
# begin: Plus at 11.6; stackHeight = 24
# begin: IdentifierExp at 11.5; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.5; stackHeight = 32
# begin: IntegerLiteral at 11.6; stackHeight = 32
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.6; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 11.6; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 11.5; stackHeight = 24
# begin: If at 12.5; stackHeight = 24
# begin: GreaterThan at 12.11; stackHeight = 24
# begin: IdentifierExp at 12.9; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.9; stackHeight = 32
# begin: IdentifierExp at 12.13; stackHeight = 32
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.13; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 12.11; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_33
# begin: Break at 12.16; stackHeight = 24
    j break_target_40
# end: Break at 12.16; stackHeight = 24
    j if_done_33
  if_else_33:
# begin: Block at 13.5; stackHeight = 24
# end: Block at 13.5; stackHeight = 24
  if_done_33:
# end: If at 12.5; stackHeight = 24
# begin: Assign at 13.9; stackHeight = 24
# begin: Plus at 13.15; stackHeight = 24
...
# begin: IdentifierExp at 13.17; stackHeight = 32
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.17; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 13.15; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 16($sp)
# end: Assign at 13.9; stackHeight = 24
# end: Block at 10.18; stackHeight = 24
  while_cond_40:
# begin: LessThan at 10.13; stackHeight = 24
# begin: IntegerLiteral at 10.11; stackHeight = 24
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.11; stackHeight = 32
# begin: IntegerLiteral at 10.15; stackHeight = 32
    li $t0, 5
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.15; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 10.13; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_40
  break_target_40:
# end: BreakTarget at 10.4; stackHeight = 24
    addu $sp, $sp, 8
# end: Block at 8.34; stackHeight = 16
# begin: Assign at 8.29; stackHeight = 16
# begin: Plus at 8.30; stackHeight = 16
# begin: IdentifierExp at 8.29; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.29; stackHeight = 24
# begin: IntegerLiteral at 8.30; stackHeight = 24
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.30; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 8.30; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 8.29; stackHeight = 16
# end: Block at 8.3; stackHeight = 16
  while_cond_43:
# begin: LessThan at 8.21; stackHeight = 16
# begin: IdentifierExp at 8.19; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.19; stackHeight = 24
# begin: IntegerLiteral at 8.23; stackHeight = 24
    li $t0, 2000
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.23; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 8.21; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_43
  break_target_43:
# end: BreakTarget at 8.3; stackHeight = 16
    addu $sp, $sp, 8
# end: Block at 8.3; stackHeight = 8
# begin: CallStatement at 16.9; stackHeight = 8
# begin: Call at 16.9; stackHeight = 8
# begin: Super at 16.9; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 16.9; stackHeight = 12
# begin: IdentifierExp at 16.18; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.18; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 16.9; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 16.9; stackHeight = 8
# begin: CallStatement at 17.9; stackHeight = 8
# begin: Call at 17.9; stackHeight = 8
# begin: Super at 17.9; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 17.9; stackHeight = 12
# begin: StringLiteral at 17.18; stackHeight = 12
    la $t0, strLit_49
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 17.18; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 17.9; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 17.9; stackHeight = 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
