...
strLit_46: # StringLiteral at 21.17
.text
.globl main
main:
    jal vm_init
...
# begin: LessThan at 9.12; stackHeight = 16
# begin: IdentifierExp at 9.10; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.10; stackHeight = 24
...
# end: IntegerLiteral at 9.14; stackHeight = 32
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 9.12; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_26
# begin: Block at 9.20; stackHeight = 16
...
# end: Block at 9.20; stackHeight = 16
    j if_done_26
  if_else_26:
...
# begin: If at 14.6; stackHeight = 16
# begin: GreaterThan at 14.12; stackHeight = 16
# begin: IdentifierExp at 14.10; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.10; stackHeight = 24
# begin: IntegerLiteral at 14.14; stackHeight = 24
    li $t0, 500
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 14.14; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 14.12; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_37
# begin: Block at 14.19; stackHeight = 16
# end: Block at 14.19; stackHeight = 16
    j if_done_37
  if_else_37:
# begin: Block at 16.11; stackHeight = 16
# begin: Assign at 17.7; stackHeight = 16
# begin: Minus at 17.13; stackHeight = 16
# begin: IdentifierExp at 17.9; stackHeight = 16
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.9; stackHeight = 24
# begin: IntegerLiteral at 17.15; stackHeight = 24
    li $t0, 7
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.15; stackHeight = 32
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 17.13; stackHeight = 24
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 8($sp)
# end: Assign at 17.7; stackHeight = 16
# end: Block at 16.11; stackHeight = 16
  if_done_37:
# end: If at 14.6; stackHeight = 16
...
# begin: IdentifierExp at 20.17; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 20.17; stackHeight = 20
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: StringLiteral at 21.17; stackHeight = 12
    la $t0, strLit_46
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 21.17; stackHeight = 16
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
