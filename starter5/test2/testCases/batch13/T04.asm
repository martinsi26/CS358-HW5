...
# ****** class Vehicle ****** # ClassDecl at 9.7
  .byte 0 # ClassDecl at 9.7
  .byte 214 # 'V' with high bit set # ClassDecl at 9.7
  .byte 101 # 'e' # ClassDecl at 9.7
  .byte 104 # 'h' # ClassDecl at 9.7
  .byte 105 # 'i' # ClassDecl at 9.7
  .byte 99 # 'c' # ClassDecl at 9.7
  .byte 108 # 'l' # ClassDecl at 9.7
  .byte 101 # 'e' # ClassDecl at 9.7
CLASS_Vehicle: # ClassDecl at 9.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Vehicle_main # MethodDeclVoid at 10.14
  .word mth_Vehicle_price # MethodDeclNonVoid at 27.13
END_CLASS_Vehicle: # ClassDecl at 9.7
...
dataArrayVTableStart: # IntegerType at 0.0
  .byte 0 # ArrayType at 13.19
  .byte 0 # ArrayType at 13.19
  .byte 219 # '[' with high bit set # ArrayType at 13.19
  .byte 73 # 'I' # ArrayType at 13.19
CLASS_ARRAY_INT: # ArrayType at 13.19
  .word mth_Object_hashCode # ArrayType at 13.19
  .word mth_Object_equals # ArrayType at 13.19
  .word mth_Object_toString # ArrayType at 13.19
END_CLASS_ARRAY_INT: # ArrayType at 13.19
...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 83 # StringLiteral at 17.16
  .byte 116 # StringLiteral at 17.16
  .byte 114 # StringLiteral at 17.16
  .byte 105 # StringLiteral at 17.16
  .byte 110 # StringLiteral at 17.16
  .byte 103 # StringLiteral at 17.16
  .byte 45 # StringLiteral at 17.16
  .byte 108 # StringLiteral at 17.16
  .byte 105 # StringLiteral at 17.16
  .byte 116 # StringLiteral at 17.16
  .byte 0 # StringLiteral at 17.16
  .byte 0 # StringLiteral at 17.16
  .word CLASS_String # StringLiteral at 17.16
  .word 4 # StringLiteral at 17.16
  .word -10 # StringLiteral at 17.16
strLit_35: # StringLiteral at 17.16
...
strLit_67: # StringLiteral at 23.18
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 5.20; stackHeight = 0
# begin: Call at 5.20; stackHeight = 0
# begin: NewObject at 5.6; stackHeight = 0
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Vehicle
    sw $t0, -12($s7)
# end: NewObject at 5.6; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 5.20; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 5.20; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Vehicle_main
mth_Vehicle_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: LocalVarDecl at 11.7; stackHeight = 0
# begin: IntegerLiteral at 11.13; stackHeight = 0
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.13; stackHeight = 8
    lw $zero, ($sp) #**"sum"
# end: LocalVarDecl at 11.7; stackHeight = 8
# begin: LocalVarDecl at 12.11; stackHeight = 8
# begin: True at 12.15; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: True at 12.15; stackHeight = 12
    lw $zero, ($sp) #**"b"
# end: LocalVarDecl at 12.11; stackHeight = 12
# begin: LocalVarDecl at 13.9; stackHeight = 12
# begin: NewArray at 13.19; stackHeight = 12
# begin: IntegerLiteral at 13.27; stackHeight = 12
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.27; stackHeight = 20
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    ...
    sw $t0, -12($s7)
# end: NewArray at 13.19; stackHeight = 16
    lw $zero, ($sp) #**"myArray"
# end: LocalVarDecl at 13.9; stackHeight = 16
# begin: Block at 16.3; stackHeight = 16
# begin: LocalVarDecl at 16.12; stackHeight = 16
# begin: IntegerLiteral at 16.16; stackHeight = 16
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.16; stackHeight = 24
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 16.12; stackHeight = 24
# begin: BreakTarget at 16.3; stackHeight = 24
    j while_cond_61
  while_top_61:
# begin: Block at 16.3; stackHeight = 24
# begin: Block at 16.34; stackHeight = 24
# begin: Assign at 17.8; stackHeight = 24
# begin: Plus at 17.14; stackHeight = 24
# begin: IdentifierExp at 17.10; stackHeight = 24
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.10; stackHeight = 32
# begin: Call at 17.29; stackHeight = 32
# begin: StringLiteral at 17.16; stackHeight = 32
    la $t0, strLit_35
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 17.16; stackHeight = 36
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 17.29; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 17.14; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 16($sp)
# end: Assign at 17.8; stackHeight = 24
# begin: Assign at 18.8; stackHeight = 24
# begin: Plus at 18.14; stackHeight = 24
# begin: IdentifierExp at 18.10; stackHeight = 24
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 18.10; stackHeight = 32
# begin: Call at 18.30; stackHeight = 32
# begin: NewObject at 18.16; stackHeight = 32
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Vehicle
    sw $t0, -12($s7)
# end: NewObject at 18.16; stackHeight = 36
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 18.30; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 18.14; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 16($sp)
# end: Assign at 18.8; stackHeight = 24
# begin: Assign at 19.8; stackHeight = 24
# begin: Plus at 19.14; stackHeight = 24
# begin: IdentifierExp at 19.10; stackHeight = 24
    lw $t0, 16($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.10; stackHeight = 32
# begin: Call at 19.21; stackHeight = 32
# begin: This at 19.16; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 19.16; stackHeight = 36
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 19.21; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 19.14; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 16($sp)
# end: Assign at 19.8; stackHeight = 24
# begin: Assign at 20.6; stackHeight = 24
# begin: Call at 20.19; stackHeight = 24
# begin: NewArray at 20.8; stackHeight = 24
# begin: IntegerLiteral at 20.16; stackHeight = 24
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 20.16; stackHeight = 32
    lw $s7, ($sp)
    addu $sp, $sp, 8
    li $s6, 1
    jal newObject
    la $t0, CLASS_ARRAY_INT
    sw $t0, -12($s7)
# end: NewArray at 20.8; stackHeight = 28
# begin: IdentifierExp at 20.26; stackHeight = 28
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 20.26; stackHeight = 32
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.19; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 12($sp)
# end: Assign at 20.6; stackHeight = 24
# end: Block at 16.34; stackHeight = 24
# begin: Assign at 16.29; stackHeight = 24
# begin: Plus at 16.30; stackHeight = 24
# begin: IdentifierExp at 16.29; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.29; stackHeight = 32
# begin: IntegerLiteral at 16.30; stackHeight = 32
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.30; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 16.30; stackHeight = 32
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 16.29; stackHeight = 24
# end: Block at 16.3; stackHeight = 24
  while_cond_61:
# begin: LessThan at 16.21; stackHeight = 24
# begin: IdentifierExp at 16.19; stackHeight = 24
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 16.19; stackHeight = 32
# begin: IntegerLiteral at 16.23; stackHeight = 32
    li $t0, 2000
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.23; stackHeight = 40
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 16.21; stackHeight = 28
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_61
  break_target_61:
# end: BreakTarget at 16.3; stackHeight = 24
    addu $sp, $sp, 8
# end: Block at 16.3; stackHeight = 16
# begin: CallStatement at 22.9; stackHeight = 16
# begin: Call at 22.9; stackHeight = 16
# begin: Super at 22.9; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.9; stackHeight = 20
# begin: IdentifierExp at 22.18; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 22.18; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.9; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.9; stackHeight = 16
# begin: CallStatement at 23.9; stackHeight = 16
# begin: Call at 23.9; stackHeight = 16
# begin: Super at 23.9; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 23.9; stackHeight = 20
# begin: StringLiteral at 23.18; stackHeight = 20
    la $t0, strLit_67
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 23.18; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 23.9; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 23.9; stackHeight = 16
# begin: CallStatement at 24.9; stackHeight = 16
# begin: Call at 24.9; stackHeight = 16
# begin: Super at 24.9; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 24.9; stackHeight = 20
# begin: IdentifierExp at 24.19; stackHeight = 20
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 24.19; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 24.9; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 24.9; stackHeight = 16
# begin: CallStatement at 25.9; stackHeight = 16
# begin: Call at 25.9; stackHeight = 16
# begin: Super at 25.9; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 25.9; stackHeight = 20
# begin: StringLiteral at 25.18; stackHeight = 20
    la $t0, strLit_67
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 25.18; stackHeight = 24
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 25.9; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 25.9; stackHeight = 16
    addu $sp, $sp, 16
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Vehicle_price:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:price"
# begin: IntegerLiteral at 28.10; stackHeight = 0
    li $t0, 1234
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 28.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
