...
CLASS_Vehicle: # ClassDecl at 9.7
  ...
  .word mth_Lib_intToString # MethodDeclNonVoid at 0.0
  .word mth_Lib_intToChar # MethodDeclNonVoid at 0.0
  .word mth_Vehicle_main # MethodDeclVoid at 11.14
...
# field Vehicle.myVal offset = -16: InstVarDecl at 10.6
...
strLit_43: # StringLiteral at 20.18
.text
.globl main
main:
    jal vm_init
...
mth_Main_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: CallStatement at 5.17; stackHeight = 0
# begin: Call at 5.17; stackHeight = 0
# begin: NewObject at 5.3; stackHeight = 0
    li $s6, 2
    li $s7, 0
    jal newObject
    la $t0, CLASS_Vehicle
    sw $t0, -12($s7)
# end: NewObject at 5.3; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 5.17; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 5.17; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Vehicle_main:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:main"
# begin: Assign at 12.9; stackHeight = 0
# begin: IntegerLiteral at 12.11; stackHeight = 0
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 12.9; stackHeight = 0
# begin: Block at 15.3; stackHeight = 0
# begin: LocalVarDecl at 15.12; stackHeight = 0
# begin: IntegerLiteral at 15.16; stackHeight = 0
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.16; stackHeight = 8
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 15.12; stackHeight = 8
# begin: BreakTarget at 15.3; stackHeight = 8
    j while_cond_37
  while_top_37:
# begin: Block at 15.3; stackHeight = 8
# begin: Block at 15.34; stackHeight = 8
# begin: Assign at 16.10; stackHeight = 8
# begin: Plus at 16.23; stackHeight = 8
# begin: InstVarAccess at 16.16; stackHeight = 8
# begin: This at 16.12; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 16.12; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: InstVarAccess at 16.16; stackHeight = 16
# begin: IntegerLiteral at 16.25; stackHeight = 16
    li $t0, 13
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 16.25; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 16.23; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 16.10; stackHeight = 8
# begin: Assign at 17.15; stackHeight = 8
# begin: Minus at 17.23; stackHeight = 8
# begin: IdentifierExp at 17.17; stackHeight = 8
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 17.17; stackHeight = 16
# begin: IntegerLiteral at 17.25; stackHeight = 16
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 17.25; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 17.23; stackHeight = 16
# begin: This at 17.4; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 17.4; stackHeight = 20
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 17.15; stackHeight = 8
# end: Block at 15.34; stackHeight = 8
# begin: Assign at 15.29; stackHeight = 8
# begin: Plus at 15.30; stackHeight = 8
# begin: IdentifierExp at 15.29; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 15.29; stackHeight = 16
# begin: IntegerLiteral at 15.30; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.30; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 15.30; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 15.29; stackHeight = 8
# end: Block at 15.3; stackHeight = 8
  while_cond_37:
# begin: LessThan at 15.21; stackHeight = 8
# begin: IdentifierExp at 15.19; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 15.19; stackHeight = 16
# begin: IntegerLiteral at 15.23; stackHeight = 16
    li $t0, 2000
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.23; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 15.21; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_37
  break_target_37:
# end: BreakTarget at 15.3; stackHeight = 8
    addu $sp, $sp, 8
# end: Block at 15.3; stackHeight = 0
...
# begin: IdentifierExp at 19.18; stackHeight = 4
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.18; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 20.9; stackHeight = 0
# begin: Call at 20.9; stackHeight = 0
# begin: Super at 20.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 20.9; stackHeight = 4
# begin: StringLiteral at 20.18; stackHeight = 4
    la $t0, strLit_43
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 20.18; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 20.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 20.9; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
