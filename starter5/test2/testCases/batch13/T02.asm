...
# ****** class Vehicle ****** # ClassDecl at 35.7
  .byte 0 # ClassDecl at 35.7
  .byte 214 # 'V' with high bit set # ClassDecl at 35.7
  .byte 101 # 'e' # ClassDecl at 35.7
  .byte 104 # 'h' # ClassDecl at 35.7
  .byte 105 # 'i' # ClassDecl at 35.7
  .byte 99 # 'c' # ClassDecl at 35.7
  .byte 108 # 'l' # ClassDecl at 35.7
  .byte 101 # 'e' # ClassDecl at 35.7
CLASS_Vehicle: # ClassDecl at 35.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Vehicle_price # MethodDeclNonVoid at 36.16
# ****** class Car ****** # ClassDecl at 40.7
  .byte 0 # ClassDecl at 40.7
  .byte 195 # 'C' with high bit set # ClassDecl at 40.7
  .byte 97 # 'a' # ClassDecl at 40.7
  .byte 114 # 'r' # ClassDecl at 40.7
CLASS_Car: # ClassDecl at 40.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Car_price # MethodDeclNonVoid at 41.16
END_CLASS_Car: # ClassDecl at 40.7
END_CLASS_Vehicle: # ClassDecl at 35.7
...
# intToChar parameter param0 offset = 4: MethodDeclNonVoid at 0.0
  .byte 10 # StringLiteral at 23.17
  .byte 0 # StringLiteral at 23.17
  .byte 0 # StringLiteral at 23.17
  .byte 0 # StringLiteral at 23.17
  .word CLASS_String # StringLiteral at 23.17
  .word 2 # StringLiteral at 23.17
  .word -1 # StringLiteral at 23.17
strLit_79: # StringLiteral at 23.17
.text
.globl main
main:
    jal vm_init
...
# begin: True at 5.14; stackHeight = 0
    li $t0, 1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: True at 5.14; stackHeight = 4
    lw $zero, ($sp) #**"b"
# end: LocalVarDecl at 5.10; stackHeight = 4
# begin: LocalVarDecl at 6.10; stackHeight = 4
# begin: True at 6.15; stackHeight = 4
    li $t0, 1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: True at 6.15; stackHeight = 8
    lw $zero, ($sp) #**"b2"
# end: LocalVarDecl at 6.10; stackHeight = 8
# begin: LocalVarDecl at 7.10; stackHeight = 8
# begin: True at 7.15; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: True at 7.15; stackHeight = 12
    lw $zero, ($sp) #**"b3"
# end: LocalVarDecl at 7.10; stackHeight = 12
# begin: LocalVarDecl at 8.10; stackHeight = 12
# begin: NewObject at 8.14; stackHeight = 12
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Vehicle
    sw $t0, -12($s7)
# end: NewObject at 8.14; stackHeight = 16
    lw $zero, ($sp) #**"v"
# end: LocalVarDecl at 8.10; stackHeight = 16
# begin: LocalVarDecl at 9.6; stackHeight = 16
# begin: NewObject at 9.10; stackHeight = 16
    li $s6, 1
    li $s7, 0
    jal newObject
    la $t0, CLASS_Car
    sw $t0, -12($s7)
# end: NewObject at 9.10; stackHeight = 20
    lw $zero, ($sp) #**"c"
# end: LocalVarDecl at 9.6; stackHeight = 20
# begin: LocalVarDecl at 10.10; stackHeight = 20
# begin: Null at 10.15; stackHeight = 20
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 10.15; stackHeight = 24
    lw $zero, ($sp) #**"v1"
# end: LocalVarDecl at 10.10; stackHeight = 24
# begin: LocalVarDecl at 11.10; stackHeight = 24
# begin: Null at 11.15; stackHeight = 24
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 11.15; stackHeight = 28
    lw $zero, ($sp) #**"v2"
# end: LocalVarDecl at 11.10; stackHeight = 28
# begin: LocalVarDecl at 12.10; stackHeight = 28
# begin: Null at 12.18; stackHeight = 28
    subu $sp, $sp, 4
    sw $zero, ($sp)
# end: Null at 12.18; stackHeight = 32
    lw $zero, ($sp) #**"nullV"
# end: LocalVarDecl at 12.10; stackHeight = 32
# begin: Block at 15.2; stackHeight = 32
# begin: LocalVarDecl at 15.11; stackHeight = 32
# begin: IntegerLiteral at 15.15; stackHeight = 32
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.15; stackHeight = 40
    lw $zero, ($sp) #**"i"
# end: LocalVarDecl at 15.11; stackHeight = 40
# begin: BreakTarget at 15.2; stackHeight = 40
    j while_cond_73
  while_top_73:
# begin: Block at 15.2; stackHeight = 40
# begin: Block at 15.33; stackHeight = 40
# begin: Assign at 16.8; stackHeight = 40
# begin: InstanceOf at 16.12; stackHeight = 40
# begin: IdentifierExp at 16.10; stackHeight = 40
    lw $t0, 20($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 16.10; stackHeight = 44
    la $t0, CLASS_Vehicle
    la $t1, END_CLASS_Vehicle
    jal instanceOf
# end: InstanceOf at 16.12; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 36($sp)
# end: Assign at 16.8; stackHeight = 40
# begin: Assign at 17.9; stackHeight = 40
# begin: InstanceOf at 17.13; stackHeight = 40
# begin: IdentifierExp at 17.11; stackHeight = 40
    lw $t0, 20($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.11; stackHeight = 44
    la $t0, CLASS_Car
    la $t1, END_CLASS_Car
    jal instanceOf
# end: InstanceOf at 17.13; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 32($sp)
# end: Assign at 17.9; stackHeight = 40
# begin: Assign at 18.9; stackHeight = 40
# begin: InstanceOf at 18.17; stackHeight = 40
# begin: IdentifierExp at 18.11; stackHeight = 40
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 18.11; stackHeight = 44
    la $t0, CLASS_Vehicle
    la $t1, END_CLASS_Vehicle
    jal instanceOf
# end: InstanceOf at 18.17; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 28($sp)
# end: Assign at 18.9; stackHeight = 40
# begin: Assign at 19.9; stackHeight = 40
# begin: Cast at 19.11; stackHeight = 40
# begin: IdentifierExp at 19.20; stackHeight = 40
    lw $t0, 20($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 19.20; stackHeight = 44
    # skipping cast check
# end: Cast at 19.11; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 16($sp)
# end: Assign at 19.9; stackHeight = 40
# begin: Assign at 20.9; stackHeight = 40
# begin: Cast at 20.11; stackHeight = 40
# begin: IdentifierExp at 20.20; stackHeight = 40
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 20.20; stackHeight = 44
    # skipping cast check
# end: Cast at 20.11; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 12($sp)
# end: Assign at 20.9; stackHeight = 40
# end: Block at 15.33; stackHeight = 40
# begin: Assign at 15.28; stackHeight = 40
# begin: Plus at 15.29; stackHeight = 40
# begin: IdentifierExp at 15.28; stackHeight = 40
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 15.28; stackHeight = 48
# begin: IntegerLiteral at 15.29; stackHeight = 48
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.29; stackHeight = 56
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 15.29; stackHeight = 48
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 15.28; stackHeight = 40
# end: Block at 15.2; stackHeight = 40
  while_cond_73:
# begin: LessThan at 15.20; stackHeight = 40
# begin: IdentifierExp at 15.18; stackHeight = 40
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 15.18; stackHeight = 48
# begin: IntegerLiteral at 15.22; stackHeight = 48
    li $t0, 2000
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 15.22; stackHeight = 56
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: LessThan at 15.20; stackHeight = 44
    lw $t0, ($sp)
    addu $sp, $sp, 4
    bne $t0, $zero, while_top_73
  break_target_73:
# end: BreakTarget at 15.2; stackHeight = 40
    addu $sp, $sp, 8
# end: Block at 15.2; stackHeight = 32
# begin: CallStatement at 22.8; stackHeight = 32
# begin: Call at 22.8; stackHeight = 32
# begin: Super at 22.8; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.8; stackHeight = 36
# begin: IdentifierExp at 22.18; stackHeight = 36
    lw $t0, 32($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 22.18; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.8; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.8; stackHeight = 32
# begin: CallStatement at 23.8; stackHeight = 32
# begin: Call at 23.8; stackHeight = 32
# begin: Super at 23.8; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 23.8; stackHeight = 36
# begin: StringLiteral at 23.17; stackHeight = 36
    la $t0, strLit_79
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 23.17; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 23.8; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 23.8; stackHeight = 32
# begin: CallStatement at 24.8; stackHeight = 32
# begin: Call at 24.8; stackHeight = 32
# begin: Super at 24.8; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 24.8; stackHeight = 36
# begin: IdentifierExp at 24.18; stackHeight = 36
    lw $t0, 28($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 24.18; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 24.8; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 24.8; stackHeight = 32
# begin: CallStatement at 25.8; stackHeight = 32
# begin: Call at 25.8; stackHeight = 32
# begin: Super at 25.8; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 25.8; stackHeight = 36
# begin: StringLiteral at 25.17; stackHeight = 36
    la $t0, strLit_79
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 25.17; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 25.8; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 25.8; stackHeight = 32
# begin: CallStatement at 26.8; stackHeight = 32
# begin: Call at 26.8; stackHeight = 32
# begin: Super at 26.8; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 26.8; stackHeight = 36
# begin: IdentifierExp at 26.18; stackHeight = 36
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 26.18; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 26.8; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 26.8; stackHeight = 32
# begin: CallStatement at 27.8; stackHeight = 32
# begin: Call at 27.8; stackHeight = 32
# begin: Super at 27.8; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 27.8; stackHeight = 36
# begin: StringLiteral at 27.17; stackHeight = 36
    la $t0, strLit_79
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 27.17; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 27.8; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 27.8; stackHeight = 32
# begin: CallStatement at 28.8; stackHeight = 32
# begin: Call at 28.8; stackHeight = 32
# begin: Super at 28.8; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 28.8; stackHeight = 36
# begin: Call at 28.20; stackHeight = 36
# begin: IdentifierExp at 28.17; stackHeight = 36
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 28.17; stackHeight = 40
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 28.20; stackHeight = 44
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 28.8; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 28.8; stackHeight = 32
# begin: CallStatement at 29.8; stackHeight = 32
# begin: Call at 29.8; stackHeight = 32
# begin: Super at 29.8; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 29.8; stackHeight = 36
# begin: StringLiteral at 29.17; stackHeight = 36
    la $t0, strLit_79
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 29.17; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 29.8; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 29.8; stackHeight = 32
# begin: CallStatement at 30.8; stackHeight = 32
# begin: Call at 30.8; stackHeight = 32
# begin: Super at 30.8; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 30.8; stackHeight = 36
# begin: Call at 30.20; stackHeight = 36
# begin: IdentifierExp at 30.17; stackHeight = 36
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 30.17; stackHeight = 40
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 30.20; stackHeight = 44
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 30.8; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 30.8; stackHeight = 32
# begin: CallStatement at 31.8; stackHeight = 32
# begin: Call at 31.8; stackHeight = 32
# begin: Super at 31.8; stackHeight = 32
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 31.8; stackHeight = 36
# begin: StringLiteral at 31.17; stackHeight = 36
    la $t0, strLit_79
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 31.17; stackHeight = 40
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 31.8; stackHeight = 36
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 31.8; stackHeight = 32
    addu $sp, $sp, 32
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
mth_Vehicle_price:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:price"
# begin: IntegerLiteral at 37.9; stackHeight = 0
    li $t0, 1234
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 37.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
...
mth_Car_price:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:price"
# begin: IntegerLiteral at 42.9; stackHeight = 0
    li $t0, 4321
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 42.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
