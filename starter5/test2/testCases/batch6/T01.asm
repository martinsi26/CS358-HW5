...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_factorial # MethodDeclNonVoid at 9.14
...
# factorial parameter n offset = 4: MethodDeclNonVoid at 9.14
...
strLit_6: # StringLiteral at 6.20
.text
.globl main
main:
    jal vm_init
...
# begin: Call at 5.20; stackHeight = 4
# begin: This at 5.20; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 5.20; stackHeight = 8
# begin: IntegerLiteral at 5.30; stackHeight = 8
    li $t0, 6
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.30; stackHeight = 16
    lw $zero, ($sp) #**"n"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 5.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# end: CallStatement at 6.11; stackHeight = 0
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_factorial
mth_Main_factorial:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:factorial"
# begin: LocalVarDecl at 10.9; stackHeight = 0
# begin: IdentifierExp at 10.18; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 10.18; stackHeight = 8
    lw $zero, ($sp) #**"rtnVal"
# end: LocalVarDecl at 10.9; stackHeight = 8
# begin: If at 11.5; stackHeight = 8
# begin: GreaterThan at 11.11; stackHeight = 8
# begin: IdentifierExp at 11.9; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.9; stackHeight = 16
# begin: IntegerLiteral at 11.13; stackHeight = 16
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.13; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: GreaterThan at 11.11; stackHeight = 12
    lw $t0, ($sp)
    addu $sp, $sp, 4
    beq $t0, $zero, if_else_32
# begin: Block at 11.16; stackHeight = 8
# begin: Assign at 12.14; stackHeight = 8
# begin: Times at 12.17; stackHeight = 8
...
# begin: Call at 12.18; stackHeight = 16
# begin: This at 12.18; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 12.18; stackHeight = 20
# begin: Minus at 12.29; stackHeight = 20
# begin: IdentifierExp at 12.28; stackHeight = 20
    lw $t0, 24($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.28; stackHeight = 28
# begin: IntegerLiteral at 12.30; stackHeight = 28
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.30; stackHeight = 36
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 12.29; stackHeight = 28
    lw $zero, ($sp) #**"n"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 12.18; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 12.17; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 0($sp)
# end: Assign at 12.14; stackHeight = 8
# end: Block at 11.16; stackHeight = 8
    j if_done_32
  if_else_32:
# begin: Block at 14.5; stackHeight = 8
# end: Block at 14.5; stackHeight = 8
  if_done_32:
# end: If at 11.5; stackHeight = 8
# begin: IdentifierExp at 14.12; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.12; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 8
    lw $ra, ($sp)
