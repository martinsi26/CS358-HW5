...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_ident # MethodDeclNonVoid at 16.22
# ****** class T09Helper ****** # ClassDecl at 21.7
  .byte 0 # ClassDecl at 21.7
  .byte 0 # ClassDecl at 21.7
  .byte 0 # ClassDecl at 21.7
  .byte 212 # 'T' with high bit set # ClassDecl at 21.7
  .byte 48 # '0' # ClassDecl at 21.7
  .byte 57 # '9' # ClassDecl at 21.7
...
CLASS_T09Helper: # ClassDecl at 21.7
  .word mth_Object_hashCode # MethodDeclNonVoid at 0.0
  .word mth_Object_equals # MethodDeclNonVoid at 0.0
  .word mth_Object_toString # MethodDeclNonVoid at 0.0
  .word mth_Lib_readLine # MethodDeclNonVoid at 0.0
  ...
  .word mth_Main_main # MethodDeclVoid at 4.17
  .word mth_Main_ident # MethodDeclNonVoid at 16.22
  .word mth_T09Helper_init # MethodDeclNonVoid at 24.22
  .word mth_T09Helper_me # MethodDeclNonVoid at 29.22
  .word mth_T09Helper_print # MethodDeclVoid at 32.17
END_CLASS_T09Helper: # ClassDecl at 21.7
...
# ident parameter h offset = 4: MethodDeclNonVoid at 16.22
# field T09Helper.first offset = -16: InstVarDecl at 22.9
# field T09Helper.second offset = -20: InstVarDecl at 23.9
# init parameter first offset = 12: MethodDeclNonVoid at 24.22
# init parameter second offset = 4: MethodDeclNonVoid at 24.22
  .byte 32 # StringLiteral at 34.17
...
strLit_91: # StringLiteral at 34.17
  .byte 10 # StringLiteral at 36.17
  .byte 0 # StringLiteral at 36.17
  .byte 0 # StringLiteral at 36.17
  .byte 0 # StringLiteral at 36.17
  .word CLASS_String # StringLiteral at 36.17
  .word 2 # StringLiteral at 36.17
  .word -1 # StringLiteral at 36.17
strLit_99: # StringLiteral at 36.17
.text
.globl main
main:
    jal vm_init
...
# begin: Call at 5.33; stackHeight = 0
# begin: NewObject at 5.17; stackHeight = 0
    li $s6, 3
    li $s7, 0
    jal newObject
    la $t0, CLASS_T09Helper
    sw $t0, -12($s7)
# end: NewObject at 5.17; stackHeight = 4
# begin: IntegerLiteral at 5.38; stackHeight = 4
    li $t0, 4
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.38; stackHeight = 12
    lw $zero, ($sp) #**"first"
# begin: IntegerLiteral at 5.40; stackHeight = 12
    li $t0, 88
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 5.40; stackHeight = 20
    lw $zero, ($sp) #**"second"
    lw $t0, 16($sp)
    sw $s2, 16($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 5.33; stackHeight = 4
    lw $zero, ($sp) #**"h1"
# end: LocalVarDecl at 5.12; stackHeight = 4
# begin: CallStatement at 6.5; stackHeight = 4
# begin: Call at 6.5; stackHeight = 4
...
# end: IdentifierExp at 6.2; stackHeight = 8
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 6.5; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 6.5; stackHeight = 4
# begin: Assign at 7.18; stackHeight = 4
# begin: IntegerLiteral at 7.20; stackHeight = 4
    li $t0, 72
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 7.20; stackHeight = 12
# begin: Call at 7.2; stackHeight = 12
# begin: This at 7.2; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 7.2; stackHeight = 16
# begin: IdentifierExp at 7.8; stackHeight = 16
    lw $t0, 12($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 7.8; stackHeight = 20
    lw $zero, ($sp) #**"h"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 7.2; stackHeight = 16
    lw $t1, ($sp)
    addu $sp, $sp, 4
    ...
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 7.18; stackHeight = 4
# begin: CallStatement at 8.5; stackHeight = 4
# begin: Call at 8.5; stackHeight = 4
# begin: IdentifierExp at 8.2; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 8.2; stackHeight = 8
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 8.5; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.5; stackHeight = 4
# begin: Assign at 9.17; stackHeight = 4
# begin: IntegerLiteral at 9.19; stackHeight = 4
    li $t0, 442
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 9.19; stackHeight = 12
# begin: Call at 9.5; stackHeight = 12
# begin: IdentifierExp at 9.2; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 9.2; stackHeight = 16
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.5; stackHeight = 16
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($t1)
# end: Assign at 9.17; stackHeight = 4
# begin: CallStatement at 10.5; stackHeight = 4
# begin: Call at 10.5; stackHeight = 4
# begin: IdentifierExp at 10.2; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 10.2; stackHeight = 8
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.5; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.5; stackHeight = 4
# begin: Assign at 11.39; stackHeight = 4
# begin: IntegerLiteral at 11.41; stackHeight = 4
    li $t0, 145
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 11.41; stackHeight = 12
# begin: Call at 11.2; stackHeight = 12
# begin: This at 11.2; stackHeight = 12
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.2; stackHeight = 16
# begin: Call at 11.8; stackHeight = 16
# begin: This at 11.8; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.8; stackHeight = 20
# begin: Call at 11.14; stackHeight = 20
# begin: This at 11.14; stackHeight = 20
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.14; stackHeight = 24
# begin: Call at 11.20; stackHeight = 24
# begin: This at 11.20; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 11.20; stackHeight = 28
# begin: IdentifierExp at 11.26; stackHeight = 28
    lw $t0, 24($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 11.26; stackHeight = 32
    lw $zero, ($sp) #**"h"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.20; stackHeight = 28
    lw $zero, ($sp) #**"h"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.14; stackHeight = 24
    lw $zero, ($sp) #**"h"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.8; stackHeight = 20
    lw $zero, ($sp) #**"h"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 11.2; stackHeight = 16
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 11.39; stackHeight = 4
# begin: CallStatement at 12.5; stackHeight = 4
# begin: Call at 12.5; stackHeight = 4
# begin: IdentifierExp at 12.2; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 12.2; stackHeight = 8
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.5; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.5; stackHeight = 4
# begin: Assign at 13.52; stackHeight = 4
# begin: IntegerLiteral at 13.54; stackHeight = 4
    li $t0, 9876
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 13.54; stackHeight = 12
# begin: Call at 13.40; stackHeight = 12
# begin: Call at 13.35; stackHeight = 12
# begin: Call at 13.30; stackHeight = 12
# begin: Call at 13.25; stackHeight = 12
# begin: Call at 13.20; stackHeight = 12
# begin: Call at 13.15; stackHeight = 12
# begin: Call at 13.10; stackHeight = 12
# begin: Call at 13.5; stackHeight = 12
# begin: IdentifierExp at 13.2; stackHeight = 12
    lw $t0, 8($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 13.2; stackHeight = 16
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.5; stackHeight = 16
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.10; stackHeight = 16
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.15; stackHeight = 16
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.20; stackHeight = 16
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.25; stackHeight = 16
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
...
# end: Call at 13.30; stackHeight = 16
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.35; stackHeight = 16
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.40; stackHeight = 16
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($t1)
# end: Assign at 13.52; stackHeight = 4
# begin: CallStatement at 14.5; stackHeight = 4
# begin: Call at 14.5; stackHeight = 4
# begin: IdentifierExp at 14.2; stackHeight = 4
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 14.2; stackHeight = 8
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.5; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.5; stackHeight = 4
    addu $sp, $sp, 4
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_ident
mth_Main_ident:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:ident"
# begin: IdentifierExp at 17.9; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 17.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_T09Helper_init
mth_T09Helper_init:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:init"
# begin: Assign at 25.13; stackHeight = 0
# begin: IdentifierExp at 25.15; stackHeight = 0
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 25.15; stackHeight = 8
# begin: This at 25.2; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 25.2; stackHeight = 12
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($t1)
# end: Assign at 25.13; stackHeight = 0
# begin: Assign at 26.14; stackHeight = 0
# begin: IdentifierExp at 26.16; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 26.16; stackHeight = 8
# begin: This at 26.2; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 26.2; stackHeight = 12
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($t1)
# end: Assign at 26.14; stackHeight = 0
# begin: This at 27.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 27.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_T09Helper_me
mth_T09Helper_me:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:me"
# begin: This at 30.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 30.9; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
    addu $sp, $sp, 0
    lw $ra, ($sp)
...
# begin: CallStatement at 35.8; stackHeight = 0
# begin: Call at 35.8; stackHeight = 0
# begin: Super at 35.8; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 35.8; stackHeight = 4
# begin: IdentifierExp at 35.17; stackHeight = 4
    lw $t0, -20($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 35.17; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 35.8; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 35.8; stackHeight = 0
