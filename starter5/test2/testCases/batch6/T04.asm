...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_incXRtnOld # MethodDeclNonVoid at 25.14
...
# field Main.y offset = -20: InstVarDecl at 6.7
  .byte 32 # StringLiteral at 11.39
...
strLit_14: # StringLiteral at 11.39
  .byte 10 # StringLiteral at 12.39
  .byte 0 # StringLiteral at 12.39
  .byte 0 # StringLiteral at 12.39
  .byte 0 # StringLiteral at 12.39
  .word CLASS_String # StringLiteral at 12.39
  .word 2 # StringLiteral at 12.39
  .word -1 # StringLiteral at 12.39
strLit_22: # StringLiteral at 12.39
.text
.globl main
main:
    jal vm_init
...
# begin: Assign at 10.7; stackHeight = 0
# begin: IntegerLiteral at 10.9; stackHeight = 0
    li $t0, 88
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($s2)
# end: Assign at 10.7; stackHeight = 0
...
# begin: IdentifierExp at 12.20; stackHeight = 4
    lw $t0, -20($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
...
# begin: CallStatement at 12.30; stackHeight = 0
# begin: Call at 12.30; stackHeight = 0
# begin: Super at 12.30; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 12.30; stackHeight = 4
# begin: StringLiteral at 12.39; stackHeight = 4
    la $t0, strLit_22
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 12.39; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.30; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.30; stackHeight = 0
# begin: Assign at 13.7; stackHeight = 0
# begin: Call at 13.9; stackHeight = 0
# begin: This at 13.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 13.9; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
...
# begin: IdentifierExp at 15.20; stackHeight = 4
    lw $t0, -20($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 15.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 15.30; stackHeight = 0
# begin: Call at 15.30; stackHeight = 0
# begin: Super at 15.30; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 15.30; stackHeight = 4
# begin: StringLiteral at 15.39; stackHeight = 4
    la $t0, strLit_22
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 15.39; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 15.30; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 15.30; stackHeight = 0
# begin: Assign at 16.7; stackHeight = 0
# begin: Call at 16.9; stackHeight = 0
# begin: This at 16.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 16.9; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 16.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($s2)
...
# begin: IdentifierExp at 18.20; stackHeight = 4
    lw $t0, -20($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 18.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 18.30; stackHeight = 0
# begin: Call at 18.30; stackHeight = 0
# begin: Super at 18.30; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 18.30; stackHeight = 4
# begin: StringLiteral at 18.39; stackHeight = 4
    la $t0, strLit_22
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 18.39; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 18.30; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 18.30; stackHeight = 0
# begin: Assign at 19.7; stackHeight = 0
# begin: IntegerLiteral at 19.9; stackHeight = 0
    li $t0, 872
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 19.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 19.7; stackHeight = 0
# begin: Assign at 20.7; stackHeight = 0
# begin: Call at 20.9; stackHeight = 0
# begin: This at 20.9; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 20.9; stackHeight = 4
    lw $t0, 0($sp)
    sw $s2, 0($sp)
    move $s2, $t0
    beq $s2, $zero, nullPtrException
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 20.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -20($s2)
# end: Assign at 20.7; stackHeight = 0
# begin: CallStatement at 21.11; stackHeight = 0
# begin: Call at 21.11; stackHeight = 0
# begin: Super at 21.11; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 21.11; stackHeight = 4
# begin: IdentifierExp at 21.20; stackHeight = 4
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 21.20; stackHeight = 12
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 21.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 21.11; stackHeight = 0
# begin: CallStatement at 21.30; stackHeight = 0
# begin: Call at 21.30; stackHeight = 0
# begin: Super at 21.30; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 21.30; stackHeight = 4
# begin: StringLiteral at 21.39; stackHeight = 4
    la $t0, strLit_14
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 21.39; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 21.30; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 21.30; stackHeight = 0
# begin: CallStatement at 22.11; stackHeight = 0
# begin: Call at 22.11; stackHeight = 0
# begin: Super at 22.11; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.11; stackHeight = 4
# begin: IdentifierExp at 22.20; stackHeight = 4
    lw $t0, -20($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 22.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.11; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.11; stackHeight = 0
# begin: CallStatement at 22.30; stackHeight = 0
# begin: Call at 22.30; stackHeight = 0
# begin: Super at 22.30; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 22.30; stackHeight = 4
# begin: StringLiteral at 22.39; stackHeight = 4
    la $t0, strLit_22
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 22.39; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 22.30; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 22.30; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_incXRtnOld
mth_Main_incXRtnOld:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:incXRtnOld"
# begin: LocalVarDecl at 26.9; stackHeight = 0
# begin: IdentifierExp at 26.15; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 26.15; stackHeight = 8
    lw $zero, ($sp) #**"old"
# end: LocalVarDecl at 26.9; stackHeight = 8
# begin: Assign at 27.7; stackHeight = 8
# begin: Plus at 27.11; stackHeight = 8
...
# begin: IntegerLiteral at 27.13; stackHeight = 16
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 27.13; stackHeight = 24
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 27.11; stackHeight = 16
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 27.7; stackHeight = 8
# begin: IdentifierExp at 28.12; stackHeight = 8
    lw $t0, 0($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
