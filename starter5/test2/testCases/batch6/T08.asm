...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_callMe # MethodDeclNonVoid at 10.16
...
# callMe parameter y offset = 4: MethodDeclNonVoid at 10.16
.text
.globl main
main:
    jal vm_init
...
# begin: Call at 6.10; stackHeight = 8
# begin: This at 6.10; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 6.10; stackHeight = 12
# begin: IdentifierExp at 6.17; stackHeight = 12
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 6.17; stackHeight = 20
    lw $zero, ($sp) #**"y"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Call at 6.10; stackHeight = 16
    lw $zero, ($sp) #**"z"
...
# begin: IdentifierExp at 7.17; stackHeight = 20
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 7.17; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 8.8; stackHeight = 16
# begin: Call at 8.8; stackHeight = 16
# begin: Super at 8.8; stackHeight = 16
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 8.8; stackHeight = 20
# begin: IdentifierExp at 8.17; stackHeight = 20
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 8.17; stackHeight = 28
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# end: Call at 8.8; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 8.8; stackHeight = 16
    addu $sp, $sp, 16
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
...
# begin: IdentifierExp at 11.17; stackHeight = 4
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 11.17; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: Assign at 12.2; stackHeight = 0
# begin: Plus at 12.3; stackHeight = 0
# begin: IdentifierExp at 12.2; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 12.2; stackHeight = 8
# begin: IntegerLiteral at 12.3; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.3; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 12.3; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, 4($sp)
# end: Assign at 12.2; stackHeight = 0
...
# begin: IdentifierExp at 13.17; stackHeight = 4
    lw $t0, 8($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.17; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: Times at 14.10; stackHeight = 0
# begin: IdentifierExp at 14.9; stackHeight = 0
    lw $t0, 4($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.9; stackHeight = 8
# begin: IdentifierExp at 14.11; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 14.11; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 14.10; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    addu $sp, $sp, 0
    lw $ra, ($sp)
