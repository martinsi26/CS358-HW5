...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_mpyIncX # MethodDeclVoid at 18.15
...
# mpyIncX parameter m offset = 12: MethodDeclVoid at 18.15
# mpyIncX parameter i offset = 4: MethodDeclVoid at 18.15
  .byte 32 # StringLiteral at 9.39
  .byte 0 # StringLiteral at 9.39
  .byte 0 # StringLiteral at 9.39
  .byte 0 # StringLiteral at 9.39
  .word CLASS_String # StringLiteral at 9.39
  .word 2 # StringLiteral at 9.39
  .word -1 # StringLiteral at 9.39
strLit_9: # StringLiteral at 9.39
  .byte 10 # StringLiteral at 15.39
  .byte 0 # StringLiteral at 15.39
  .byte 0 # StringLiteral at 15.39
  .byte 0 # StringLiteral at 15.39
  .word CLASS_String # StringLiteral at 15.39
  .word 2 # StringLiteral at 15.39
  .word -1 # StringLiteral at 15.39
strLit_50: # StringLiteral at 15.39
.text
.globl main
main:
    jal vm_init
...
# begin: IntegerLiteral at 8.9; stackHeight = 0
    li $t0, 278
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 8.9; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
...
# begin: IdentifierExp at 9.20; stackHeight = 4
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 9.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 9.30; stackHeight = 0
# begin: Call at 9.30; stackHeight = 0
# begin: Super at 9.30; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 9.30; stackHeight = 4
# begin: StringLiteral at 9.39; stackHeight = 4
    la $t0, strLit_9
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 9.39; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 9.30; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 9.30; stackHeight = 0
# begin: CallStatement at 10.5; stackHeight = 0
# begin: Call at 10.5; stackHeight = 0
# begin: This at 10.5; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 10.5; stackHeight = 4
# begin: IntegerLiteral at 10.13; stackHeight = 4
    li $t0, 23
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.13; stackHeight = 12
    lw $zero, ($sp) #**"m"
# begin: IntegerLiteral at 10.17; stackHeight = 12
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.17; stackHeight = 20
    lw $zero, ($sp) #**"i"
    lw $t0, 16($sp)
    sw $s2, 16($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 10.5; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 10.5; stackHeight = 0
...
# begin: CallStatement at 12.5; stackHeight = 0
# begin: Call at 12.5; stackHeight = 0
# begin: This at 12.5; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 12.5; stackHeight = 4
# begin: IntegerLiteral at 12.13; stackHeight = 4
    li $t0, 3
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.13; stackHeight = 12
    lw $zero, ($sp) #**"m"
# begin: Minus at 12.16; stackHeight = 12
# begin: IntegerLiteral at 12.16; stackHeight = 12
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.16; stackHeight = 20
# begin: IntegerLiteral at 12.17; stackHeight = 20
    li $t0, 823
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.17; stackHeight = 28
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 12.16; stackHeight = 20
    lw $zero, ($sp) #**"i"
    lw $t0, 16($sp)
    sw $s2, 16($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 12.5; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 12.5; stackHeight = 0
...
# begin: IdentifierExp at 13.20; stackHeight = 4
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 13.20; stackHeight = 12
    lw $zero, ($sp) #**"param0"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: CallStatement at 13.30; stackHeight = 0
# begin: Call at 13.30; stackHeight = 0
# begin: Super at 13.30; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: Super at 13.30; stackHeight = 4
# begin: StringLiteral at 13.39; stackHeight = 4
    la $t0, strLit_9
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: StringLiteral at 13.39; stackHeight = 8
    lw $zero, ($sp) #**"param0"
    lw $t0, 4($sp)
    sw $s2, 4($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 13.30; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 13.30; stackHeight = 0
# begin: CallStatement at 14.5; stackHeight = 0
# begin: Call at 14.5; stackHeight = 0
# begin: This at 14.5; stackHeight = 0
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 14.5; stackHeight = 4
# begin: IntegerLiteral at 14.13; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 14.13; stackHeight = 12
    lw $zero, ($sp) #**"m"
# begin: IntegerLiteral at 14.16; stackHeight = 12
    li $t0, 8
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 14.16; stackHeight = 20
    lw $zero, ($sp) #**"i"
    lw $t0, 16($sp)
    sw $s2, 16($sp)
    move $s2, $t0
    ...
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: Call at 14.5; stackHeight = 4
    lw $t0, ($sp)
    addu $sp, $sp, 4
# end: CallStatement at 14.5; stackHeight = 0
...
# end: CallStatement at 15.30; stackHeight = 0
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_mpyIncX
mth_Main_mpyIncX:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:mpyIncX"
# begin: Assign at 19.7; stackHeight = 0
# begin: Times at 19.11; stackHeight = 0
...
# begin: IdentifierExp at 19.13; stackHeight = 8
    lw $t0, 20($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 19.13; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Times at 19.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 19.7; stackHeight = 0
# begin: Assign at 20.7; stackHeight = 0
# begin: Plus at 20.11; stackHeight = 0
# begin: IdentifierExp at 20.9; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 20.9; stackHeight = 8
# begin: IdentifierExp at 20.13; stackHeight = 8
    lw $t0, 12($sp)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 20.13; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 20.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
