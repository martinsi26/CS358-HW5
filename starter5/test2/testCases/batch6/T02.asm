...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_incX1 # MethodDeclVoid at 18.15
  .word mth_Main_incX2 # MethodDeclVoid at 22.15
  .word mth_Main_incX3 # MethodDeclVoid at 26.15
...
strLit_42: # StringLiteral at 15.39
.text
.globl main
main:
    jal vm_init
...
# end: CallStatement at 15.30; stackHeight = 0
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_incX1
mth_Main_incX1:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:incX1"
# begin: Assign at 19.7; stackHeight = 0
# begin: Plus at 19.11; stackHeight = 0
...
# begin: IntegerLiteral at 19.13; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 19.13; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 19.11; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 19.7; stackHeight = 0
    ...
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_incX2
mth_Main_incX2:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:incX2"
# begin: Assign at 23.5; stackHeight = 0
# begin: Plus at 23.6; stackHeight = 0
# begin: IdentifierExp at 23.5; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 23.5; stackHeight = 8
# begin: IntegerLiteral at 23.6; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 23.6; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 23.6; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 23.5; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
.globl mth_Main_incX3
mth_Main_incX3:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:incX3"
# begin: Assign at 27.5; stackHeight = 0
# begin: Plus at 27.7; stackHeight = 0
# begin: IdentifierExp at 27.5; stackHeight = 0
    lw $t0, -16($s2)
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IdentifierExp at 27.5; stackHeight = 8
# begin: IntegerLiteral at 27.7; stackHeight = 8
    li $t0, 1
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 27.7; stackHeight = 16
    lw $t2, ($sp)
    addu $sp, $sp, 8
    lw $t1, ($sp)
    addu $sp, $sp, 8
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Plus at 27.7; stackHeight = 8
    lw $t0, ($sp)
    addu $sp, $sp, 8
    sw $t0, -16($s2)
# end: Assign at 27.5; stackHeight = 0
    addu $sp, $sp, 0
    lw $ra, ($sp)
    addu $sp, $sp, 4
    jr $ra
