...
CLASS_Main: # ClassDecl at 3.7
  ...
  .word mth_Main_incX # MethodDeclVoid at 18.15
...
# incX parameter n offset = 4: MethodDeclVoid at 18.15
...
strLit_49: # StringLiteral at 15.39
.text
.globl main
main:
    jal vm_init
...
# begin: IntegerLiteral at 10.10; stackHeight = 4
    li $t0, 12
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 10.10; stackHeight = 12
    lw $zero, ($sp) #**"n"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: Minus at 12.10; stackHeight = 4
# begin: IntegerLiteral at 12.10; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 12.10; stackHeight = 12
...
# end: IntegerLiteral at 12.11; stackHeight = 20
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 12.10; stackHeight = 12
    lw $zero, ($sp) #**"n"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
...
# begin: Minus at 14.10; stackHeight = 4
# begin: IntegerLiteral at 14.10; stackHeight = 4
    li $t0, 0
    subu $sp, $sp, 8
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: IntegerLiteral at 14.10; stackHeight = 12
...
# end: IntegerLiteral at 14.11; stackHeight = 20
    ...
    sw $s5, 4($sp)
    sw $t0, ($sp)
# end: Minus at 14.10; stackHeight = 12
    lw $zero, ($sp) #**"n"
    lw $t0, 8($sp)
    sw $s2, 8($sp)
    move $s2, $t0
