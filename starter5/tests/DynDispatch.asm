...
# end: CallStatement at 0.0; stackHeight = 0
  li $v0, 10
  syscall
# begin: MethodDeclVoid at 4.14; stackHeight = 0
.globl mth_Main_main
mth_Main_main:
subu $sp, $sp, 4
sw $ra, ($sp)
...
sw $s5, 4($sp)
sw $t0, ($sp)
# end: Call at 7.21; stackHeight = 16
lw $t0, 8($sp)
sw $s2, 8($sp)
move $s2, $t0
...
subu $sp, $sp, 4
sw $t0, ($sp)
# end: Call at 7.9; stackHeight = 8
lw $t0, ($sp)
addu $sp, $sp, 4
# end: CallStatement at 7.9; stackHeight = 4
# begin: CallStatement at 8.9; stackHeight = 4
# begin: Call at 8.9; stackHeight = 4
subu $sp, $sp, 4
sw $s2, ($sp)
# begin: StringLiteral at 8.18; stackHeight = 8
li $t0, strLit_15
subu $sp, $sp, 4
sw $t0, ($sp)
# end: StringLiteral at 8.18; stackHeight = 12
lw $t0, 4($sp)
sw $s2, 4($sp)
move $s2, $t0
...
subu $sp, $sp, 4
sw $t0, ($sp)
# end: Call at 8.9; stackHeight = 8
lw $t0, ($sp)
addu $sp, $sp, 4
# end: CallStatement at 8.9; stackHeight = 4
# begin: CallStatement at 9.9; stackHeight = 4
# begin: Call at 9.9; stackHeight = 4
subu $sp, $sp, 4
sw $s2, ($sp)
# begin: Call at 9.21; stackHeight = 8
# begin: IdentifierExp at 9.18; stackHeight = 8
lw $t0, 4($sp) #**LocalVar
subu $sp, $sp, 4
sw $t0, ($sp)
# end: IdentifierExp at 9.18; stackHeight = 12
lw $t0, 0($sp)
sw $s2, 0($sp)
move $s2, $t0
beq $s2, $0, nullPtrException
...
sw $s5, 4($sp)
sw $t0, ($sp)
# end: Call at 9.21; stackHeight = 12
lw $t0, 8($sp)
sw $s2, 8($sp)
move $s2, $t0
jal mth_Lib_printInt
...
subu $sp, $sp, 4
sw $t0, ($sp)
# end: Call at 9.9; stackHeight = 4
lw $t0, ($sp)
addu $sp, $sp, 4
# end: CallStatement at 9.9; stackHeight = 0
# begin: CallStatement at 10.9; stackHeight = 0
# begin: Call at 10.9; stackHeight = 0
subu $sp, $sp, 4
sw $s2, ($sp)
# begin: StringLiteral at 10.18; stackHeight = 4
li $t0, strLit_24
subu $sp, $sp, 4
sw $t0, ($sp)
# end: StringLiteral at 10.18; stackHeight = 8
lw $t0, 4($sp)
sw $s2, 4($sp)
move $s2, $t0
jal mth_Lib_printStr
...
subu $sp, $sp, 4
sw $t0, ($sp)
# end: Call at 10.9; stackHeight = 4
lw $t0, ($sp)
addu $sp, $sp, 4
# end: CallStatement at 10.9; stackHeight = 0
addu $sp, $sp, 0
lw $ra, ($sp)
addu $sp, $sp, 4
jr $ra
# end: MethodDeclVoid at 4.14; stackHeight = -4
