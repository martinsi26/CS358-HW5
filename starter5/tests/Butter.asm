...
# end: CallStatement at 0.0; stackHeight = -4
  li $v0, 10
  syscall
# begin: MethodDeclVoid at 4.17; stackHeight = -4
.globl mth_Main_main
mth_Main_main:
subu $sp, $sp, 4
sw $ra, ($sp)
...
la $t0, CLASS_Jam
sw $t0, -12($s7)
# end: NewObject at 5.9; stackHeight = 0
lw $t0, 0($sp)
sw $s2, 0($sp)
move $s2, $t0
beq $s2, $0, nullPtrException
...
subu $sp, $sp, 4
sw $t0, ($sp)
# end: Call at 5.19; stackHeight = 0
lw $t0, ($sp)
addu $sp, $sp, 4
# end: CallStatement at 5.19; stackHeight = -4
addu $sp, $sp, -4
lw $ra, ($sp)
addu $sp, $sp, 4
jr $ra
...
la $t0, CLASS_Jam
sw $t0, -12($s7)
# end: NewObject at 31.17; stackHeight = 0
lw $0, ($sp) #**j
# end: LocalVarDecl at 31.13; stackHeight = 0
# begin: CallStatement at 32.11; stackHeight = 0
# begin: Call at 32.11; stackHeight = 0
# begin: IdentifierExp at 32.9; stackHeight = 0
lw $t0, 0($sp)
subu $sp, $sp, 4
sw $t0, ($sp)
# end: IdentifierExp at 32.9; stackHeight = 4
# begin: IntegerLiteral at 32.16; stackHeight = 4
li $t0, 33
subu $sp, $sp, 8
sw $s5, 4($sp)
sw $t0, ($sp)
# end: IntegerLiteral at 32.16; stackHeight = 12
lw $t0, 8($sp)
sw $s2, 8($sp)
move $s2, $t0
beq $s2, $0, nullPtrException
...
subu $sp, $sp, 4
sw $t0, ($sp)
# end: Call at 32.11; stackHeight = 4
lw $t0, ($sp)
addu $sp, $sp, 4
# end: CallStatement at 32.11; stackHeight = 0
# begin: Assign at 33.11; stackHeight = 0
# begin: InstVarAccess at 33.14; stackHeight = 0
# begin: IdentifierExp at 33.13; stackHeight = 0
lw $t0, 0($sp)
subu $sp, $sp, 4
sw $t0, ($sp)
# end: IdentifierExp at 33.13; stackHeight = 4
lw $t0, ($sp)
addu $sp, $sp, 4
...
sw $s5, 4($sp)
sw $t0, ($sp)
# end: InstVarAccess at 33.14; stackHeight = 8
lw $t0, ($sp)
addu $sp, $sp, 8
sw $t0, -16($sp)
# end: Assign at 33.11; stackHeight = 0
# begin: Assign at 34.9; stackHeight = 0
# begin: Plus at 34.10; stackHeight = 0
# begin: IdentifierExp at 34.9; stackHeight = 0
lw $t0, -16($s2)
subu $sp, $sp, 8
sw $s5, 4($sp)
sw $t0, ($sp)
# end: IdentifierExp at 34.9; stackHeight = 8
# begin: IntegerLiteral at 34.10; stackHeight = 8
li $t0, 1
subu $sp, $sp, 8
sw $s5, 4($sp)
sw $t0, ($sp)
# end: IntegerLiteral at 34.10; stackHeight = 16
lw $t2, ($sp)
addu $sp, $sp, 8
lw $t1, ($sp)
addu $sp, $sp, 8
...
sw $s5, 4($sp)
sw $t0, ($sp)
# end: Plus at 34.10; stackHeight = 8
lw $t0, ($sp)
addu $sp, $sp, 8
sw $t0, -16($sp)
# end: Assign at 34.9; stackHeight = 0
# begin: CallStatement at 35.14; stackHeight = 0
# begin: Call at 35.14; stackHeight = 0
subu $sp, $sp, 4
sw $s2, ($sp)
# begin: IdentifierExp at 35.23; stackHeight = 4
lw $t0, -16($s2)
subu $sp, $sp, 8
sw $s5, 4($sp)
sw $t0, ($sp)
# end: IdentifierExp at 35.23; stackHeight = 12
lw $t0, 8($sp)
sw $s2, 8($sp)
move $s2, $t0
beq $s2, $0, nullPtrException
...
subu $sp, $sp, 4
sw $t0, ($sp)
# end: Call at 35.14; stackHeight = 4
lw $t0, ($sp)
addu $sp, $sp, 4
# end: CallStatement at 35.14; stackHeight = 0
# begin: CallStatement at 36.14; stackHeight = 0
# begin: Call at 36.14; stackHeight = 0
subu $sp, $sp, 4
sw $s2, ($sp)
# begin: StringLiteral at 36.23; stackHeight = 4
li $t0, strLit_100
subu $sp, $sp, 4
sw $t0, ($sp)
# end: StringLiteral at 36.23; stackHeight = 8
lw $t0, 4($sp)
sw $s2, 4($sp)
move $s2, $t0
beq $s2, $0, nullPtrException
...
subu $sp, $sp, 4
sw $t0, ($sp)
# end: Call at 36.14; stackHeight = 4
lw $t0, ($sp)
addu $sp, $sp, 4
# end: CallStatement at 36.14; stackHeight = 0
addu $sp, $sp, 0
lw $ra, ($sp)
addu $sp, $sp, 4
jr $ra
