...
# helpInsert parameter data offset = 4: MethodDeclNonVoid at 65.25
# insert parameter data offset = 4: MethodDeclNonVoid at 70.25
# helpPrint parameter bl offset = 8: MethodDeclVoid at 90.17
# helpPrint parameter lib offset = 4: MethodDeclVoid at 90.17
# lookup parameter data offset = 4: MethodDeclNonVoid at 94.20
# delete parameter data offset = 4: MethodDeclNonVoid at 99.25
# helpDelete parameter data offset = 8: MethodDeclNonVoid at 106.25
# helpDelete parameter isShort offset = 4: MethodDeclNonVoid at 106.25
# helpInsert parameter data offset = 4: MethodDeclNonVoid at 120.25
# field NonNullRedBlackTree.data offset = -16: InstVarDecl at 128.9
# field NonNullRedBlackTree.left offset = 0: InstVarDecl at 129.18
# field NonNullRedBlackTree.right offset = 4: InstVarDecl at 130.18
# field NonNullRedBlackTree.isBlack offset = -20: InstVarDecl at 131.13
# init parameter data offset = 16: MethodDeclNonVoid at 149.32
# init parameter left offset = 12: MethodDeclNonVoid at 149.32
# init parameter right offset = 8: MethodDeclNonVoid at 149.32
# init parameter isBlack offset = 4: MethodDeclNonVoid at 149.32
# helpInsert parameter data offset = 4: MethodDeclNonVoid at 159.25
# lookup parameter data offset = 4: MethodDeclNonVoid at 181.20
# helpDelete parameter data offset = 8: MethodDeclNonVoid at 195.25
# helpDelete parameter isShort offset = 4: MethodDeclNonVoid at 195.25
# adjustAfterDelete parameter doMirrorImage offset = 8: MethodDeclNonVoid at 259.32
# adjustAfterDelete parameter isShort offset = 4: MethodDeclNonVoid at 259.32
# getRight parameter doMirrorImage offset = 4: MethodDeclNonVoid at 379.25
# getLeft parameter doMirrorImage offset = 4: MethodDeclNonVoid at 388.25
# setRight parameter node offset = 8: MethodDeclVoid at 393.17
# setRight parameter doMirrorImage offset = 4: MethodDeclVoid at 393.17
# setLeft parameter node offset = 8: MethodDeclVoid at 403.17
# setLeft parameter doMirrorImage offset = 4: MethodDeclVoid at 403.17
# rebalanceAfterInsert parameter doMirrorImage offset = 4: MethodDeclNonVoid at 410.25
# helpPrint parameter bl offset = 8: MethodDeclVoid at 460.17
# helpPrint parameter lib offset = 4: MethodDeclVoid at 460.17
# helpPrintIndent parameter bl offset = 8: MethodDeclVoid at 483.17
# helpPrintIndent parameter lib offset = 4: MethodDeclVoid at 483.17
# field BooleanList.val offset = -16: InstVarDecl at 502.13
# field BooleanList.next offset = 0: InstVarDecl at 503.17
# init parameter val offset = 8: MethodDeclNonVoid at 505.24
# init parameter next offset = 4: MethodDeclNonVoid at 505.24
...
# begin: This at 151.2; stackHeight = 8
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 151.2; stackHeight = 12
    lw $t1, ($sp)
    addu $sp, $sp, 4
...
# begin: This at 152.2; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 152.2; stackHeight = 8
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
...
# begin: This at 153.2; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 153.2; stackHeight = 8
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
...
# begin: This at 154.2; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 154.2; stackHeight = 8
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
...
# begin: Break at 226.25; stackHeight = 16
    addu $sp, $sp, 4
    j break_target_380
# end: Break at 226.25; stackHeight = 16
    j if_done_371
  if_else_371:
# begin: Block at 227.7; stackHeight = 16
# end: Block at 227.7; stackHeight = 16
  if_done_371:
# end: If at 226.7; stackHeight = 16
# begin: Assign at 227.12; stackHeight = 16
# begin: IdentifierExp at 227.14; stackHeight = 16
    lw $t0, 0($sp)
    subu $sp, $sp, 4
    sw $t0, ($sp)
# end: IdentifierExp at 227.14; stackHeight = 20
    lw $t0, ($sp)
    addu $sp, $sp, 4
    sw $t0, 4($sp)
# end: Assign at 227.12; stackHeight = 16
    addu $sp, $sp, 4
...
# begin: This at 233.3; stackHeight = 28
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 233.3; stackHeight = 32
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
...
mth_NonNullRedBlackTree_rebalanceAfterInsert:
    subu $sp, $sp, 4
    sw $ra, ($sp) #**"RA:rebalanceAfterInsert"
...
# begin: This at 429.7; stackHeight = 24
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 429.7; stackHeight = 28
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
...
# begin: This at 506.2; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 506.2; stackHeight = 8
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
...
# begin: This at 507.2; stackHeight = 4
    subu $sp, $sp, 4
    sw $s2, ($sp)
# end: This at 507.2; stackHeight = 8
    lw $t1, ($sp)
    addu $sp, $sp, 4
    beq $t1, $zero, nullPtrException
    lw $t0, ($sp)
